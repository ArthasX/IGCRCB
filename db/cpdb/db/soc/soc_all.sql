...
CREATE TABLE SOC0103  (
	AURID INTEGER NOT NULL , 
...
CREATE TABLE SOC0109  (
	...
	CREQUIRED VARCHAR(8),
	PRIMARY KEY (CID), 
	FOREIGN KEY (EID) REFERENCES SOC0117(EID) ON DELETE CASCADE
)TABLESPACE SOC_SPACE;

CREATE TABLE SOC0107  (
	CIID INTEGER NOT NULL , 
	CID INTEGER NOT NULL , 
	EIID INTEGER NOT NULL , 
	EID INTEGER NOT NULL , 
	...
	CISMALLVERSION INTEGER,
	PRIMARY KEY (CIID), 
	FOREIGN KEY (CID) REFERENCES SOC0109(CID) ON DELETE CASCADE
)TABLESPACE SOC_SPACE;

CREATE TABLE SOC0108  (
	ciid  INTEGER  NOT NULL,
	cid  INTEGER  NOT NULL,
	eiid  INTEGER  NOT NULL,
	eid  INTEGER  NOT NULL,
...
CREATE TABLE SOC0118  (
	...
	PRIMARY KEY (EIID), 
	FOREIGN KEY (EID) REFERENCES SOC0117(EID) ON DELETE CASCADE, 
	FOREIGN KEY (EIROOTMARK) REFERENCES SOC0118(EIID) ON DELETE CASCADE
)TABLESPACE SOC_SPACE;

CREATE TABLE SOC0119  (
...
ALTER TABLE SOC0119 PCTFREE 0;

CREATE INDEX CLDEIID ON SOC0119 (CLDEIID ASC);

CREATE INDEX PAREIID ON SOC0119 (PAREIID ASC);

CREATE TABLE SOC0120  (
...
CREATE TABLE SOC0405  ( 
	LVID INTEGER NOT NULL , 
	HOSTNAME VARCHAR(32) , 
	VGNAME VARCHAR(32) , 
	LVTYPE VARCHAR(16) , 
	LVNAME VARCHAR(32) , 
...
CREATE TABLE SOC0434(
	PVVID INTEGER NOT NULL,
	SN VARCHAR(64),
	PVID VARCHAR(64),
	SNAME VARCHAR(64),
	LUNID VARCHAR(32),
