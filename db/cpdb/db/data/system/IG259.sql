insert into IG259 (PTID, PTNAME, PTTYPE, PTSTARTPG, PTDETAILPG, PTCRTDATE, PTPICINFO, PTSTATUS, PTSAVEPG, PTQRTZFLAG, FINGERPRINT)
...
insert into IG259 (PTID, PTNAME, PTTYPE, PTSTARTPG, PTDETAILPG, PTCRTDATE, PTPICINFO, PTSTATUS, PTSAVEPG, PTQRTZFLAG, FINGERPRINT)
values (6, '个人工作', 'WB', 'IGEXTWB0102_Disp.do', 'IGEXTWB0103_Disp.do?prid=', '2009/07/17', 'images/wkm/extwb/extwb.gif', 'a', 'IGMTP0102.do,personTask.do', 'WP', '');

insert into IG259 (PTID, PTNAME, PTTYPE, PTSTARTPG, PTDETAILPG, PTCRTDATE, PTPICINFO, PTSTATUS, PTSAVEPG, PTQRTZFLAG, FINGERPRINT)
values (7, '指派工作', 'WA', 'IGEXTWA0102_Disp.do', 'IGEXTWA0103_Disp.do?prid=', '2009/07/17', 'images/wkm/extwa/extwa.gif', 'a', 'IGMTP0101.do,enterpriseTask.do', 'WE', '');
