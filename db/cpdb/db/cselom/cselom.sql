...
CREATE TABLE GINOUTSTOCKDETAIL (
...
CREATE VIEW GOutStockVW AS
    SELECT  A.GOID,
            ...
            B.GSFREEZENUM
    FROM GOutStock A
    LEFT OUTER JOIN GStock B ON(A.GOCATEGORY = B.GSCATEGORY and A.GOCODE = B.GSCODE and A.GOORG = B.GSORG);

CREATE VIEW GinoutStockDetailVW AS
     SELECT  A.GIODID,
            A.GIODTYPE, 
            A.GIODORG, 
            A.GIODCATEGORY, 
            ...
            B.GSAVGPRICE,
            B.GSFREEZENUM
    FROM    GINOUTSTOCKDETAIL A
    LEFT OUTER JOIN GStock B ON(A.GIODCATEGORY = B.GSCATEGORY and A.GIODCODE = B.GSCODE and A.GIODORG = B.GSORG) where A.GIODTYPE = '0';

CREATE VIEW RecptionGuestInfo AS
SELECT a.rid,
          b.rname,
          b.rapporgid,
          b.retime,
          b.rstime,
          b.rpporg,
          b.rdescription FROM  RECPTIONGUEST  a,RECPTION b where a.rid=b.rid;