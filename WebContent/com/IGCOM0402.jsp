...
<bean:define id="id" value="IGCOM0402" toScope="request" />
  ...
  <div id="main_top_person">
      <div id="box10">
		<div id="showJobPersion" >
			<h1>处理中工作</h1><font style="font-family:Arial, Helvetica, sans-serif">个人&nbsp;|&nbsp;<a href="javascript:switchShowJob('2')" style="color: #006BC6">全部</a></font>
		</div>
		<div id="showJobGrpup" style="display:none">
			<h1>处理中工作</h1><font style="font-family:Arial, Helvetica, sans-serif"><a href="javascript:switchShowJob('1')" style="color: #006BC6">个人</a>&nbsp;|&nbsp;全部</font>
		</div>
    <div id="persionAsc">
        <table width="980" border="0" cellspacing="0" cellpadding="0" style="margin-left:8px">
	      <tr align="left">
                <th width="60"></th>
                <th width="40"></th>
                <th width="100">编号</th>
                <th width="200">名称</th>
                <th width="200">类型</th>
                <th width="100"><a href="javascript:showPersionList();">开始时间<img src="images/timedown.gif" border="0"></a></th>
                <th width="100">处理角色</th>
                <th width="80">处理人</th>
                <th width="100">状态</th>
	      </tr>
		<logic:iterate id="processRecordInfo" name="igcom03041VO" indexId="index" property="processRecordInfoForMeListAsc" type="com.deliverik.framework.workflow.prr.model.IG677Info">
               ...
               <tr>
                  <td colspan="9"><img src="images/td_line_bg2.gif" border="0" height="1" /></td>
		     </tr>
		</logic:iterate>
       <tr> 	
          <td colspan="9">
    ...
    <div id="persion" style="display:none">
       <table width="980" border="0" cellspacing="0" cellpadding="0" style="margin-left:8px">
	      <tr align="left">
                ...
                <th width="200">名称</th>
                <th width="200">类型</th>
                <th width="100"><a href="javascript:showPersionListAsc();">开始时间<img src="images/timeup.gif" border="0" /></a></th>
                <th width="100">处理角色</th>
                <th width="80">处理人</th>
                <th width="100">状态</th>
	      </tr>
   ...
   <div id="groupAsc" style="display:none">
        <table width="980" border="0" cellspacing="0" cellpadding="0" style="margin-left:8px">
	      <tr align="left">
                ...
                <th width="200">名称</th>
                <th width="200">类型</th>
                <th width="100"><a href="javascript:showGroupList();">开始时间<img src="images/timedown.gif" border="0"></a></th>
                <th width="100">处理角色</th>
                <th width="80">处理人</th>
                <th width="100">状态</th>
	      </tr>
   ...
   <div id="group" style="display:none">
        <table width="980" border="0" cellspacing="0" cellpadding="0" style="margin-left:8px">
	      <tr align="left">
                ...
                <th width="200">名称</th>
                <th width="200">类型</th>
                <th width="100"><a href="javascript:showGroupListAsc();">开始时间<img src="images/timeup.gif" border="0"></a></th>
                <th width="100">处理角色</th>
                <th width="80">处理人</th>
                <th width="100">状态</th>
	      </tr>
