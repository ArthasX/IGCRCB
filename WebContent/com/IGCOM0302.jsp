...
<html:html>
<bean:define id="id" value="IGCOM0302" toScope="request"/>
        ...
        function setParentValue(eid, elabel, ename, eiid, eilabel, einame, ecategory, eiversion){
            if(!window.opener.closed){
                if(document.forms[0].pidid.value=="" || document.forms[0].pidid.value==null){
                	window.opener.setParamIGCOM0302(eid, elabel, ename, eiid, eilabel, einame ,ecategory);
	            }else{
	 		 		if(window.opener.gid=="IGZWJ0101"){
	 		 			window.opener.setParamIGCOM0302(eid, elabel, ename, eiid, eilabel, einame , ecategory, document.forms[0].pidid.value, eiversion);
	 		 		}else if(window.opener.gid=="IGPRR0101"){
	 		 			window.opener.setParamIGCOM0302(eid, elabel, ename, eiid, eilabel, einame , ecategory, document.forms[0].pidid.value, eiversion);
	 		 		}else if(window.opener.gid == "IGDRM0110"){
	 		 			window.opener.setParamIGCOM0302(eid, elabel, ename, eiid, eilabel, einame , ecategory, eiversion,document.forms[0].pidid.value);
	 		 		}
	 		 		else {
		            	window.opener.setParamIGCOM0302(eid, elabel, ename, eiid, eilabel, einame , ecategory, document.forms[0].pidid.value, eiversion);	 			
	 		 		}
...
<div id="maincontent">
<div id="container">
        <html:form styleId="form" action="/IGCOM0302" onsubmit="return checkSubmit(this);">
    ...
    <div id="location">
        ...
        <div id="search">
            ...
            <div class="conditions">
                <div>
                	<label>所属模型：</label><html:text name="IGCOM0329Form" property="ename" styleId="ename" errorStyleClass="inputError imeDisabled" size="10" readonly="true"/>
					...
					<%}else{ %>
					<img src="images/tree.gif" style="cursor: hand;" alt="所属模型" width="16" height="16" border="0" 
							onclick="setEntity('IGCIM1203_ENTITY_TREE.do?levelnode=');"/>
					<%} %>
					<html:hidden name="IGCOM0329Form" property="esyscodingbegin" styleId="esyscodingbegin"/>
					<html:hidden name="IGCOM0329Form" property="esyscoding" styleId="esyscoding"/>&nbsp;&nbsp;
					<html:hidden name="IGCOM0329Form" property="estatus" styleId="estatus"/>

	                <label>资产名称：</label><html:text name="IGCOM0329Form" property="einame" styleId="einame" errorStyleClass="inputError imeDisabled" size="10"/> 
		...
		<div id="results_list">
	       ...
	       <table width="100%" class="table_style">
	            ...
	            <!-- body部 -->
	                ...
	                <logic:present name="IGCOM03291VO" property="entityDataList" >
	                    <logic:iterate id="bean" name="IGCOM03291VO" property="entityDataList" indexId="index">
	                        <tr  >
                                      <!-- 选择 -->
                                      <td>
                                          <div class="nowrapDiv">
	    ...
	    <html:hidden name="IGCOM0329Form" property="emodeltype_eq" styleId="emodeltype_eq"/>
