...
<title><bean:message bundle="comResources" key="ietitle.IGCOM0314"/></title>
...
<!--
	...
	var xiSwfUrlStr = "images/dbmswf/EnhancedRavisGraph_HOST.swf";
	...
	function changeColorByFs(eiid,domainversion){
		 var res;
		 var objAjax = new Ajax.Request(getAppRootUrl() + ajaxAction,{asynchronous:false, 
				parameters: 'type=changeColorByFs&eiid='+eiid+'&domainversion='+domainversion,
				 onSuccess:  function(req, json){
				 var result=req.responseText;
					if(result != null && result != ""){
						res=result;
		 ...
		 EnhancedRavisGraph.setShowDataIOByFs(res);
	}

	function changeColorByLv(eiid,domainversion){
		 var res;
		 var objAjax = new Ajax.Request(getAppRootUrl() + ajaxAction,{asynchronous:false, 
				parameters: 'type=changeColorByLv&eiid='+eiid+'&domainversion='+domainversion,
				 onSuccess:  function(req, json){
				 var result=req.responseText;
					if(result != null && result != ""){
						res=result;
		 ...
		 EnhancedRavisGraph.setShowDataIOByLv(res);
	}

	function changeColorByVg(eiid,domainversion){
		 var res;
		 var objAjax = new Ajax.Request(getAppRootUrl() + ajaxAction,{asynchronous:false, 
				parameters: 'type=changeColorByVg&eiid='+eiid+'&domainversion='+domainversion,
				 onSuccess:  function(req, json){
				 var result=req.responseText;
					if(result != null && result != ""){
						res=result;
	...
	function changeColorByPv(eiid,domainversion){
		 var res;
		 var objAjax = new Ajax.Request(getAppRootUrl() + ajaxAction,{asynchronous:false, 
				parameters: 'type=changeColorByPv&eiid='+eiid+'&domainversion='+domainversion,
				 onSuccess:  function(req, json){
				 var result=req.responseText;
					if(result != null && result != ""){
						res=result;
		 ...
		 EnhancedRavisGraph.setShowDataIOByPv(res);
	}
