...
<html:html>
<bean:define id="id" value="IGCOM0327" toScope="request"/>
...
<div id="maincontent">
<div id="container">
        <html:form styleId="form" action="/IGCOM0327" onsubmit="return checkSubmit(this);">
    ...
    <div id="location">
        ...
        <div id="search">
            ...
            <div class="conditions">
                <div>
                	<label><bean:message bundle="comResources" key="label.IGCOM0302.model"/></label><html:text name="IGCOM0327Form" property="ename" styleId="ename" errorStyleClass="inputError imeDisabled" size="10" readonly="true"/>
					<logic:notEqual value="false" name="IGCOM0327Form" property="flag">
					...
					<html:hidden name="IGCOM0327Form" property="flag" styleId="flag"/>
	                ...
	                <label><bean:message bundle="comResources" key="label.IGCOM0302.assetname"/></label><html:text name="IGCOM0327Form" property="einame" styleId="einame" errorStyleClass="inputError imeDisabled" size="10"/> 
	    ...
	    <html:hidden name="IGCOM0327Form" property="pidid" styleId="pidid"/>
    </html:form>
</div>
