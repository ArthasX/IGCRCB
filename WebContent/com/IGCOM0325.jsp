...
<title><bean:message bundle="comResources" key="ietitle.IGCOM0325"/></title>
...
<!--
	...
	var xiSwfUrlStr = "images/dbmswf/EnhancedRavisGraph_SWITCH.swf";
	...
	function changeColorByPort(eiid,domainversion){
		 var res;
		 var objAjax = new Ajax.Request(getAppRootUrl() + ajaxAction,{asynchronous:false, 
				parameters: 'type=changeColorByPort&eiid='+eiid+'&domainversion='+domainversion,
				 onSuccess:  function(req, json){
				 var result=req.responseText;
					if(result != null && result != ""){
						res=result;
		 ...
		 EnhancedRavisGraph.setShowDataIOByPort(res);
	}

	function changeColorByZonging(eiid,domainversion){
		 var res;
		 var objAjax = new Ajax.Request(getAppRootUrl() + ajaxAction,{asynchronous:false, 
				parameters: 'type=changeColorByZonging&eiid='+eiid+'&domainversion='+domainversion,
				 onSuccess:  function(req, json){
				 var result=req.responseText;
					if(result != null && result != ""){
						res=result;
		 ...
		 EnhancedRavisGraph.setShowDataIOByZonging(res);
	}
