...
<html:html>
<bean:define id="id" value="IGCRC2402" toScope="request" />
<bean:define id="title" value="事件平均响应时间统计" toScope="request" />
<!-- header1 -->
...
function onExcel(){
	//导出校验
	if(isDepartment() && isYear()){
		form.action = "IGCRC2402_Excel.do";
		form.submit();
	}
}
...
function modify(obj){
	...
	var url = "/IGDBM1200.do?propentime_like="+propentime_like+
			"&prpdid=01080&ppuserid="+userid+"&alarm_Is=0&ppstatus=W&ppbacktime_isNull=0";
...
<div id="contentWrap">
<div id="content">
	<html:form action="/IGCRC2402" styleId="form">
	<div id="location">
	<div class="image"></div>
	...
	<div>
		<span style="font-size:15px;"><strong>事件平均响应时间统计</strong></span>
	</div>
