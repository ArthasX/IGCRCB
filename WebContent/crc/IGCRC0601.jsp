...
%>
<html:html>
<bean:define id="id" value="IGCRC0601" toScope="request" />
...
<script type="text/javascript">
	function setTree(){
		var temp = window.showModalDialog("IGSYM1505_TREE.do?ccid=296",null,"dialogWidth:400px;dialogHeight:500px;status:no;help:no;resizable:yes");
		if("_resetall"==temp){
...
<div id="content">
	...
	<table class="table_style">
		<tr>
			...
			<th width="18%"><a href="IGWKM0103.do?orderVal=prtitle">服务请求名称			
