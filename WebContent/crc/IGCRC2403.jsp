...
<html:html>
<bean:define id="id" value="IGCRC2403" toScope="request" />
<bean:define id="title" value="告警平均解决时间统计" toScope="request" />
<!-- header1 -->
...
function onExcel(){
	//导出校验
	if(isDepartment() && isYear()){
		form.action = "IGCRC2403_Excel.do";
		form.submit();
	}
}
...
function modify(obj){
	...
	var url = "/IGDBM1200.do?propentime_like="+propentime_like+
			"&prpdid=01080&ppuserid="+userid+"&alarm_Is=1&ppstatus=W";
	//var url = '/IGDBM1200.do?prid_in='+pridIn;
	window.openSubWindow(url,"_blank", 1100, 600);
}
jQuery(function(){
...
<div id="contentWrap">
<div id="content">
	<html:form action="/IGCRC2403" styleId="form">
	<div id="location">
	<div class="image"></div>
	...
	<div>
		<span style="font-size:15px;"><strong>告警平均解决时间统计</strong></span>
	</div>
