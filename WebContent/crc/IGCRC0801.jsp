...
%>
<html:html>
<bean:define id="id" value="IGCRC0801" toScope="request" />
...
<div id="content">
	...
	<div style="margin-top:12px;">
		...
		<html:text property="propentime" styleId="propentime" errorStyleClass="inputError imeDisabled" size="16" readonly="true" style="width:125px;"/>
		<img src="images/date.gif" align="middle" onclick="calendar($('propentime'))" border="0" style="cursor: hand" />
		<span></span>
		<html:text property="prclosetime" styleId="prclosetime" errorStyleClass="inputError imeDisabled" size="16" readonly="true" style="width:125px;"/>
			...
			<logic:iterate id="bean" name="IGWKM01011VO" property="processList"
				...
				<logic:notEqual name="bean" property="prtype"  value="<%=IGPROCESSType.SELF_DEFINING_WORK_PRTYPE %>">
					...
					<td><%-- <bean:write name="bean"
						property="prtitle" /> --%>
						<ig:publicProcessInfoValue pidname="文档名称" prid="${bean.prid}"/>
					</td>
					<td><bean:write name="bean"
						property="prusername" />
					</td>
