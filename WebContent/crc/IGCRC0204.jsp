...
<html:html>
<bean:define id="id" value="IGCRC0204" toScope="request" />
			...
			<div id="contentWrap">
				<div id="content">
					<div id="location">
						...
						<div class="back"><a href="IGCRC0203_Disp.do" target="_self">返回</a></div> 
					</div>
					
					<div id="formwrapper">
						<html:form styleId="form"
							action="/IGCRC0203_Upadte.do">
							<!--  message -->
							<ig:message />
							<!--  /message -->
							<fieldset>
								...
								<div>
									...
									<input type="hidden" name="pedeventid" value="${IGCRC0203VO.igalarmInfo.pedeventid}" />
								</div>
								...
								<c:if test="${IGCRC0203VO.igalarmInfo.shieldflag=='1' }">
									<div>
										<label for="Name"><strong>关联变更/演练</strong>：</label>
										<p class="p2">${IGCRC0203VO.igalarmInfo.shielddesc }</p>
									</div>
								</c:if>
