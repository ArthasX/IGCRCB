...
<html>
<bean:define id="id" value="IGCRC0701" toScope="request" />
...
<div id="contentWrap">
<div id="content"><html:form action="/IGPRR0101_QuartzSdl_Insert" styleId="form"
	...
	<div id="location">
	<div class="image"></div>
	<p class="fonts1"><p class="fonts1">日常工作计划&gt;&gt; 工作发起</p>
	</div>
	<div>
        ...
        <legend>任务信息</legend>
         <table width="100%" border="0">
          <tr>
            ...
            <td width="37%">${IGMTP0101Form.qjname }</td>
            <td width="10%"><label><strong>任务描述</strong>：</label></td>
            <td width="36%">${IGMTP0101Form.qjdesc }</td>
            </tr>
          <tr>
            <td>&nbsp;</td>
            <td><label><strong>执行人员</strong>：</label></td>
            <td>${IGMTP0101Form.qjimplusername }</td>
           <td><label><strong>创建人员</strong>：</label></td>
            <td>${IGMTP0101Form.qjcrtusername }</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><label><strong>开始时间</strong>：</label></td>
            <td>${IGMTP0101Form.qjcrttime }</td>
            <td><label><strong>结束时间</strong>：</label></td>
            <td>${IGMTP0101Form.qjendtime }</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><label><strong>执行时间</strong>：</label></td>
            <td>${IGMTP0101Form.qjperiodinfo }</td>
            <td></td>
            <td></td>
            <%-- <td><label><strong>调度方式</strong>：</label> </td>
            <td><ig:codeValue ccid="STRATEGY_WORK_CODE" cid="${IGMTP0101Form.qjtype}" /></td> --%>
            <html:hidden property="quartzTime" value="${IGMTP0101Form.dotime}" />
          </tr>
        </table>
    </fieldset>
    </div>
...
<%-- 				<html:textarea property="prdesc" cols="60" rows="6"  errorStyleClass="inputError imeActive"></html:textarea></td> --%>
	...
	<html:hidden property="prpdname" styleId="prpdname" name="IGPRR0101Form" />
