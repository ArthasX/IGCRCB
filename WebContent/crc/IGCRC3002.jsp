...
<html:html>
<bean:define id="id" value="IGCRC3002" toScope="request" />
<bean:define id="title" value="对外服务查询" toScope="request" />
<!-- header1 -->
...
<div id="content">
	...
	<html:submit styleClass="button" value="查询" /> &nbsp;<input type="button" value="导出" class="button" onclick="onExcel()">
	</div>
