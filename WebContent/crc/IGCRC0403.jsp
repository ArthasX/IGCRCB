...
<bean:define id="id" value="IGCRC0403" toScope="request" />
<bean:define id="title" value="变更批量分派" toScope="request" />
...
<div id="contentWrap">
<div id="content">
<html:form action="/IGCRC0403" styleId="form" onsubmit="return checkSubmit(this);" >
