...
<html:html>
<bean:define id="id" value="IGCRC1001" toScope="request" />
...
<div id="content">
	...
	<div style="margin-top:4px;">
		...
		<span class="subscribe">程序更新名称：</span>
    	...
    	<html:submit styleClass="button" value="查询"  onclick="onSearch()"/></div>
		<html:hidden property="selectstatus" name="selectstatus" value="1"/>
    </div>
	<div style="margin-left:78px;">
		<span class="subscribe" style="width:84px;">处理人：</span>
		...
		<logic:present name="AD_ProcessInfoQueryMap" scope="session">
			<logic:iterate id="map" name="AD_ProcessInfoQueryMap" scope="session" indexId="index">
				...
				<ig:processInfoQuery pdid="${bean.pdid }" pidname="${bean.pidname }" name="IGWKM0101Form" property="varvalues[${index }]" style="margin-left:8px;margin-top:8px;" styleClassTagName="subscribe"/>
			</logic:iterate> 
		</logic:present>
	...
	<div style="display:none;margin-left: 78px" id="div_0.25">
	<br />
	...
	<table class="table_style">
		<tr>
			...
			<th width="20%"><a href="IGWKM0103.do?orderVal=prtitle">程序更新名称			
			...
			<logic:iterate id="bean" name="IGWKM01011VO" property="processList"
				...
				<logic:notEqual name="bean" property="prtype"  value="<%=IGPROCESSType.SELF_DEFINING_WORK_PRTYPE %>">
					...
					<td><bean:write name="bean" 
						property="prserialnum" />
					</td>
					<td><bean:write name="bean"
						property="prtitle" />
					</td>
					<td>
					<ig:publicProcessInfoValue pidname="是否需要测试" prid="${bean.prid}"/>
					</td>
					<td><bean:write name="bean" 
						property="prusername" />
					</td>
