...
<html:html>
<bean:define id="id" value="IGCRC0901" toScope="request" />
...
<div id="content">
	...
	<div style="margin-top:12px;">
		...
		<html:text errorStyleClass="inputError imeActive" property="content" size="40" style="width:302px"/>
