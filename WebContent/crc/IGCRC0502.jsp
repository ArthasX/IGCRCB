...
<bean:define id="id" value="IGCRC0502" toScope="request" />
...
function initAttFormFile(){
	...
	var access = jQuery("#pidid"+pdid+"006").parent().find("input[name='pidaccess']").val();
	if (access == "2" || access == "3") {
		jQuery("#pidid"+pdid+"006").parent().parent().hide();
	}
