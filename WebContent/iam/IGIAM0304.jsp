...
<html:html>
<bean:define id="id" value="IGIAM0304" toScope="request" />
<bean:define id="title" value="外审项目登记画面" toScope="request" />
<!-- header1 -->
...
<div id="location">
<div class="image"></div>
<p class="fonts1">审计管理 &gt;&gt; 外审项目管理 &gt;&gt; 外审项目登记</p>
</div>
...
function checktext(){
    ...
    if($F("iapOpenTime")>$F("iapCloseTime")){
        alert('审计开始日期不能晚于审计结束日期！');
        return false;
    }
...
<div id="formwrapper">
<html:form styleId="form" action="/IGIAM0303_Insert" enctype="multipart/form-data">
	<ig:message />
	<fieldset>
		<legend>新增外审项目信息</legend>
		...
		<div><label for="Name"><span class="red">*</span><strong>检查项目名称</strong>：</label>
			<html:text property="iapName" styleId="iapName" size="82"></html:text>
		</div>
		<div><label for="Name"><span class="red">*</span><strong>检查来源</strong>：</label>
		<html:select property="iapSource" style="WIDTH:130px">
	...
	<html:hidden property="iapType" styleId="iapType" value="1"/>
    <div class="enter"><html:submit property="btn_save" value="提交" onclick="return onSubmit();" styleClass="button"  />
