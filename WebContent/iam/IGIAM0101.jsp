...
<html:html>
<bean:define id="id" value="IGIAM0101" toScope="request" />
<bean:define id="title" value="内审项目管理画面" toScope="request" />
<!-- header1 -->
...
<div id="contentWrap">
<div id="content">
<html:form styleId="form" action="/IGIAM0101_SEARCH"
	onsubmit="return checkSubmit(this);">
	
<div id="location">
<div class="image"></div>
<p class="fonts1">审计管理 &gt;&gt; 内审项目管理 &gt;&gt; 内审项目管理</p>
</div>
<div id="search">
	<div class="img"></div>
	...
	<span>&nbsp;&nbsp;状态：</span>
	<html:select property="iapStatus">
		<ig:optionsCollection ccid="IAPSTATUS" isMakeBlankRow="true" />
	</html:select><br>
	<span>&nbsp;&nbsp;审计时间：</span>
			...
			<logic:present name="IGIAM01011VO" property="internalauditprjInfoList">
				<logic:iterate id="bean" name="IGIAM01011VO"
					...
					<tr>
						...
						<td><a href="IGIAM0102_DetailedToUpdate.do?iapId=${bean.iapId}&jump=0" ><img src="images/xx.gif" border="0" alt="详细" /></a></td>
						</c:if>
						<c:if test="${bean.iapStatus == 1}">
						<td><a href="IGIAM0102_DetailedSearch.do?iapId=${bean.iapId}&jump=0" ><img src="images/xx.gif" border="0" alt="详细" /></a></td>
						</c:if>
						...
						<td>
							<c:if test="${bean.hasProblem == 'Y'}">
								<a href="IGIAM0503.do?prcorid=${bean.iapId}&bkmode=2" ><img src="images/d1.gif" border="0" alt="问题" /></a>
							</c:if>
							<c:if test="${bean.hasProblem == 'N'}">
								<a href="#" ><img src="images/d1g.gif" border="0"  /></a>
							</c:if>
						</td>
					</tr>
				</logic:iterate>
