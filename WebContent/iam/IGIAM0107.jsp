...
<html:html>
<bean:define id="id" value="IGIAM0107" toScope="request" />
...
<div id="contentWrap">
<div id="content">
<html:form styleId="form" action="/IGIAM0105_SEARCH"
...
<div id="search">
	...
	<html:select property="iapStatus">
		<ig:optionsCollection ccid="IAPSTATUS"/>
	</html:select><br>
			...
			<logic:present name="IGIAM01011VO" property="internalauditprjInfoList">
				<logic:iterate id="bean" name="IGIAM01011VO"
					...
					<tr>
						...
						<td><a href="IGIAM0102_DetailedSearch.do?iapId=${bean.iapId}&jump=1" ><img src="images/xx.gif" border="0" alt="详细" /></a></td>
					</tr>
				</logic:iterate>
			</logic:present>
	</table>
