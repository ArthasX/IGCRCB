...
<html:html>
<bean:define id="id" value="IGIAM0407" toScope="request" />
...
<div class="msg_box"><html:form styleId="form" action="/IGIAM0401_SEARCH.do">
	<div class="msg_img"><img src="images/Round_Icon_09.gif"
		border="0" /></div>
	<div class="msgcontent"><div class="txMessageInf">审计报告信息保存成功！</div></div>
