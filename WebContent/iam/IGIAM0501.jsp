...
%>
<html:html>
<bean:define id="id" value="IGIAM0501" toScope="request" />
...
<div id="contentWrap">
<div id="content">
	<html:form action="/IGIAM0501" styleId="form" onsubmit="return checkSubmit(this);">
	<div id="location">
	<div class="image"></div>
		...
		<logic:present name="IGWKM01011VO" property="processList">
			<logic:iterate id="bean" name="IGWKM01011VO" property="processList"
				...
				<bean:define id="prtype" name="bean" property="prtype" />
					...
					onclick="doLook(getAppRootUrl()+'/IGPRR0102_Disp.do?prid=<bean:write name="bean" property="prid" />&jump=99');">
