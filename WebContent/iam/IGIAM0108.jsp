...
<html:html>
<bean:define id="id" value="IGIAM0108" toScope="request" />
...
<div id="maincontent">
<div id="content">
<html:form styleId="form" action="/IGIAM0101_HELPSEARCH"
...
<%-- 	<html:hidden property="iapType" name="IGIAM0102Form" value="0"/> --%>
	...
	<input type="button"  class="button" onclick="javascript:clearForm();" value="清空" />
	</div>
	</div>
	</div>
	<div id="results_list">
