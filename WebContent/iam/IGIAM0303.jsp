...
<html:html>
<bean:define id="id" value="IGIAM0303" toScope="request" />
<bean:define id="title" value="外审项目修改画面" toScope="request" />
<!-- header1 -->
...
<div id="location">
<div class="image"></div>
<p class="fonts1">审计管理 &gt;&gt; 外审项目管理 &gt;&gt; 外审项目管理 &gt;&gt; 外审项目信息修改</p>
<div class="back"><a href="IGIAM0302_Back.do" target="_self">返回</a></div>
</div>
<head>
...
function saveMessage() {
	...
	if(window.confirm("是否保存当前信息？")){
		form.action="IGIAM0302_Update.do";
		form.submit();
	} else {
		return false;
	}
...
<div id="formwrapper">
<html:form styleId="form" action="/IGIAM0302_Delete" enctype="multipart/form-data">
	<ig:message />
	<fieldset>
