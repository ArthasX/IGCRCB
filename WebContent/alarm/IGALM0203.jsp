...
<html:html>
<bean:define id="id" value="IGALM0203" toScope="request" />
...
function toback(){
    form1.action = getAppRootUrl() + "/IGALM0202_Back.do?";
    form1.submit();
}
</script>
<body>
...
<div id="location">
<div class="image"></div>
<p class="fonts1"><ig:navigation extname1="${urlable}"/> &gt;&gt; 规则模板变更</p>
<div class="back"><html:link href="javascript:toback();">返回</html:link></div> 
</div>
<div id="formwrapper"><html:form styleId="form1"
	action="/IGALM0203_Edit" onsubmit="return checkSubmit(this);" enctype="multipart/form-data">
	<!--  message -->
	<ig:message />
	<!--  /message -->
	<fieldset>
	...
	<div>
	    ...
	    <html:select name="IGALM0201Form" property="categoryid" style="width: 150px;" tabindex="4" styleId="category">
	    	<html:options collection="monitorIndexList" property="value" name="" labelProperty="label" />
	    </html:select><br />
	</div>
	...
	<fieldset>
		<legend>规则条件</legend>
    <bean:size id="xh" name="IGALM02031VO" property="crm07TBList"/>
    <c:if test="${xh==null }">
		<c:set value="0" var="xh"></c:set>
    </c:if>
    <div align="right">
  <input name="add" type="button" class="button" value="添加条件" onclick="addWHMFile(${xh});"/>
	...
	<table class="table_style" id="tb2">
		...
		<logic:present name="IGALM02031VO" property="crm07TBList">
			<logic:iterate id="bean" name="IGALM02031VO"
				property="crm07TBList" indexId="index">
				<tr class="<ig:rowcss index="${index}"/>">
					...
					<td><html:text property="alarmmsgs" errorStyleClass="inputError imeActive" value="${bean.alarmmsg}" styleId="alarmmsgs${index}" /></td>
					<td><img src="images/delete.gif" onclick="deleteitem1(this);" border="0" alt="删除添加编辑框！" style="cursor: hand"/></td>
				</tr>
			</logic:iterate>
		</logic:present>
		</table>
    ...
    <html:hidden property="ruletempid"/>
</html:form></div>
</div>
</div>
