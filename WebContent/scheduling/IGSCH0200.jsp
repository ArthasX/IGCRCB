...
<html:html>
<bean:define id="id" value="IGSCH0200" toScope="request" />
<bean:define id="title" value="个人定时任务成功页面" toScope="request" />
...
<div class="msg_box" style="<%="error".equals(type)?"":"display:none" %>">
	...
	<div class="msgcontent1"><ig:message/></div>
	<div class="msgbtn">
	<html:submit property="button" value="返回" styleClass="button" onclick="window.location='IGSCH0001_Disp.do?type=WP';"></html:submit>
	</div>
</div>
