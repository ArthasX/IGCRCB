...
<bean:define id="id" value="IGSCH0202" toScope="request" />
<bean:define id="title" value="个人定时任务" toScope="request" />
...
<!--container 左菜单 右侧内容-->
   ...
   <div id="location">
       <div class="image"></div>
        <p class="fonts1">流程管理 &gt;&gt; 任务调度 &gt;&gt; 个人任务</p>
          <div class="back"><a href="IGSCH0001_Disp.do" target="_self">返回</a></div>
    </div>
       <div id="formwrapper">
		<html:form action="/IGSCH0202" styleId="form" enctype="multipart/form-data">
       <ig:message/>
        <fieldset>
        <legend>任务信息</legend>
        ...
        <table width="700" border="0" cellpadding="3" cellspacing="4">
          ...
          <tr>
            <td width="8%">&nbsp;</td>
            <td width="112" align="right" bgcolor="#eeeeee"><strong>任务描述</strong>：</td>
	...
	<logic:present name="IGSCH02021VO" property="processInfoDefList">
	<logic:notEmpty name="IGSCH02021VO" property="processInfoDefList">
	<logic:iterate id="infoDef" name="IGSCH02021VO" property="processInfoDefList" indexId="index">
	<div>
