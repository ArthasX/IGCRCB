...
<html:html>
<bean:define id="id" value="IGSCH0400" toScope="request" />
<bean:define id="title" value="中止成功页面" toScope="request" />
<!-- header1 -->
...
<div class="msg_box"><html:form styleId="form" action="/IGSCH0401_Disp.do">
