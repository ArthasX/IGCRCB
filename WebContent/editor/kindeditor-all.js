...
_extend(KCmd, {
	...
	insertimage : function(url, title, width, height, border, align,name) {
		title = _undef(title, '');
	...
	self.plugin.image = {
		edit : function() {
			...
			self.plugin.imageDialog({
				...
				clickFn : function(url, title, width, height, border, align,name) {
					self.exec('insertimage', url, title, width, height, border, align,name);
			...
			var uploadbutton = K.uploadbutton({
				...
				afterUpload : function(data) {
					...
					if (data.error === 0) {
						...
						urlBox.val(url);
						!titleBox.val()&&titleBox.val(data.name);
						if (self.afterUpload) {
							self.afterUpload.call(self, url, data, name);
						}
						alert(self.lang('uploadSuccess'));
