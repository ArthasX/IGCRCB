...
<html:html>
<bean:define id="id" value="IGSMR0603" toScope="request" />
...
<html:form action="/IGSMR0602_FIRST" styleId="form" >
        	<div id="results_list">
        ...
        <tr> 
	       ...
	       <logic:present name="IGSMR06011VO" property="map_first">
			<logic:iterate id="map_first" name="IGSMR06011VO" property="map_first">
			...
			<html:link action="/IGPRR0102_Disp.do?prtype=WD2&prid=${info.prid}&jump=89" style="text-decoration:underline;">
		 		${info.prtitle}
<!-- 		 		(报送空表) -->
		 	</html:link>	
		 	</logic:present>
