...
<html:html>
<bean:define id="id" value="IGSMR1102" toScope="request" />
...
<html:form action="/IGSMR1102_DISP" styleId="form" >
        	<div id="results_list">
        ...
        <tr> 
	       ...
	       <logic:present name="IGSMR11011VO" property="map_arq">
			<logic:iterate id="map_arq" name="IGSMR11011VO" property="map_arq">
			...
			<td align="left">	
			<html:link action="/IGPRR0102_Disp.do?prtype=WD3&prid=${info.prid}&jump=101"  style="text-decoration:underline;">
		 		${info.prtitle}
		 	</html:link>
			 </td>
			 <td>
