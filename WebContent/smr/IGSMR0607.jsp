...
<html:html>
<bean:define id="id" value="IGSMR0607" toScope="request" />
			...
			<div id="contentWrap" style="width: 600px;">
				<div id="content">
					<div id="formwrapper" style="width: 600px;">
						<html:form styleId="form" action="/IGSMR0603"
							...
							<fieldset style="width: 550px;">
								<legend>催办信息</legend>								
								<div>
									<html:textarea name="IGSMR0602Form" property="view"
										styleId="view" errorStyleClass="inputError" rows="6"
										cols="40" tabindex="3" />
									<br>
								</div>
								<html:hidden property="prid" name="IGSMR0602Form" />								
							</fieldset>
							<div class="enter">
