...
<html:html>
<bean:define id="id" value="IGSMR0605" toScope="request" />
...
function stop(instanceID){
	...
	form.action="IGSMR0603_STOP.do?instanceID="+instanceID;
	form.submit();
}
function sendmessage(){
	...
	if(null != alids && alids.length > 0){
		var url="IGSMR0603_Modal.do?prid="+prid;
		...
		<div id="container">
			...
			<div id="contentWrap">
				<div id="content">
					...
					<div id="search">
					<html:form action="/IGSMR0603_DISP" styleId="form" onsubmit="return checkForm();">
					 ...
					 <html:select  property="year" styleId="year" style="width:100px;" errorStyleClass="inputError" tabindex="1">
                       ...
                       <span><span class="red">*</span>季度</span>：
						<html:select  property="quarter" styleId="quarter" style="width:100px;" errorStyleClass="inputError" tabindex="1">
			...
			<logic:present name="IGSMR06021VO" property="map_see">
			<logic:iterate id="map_see" name="IGSMR06021VO" property="map_see">
			...
			<html:link action="/IGPRR0102_Disp.do?prtype=WD2&prid=${info.prid}&jump=91" style="text-decoration:underline;">			
		 	${info.prtitle }
<!-- 		 	(报送空表)		 			 	 -->
		 	</html:link>
		 	</logic:present>
			...
			<img src="images/stop_16.png"  border="0" onclick="stop(${info.instanceID});" style="cursor: hand"/>
						...
						<logic:present name="IGSMR06021VO" property="map_see">
						<bean:size id="size" name="IGSMR06021VO" property="map_see"/>
						<c:if test="${size!=0 }">
