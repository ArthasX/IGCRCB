...
<html:html>
<bean:define id="id" value="IGSMR0602" toScope="request" />
...
<html:form action="/IGSMR0602_DISP" styleId="form" >
        	<div id="results_list">
        ...
        <tr> 
	       ...
	       <logic:present name="IGSMR06011VO" property="map_arq">
			<logic:iterate id="map_arq" name="IGSMR06011VO" property="map_arq">
			...
			<td align="left">	
			<html:link action="/IGPRR0102_Disp.do?prtype=WD2&prid=${info.prid}&jump=88"  style="text-decoration:underline;">
		 		${info.prtitle}
		 	</html:link>
			 </td>
			 <td>
