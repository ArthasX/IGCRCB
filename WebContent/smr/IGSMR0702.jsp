...
<html:html>
<bean:define id="id" value="IGSMR0702" toScope="request" />
...
<html:form action="/IGSMR0702" styleId="form" >
        ...
        <tr> 
	       ...
	       <logic:present name="IGSMR07021VO" property="map_arq">
			<logic:iterate id="map_arq" name="IGSMR07021VO" property="map_arq">
			...
			<td align="left">			
			<html:link action="/IGPRR0102_Disp.do?prtype=WD3&prid=${info.prid}&jump=92"  style="text-decoration:underline;">
		 	${info.prtitle}
		 	</html:link>
			 </td>
			 <td>
