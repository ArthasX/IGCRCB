...
<html:html>
<bean:define id="id" value="ITEMS0117" toScope="request" />
<bean:define id="title" value="物品损耗调整页面" toScope="request" />
<!-- header1 -->
...
function checkLength(obj){
	if(obj.value.strlen()>32){
		alert("损耗说明不能大于"+Math.floor(32/strByteFlag)+"个汉字！");
		obj.value = "";
		return;
	}
}
...
<div id="location">
<div class="image"></div>
<p class="fonts1"><ig:navigation extname1="${urlable}"/> &gt;&gt; 物品损耗</p>
<div class="back"><a href="ITEMS0112_BACK.do" target="_self">返回</a></div>
</div>
<html:form action="/ITEMS0117">
<div id="results_list">
