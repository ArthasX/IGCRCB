...
<html:html>
<bean:define id="id" value="ITEM0149" toScope="request"/>
<bean:define id="title" value="申领审批成功提示页面" toScope="request"/>
<!-- header1 -->
...
<div id="contentWrap">
        <div id="content">
			...
			<div class="msg_box">
				...
				<div class="msgcontent"><div class="txMessageInf">审批成功！</div>
