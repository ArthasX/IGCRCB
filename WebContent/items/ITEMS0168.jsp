...
<%
	...
	response.setHeader("Content-disposition","attachment;filename="  + new String( "配送物品清单明细.xls".getBytes("gb2312"), "ISO8859-1" ) );
	ExportExcel.exportITEMS0168(response.getOutputStream(),vo.getOutStocktbList(),form.getOuttime_f(),form.getOuttime_t());
	out.clear();
