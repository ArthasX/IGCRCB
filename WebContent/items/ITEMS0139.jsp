...
<%
	...
	response.setHeader("Content-disposition","attachment;filename="  + new String( "结账清单全明细.xls".getBytes("gb2312"), "ISO8859-1" ) );
	ExportExcel.exportITEMS0139(response.getOutputStream(),vo.getOutStockList(),form.getOuttime_f(),form.getOuttime_t());
	out.clear();
