...
<html:html>
<bean:define id="id" value="IGCIM0202" toScope="request" />
...
function toback(){
	if($F('mode')==0){
		form.action = getAppRootUrl() + "/IGCIM0203_Disp.do";
	}
	if($F('mode')==1){
...
<p class="fonts1">
	<logic:equal name="IGCIM0202Form" property="mode" value="0">
		配置管理 &gt;&gt;数据导入 &gt;&gt;Domain管理 &gt;&gt;Domain登记
	</logic:equal>
	<logic:equal name="IGCIM0202Form" property="mode" value="1">
		配置管理 &gt;&gt;数据导入 &gt;&gt;Domain管理 &gt;&gt;Domain修改
	</logic:equal>
...
<div id="formwrapper"><html:form styleId="form"
	action="/IGCIM0202" onsubmit="return checkSubmit(this);">
	<!--  message -->
