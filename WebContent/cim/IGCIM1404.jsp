...
<html:html>
<bean:define id="id" value="IGCIM1404" toScope="request" />
...
<script type="text/javascript">	
		...
		function confirmDisp(ident){
			...
			<logic:present name="IGCIM14041VO" property="configItemVWInfoMap">
			<logic:iterate id="map" name="IGCIM14041VO" property="configItemVWInfoMap" indexId="number">
        ...
        function toback(){
        	form.action = getAppRootUrl() + "/IGCIM1404.do?org.apache.struts.taglib.html.CANCEL=1";
        	form.submit();
        }
      ...
      //删除附件
    	function delFile(fileid){
    		 if( window.confirm("您是否确定删除附件？")){
    			form.action = getAppRootUrl() + "/IGCIM1404.do?delfile["+fileid+"]="+1+"&ident="+0;
    	        form.submit();
    		 }
      }
	</script>
...
<html:form styleId="form" action="/IGCIM1404"
	...
	<table class="table_style">
		...
		<tr>
			<td align="center">${IGCIM14041VO.entityData.ename}</td>
			<td>${IGCIM14041VO.entityData.eilabel}</td>
			<td>${IGCIM14041VO.entityData.einame}</td>
			<td>${IGCIM14041VO.eiorgname}</td>
			<td>${IGCIM14041VO.entityData.eidesc}</td>
			<td>${IGCIM14041VO.entityData.eiusername}</td>
			<td>${IGCIM14041VO.entityData.eiinsdate}</td>
	...
	<logic:present name="IGCIM14041VO" property="flag">
	<logic:equal value="true" name="IGCIM14041VO" property="flag">	
	<logic:present name="IGCIM14041VO" property="configItemVWInfoMap">
		<div id="TabbedPanels1" class="TabbedPanels">
		<ul class="TabbedPanelsTabGroup">
			<logic:iterate id="map" name="IGCIM14041VO"
		...
		<div class="TabbedPanelsContentGroup"><logic:present
			name="IGCIM14041VO" property="configItemVWInfoMap">
			<logic:iterate id="map" name="IGCIM14041VO"
				property="configItemVWInfoMap" indexId="number">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						<tr  onmouseover="mouseOverNoHand(this);" onmouseout="mouseOutNoHand(this);" <logic:equal name="bean" property="cseq" value="1">style="display: none;"</logic:equal>>
							...
							<logic:equal name="bean" property="cattach" value="4">
								...
								<logic:equal name="bean" property="cattach" value="5">
								<logic:present name="IGCIM1404Form" property="civalue[${ADcount}]">
									<bean:define id="civalue" name="IGCIM1404Form" property="civalue[${ADcount}]" type="java.lang.String" />
								...
								<logic:notPresent name="IGCIM1404Form" property="civalue[${ADcount}]">
									<logic:iterate id="checkboxbean" name="ADlist${ADmapcount}">
	...
	<html:hidden property="eiid" styleId="eiid" value="${IGCIM1404Form.eiid}" />
	<html:hidden property="eiversion" styleId="eiversion" value="${IGCIM14041VO.entityData.eiversion}" />
	<html:hidden property="eiorgsyscoding" styleId="eiorgsyscoding" value="${IGCIM14041VO.entityData.eiorgsyscoding}" />
</html:form></div>
</div>
</div>
