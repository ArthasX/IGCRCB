...
<html:html>
<bean:define id="id" value="IGCIM0101" toScope="request"/>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGCIM0109"
			       ...
			       <table width="100%" class="table_style">
			            <!-- header部 -->
			                <tr>
					           ...
					           <th width="12%"><bean:message bundle="asmResources" key="title.IGCIM0101.devicename"/></th>
					           <!--<th width="17%">序列号</th>-->
...
<%-- 					           <th width="*%"><bean:message bundle="asmResources" key="title.IGCIM0101.rawci" /></th> --%>
					           <th width="8%"><bean:message bundle="asmResources" key="title.IGCIM0101.ShowInfo"/></th>
			                ...
			                <logic:present name="IGCIM01011VO" property="entityDataList" >
			                    ...
			                    <logic:iterate id="bean" name="IGCIM01011VO" property="entityDataList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                            ...
			                            <td>
			                                <div class="nowrapDiv">
			                                 <!--<html:link action="/IGCIM0108_Disp.do?eiid=${bean.eiid}">-->
			                                 ${bean.einame}
			                                 <!--</html:link>-->
...
<!-- 			                            <td> -->
<!-- 			                            <div align="center"> -->
<%-- 			                            	  <html:link action="/IGCIM0110_Disp.do?firstAccess=1&eiid=${bean.eiid}"> --%>
<!-- 			                            	  	 <img src="images/cr.gif" alt="配置源数据" width="16" height="16"  border="0"/> -->
<%-- 			                            	  </html:link> --%>
<!-- 			                            </div> -->
<!-- 			                            </td> -->
			                            ...
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGCIM0113_Disp.do?eiid=${bean.eiid}"><img src="images/xx.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0101.displayInfo.alt"/>' width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
<!-- 			                            拓扑关系图 -->
<!-- 			                            <td> -->
...
<!-- 			                            </td> -->
			                            ...
			                            <td>
			                                ...
			                                <c:if test="${fn:substring(bean.esyscoding,0,9)=='999001001'}"><html:link action="/IGCIM0106_Disp.do?eiid=${bean.eiid}&relationType=0"><img src="images/record_(copy)_16x16.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0101.relationshipInfo.alt"/>' width="16" height="16"  border="0"/></html:link></c:if>
			                                </div>
			                            </td>
			                            <!-- 包含关系图 -->
			                            <td>
			                                <div class="nowrapDiv">
				                                <c:if test='${bean.eirootmark != null && bean.eirootmark != ""}'>
	                                                <a href="javascript:void(0)" onclick="openSubIGASM0346('${bean.eirootmark}','${bean.eiid}','${bean.eiversion}','${bean.eismallversion}','0')"><img src="images/relationships.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0101.belongrelationshipDiagram.alt"/>' width="16" height="16"  border="0"/></a>
				                                </c:if>
				                                <c:if test='${bean.eirootmark == null || bean.eirootmark == ""}'>
