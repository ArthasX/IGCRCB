...
<html:html>
<bean:define id="id" value="IGCIM1408" toScope="request"/>
<bean:define id="title" value="人员查询画面" toScope="request"/>
...
<!-- /header1 -->
	...
	function deleteRec(){
        ...
        if( window.confirm(confirmMsg)){
            form.action = getAppRootUrl() + "/IGCIM1401_Del.do";
            return true;
        } else {
            return false;
        }
	...
	function setRoleDomain(url){
		...
		var url = "IGSYM0304.do?roletype=IGAC08";
		</logic:notPresent>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            <html:form styleId="form" action="/IGCIM1408"
         ...
         <div id="search">
		             ...
		             <div class="conditions">
                          ...
                          <label><span class="red">*</span>所属机构：</label><html:text property="eiorgname" readonly="true"></html:text>
			                ...
			                <label>所属模型：</label><html:text property="ename" styleId="ename"  errorStyleClass="inputError imeDisabled" size="15" readonly="true"/>
			                 <img src="images/tree.gif" style="cursor: hand;" alt="资产模型" width="16" height="16" border="0" onclick="setEntity('IGSYM1201_ENTITY_TREE.do?levelnode=999010');"/>
                ...
                <div id="results_list">
			       ...
			       <table class="table_style">
			            ...
			            <!-- body部 -->
			                ...
			                <logic:present name="IGCIM14011VO" property="entityDataList" >
			                    <logic:iterate id="bean" name="IGCIM14011VO" property="entityDataList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                            ...
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGCIM1409_Disp.do?eiid=${bean.eiid}"><img src="images/xx.gif" alt="显示详细信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                            <!-- 关系信息 -->
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGCIM1411_Disp.do?eiid=${bean.eiid}"><img src="images/record_(copy)_16x16.gif" alt="关系信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                               <!-- 关系图 -->
			                               <!-- 
			                            ...
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGCIM1410_Disp.do?eiid=${bean.eiid}&civersion="><img src="images/notepad_16x16.gif" alt="历史版本" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                        </tr>
			                    </logic:iterate>
                ...
                <html:hidden property="ecategory" styleId="ecategory" value="${IGCIM1401Form.ecategory}"/>
            </html:form>
        </div>
    </div>
