...
<html:html>
<bean:define id="id" value="IGCIM0904" toScope="request" />
<bean:define id="title"   toScope="request" >
	<bean:message bundle="asmResources" key="ietitle.IGCIM0904"/>
</bean:define>
    ...
    var gid='IGCIM0106';
	    function deleteRec(){
	        ...
	        if( window.confirm(confirmMsg)){
	            form.action = getAppRootUrl() + "/IGAIM0106_Del.do";
	            return true;
	        } else {
	            return false;
	        }
...
<html:form styleId="form" action="/IGCIM0904_Disp"
