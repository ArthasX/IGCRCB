...
<html:html>
<bean:define id="id" value="IGCIM0301" toScope="request" />
...
<script type="text/javascript">	
	...
	function openAuditWaitTaskDetail(auwtid){
	 	openSubWindow( '/IGCIM0303_Disp.do?auwtid='+ auwtid,"auditWaitTask","800","600");
	}
	...
	function importEI(){
	    ...
	    if(window.confirm('<bean:message bundle="asmResources" key="message.IGCIM0301.002"/>')){
	    	//disableAllButton();
	        form.action = getAppRootUrl() + "/IGCIM0301_Import.do";
	...
	function compareEI(){
	    if(window.confirm('<bean:message bundle="asmResources" key="message.IGCIM0301.006"/>')){
	        form.action = getAppRootUrl() + "/IGCIM0301_Compare.do";
	        return true;
	    } else {
	        return false;
	    }
	...
	function deleteTask(){
	    ...
	    if(window.confirm('<bean:message bundle="asmResources" key="message.IGCIM0301.004"/>')){
	    	//disableAllButton();
	        form.action = getAppRootUrl() + "/IGCIM0301_Delete.do";
	        //document.forms[0].submit();
	        return true;
	    } else {
	        return false;
...
<div id="contentWrap">
<div id="content"><html:form styleId="form" action="/IGCIM0301_Disp"
