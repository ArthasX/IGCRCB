...
<html:html>
<bean:define id="id" value="IGCIM0201" toScope="request" />
...
<script type="text/javascript">	
	...
	function openEiWaitTaskDetail(eitid){
	 	openSubWindow( '/IGCIM0210_Disp.do?eitid='+ eitid,"eiWaitTask","800","600");
	}
	...
	function importEI(){
	    ...
	    if(window.confirm('<bean:message bundle="asmResources" key="message.IGCIM0201.002"/>')){
	    	//disableAllButton();
	        form.action = getAppRootUrl() + "/IGCIM0201_Import.do";
	...
	function deleteTask(){
	    ...
	    if(window.confirm('<bean:message bundle="asmResources" key="message.IGCIM0201.004"/>')){
	    	//disableAllButton();
	        form.action = getAppRootUrl() + "/IGCIM0201_Delete.do";
	        //document.forms[0].submit();
	        return true;
	    } else {
	        return false;
...
<div id="contentWrap">
<div id="content"><html:form styleId="form" action="/IGCIM0201_Disp"
