...
<html:html>
<bean:define id="id" value="IGCIM1703" toScope="request"/>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
			<div id="search">
				<div class="img"></div>
					<html:form action="IGCIM1703" method="POST">
				<div class="conditions">
					<html:hidden property="warnType" value="5"/>
						服务器名称:<html:text property="logName" size="15"/> 
						CI类型:<html:select property="ciType">
									<html:option value=""> </html:option>
									<html:optionsCollection name="IGCIM17031VO" property="ciTypes" label="impTypename" value="impTypeid"/>
								</html:select>
	       ...
	       <table width="100%" class="table_style">
	       	<tr>
	       	 ...
	       	 <logic:present name="IGCIM17031VO" property="soc0153List" >
	       	 	<logic:iterate id="bean" name="IGCIM17031VO" property="soc0153List" indexId="index">
	       	 		<tr>
