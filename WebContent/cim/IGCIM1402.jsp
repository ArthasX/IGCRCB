...
<html:html>
<bean:define id="id" value="IGCIM1402" toScope="request"/>
<bean:define id="title" value="人员基本信息登记画面" toScope="request"/>
	...
	<script type="text/javascript">	
		 ...
		 function checkForm(){
		    	...
		    	if($F('eiinsdate').trim()==""){
		    		...
		    		var message = '<bean:message key="IGCO10000.W001" arg0="人员基本信息" />';
	    ...
	    function setEntity(url){
	    	url = url+"?roletype=IGAC08&subtype=999010";
			var temp = window.showModalDialog(url,null,"dialogWidth:400px;dialogHeight:500px;status:no;help:no;resizable:yes");
			if("_resetall"==temp){
...
<!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGCIM1402" onsubmit="return checkSubmit(this);">
                      <!--  message -->
                      <ig:message/>
                      <!--  /message -->     
		            <fieldset>
	                    <logic:equal name="IGCIM1402Form" property="mode" value="0">
			            <legend>人员基本信息添加</legend>
			            </logic:equal>
	                    <logic:equal name="IGCIM1402Form" property="mode" value="1">
			            ...
			            <div>
			                ...
			                <html:text property="einame" style="width:125px;" errorStyleClass="inputError imeActive" tabindex="2"/>
			                <br>
			            </div>
			            <div>
			                <label for="Name"><strong>联系方式</strong>：</label>
			                <html:text property="eidesc" styleId="eidesc" tabindex="3" style="width:125px;" errorStyleClass="inputError"/>
			                <br>
			            </div>
                        <div>
