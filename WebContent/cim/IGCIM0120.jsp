...
<html:html>
<bean:define id="id" value="IGCIM0120" toScope="request"/>
...
<!-- /header1 -->
	...
	function deleteRec(){
        ...
        if( window.confirm(confirmMsg)){
            form.action = getAppRootUrl() + "/IGCIM0121_Del.do";
            return true;
        } else {
            return false;
        }
...
// 	}
	...
	function setEntity(){
    	...
    	<logic:notPresent name="ADrolemanager">
		var url = "IGSYM0304_ASSET.do?roletype=IGBU01&subtype=999003";
		</logic:notPresent>
		<logic:present name="ADrolemanager">
		<logic:equal name="ADrolemanager" value="true">
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            <html:form styleId="form" action="/IGCIM0120"
...
<!--					           <th width="8%"><bean:message bundle="asmResources" key="label.IGCIM0121.RelationshioDiagram"/></th>-->
			            ...
			            <!-- body部 -->
			                ...
			                <logic:present name="IGCIM01201VO" property="entityDataList" >
			                    <logic:iterate id="bean" name="IGCIM01201VO" property="entityDataList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                            ...
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGCIM0124_Disp.do?eiid=${bean.eiid}&backurl=IGCIM0120_Back.do"><img src="images/xx.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0121.DiaplayDetail.alt"/>' width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                            <!-- 关系信息 -->
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGCIM0126_Disp.do?eiid=${bean.eiid}&backurl=IGCIM0120_Back.do"><img src="images/record_(copy)_16x16.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0121.RelationshipInfo.alt"/>'  width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                             <!-- 关系图 -->
<!--			                            <td>-->
...
<!--	                                                <a href="javascript:void(0)" onclick="showDetailInfo('${bean.eiid}')"><img src="images/relationships.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0121.RelationshipDiagram.alt"/>' width="16" height="16"  border="0"/></a>-->
<!--				                                </logic:notEqual>-->
