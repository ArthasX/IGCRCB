...
<html:html>
<bean:define id="id" value="IGCIM0104" toScope="request" />
<bean:define id="title" toScope="request">
	<bean:message bundle="asmResources" key="ietitle.IGCIM0104" />
</bean:define>
...
<script type="text/javascript">
	...
	function confirmDisp() {
		...
		if ($F('attachFile[${ADcheckCount}]').trim() == "") {
			alert('<bean:message bundle="asmResources" key="message.IGCIM0104.001"/>'
					+ "${bean.cname}！");
			return false;
		}
		</logic:equal>
		...
		if (submitValue.strlen() > 128) {
			alert("${bean.cname}"
					+ '<bean:message bundle="asmResources" key="message.IGCIM0104.002"/>'
					+ Math.floor(128 / strByteFlag)
					+ '<bean:message bundle="asmResources" key="message.IGCIM0104.003"/>');
			submitValue = "";
			return false;
		}
		if (flag) {
			...
			alert('<bean:message bundle="asmResources" key="message.IGCIM0104.004"/>'
					+ "${bean.cname}！");
			return false;
		}
		</logic:equal>
	...
	function toback() {
		form.action = getAppRootUrl()
				+ "/IGCIM0113.do?org.apache.struts.taglib.html.CANCEL=1";
		form.submit();
	}
	var num = 0;
	...
	function goLook(id, v, sv, name) {
		...
		var url = "/IGCIM0141.do?eiid=" + id + "&eiversion=" + v
				+ "&eismallversion=" + sv + "&filename=" + name;
		openSubWindow(url, '_blank', '800', '600');

	}

	function saveXML(id) {
		document.forms[0].action = getAppRootUrl() + "/IGCIM0104_SAVE.do?eiid="
				+ id;
						...
						<div class="back">
							<html:link href="javascript:toback();">
								<bean:message bundle="asmResources"
									key="button.IGCIM0104.btn_toback" />
							</html:link>
						</div>
					</div>
</div>
					<html:form styleId="form" action="/IGCIM0113"
						enctype="multipart/form-data" onsubmit="return checkSubmit(this);">
						<div class="title">
							<div class="name">
								<bean:message bundle="asmResources"
									key="label.IGCIM0104.DeviceInfo" />
							</div>
						</div>
						<div id="results_list">
							<table class="table_style">
								<tr>
									<th width="8%"><bean:message bundle="asmResources"
											key="label.IGCIM0104.ModelName" /></th>
									<th width="12%"><bean:message bundle="asmResources"
											key="label.IGCIM0104.DeviceNO" /></th>
									<th width="18%"><bean:message bundle="asmResources"
											key="label.IGCIM0104.DeviceName" /></th>
									<th width="15%"><bean:message bundle="asmResources"
											key="label.IGCIM0104.DeviceOrgan" /></th>
									<th width="15%"><bean:message bundle="asmResources"
											key="label.IGCIM0104.DeviceRemark" /></th>
									<th width="10%"><bean:message bundle="asmResources"
											key="label.IGCIM0104.DeviceManager" /></th>
									<th width="10%">更新时间</th>
								...
								<tr>
									...
									<td>${IGCIM01041VO.entityData.eiinsdate}</td>
...
<!-- 版本号 -->
<logic:present name="IGCIM01041VO" property="configItemVersionTime">
<div class="title">
	<div class="name"><bean:message bundle="asmResources" key="label.IGCIM0104.historyVersionInfo"/></div>
</div>
<div id="results_list">
   <table width="100%" class="table_style" >
	 <tr>
		<th width="50%"><bean:message bundle="asmResources" key="label.IGCIM0104.VersionINO"/> </th>
		<th width="50%">更新时间</th>
	 </tr>
		<logic:iterate id="bean" name="IGCIM01041VO" property="configItemVersionTime"
				indexId="index">
				<tr>
		       		<td>
				       <c:if test="${IGCIM01041VO.flag==true}">
				          <a href='javascript:openVersionInfoDetail_SOC(${IGCIM01041VO.entityData.eiid},${bean.civersion},${bean.cismallversion})'>${bean.civersion}.${bean.cismallversion}版</a>
				       </c:if>
				       <c:if test="${IGCIM01041VO.flag!=true}">${bean.civersion}.${bean.cismallversion}版 </c:if>
		       		</td>
		       		<td>
		          		${bean.ciupdtime}
		       		</td>
    ...
    <div class="enter">
		<logic:present name="IGCIM01041VO" property="configItemVersionTime">
			<bean:size id="num" name="IGCIM01041VO" property="configItemVersionTime"/>
				<c:if test="${num > 1}">
			    	<html:button property="btn_compare" styleClass="button" style="height:20px;" onclick="openEiVersionWindow_SOC('${IGCIM01041VO.entityData.eiid}');" >
			    		 <bean:message bundle="asmResources" key="button.IGCIM0104.btn_compare"/> 
			    	</html:button>
    			</c:if>
		</logic:present>
	</div>
						...
						<div class="title">
							<div class="name">
								<bean:message bundle="asmResources"
									key="label.IGCIM0104.DeviceConfigInfo" />
							</div>
						</div>
						<div class="message">
							<ig:message />
						...
						<logic:present name="IGCIM01041VO" property="flag">
							<logic:equal value="true" name="IGCIM01041VO" property="flag">
								<logic:present name="IGCIM01041VO"
									...
									<div id="TabbedPanels1" class="TabbedPanels">
															...
															<table class="table_style2">
																<tr>
																	<th width="15%"><bean:message
																			bundle="asmResources"
																			key="label.IGCIM0104.ConfigName" /></th>
																	<th width="30%"><bean:message
																			bundle="asmResources"
																			key="label.IGCIM0104.ConfigInfo" /></th>
																	<th width="10%"></th>
																	<th width="20%">
																	<bean:message bundle="asmResources" key="label.IGCIM0104.ConfigRemark"/>
																	</th>
																	<th width="17%"><bean:message
																			bundle="asmResources"
																			key="label.IGCIM0104.Attachment" /></th>
																	...
																	<tr onmouseover="mouseOverNoHand(this);"
																		...
																		<td
																			...
																			<div class="nowrapDiv">
																				...
																				<logic:equal name="bean" property="cattach"
																					value="0">
																					<logic:equal name="bean" property="clabel"
																						value="<%=EntityItemKeyWords.ENTITY_DEFAULT_PROPERTY_STATUS%>">
																						<ig:codeValue ccid="EQUIPMENT_STATUS_CODE"
																							cid="${bean.civalue}" />
																					</logic:equal>
																					<logic:notEqual name="bean" property="clabel"
																						value="<%=EntityItemKeyWords.ENTITY_DEFAULT_PROPERTY_STATUS%>">
																						<html:text property="civalue[${ADcount}]"
																							styleId="civalue" size="40"
																							errorStyleClass="inputError" styleClass="input1" readonly="true"/>
																				...
																				<logic:equal name="bean" property="cattach"
																					...
																					<html:text property="civalue[${ADcount}]"
																						...
																						readonly="true" styleClass="input1"/>
																				...
																				<logic:equal name="bean" property="cattach"
																					...
																					<img src="images/seek.gif" border="0" width="16"
																						height="16"
																						alt='<bean:message bundle="asmResources" key="img.IGCIM0104.find.alt"/>'
																				...
																				<logic:equal name="bean" property="cattach"
																					value="5">
																					<logic:present name="IGCIM0104Form"
																						property="civalue[${ADcount}]">
																						<bean:define id="civalue" name="IGCIM0104Form"
																							property="civalue[${ADcount}]"
										...
										errorStyleClass="inputError" rows="5" cols="25" readonly="true" styleClass="input1" />
 																				</logic:equal>  

																			</div>
																		</td>

																		<td align="left"><logic:equal name="bean"
																				property="cattach" value="8">
							 ...
							 -->
								...
								property="ciupdtime">&nbsp;</logic:empty> ${bean.ciupdtime}</div -->
																			<html:hidden property="ciid" styleId="ciid"
																				...
																				property="eid" styleId="eid" value="${bean.eid}" />
																			<html:hidden property="esyscoding"
																				styleId="esyscoding" value="${bean.esyscoding}" />
																			<html:hidden property="entityItemCivalue[${ADcount}]"
						...
						<div class="enter">
							<bean:define id="entityData" name="IGCIM01041VO"
								property="entityData" />
						...
						<html:hidden property="eiid" styleId="eiid"
							value="${IGCIM0104Form.eiid}" />
						<html:hidden property="eiversion" styleId="eiversion"
							value="${IGCIM01041VO.entityData.eiversion}" />
						<html:hidden property="eismallversion" styleId="eismallversion"
							value="${IGCIM01041VO.entityData.eismallversion}" />
						<html:hidden property="emodeltype" styleId="emodeltype"
							value="${IGCIM01041VO.entityData.emodeltype}" />
						<html:hidden property="eiorgsyscoding" styleId="eiorgsyscoding"
							value="${IGCIM01041VO.entityData.eiorgsyscoding}" />
					</html:form>
				</div>
			</div>
		</div>
