...
<html:html>
<bean:define id="id" value="IGCIM1411" toScope="request"/>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            ...
            <html:form styleId="form"  action="/IGCIM1406" onsubmit="return checkSubmit(this);">
                <div class="title">
...
//-->
                ...
                <html:hidden property="pareid" styleId="pareid" value="${IGCIM14061VO.entityData.eid}"/>
                <html:hidden property="pareiid" styleId="pareiid" value="${IGCIM14061VO.entityData.eiid}"/>
                <html:hidden property="pareiname" styleId="pareiname" value="${IGCIM14061VO.entityData.einame}"/>
            </html:form>  
		 </div>
     </div>
</div>
