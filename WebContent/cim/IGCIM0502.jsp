...
<html:html>
<bean:define id="id" value="IGCIM0502" toScope="request"/>
<bean:define id="title"  toScope="request">
	<bean:message bundle="asmResources" key="ietitle.IGCIM0502"/>
</bean:define>
<!-- header1 -->
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGCIM0502"
            ...
            <div id="location">
		             ...
		             <div class="conditions">
                          ...
                          <label><span class="red">*</span><bean:message bundle="asmResources" key="label.IGCIM0101.organ"/></label><html:text property="eiorgname" readonly="true"></html:text>
			               ...
			               <!-- <label><span class="red">*</span><bean:message bundle="asmResources" key="label.IGCIM0101.model"/></label><html:text property="ename" styleId="ename"  errorStyleClass="inputError imeDisabled" size="15" readonly="true"/>
			                ...
			                <label><bean:message bundle="asmResources" key="label.IGCIM0502.model"/></label>
			                <html:select property="esyscoding" value="${IGCIM05021VO.esyscoding}" style="width: 120px;" errorStyleClass="inputError" tabindex="5" >
	                           <ig:optionsCollection ccid="SWITCH_CMDB" isMakeBlankRow="true" isCodeLabel="true" />
	                        </html:select>
			                <label>&nbsp;&nbsp;<bean:message bundle="asmResources" key="title.IGCIM0502.switchname"/></label>
                ...
                <div id="results_list">
			       ...
			       <table width="100%" class="table_style">
			            <!-- header部 -->
			                <tr><!--
					            <th width="12%"><bean:message bundle="asmResources" key="title.IGCIM0502.switchID"/></th>
					            -->
					            <th width="18%"><bean:message bundle="asmResources" key="title.IGCIM0502.switchname"/></th>
								<th width="18%"><bean:message bundle="asmResources" key="title.IGCIM0502.switchType"/></th>
			            ...
			            <!-- body部 -->			  
			                <logic:present name="IGCIM05021VO" property="entityDataList" >
			                	<bean:define id="vo"  name="IGCIM05021VO" />
			                	<bean:define id="showRelation"  name="IGCIM05021VO" property="showRelationMap"/>
			                    <logic:iterate id="bean" name="IGCIM05021VO" property="entityDataList" indexId="index">
			     ...
			     <div id="operate">
                            <logic:present name="IGCIM05021VO" property="entityDataList" ></logic:present>
			                <!-- paging -->
