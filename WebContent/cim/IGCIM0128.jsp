...
<html:html>
<bean:define id="id" value="IGCIM0128" toScope="request"/>
...
<!-- /header1 -->
	<script type="text/javascript">	
	    ...
	    function toback(){
	        form.action = getAppRootUrl() + "/IGCIM0121_Back.do?";
	        form.submit();
	    }
...
<div id="container"> <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGCIM0128" onsubmit="return checkSubmit(this);">
                      <!--  message -->
                      <ig:message/>
                      <!--  /message -->     
		            <fieldset>
