...
<html:html>
<bean:define id="id" value="IGCIM0907" toScope="request"/>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGCIM0907"
                ...
                <div id="search">
		             ...
		             <div class="conditions">
                          ...
                          <label><span class="red">*</span><bean:message bundle="asmResources" key="label.IGCIM0101.organ"/></label><html:text property="eiorgname" readonly="true"></html:text>
	                        ...
	                        <label>&nbsp;&nbsp;环境类型：</label>
	                         <html:select name="IGCIM0101Form" styleId="eitype" property="eitype" style="width: 50px;" errorStyleClass="inputError">
	 							<html:option value="生产">生产</html:option>
	 							<html:option value="灾备">灾备</html:option>
	 							<html:option value="异地">异地</html:option>
	 						</html:select>
			                    ...
			                    <logic:iterate id="bean" name="IGCIM01011VO" property="soc0118List" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                           ...
			                           <!-- 详细信息 -->
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGCIM0905_Disp.do?eiid=${bean.eiid}&backUrl=IGCIM0907_Back.do"><img src="images/xx.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0101.displayInfo.alt"/>' width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                                ...
			                                <!--<html:link action="/IGAIM0106_Disp.do?eiid=${bean.eiid}&relationType=1"><img src="images/record_(copy)_16x16.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0101.relationshipInfo.alt"/>' width="16" height="16"  border="0"/></html:link>-->
				                                ...
				                                <c:choose>
				                                	<c:when test="${fn:substring(bean.esyscoding,0,9)=='999001001'
					                                	...
					                                	<html:link action="/IGAIM0106_Disp.do?eiid=${bean.eiid}&relationType=0&backUrl=IGCIM0907_Back.do">
