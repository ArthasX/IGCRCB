...
<html:html>
<bean:define id="id" value="IGCIM0912" toScope="request"/>
	...
	function checkForm(){
	 ...
	 function setEntity(){
		 var alertMessage = '<bean:message bundle="asmResources" key="message.IGCIM0101.005"/>';
			var url = "IGCIM1203_ENTITY_TREE.do?levelnode=999001031";
...
//				 document.forms[0].eid.value = "";
	 ...
	 function initEname(){
		 	if("设备资产"==document.forms[0].ename.value){
				document.forms[0].ename.value = "存储";
				document.forms[0].esyscoding.value = "999001031";
		 	}
		}
	</script>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGCIM0912"
			                    ...
			                    <logic:iterate id="bean" name="IGCIM01011VO" property="soc0118List" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                           ...
			                           <!-- 详细信息 -->
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGCIM0905_Disp.do?eiid=${bean.eiid}&backUrl=IGCIM0912_Back.do"><img src="images/xx.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0101.displayInfo.alt"/>' width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                                ...
			                                <!--<html:link action="/IGAIM0106_Disp.do?eiid=${bean.eiid}&relationType=1"><img src="images/record_(copy)_16x16.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0101.relationshipInfo.alt"/>' width="16" height="16"  border="0"/></html:link>-->
				                                ...
				                                <c:choose>
				                                	<c:when test="${fn:substring(bean.esyscoding,0,9)=='999001001'
					                                	...
					                                	<html:link action="/IGAIM0106_Disp.do?eiid=${bean.eiid}&relationType=0&backUrl=IGCIM0912_Back.do">
