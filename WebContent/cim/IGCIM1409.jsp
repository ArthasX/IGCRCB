...
<html:html>
<bean:define id="id" value="IGCIM1409" toScope="request" />
<bean:define id="title" value="人员配置信息查看画面" toScope="request" />
...
<div id="location">
<div class="image"></div>
<p class="fonts1"><ig:navigation extname1="${urlable}"/> &gt;&gt; 人员配置查看</p>
			...
			<logic:iterate id="map" name="IGCIM14041VO"
				...
				<table class="table_style2">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						...
						<bean:define id="cldVersionMap" name="IGCIM1404Form" property="cldVersionMap" type="java.util.Map"/>
...
//-->
	...
	<html:hidden property="eiid" styleId="eiid"
		value="${IGCIM1404Form.eiid}" />
	<html:hidden property="eiversion" styleId="eiversion"
		value="${IGCIM14041VO.entityData.eiversion}" />
</html:form></div>
</div>
</div>
