...
<html:html>
<bean:define id="id" value="IGCIM0910" toScope="request"/>
...
//				 document.forms[0].eid.value = "";
	 ...
	 function initEname(){
		 if("设备资产"==document.forms[0].ename.value){
			document.forms[0].ename.value = "网络设备";
			document.forms[0].esyscoding.value = "999001028";
		}
	 }
	</script>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGCIM0910"
            ...
            <div id="location">
                ...
                <div id="search">
		             ...
		             <div class="conditions">
                          ...
                          <div> <label><span class="red">*</span><bean:message bundle="asmResources" key="label.IGCIM0101.model"/></label>
                          	<html:select property="esyscoding" style="margin:0px;height:20px;">
                          		<ig:optionsCollection ccid="NET_CCID" isMakeBlankRow="false" />
                          	</html:select>
                         	<label>&nbsp;&nbsp;&nbsp;&nbsp;IP:</label><html:text property="ip" errorStyleClass="inputError imeDisabled" size="10"><script type="text/javascript">printBRByScreenWidth();</script></html:text>
                ...
                <div id="results_list">
			       ...
			       <table width="100%" class="table_style">
			            ...
			            <!-- body部 -->			  
			                <logic:present name="IGCIM09101VO" property="entityDataList" >
			                	<bean:define id="vo"  name="IGCIM09101VO" />
			                	<bean:define id="showRelation"  name="IGCIM09101VO" property="showRelationMap"/>
			                    <logic:iterate id="bean" name="IGCIM09101VO" property="entityDataList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                           ...
			                           <!-- 详细信息 -->
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGCIM0905_Disp.do?eiid=${bean.eiid}&backUrl=IGCIM0910_Back.do"><img src="images/xx.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0101.displayInfo.alt"/>' width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                            <!-- CI关系 -->
			                            <td>
			                                <div class="nowrapDiv">
					                                	...
					                                	<html:link action="/IGCIM2005_Disp.do?eiid=${bean.eiid}&relationType=0&backurl=IGCIM0910_Back.do">
                ...
                <html:hidden property="ecategory" styleId="ecategory" value="${IGCIM0910Form.ecategory}"/>
            </html:form>
        </div>
    </div>
