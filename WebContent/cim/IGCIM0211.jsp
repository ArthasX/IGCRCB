...
<html:html>
<bean:define id="id" value="IGCIM0211" toScope="request" />
...
<script type="text/javascript">	
    function toback(){
        form.action = getAppRootUrl() + "/IGCIM0207_back.do";
        form.submit();
    }
</script>
...
<div class="enter">
	<html:form styleId="form"  action="/IGCIM0207_back" onsubmit="return checkSubmit(this);">
