...
<html:html>
<bean:define id="id" value="IGCIM0139" toScope="request"/>
<bean:define id="title" value="按应用查询" toScope="request"/>
...
<!-- /header1 -->
	...
	function deleteRec(){
        ...
        if( window.confirm(confirmMsg)){
            form.action = getAppRootUrl() + "/IGCIM0139_Del.do";
            return true;
        } else {
            return false;
        }
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGCIM0139"
...
<%-- 			                <label>&nbsp;&nbsp;人员姓名：</label><html:text property="einame" styleId="einame" errorStyleClass="inputError imeDisabled" size="10" />&nbsp;&nbsp;  --%>
                ...
                <div id="results_list">
			       ...
			       <table width="100%" class="table_style">
			            ...
			            <!-- body部 -->		
			                <logic:present name="IGCIM01391VO" property="soc0119InfoList" >
			                    <logic:iterate id="bean" name="IGCIM01391VO" property="soc0119InfoList" indexId="index">
                ...
                <html:hidden property="ecategory" styleId="ecategory" value="${IGCIM0139Form.ecategory}"/>
            </html:form>
        </div>
    </div>
