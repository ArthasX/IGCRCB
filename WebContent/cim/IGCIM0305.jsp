...
<html:html>
<bean:define id="id" value="IGCIM0305" toScope="request" />
...
function toback(){
	if($F('mode')==0){
	form.action = getAppRootUrl() + "/IGCIM0307_Disp.do";
	}
	if($F('mode')==1){
	form.action = getAppRootUrl() + "/IGCIM0307.do";
	}
	form.submit();
}
...
<div id="formwrapper"><html:form styleId="form"
	action="/IGCIM0305" onsubmit="return checkSubmit(this);">
