...
<html:html>
<bean:define id="id" value="IGCIM2001" toScope="request"/>
...
<!-- /header1 -->
	<script type="text/javascript">	
	    ...
	    function setEntity(){
	    	url = "IGCIM1203_ENTITY_TREE.do?levelnode=999001028";
			var temp = window.showModalDialog(url,null,"dialogWidth:400px;dialogHeight:500px;status:no;help:no;resizable:yes");
	    ...
	    function toback(){
	        form.action = getAppRootUrl() + "/IGCIM0902_Disp.do";
	        form.submit();
	    }
	</script>
<body onload="clear();">
...
<%--                 <div class="back"><html:link href="javascript:toback();"><bean:message bundle="asmResources" key="button.IGCIM0102.btn_toback"/></html:link></div> --%>
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGCIM2001" onsubmit="return checkSubmit(this);">
                      <!--  message -->
                      <ig:message/>
                      <!--  /message -->     
		            <fieldset>
	                    <logic:equal name="IGCIM2001Form" property="mode" value="0">
			            <legend><bean:message bundle="asmResources" key="label.IGCIM0102.AddDeviceInfo"/></legend>
			            </logic:equal>
	                    <logic:equal name="IGCIM2001Form" property="mode" value="1">
                        ...
                        <div>
                            ...
                            <html:text property="ename" errorStyleClass="inputError imeActive" readonly="true" tabindex="2"/>
                             <img src="images/tree.gif" style="cursor: hand;" alt='<bean:message bundle="asmResources" key="img.IGCIM0102.AssetModel.alt"/>' width="16" height="16" border="0" onclick="setEntity();"/>
                            <br>
                        </div>
