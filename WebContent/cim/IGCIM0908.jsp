...
<html:html>
<bean:define id="id" value="IGCIM0908" toScope="request"/>
	...
	function checkForm(){
	 ...
	 function setEntity(){
		 var alertMessage = '<bean:message bundle="asmResources" key="message.IGCIM0101.005"/>';
			var url = "IGCIM1203_ENTITY_TREE.do?levelnode=999002001";
...
//				 document.forms[0].eid.value = "";
	...
	function initEname(){
		if("设备资产"==document.forms[0].ename.value){
			document.forms[0].ename.value = "数据库";
			document.forms[0].esyscoding.value = "999002001";
		}
	}
	</script>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGCIM0908"
			                ...
			                <logic:present name="IGCIM01011VO" property="soc0118List" >
			                    ...
			                    <logic:iterate id="bean" name="IGCIM01011VO" property="soc0118List" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                            ...
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGCIM0905_Disp.do?eiid=${bean.eiid}&backUrl=IGCIM0908_Back.do"><img src="images/xx.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0101.displayInfo.alt"/>' width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                            <!-- 拓扑关系图 -->
<!--			                            <td>-->
			                                ...
			                                <!--<html:link action="/IGAIM0106_Disp.do?eiid=${bean.eiid}&relationType=1"><img src="images/record_(copy)_16x16.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0101.relationshipInfo.alt"/>' width="16" height="16"  border="0"/></html:link>-->
				                                ...
				                                <c:choose>
				                                	<c:when test="${fn:substring(bean.esyscoding,0,9)=='999001001'
					                                	...
					                                	<html:link action="/IGAIM0106_Disp.do?eiid=${bean.eiid}&relationType=0&backUrl=IGCIM0908_Back.do">
