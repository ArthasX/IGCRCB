...
<html:html>
<bean:define id="id" value="IGCIM1405" toScope="request" />
...
var gid='IGCIM1405';
	function toback() {
		form.action = getAppRootUrl() + "/IGCIM1405_Back.do?btn_back=1";
		form.submit();
	}
</script>
<body >
...
<div class="message"><ig:message /></div>
 ...
 <div class="enter">
	<html:form styleId="form"  action="/IGCIM1405_Back" onsubmit="return checkSubmit(this);">
	<c:if test="${IGCIM14051VO.flag==true}">
    	<logic:present name="IGCIM14051VO" property="configItemVersionTime">
