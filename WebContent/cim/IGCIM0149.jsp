...
var setting = {
	...
	var zNodes =${IGCIM01491VO.initTreeStr};
	...
	function beforeClick(treeId, treeNode) {
		...
		if(nlv>0){//判断不是第一个结点
			...
			if(idTypeFlag==1){
				$('#IndexContext').attr("src","IGCIM0148_Disp.do?eiid=" + idArr[1]);
			}
		}
	}
...
<iframe name="IndexContext" id="IndexContext" width="756" height="600" frameborder="0" scrolling="auto" src="IGCIM0148_Disp.do?eiid=${IGCIM0149Form.eiid}"></iframe>
</div>
</div>
</body>
</html:html>
