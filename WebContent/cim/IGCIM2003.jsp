...
<html:html>
<bean:define id="id" value="IGCIM2003" toScope="request" />
...
<script type="text/javascript">	
		...
		function confirmDisp(){		
			...
			<logic:present name="IGCIM20031VO" property="configItemVWInfoMap">
			<logic:iterate id="map" name="IGCIM20031VO" property="configItemVWInfoMap" indexId="number">
        ...
        function toback(){
//         	form.action = getAppRootUrl() + "/IGCIM2004_Back.do";
//         	form.submit();
        	window.location=getAppRootUrl() + "/IGCIM2004_Back.do";
        }
        var num = 0;
        ...
        function goLook(id,v,sv,name){
    		...
    		var url = "/IGCIM0141.do?eiid="+id+"&eiversion="+v+"&eismallversion="+sv+"&filename="+name;
		...
		function saveXML(id){
			document.forms[0].action =  getAppRootUrl()+"/IGCIM0104_SAVE.do?eiid="+id;
...
<div class="image"></div>
<p class="fonts1">
	<ig:navigation extname1="${urlable}"/> &gt;&gt; 属性编辑
</p>
...
<html:form styleId="form" action="/IGCIM2003"
	enctype="multipart/form-data" onsubmit="return checkSubmit(this);">
	<div class="title">
	<div class="name"><bean:message bundle="asmResources" key="label.IGCIM0104.DeviceInfo"/></div>
	</div>
	<div id="results_list">
...
<!--			<th width="15%"><bean:message bundle="asmResources" key="label.IGCIM0104.DeviceOrgan"/></th>-->
		...
		<tr>
			<td align="center">${IGCIM20031VO.entityData.ename}</td>
			<td>${IGCIM20031VO.entityData.eilabel}</td>
			<td>${IGCIM20031VO.entityData.einame}</td>
<!--			<td>${IGCIM20031VO.eiorgname}</td>-->
			<td>${IGCIM20031VO.entityData.eidesc}</td>
			<!--<td><ig:codeValue ccid="EQUIPMENT_STATUS_CODE" cid="${IGCIM20031VO.entityData.eistatus}"/></td>-->
			<td>${IGCIM20031VO.entityData.eiusername}</td>
			<td>${IGCIM20031VO.entityData.eiupdtime}</td>
	...
	<logic:present name="IGCIM20031VO" property="flag">
	<logic:equal value="true" name="IGCIM20031VO" property="flag">	
	<logic:present name="IGCIM20031VO" property="configItemVWInfoMap">
		<div id="TabbedPanels1" class="TabbedPanels">
		<ul class="TabbedPanelsTabGroup">
			<logic:iterate id="map" name="IGCIM20031VO"
		...
		<div class="TabbedPanelsContentGroup"><logic:present
			name="IGCIM20031VO" property="configItemVWInfoMap">
			<logic:iterate id="map" name="IGCIM20031VO"
				property="configItemVWInfoMap" indexId="number">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						<tr onmouseover="mouseOverNoHand(this);" onmouseout ="mouseOutNoHand(this);" <logic:equal name="bean" property="cseq" value="1">style="display: none;"</logic:equal>>
							...
							<div class="nowrapDiv">
								...
								<logic:equal name="bean" property="cattach" value="5">
									<logic:present name="IGCIM2003Form" property="civalue[${ADcount}]">
									...
									<logic:notPresent name="IGCIM2003Form" property="civalue[${ADcount}]">
										<logic:iterate id="checkboxbean" name="ADlist${ADmapcount}">
							...
							<td align="left">
								<logic:equal name="bean" property="cattach" value="8">
									...
									<html:button property="btn_look" styleClass="button"  onclick="goLook('${IGCIM20031VO.entityData.eiid}','${bean.civersion}','${bean.cismallversion}','${bean.civalue}');" >
...
<%-- 								${bean.civersion}<c:if test="${IGCIM20031VO.entityData.emodeltype == '1'}">.${bean.cismallversion}</c:if> --%>
<%-- 							</logic:notEmpty> --%>
<!-- 							</div> -->
<!-- 							</td> -->
	...
	<div class="enter">
	<bean:define id="entityData" name="IGCIM20031VO" property="entityData" />
	...
	<html:button property="btn_cancle" onclick="toback()" styleClass="button">返回</html:button>
	</div>
	<html:hidden property="eiid" styleId="eiid" value="${IGCIM2003Form.eiid}" />
	<html:hidden property="einame" styleId="einame" value="${IGCIM20031VO.entityData.einame}" />
	<html:hidden property="eiversion" styleId="eiversion" value="${IGCIM20031VO.entityData.eiversion}" />
	<html:hidden property="eismallversion" styleId="eismallversion" value="${IGCIM20031VO.entityData.eismallversion}" />
	<html:hidden property="emodeltype" styleId="emodeltype" value="${IGCIM20031VO.entityData.emodeltype}" />
	<html:hidden property="eiorgsyscoding" styleId="eiorgsyscoding" value="${IGCIM20031VO.entityData.eiorgsyscoding}" />
</html:form></div>
</div>
</div>
