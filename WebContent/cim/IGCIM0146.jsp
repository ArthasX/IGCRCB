...
<%
	...
	IGCIM0146Form form = (IGCIM0146Form)request.getAttribute("IGCIM0146Form");
%>

<%@page import="com.deliverik.infogovernor.soc.cim.form.IGCIM0146Form"%><html:html>
<title><bean:message bundle="asmResources" key="ietitle.IGCIM0146"/></title>
<bean:define id="treemap" name="IGCIM01461VO" property="treeNodeMap" type="java.util.Map" />
<style>
html,body {
   margin-top:0;
   padding:0;
...
%>
<%!
	public void writeJS (String lastNode,Map<String,TreeNode> treeNodeMap, IGCIM0146Form form){
...
if (document.getElementById) {
	var tree = new WebFXTree('<bean:message bundle="asmResources" key="label.IGCIM0146.belongRelation"/>');
...
<%if(!treemap.isEmpty()){%>
	...
	<script type="text/javascript">
		...
		function selectType(id,name){
			$("frmcontent").src = "IGCIM0147_Disp.do?eiid=" + id.split("_")[0] + "&civersion=" + id.split("_")[1] +"&cismallversion=" + id.split("_")[2];
		}
	</script>
</table>
<%}%>
<%	
	if(treemap.isEmpty()){%>
<bean:message bundle="asmResources" key="label.IGCIM0146.belongRelation"/>
<%}%>
</div>
<iframe name="frmcontent" width="756" height="550" frameborder="0" scrolling="auto" src="IGCIM0147_Disp.do?eiid=${IGCIM0146Form.eiid}&civersion=${IGCIM0146Form.eiversion}&cismallversion=${IGCIM0146Form.eismallversion}&flag=${IGCIM0146Form.flag}&assetRoleType='IGCI01'"></iframe>
</div>
</div>
</body>
</html:html>
