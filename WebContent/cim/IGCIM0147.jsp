...
<html:html>
<bean:define id="id" value="IGCIM0147" toScope="request" />
...
<logic:present name="IGCIM01471VO" property="flag">
	<logic:equal value="true" name="IGCIM01471VO" property="flag">
		<logic:present name="IGCIM01471VO" property="configItemMap">
			<div id="TabbedPanels1" class="TabbedPanels">
			<ul class="TabbedPanelsTabGroup">
				<logic:iterate id="map" name="IGCIM01471VO" property="configItemMap"
					indexId="number">
			...
			<div class="TabbedPanelsContentGroup"><logic:present
				name="IGCIM01471VO" property="configItemMap">
				<logic:iterate id="map" name="IGCIM01471VO" property="configItemMap"
					indexId="number">
