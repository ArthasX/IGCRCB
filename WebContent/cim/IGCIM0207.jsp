...
<html:html>
<bean:define id="id" value="IGCIM0207" toScope="request" />
...
<script type="text/javascript">	
    ...
    if( window.confirm(confirmMsg)){
        form.action = getAppRootUrl() + "/IGCIM0207_Del.do";
        return true;
    } else {
        return false;
    }
...
<div id="contentWrap">
<div id="content"><html:form styleId="form" action="/IGCIM0207"
				...
				<tr class="<ig:rowcss index="${index}"/>">
					...
					<logic:equal name="bean" property="deleteflag" value="1">
					 ...
					 <!-- 历史版本 -->
			          <td>
			          <div class="nowrapDiv">
                          <html:link action="/IGCIM0211_Disp.do?impeiname=${bean.impeiname}&&impversion=${bean.impversion}"><img src="images/notepad_16x16.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0207.HistoryVersion.alt"/>'  width="16" height="16"  border="0"/></html:link>
			          </div>
			          </td>
					<!-- 详细信息 -->
					<!-- 
