...
<html:html>
<bean:define id="id" value="IGCIM0209" toScope="request"/>
...
<!-- /header1 -->
	...
	function toAdd(){
		...
		form.action = getAppRootUrl() + "/IGCIM0204_Disp.do?eiddid="+eiddid+"&&eiddversion="+version;
		form.submit();
	}
	</script>
<body>
...
<div id="container">
 ...
 <div class="msg">
			...
			<div class="msg_box">
			 <html:form styleId="form" action="/IGCIM0209" onsubmit="return checkSubmit(this);">
