...
<div class="title">
	...
	<table class="table_style">
		<tr>
			<th width="12%"><bean:message bundle="asmResources" key="label.IGCIM0104.ModelName"/></th>
			<th width="45%"><bean:message bundle="asmResources" key="label.IGCIM0104.DeviceNO"/></th>
			<th width="20%"><bean:message bundle="asmResources" key="label.IGCIM0104.DeviceName"/></th>
		...
		<tr>
			<td align="center">${IGCIM01381VO.entityItemData.ename}</td>
			<td>${IGCIM01381VO.entityItemData.eilabel}</td>
			<td>${IGCIM01381VO.entityItemData.einame}</td>
			<!--<td>${IGCIM01381VO.entityItemData.organizationTB.orgname}</td>-->
			<td>${IGCIM01381VO.entityItemData.eidesc}</td>
			<!--<td><ig:codeValue ccid="EQUIPMENT_STATUS_CODE" cid="${IGCIM01041VO.entityData.eistatus}"/></td>-->
			<!--<td>${IGCIM01381VO.entityItemData.eiusername}</td>-->
			<!--<td>${IGCIM01381VO.entityItemData.eiinsdate}</td>-->
...
-->
<input type="button" class="button" value="版本比较" onclick="openEiVersionWindow('${IGCIM0138Form.eiid}');" />
</div>
</body>
</html:html>