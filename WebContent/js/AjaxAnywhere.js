...
/**
* Modifyed by TianChangyi,Create XMLHttpRequest pool.
*/
AjaxAnywhere.prototype.getInstance = function (){
     for (var i = 0; i < this._objPool.length; i ++)
        ...
        this._objPool[this._objPool.length] = this.createObj();
        return this._objPool[this._objPool.length - 1];
}
/**
* Modifyed by TianChangyi,Create XMLHttpRequest pool.
*/
AjaxAnywhere.prototype.createObj = function (){
...
AjaxAnywhere.prototype.showLoadingMessage = function() {
    ...
    div.style.display = "";
	*/
	var div = document.getElementById("splashLayer");
	if (div == null) {
		document.write("<div id=splashLayer align=center style='position:absolute;left:0;top:0;z-index:1000;margin:0px;visibility:hidden; width:100%; height:100%; '><div style='position: absolute;top:expression((this.parentElement.offsetHeight-this.offsetHeight)/3);left:expression((this.parentElement.offsetWidth-this.offsetWidth)/2)'><table width=250 border=0 align=center cellpadding=0 cellspacing=1 bordercolor=#FF0000 bgcolor=#000000><tr bgcolor=#FFFFFF><td height=60 style='font-size:12px;' id=infoTD align=center bordercolor=#FF0000 bgcolor=#C4E5DE>正在后台操作，请稍候…</td></tr></table></div></div>");
		div = document.getElementById("splashLayer");
	}
