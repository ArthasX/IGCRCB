...
function openSubIGCOM0300(eiid, storageID){
	...
	openSubWindow('/IGASM0300_Disp.do?' + params,'_blank','1440','900');
}
...
function openSubIGCOM0309(parmStr,eiid,srname){
	openSubWindow('/IGCOM0309_Filter_Disp.do?attrName='+parmStr+'&srpareiid_eq='+eiid+'&srname='+srname,'_blank','800','600');
}
...
function addFile() 
{
	...
	cell.innerHTML= "<input type='file' name='attachFile["+attachFileNum+"]' class='inputbutton' contentEditable='false'><input type='button' class='delbutton' value='\u5220\u9664' onclick='deleteitem(this)'>";
	attachFileNum++;
}
