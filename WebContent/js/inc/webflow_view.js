...
function flowContextMenu(){
  var menuSrc = '<menu><entity id="c0"><description>\u589e\u52a0\u8282\u70b9</description><image>jsp/flowdesigner/inc/contextMenu/images/add_step.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();newStep("NormalStep");</onClick><contents></contents></entity>';
  menuSrc+= '<entity id="c1"><description>\u589e\u52a0\u52a8\u4f5c</description><image>jsp/flowdesigner/inc/contextMenu/images/add_action.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();newAction();</onClick><contents></contents></entity>';
  menuSrc+= '<entity id="c2"><description>\u5237    \u65b0</description><image>jsp/flowdesigner/inc/contextMenu/images/refresh_vml.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();redrawVML();</onClick><contents></contents></entity></menu>';
  showContextMenu(menuSrc);
}

function stepContextMenu(stepId,stepType){
  //菜单源文本
  var menuSrc = '<menu><entity id="c0"><description>Edit Step['+stepId+']</description><image>jsp/flowdesigner/inc/contextMenu/images/edit_obj.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();editStep("'+stepId+'","'+stepType+'");</onClick><contents></contents></entity>';
  if(stepType!='BeginStep' && stepType!='EndStep') menuSrc+= '<entity id="c1"><description>Delete Step['+stepId+']</description><image>jsp/flowdesigner/inc/contextMenu/images/del_obj.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();delStep("'+stepId+'");</onClick><contents></contents></entity>';
  menuSrc+= '<entity id="c2"><description>Refresh</description><image>jsp/flowdesigner/inc/contextMenu/images/refresh_vml.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();redrawVML();</onClick><contents></contents></entity></menu>';
  showContextMenu(menuSrc);
}

function actionContextMenu(actionId){
  //菜单源文本
  var menuSrc = '<menu><entity id="c0"><description>Edit Action['+actionId+']</description><image>jsp/flowdesigner/inc/contextMenu/images/edit_obj.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();editAction("'+actionId+'");</onClick><contents></contents></entity>';
  menuSrc+= '<entity id="c1"><description>Delete Action['+actionId+']</description><image>jsp/flowdesigner/inc/contextMenu/images/del_obj.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();delAction("'+actionId+'");</onClick><contents></contents></entity>';
  menuSrc+= '<entity id="c2"><description>Refresh</description><image>jsp/flowdesigner/inc/contextMenu/images/refresh_vml.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();redrawVML();</onClick><contents></contents></entity></menu>';
  showContextMenu(menuSrc);
}
...
function showContextMenu(menuSrc){
  ...
  loadContextMenu(menuText,'jsp/flowdesigner/inc/contextMenu/contextmenu.xsl')
}
...
function workFlowDialog(id,type){
	...
	switch (type){
        case 'NormalStep': dialogURL = id==null?'jsp/flowdesigner/_stepdialog.html':'jsp/flowdesigner/_stepdialog.html?stepid='+id;break;
	    case 'BeginStep': dialogURL = id==null?'jsp/flowdesigner/_stepdialog.html':'jsp/flowdesigner/_stepdialog.html?stepid='+id;break;
	    case 'EndStep': dialogURL = id==null?'jsp/flowdesigner/_stepdialog.html':'jsp/flowdesigner/_stepdialog.html?stepid='+id;break;
	    case 'Action': dialogURL = id==null?'jsp/flowdesigner/_actiondialog.html':'jsp/flowdesigner/_actiondialog.html?actionid='+id;break;
		case 'Flow': dialogURL = id==null?'jsp/flowdesigner/_flowdialog.html':'jsp/flowdesigner/_flowdialog.html?flowid='+id;break;		
	} 
...
function drawTreeView(){
  document.all.treeview.src="jsp/flowdesigner/_flowtree.html";
}
