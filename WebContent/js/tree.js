...
var webFXTreeConfig = {
	rootIcon        : 'images/tree/department.gif',
	openRootIcon    : 'images/tree/department.gif',
	folderIcon      : 'images/tree/node.jpg',
	openFolderIcon  : 'images/tree/node.jpg',
	fileIcon        : 'images/tree/node.jpg',
...
function WebFXTreeAbstractNode(sText, sAction, highLight) {
	this.childNodes  = [];
...
WebFXTreeAbstractNode.prototype.expandRootChildren = function() {
	for (var i = 0; i < this.childNodes.length; i++) {
		if ((this.folder) && (!this.open)) { this.expand(); }
	}
	...
	if(this.childNodes.length > 0) {
		...
		for (var j = 0; j < firstNode.childNodes.length; j++) {
			if ((firstNode.folder) && (!firstNode.open)) { firstNode.expand(); }
		} 
	}
}
...
function WebFXTreeItem(sText, sAction, eParent, sIcon, sOpenIcon, highLight) {
	this.base = WebFXTreeAbstractNode;
	this.base(sText, sAction, highLight);
	/* Defaults to close */
//	if (webFXTreeConfig.usePersistence) {
