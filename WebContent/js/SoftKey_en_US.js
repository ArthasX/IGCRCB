...
function WriteToPopup(oPopUp, obj) {
	var outStr = '<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style>';
	    outStr += '*{font-size: 16px; font-weight:800; font-family: Arial;color:#666666}';
		outStr += '</style>';
		outStr += '<SCRIPT>';
		...
		outStr += 'alert("Digital here limit to 13 bits for integer part and 2 bits for decimal part");';
		outStr += 'flag=0;';
		outStr += '}';
		outStr += '}else{';
		...
		outStr += '</TR>';
		outStr += '<TR align="center" >';
		outStr += '<TD colspan="3" onClick=clearStr() BGCOLOR="EEEEEE" style="cursor: hand" onmouseover="mouseOver(this)" onmouseout="mouseOut(this)">back</TD>';
		outStr += '</TR>';
		outStr += '</TABLE>';
		outStr += '</body></html>';
...
function WriteToPopupWD(oPopUp, obj) {
	var outStr = '<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style>';
		...
		outStr += '</TR>';
		outStr += '<TR align="center">';
		outStr += '<TD colspan="3" onClick=setComp() BGCOLOR="EEEEEE" style="cursor: hand" onmouseover="mouseOver(this)" onmouseout="mouseOut(this)">ok</TD>';
		outStr += '</TR>';
		outStr += '<TR align="center" >';
		outStr += '<TD colspan="3" onClick=clearStr() BGCOLOR="EEEEEE" style="cursor: hand" onmouseover="mouseOver(this)" onmouseout="mouseOut(this)">back</TD>';
		outStr += '</TR>';
