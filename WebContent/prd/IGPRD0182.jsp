...
<html:html>
<bean:define id="id" value="IGPRD0182" toScope="request" />
...
<script type="text/javascript">	
		...
		function setParentValue(id,type,name,option){
			if(!window.opener.closed){
				if( type != '2' && type != 'B' && type != 'E'){
					alert("表达类型只能为下拉列表、单选或单选其它");
					return false;
				}
		...
		<logic:present name="IGPRD01101VO" property="processInfoDefList">
			<logic:iterate id="bean" name="IGPRD01101VO"
				...
				<tr onmouseover="mouseOver(this);"
					...
					onclick="return setParentValue('${bean.pidid}','${bean.pidtype}','${bean.pidname}','${bean.pidoption}')">
<!--					<td>${index+1}</td>-->
					<td>${bean.pidid}</td>
