...
<html:html>
<bean:define id="id" value="IGPRD0169" toScope="request"/>
...
<div id="container"> <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
            ...
            <div id="location">
                <div class="image"></div>
                <p class="fonts1">系统管理 &gt;&gt; 流程定义 &gt;&gt; 流程管理 &gt;&gt; 页面管理 &gt;&gt;流程页面登记
	            </p>
	            <div class="back"><a href="IGPRD0168_Disp.do?pdid=${IGPRD0168Form.pdid}" target="_self">返回</a></div> 
            </div>

            <div id="formwrapper">
            <html:form styleId="form" action="/IGPRD0168_Insert.do" onsubmit="return checkSubmit(this);">
				<!--  message -->
				<ig:message/>
				<!--  /message -->     
				 <fieldset>
					   <legend>流程页面登记</legend>
					 <div>
						<label for="Name"><strong><span class="red">*</span>页面类型</strong>：</label>
							<html:select name="IGPRD0169Form" property="pjdtype">
								<ig:optionsCollection ccid="PROCESS_JSP_CODE" isMakeBlankRow="true" isCodeLabel="true"/>
							</html:select>
						<br>
    				</div>                                    
    				<div>
    				...
    				<div>
	       			...
	       			<html:hidden property="pdid" value="${IGPRD0168Form.pdid }"/>
    				</fieldset>
				<div class="enter">
