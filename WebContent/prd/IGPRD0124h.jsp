...
<html:html>
<bean:define id="id" value="IGPRD0124h" toScope="request" />
...
<div id="location">
<div class="image"></div>
<p class="fonts1"><ig:navigation /> &gt;&gt; 历史版本 &gt;&gt; 状态列表 &gt;&gt; 授权</p>
<div class="back"><a href="IGPRD0140_Back.do?pdid=IGPRD01224Form.pdid" target="_self">返回</a></div> 
</div>
