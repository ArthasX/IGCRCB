...
<html:html>
<bean:define id="id" value="IGPRD0117" toScope="request" />
...
<div class="back"><a href="IGPRD0104_Back.do?pdid=<bean:write name="IGPRD0107Form" property="pdid"/>" target="_self">返回</a></div> 
</div>
