...
<html:html>
<bean:define id="id" value="IGPRD0131h" toScope="request" />
...
<div id="location">
<div class="image"></div>
<p class="fonts1">系统管理 &gt;&gt; 流程定义 &gt;&gt; 流程管理 &gt;&gt; 历史版本 &gt;&gt; 机构列表 &gt;&gt; 授权</p>
<div class="back"><a href="IGPRD0140_Back.do?pdid=${IGPRD0131Form.pdid }" target="_self">返回</a></div> 
</div>
