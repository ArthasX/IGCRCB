...
<html:html>
<bean:define id="id" value="IGPRD0116" toScope="request" />
...
function toback(){
	 IGPRD0116Form.action = getAppRootUrl() + "/IGPRD0104_Back.do?pdid="+IGPRD0116Form.pdid.value + "&ppsdid=${IGPRD0116Form.ppsdid}";
...
<div id="location">
<div class="image"></div>
<p class="fonts1"><ig:navigation /> &gt;&gt; 状态列表 &gt;&gt; 缺省权限</p>
...
<c:if test="${IGPRD01161VO.processStatusDef.psdtype!='2'}">
	<table id="tab_del" class="table_style13" align="left" <c:if test="${IGPRD01161VO.processStatusDef.psdtype=='6'}">style="display:none"</c:if>>
		<tr>
			<th width="20%"></th>
			<th width="80%">
				<c:if test="${IGPRD01161VO.processStatusDef.psdtype == '2'}">
				...
				<logic:equal value="0" name="flag">
					<logic:empty name="ppbdvw" property="pdbdid">
						<tr>
							...
							<logic:equal name="ppbdvw" property="pbdid" value="<%=IGPRDCONSTANTS.BUTTON_UPDATE %>">
								<html:text property="pdbdname" size="10" value="保存" />
								提示信息：
								<html:text property="pdbddesc" size="10" value="保存" />
							</logic:equal>
...
<div id="processDefinitionDiv" style="width:98%;margin:5px auto 10px;display:none">
	...
	<div id="results_list">
	<ig:message/>
	<table class="table_style13" align="left">
			<tr>
				<th width="30%">表单名称</th>
				<th width="50%">权限</th>
				<th width="20%">必填</th>
	...
	<input type="hidden" name="ppsdid" value="${ppsdid}"/>
</html:form></div>
</div>
