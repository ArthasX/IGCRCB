...
<html:html>
<bean:define id="id" value="IGPRD0130" toScope="request"/>
...
<div id="container">
 ...
 <div class="msg">
			...
			<div class="msg_box">
			 <html:form styleId="form" action="/IGPRM0301_Disp" onsubmit="return checkSubmit(this);">
				...
				<input type="hidden" name="pdid" id="pdid" value="${pdid }">
		         <html:submit property="btn_search" value="确定" styleClass="button" />
			</div>
			</html:form>
			</div>
		 </div>
