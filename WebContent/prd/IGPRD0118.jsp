...
<html:html>
<bean:define id="id" value="IGPRD0118" toScope="request" />
...
<script type="text/javascript">	
		...
		function toAdd(){
	    	...
	    	<c:if test="${IGPRD01091VO.processStatusDef.psdtype=='6'}">
		    var flag = false; 
	        </c:if>
	    	<c:if test="${IGPRD01091VO.processStatusDef.psdtype!='6'}">
	    	//是否选择动作
...
<div id="content"><html:form action="/IGPRD0109" styleId="form"
	...
	<div id="location">
	<div class="image"></div>
	<p class="fonts1"><ig:navigation /> &gt;&gt; 状态列表 &gt;&gt; 缺省规则定义</p>
	<div class="back">
		<a href="IGPRD0104_Back.do?pdid=<bean:write name="IGPRD0109Form" property="pdid"/>&ppsdid=<bean:write name="IGPRD0109Form" property="ppsdid"/>" target="_self">返回</a>
	</div> 
	</div>
	...
	<div <c:if test="${IGPRD01091VO.processStatusDef.psdtype=='6'}">style="display:none"</c:if>><label for="Name"><strong>跃迁规则</strong>：</label></div>
	...
	<logic:present name="IGPRD01091VO" property="participantDefaultButtonDefInfoList">
		<logic:iterate id="bean" name="IGPRD01091VO"
			...
			<logic:equal name="bean" property="processButtonDefTB.pbdflag" value="<%=IGPRDCONSTANTS.BUTTON_PBDFLAG_0 %>">
	...
	<c:if test="${IGPRD01091VO.processStatusDef.psdtype=='6'}">
		<input name="roleAAA" type="radio" value="10" checked="checked" style="display: none"/>
	</c:if>
