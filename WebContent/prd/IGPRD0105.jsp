...
<!-- /header1 -->
	<script type="text/javascript">	
	    ...
	    function checkForm(){
	        ...
	        if($("psdmode").value == '1'){
	        	if($("psdflag").value != '0'){
	        		$("psdassign").value = document.getElementById("psdassignUR").value;
	        	}
	        	
	        }else{
	        	if($("psdflag").value == '0'){
	        		$("psdassign").value = document.getElementById("psdassignRO").value;
	        	}else{
	        		$("psdassign").value = document.getElementById("psdassign1").value;
	        	}
	        }
	      	//====>130225End
	    ...
	    function showModeDIV(obj){
	    	...
	    	changePsdmode(document.getElementById("psdmode"));
	    }
	    ...
	    function setDefaultDIV(){
	    	...
	    	if($F("psdtype") == "4"){
	    		document.getElementById("div_branchcond").style.display="";
	    	} else {
	    		document.getElementById("div_branchcond").style.display="none";
	    		$("branchcond").value = "";
	    	}
	    	changePsdmode(document.getElementById("psdmode"));
	    }
	    ...
	    //====>130225Begin	状态模式联动参与者类型 
	    function changePsdmode(obj){
		    if($F("mode") == "0"){
		    	if(obj.value == "1"){
		    		if($F("psdflag") == "0"){
		    			document.getElementById("div_psdassign").style.display="none";
		    			document.getElementById("psdaUR0").style.display="none";
				    	document.getElementById("psdaRO0").style.display="none";
				    	document.getElementById("psda0").style.display="none";
					}else{
						document.getElementById("div_psdassign").style.display="";
						document.getElementById("psdaUR0").style.display="";
						document.getElementById("psdaRO0").style.display="none";
				    	document.getElementById("psda0").style.display="none";
					}
		    		...
		    		if($F("psdflag") == "0"){
		    			document.getElementById("div_psdassign").style.display="";
		    			document.getElementById("psdaUR0").style.display="none";
				    	document.getElementById("psdaRO0").style.display="";
				    	document.getElementById("psda0").style.display="none";
					}else{
						document.getElementById("div_psdassign").style.display="";
						document.getElementById("psdaUR0").style.display="none";
				    	document.getElementById("psdaRO0").style.display="none";
				    	document.getElementById("psda0").style.display="";
					}
		    	}
			}else{
				if(obj.value != "1"){
					if($F("psdflag") == "0"){
						document.getElementById("div_psdassign").style.display="";
						document.getElementById("psdaRO1").style.display="";
						document.getElementById("psda1").style.display="none";
					}else{
						document.getElementById("psdaRO1").style.display="none";
						document.getElementById("psda1").style.display="";
...
<div id="container"> <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
            ...
            <div id="location">
                <div class="image"></div>
                <p class="fonts1"><ig:navigation /> &gt;&gt; 状态列表 &gt;&gt; 
	                <logic:equal name="IGPRD0105Form" property="mode" value="0">
	                                             状态登记
	                </logic:equal>
					<logic:equal name="IGPRD0105Form" property="mode" value="1">
            ...
            <html:form styleId="form" action="/IGPRD0105" onsubmit="return checkSubmit(this);">
                ...
                <fieldset>
                    ...
                    <div>
						<label for="Name"><strong><span class="red">*</span>状态类型</strong>：</label>
							<logic:equal name="IGPRD0105Form" property="mode" value="0">
								<html:select name="IGPRD0105Form" property="psdtype" styleId="psdtype" errorStyleClass="inputError" onchange="changePsdtype()" tabindex="2">
                    ...
                    <div>
						<label for="Name"><strong><span class="red">*</span>状态模式</strong>：</label>
							<logic:equal name="IGPRD0105Form" property="mode" value="0">
							<html:select name="IGPRD0105Form" property="psdmode" styleId="psdmode" errorStyleClass="inputError" tabindex="3" onchange="changePsdmode(this)">
    				...
    				<div ID="div_branchcond">
    					<label for="Name"><strong><span class="red">*</span>动态分支条件</strong>：</label>
    					<html:select name="IGPRD0105Form" property="branchcond" styleId="branchcond" errorStyleClass="inputError" tabindex="4">
							<ig:optionsCollection ccid="PROCESS_DYNAMICBRANCH_COND" isMakeBlankRow="false" isCodeLabel="true" />
						</html:select>
    				</div>
    				<div>
    				...
    				<div style="display: none" id="div_psdassign">
						...
						<label for="Name"><strong><span class="red">*</span>参与者类型</strong>：</label>
							<logic:equal name="IGPRD0105Form" property="mode" value="0">
								<span id="psdaUR0" >
									<html:select name="IGPRD0105Form" property="psdassign" styleId="psdassignUR" errorStyleClass="inputError" tabindex="5">
										<html:options collection="lvPsdassignListUR" property="value" labelProperty="label" />
									</html:select>
								</span>
								<span id="psdaRO0" style="display: none;">
									<html:select name="IGPRD0105Form" property="psdassign" styleId="psdassignRO" errorStyleClass="inputError" tabindex="5">
										<html:options collection="lvPsdassignListRO" property="value" labelProperty="label" />
									</html:select>
								</span>
								<span id="psda0" style="display: none;">
									<html:select name="IGPRD0105Form" property="psdassign" styleId="psdassign1" errorStyleClass="inputError" tabindex="5" >
										<ig:optionsCollection ccid="PROCESSSTATUSDEF_PSDASSIGN" isMakeBlankRow="false" isCodeLabel="true" />
									</html:select>
								</span>
							</logic:equal>
							<logic:equal name="IGPRD0105Form" property="mode" value="1">
								<logic:equal value="1" name="IGPRD0105Form" property="psdmode">
									<span id="psdaUR1" >
										<html:select name="IGPRD0105Form" property="psdassign" styleId="psdassignUR" errorStyleClass="inputError" tabindex="5">
											<html:options collection="lvPsdassignListUR" property="value" labelProperty="label" />
										</html:select>
								...
								<logic:notEqual value="1" name="IGPRD0105Form" property="psdmode">
									<span id="psda1" style="display: none;">
										<html:select name="IGPRD0105Form" property="psdassign" styleId="psdassign1" errorStyleClass="inputError" tabindex="5">
											<ig:optionsCollection ccid="PROCESSSTATUSDEF_PSDASSIGN" isMakeBlankRow="false" isCodeLabel="true" />
										</html:select>
									</span>
                    ...
                    <div>
                    	<label for="Name"><strong>可否代替处理</strong>：</label>
                    	<html:select name="IGPRD0105Form" property="replaceDispose" styleId="replaceDispose" errorStyleClass="inputError" tabindex="6">
                    		<html:option value="Y">是</html:option>
                    		<html:option value="N">否</html:option>
                    	</html:select>
                    </div>
		        ...
		        <html:hidden property="ppsdid" styleId="ppsdid" name="IGPRD0105Form"/>
