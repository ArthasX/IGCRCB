...
<html:html>
<bean:define id="id" value="IGPRD0134h" toScope="request" />
...
<div class="back"><a href="IGPRD0104_Back.do?pdid=<bean:write name="IGPRD0134Form" property="pdid"/>&viewhistory=1" target="_self">返回</a></div> 
</div>
