...
<html:html>
<bean:define id="id" value="IGPRD0164" toScope="request" />
<bean:define id="title" value="外部事件变更" toScope="request" />
<!-- header1 -->
		           ...
		           <html:form styleId="form" action="/IGPRD0161">
			          <div id="location">
				           ...
				           <logic:equal name="IGPRD0161Form" property="mode" value="1">
					            <p class="fonts1">系统管理 &gt;&gt; 流程定义 &gt;&gt; 外部事件配置 &gt;&gt; 外部事件变更</p>
				           </logic:equal> 
				           <div class="back">
			           ...
			           <fieldset>         
		    				...
		    				<div>
								...
								<html:textarea name="IGPRD0161Form" property="peddesc" styleId="peddesc" cols="60" rows="6" errorStyleClass="inputError" tabindex="1"/>
								<br>
		    				</div>
						</fieldset>
				          <div class="enter">
