...
<html:html>
<bean:define id="id" value="IGPRD0142h" toScope="request" />
...
<div id="location">
<div class="image"></div>
<p class="fonts1">系统管理 &gt;&gt; 流程定义 &gt;&gt; 流程管理  &gt;&gt; 历史版本 &gt;&gt; 状态列表 &gt;&gt; 可调整参与者  </p>
<div class="back"><a href="IGPRD0104_Back.do?pdid=${IGPRD0142Form.pdid}&viewhistory=1" target="_self">返回</a></div> 
</div>
