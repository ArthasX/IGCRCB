...
<html:html>
<bean:define id="id" value="IGPRD0138" toScope="request" />
...
<div class="msg_box"><html:form styleId="form" action="/IGPRD0126_List"
	...
	<div class="msgbtn">
		<logic:equal name="form" property="mode" value="0">
		      <html:submit property="btn_add_conf" value="继续新增" styleClass="button" onclick="add('${pdid}','${psdid}');"/>
               <html:submit property="btn_next" value="返回" styleClass="button" onclick="toback('${pdid}','${psdid}')"/>
	    </logic:equal>
	    <logic:equal name="form" property="mode" value="1">
	         <html:submit property="btn_next" value="修改成功返回" styleClass="buttonCX2" onclick="toback('${pdid}','${psdid}')"/>
	    </logic:equal>
	</div>
</html:form></div>
</div>
