...
<html:html>
<bean:define id="id" value="IGSYM0308" toScope="request" />
...
<div id="maincontent">
<div id="contentainer">
<html:form styleId="form" action="/IGSYM0305R"
...
<p class="fonts1">角色查询</p>
	...
	<span>&nbsp;&nbsp;角色类型：</span><span><html:select property="roletype" style="width: 130px;" errorStyleClass="inputError">
	 ...
	 <html:option value="IGBP19">信息安全管理</html:option>
	 <html:option value="IGBP24">综合管理部</html:option>
	 <html:option value="IGBP25">数据运行中心</html:option>
	 <html:option value="IGBP26">系统网络中心</html:option>
	 <html:option value="IGBP27">软件开发中心</html:option>
	 <html:option value="IGBP28">科技领导</html:option>
	 </html:select>
