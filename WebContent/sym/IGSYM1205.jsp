		...
		if(treeNodeMap!=null&&!treeNodeMap.isEmpty()){			
			if(treeNodeMap.keySet()!=null&&!treeNodeMap.keySet().isEmpty()){
					...
					while(it.hasNext()){
						...
						if(code.equals("999001")||code.startsWith("999001001")||code.startsWith("999001006")||
								code.startsWith("999001009")||code.startsWith("999002") || 
								code.startsWith("999001028") || code.startsWith("999001029")){
