...
<p class="fonts1">用户查询</p>
	...
	<table class="table_style">
		<tr>
			<th width="5%"><label> <input type="checkbox" name="checkbox" id="checkbox" onclick="selectAll('checkbox','deleteRoleid')"/> </label></th>
			<th width="10%">用户ID</th>
			<th width="10%">所属机构</th>
			<th width="10%">用户姓名</th>
			<th width="10%">用户电话</th>
		...
		<logic:present name="IGSYM04051VO" property="desplayVOList">
			<logic:iterate id="bean" name="IGSYM04051VO" property="desplayVOList" indexId="index">
				<tr >
