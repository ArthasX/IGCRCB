...
<html:html>
<bean:define id="id" value="IGSYM0402" toScope="request" />
<bean:define id="title" value="授权管理角色授权画面" toScope="request" />
<!-- header1 -->
...
<!--
	...
	function deleteRec(obj,flag){
        ...
        if(window.confirm(confirmMsg)){
            form.action = getAppRootUrl() + "/IGSYM0402.do?mode="+mode;
            return true;
        } else {
            return false;
        }
...
<div id="contentWrap">
<div id="content">
<html:form styleId="form" action="/IGSYM0402"
	onsubmit="return checkSubmit(this);">
<div id="location">
<div class="image"></div>
<p class="fonts1"><ig:navigation extname1="${urlable}"/></p>
<div class="back"><a href="IGSYM0401_RE.do" target="_self">返回</a></div>
</div>
	<html:hidden property="username"/>
	<html:hidden property="orgname"/>
	<input type="hidden" name="flag" value="1">
	
	<div class="role_title">被授权人</div>
	<div id="results_list">
	...
	<table class="table_style6" align="left">
			<tr>
				...
				<td width="20%">
					...
					<bean:write name="IGSYM0402Form" property="username"/>
				...
				<td width="38%">
					<bean:write name="IGSYM0402Form" property="orgname"/>
	...
	<table class="table_style4" align="left">
			...
			<tr>
				...
				<label> <input type="checkbox"
					name="checkbox" id="checkbox" onclick="selectAll('checkbox','urid')"/> </label>
					</th>
				<th width="22%">
				角色名称
				</th>
			...
			<logic:present name="IGSYM04021VO" property="ownRoleList">
				<logic:iterate id="bean" name="IGSYM04021VO"
					property="ownRoleList" indexId="index">
					<tr class="<ig:rowcss index="${index}"/>">
						<td><label><html:checkbox
							property="urid" value="${bean.urid}" /> </label>
						</td>
	...
	<div id="operate">
	<logic:present name="IGSYM04021VO"
		property="ownRoleList">
		<span> <html:submit property="btn_delete" value="删除所选"
			styleClass="button" onclick="return deleteRec('urid','0');" /></span>
	</logic:present>
	</div>
	<div class="role_title">可选角色</div>
	
	<logic:present name="IGSYM04021VO" property="roleMap">
		<div id="TabbedPanels1" class="TabbedPanels">
		<ul class="TabbedPanelsTabGroup">
			<logic:iterate id="map" name="IGSYM04021VO" property="roleMap" indexId="number">
