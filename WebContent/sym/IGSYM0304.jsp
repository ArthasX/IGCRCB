...
<bean:define id="title" value="资产模型列表" toScope="request" />
...
var selectedLast = "0";
<logic:notEmpty name="IGSYM03041VO" property="selectedLast">
	<bean:define id="selectedLast" name="IGSYM03041VO" property="selectedLast" type="java.lang.String" />
