...
<html:html>
<bean:define id="id" value="IGSYM1507" toScope="request" />
...
<div id="maincontent">
<div id="contentainer">
<html:form styleId="form" action="/IGSYM1506_Disp"
	...
	<table class="table_style">
			  <!-- header部 -->
			            ...
			            <!-- body部 -->
			                ...
			                <logic:present name="IGSYM15061VO" property="codeCategoryDefInfoList" >
			                    <logic:iterate id="bean" name="IGSYM15061VO" property="codeCategoryDefInfoList" indexId="index">
