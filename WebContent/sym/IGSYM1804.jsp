...
<html:html>
<bean:define id="id" value="IGSYM1804" toScope="request"/>
<bean:define id="title" value="首页管理修改" toScope="request"/>
...
<div id="container"> <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
            ...
            <div id="location">
                <div class="image"></div>
                <p class="fonts1"><ig:navigation extname1="${urlable}"/> &gt;&gt; 首页修改
	            </p>
	            <div class="back"><a href="IGSYM1801_Disp.do" target="_self">返回</a></div> 
            </div>

            <div id="formwrapper">
            <html:form styleId="form" action="/IGSYM1802_Edit.do" onsubmit="return checkSubmit(this);">
				<!--  message -->
				<ig:message/>
				<!--  /message -->     
				 <fieldset>
					 ...
					 <div>
						<label for="Name"><strong><span class="red">*</span>首页描述</strong>：</label>
							...
							value="${IGSYM18011VO.firstJspInfoList[0].hplabel}"/>
						<br>
    				</div>                                    
    				<div>
						<label for="Name"><strong><span class="red">*</span>首页显示名称</strong>：</label>
							...
							value="${IGSYM18011VO.firstJspInfoList[0].hptitle}"/>
						<br>
    				</div>
    				<div>
						<label for="Name"><strong><span class="red">*</span>首页URL </strong>：</label>
							...
							value="${IGSYM18011VO.firstJspInfoList[0].hpurl}"/>
						<br>
    				</div>
    				<html:hidden property="hpid" value="${IGSYM18011VO.firstJspInfoList[0].hpid}"/>
