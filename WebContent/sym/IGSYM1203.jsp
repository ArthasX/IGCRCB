...
<%@page import="com.deliverik.framework.utility.CommonDefineUtils"%><html:html>
<bean:define id="id" value="IGSYM1201" toScope="request" />
<bean:define id="title" value="资产模型" toScope="request" />
<bean:define id="treemap" name="IGSYM12011VO" property="treeNodeMap" type="java.util.Map" />
		...
		if(treeNodeMap!=null&&!treeNodeMap.isEmpty()){			
			if(treeNodeMap.keySet()!=null&&!treeNodeMap.keySet().isEmpty()){
					...
					while(it.hasNext()){
						...
						if (key.contains(CommonDefineUtils.ENTIY_CATEGORY_DEVICE_SYSCODING)
								|| key.contains(CommonDefineUtils.ENTIY_CATEGORY_SOFTWARE_SYSCODING)) {
