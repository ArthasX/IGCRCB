...
// 				document.getElementById("asset_domain").style.display="";							
	...
	function setDefalutAssetDiv(){
		...
		if(nowmode==1){
			...
			if(roletype!=null && roletype!="" && roletype.indexOf("IGAC")>=0){
				//document.getElementById("asset_domain").style.display="";
				if (roletype == "IGAC10") {
					document.getElementById("asset_domain").value = "999013";
				} // end if 
				if (roletype == "IGPL11") {
					document.getElementById("asset_domain").value = "999017";
				} // end if 
			}
		}
	}
	...
	// 返回按钮点击事件
	function toback(){
		window.location.href =getAppRootUrl() + "/IGSYM0301_RE.do?";
	}
//-->
	</script>
<body onload="setDefalutTypeDiv();setDefalutAssetDiv();">
<div id="maincontent">
<!--header  头部和 一级菜单-->
...
<p class="fonts1">系统管理 &gt;&gt; 角色管理 &gt;&gt; <logic:equal name="IGSYM0302Form" property="mode"
		...
		value="1">角色维护&gt;&gt;角色变更</logic:equal></p>
...
<div id="formwrapper"><html:form styleId="form"
	...
	<div id="asset_domain" style="display:none"><label for="Name"><strong><span class="red">*</span>资产管理内容</strong>：</label>
		...
		<html:hidden property="assetdomain" styleId="assetdomain"/>
		<br/>
	</div>
	...
	<div class="enter"><html:submit property="btn_insert" value="提交"
		...
		property="btn_clear" onclick="setAssetDiv(1);" styleClass="button" value="重置"/>
	<logic:equal name="IGSYM0302Form" property="mode" value="1">
		<html:button property="btn_clear" styleClass="button" value="返回" onclick="toback();"/>
	</logic:equal>
	</div>
