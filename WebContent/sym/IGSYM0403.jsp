...
<html:html>
<bean:define id="id" value="IGSYM0403" toScope="request" />
...
<div id="contentWrap">
<div id="content">
<html:form styleId="form" action="/IGSYM0403"
...
<p class="fonts1"><ig:navigation extname1="${urlable}"/></p>
	...
	<table class="table_style">
			...
			<logic:present name="IGSYM04031VO" property="roleList">
				<logic:iterate id="bean" name="IGSYM04031VO" property="roleList"
					indexId="index" type="com.deliverik.framework.user.model.Role">
					<tr class="<ig:rowcss index="${index}"/>" onmouseover="mouseOver(this);" onmouseout="mouseOut(this,'<ig:rowcss index="${index}"/>');" onclick="doLook('IGSYM0404_Disp.do?roleid=${bean.roleid}&rolename=<%=URLEncoder.encode(bean.getRolename(),"UTF-8")%>');">
						<td>${bean.rolename}</td>
						<td><ig:codeValue ccid="ROLE_CATEGORY_CODE" cid="${bean.roletype}" /></td>
						<td>${bean.roledesc}</td>
						<td>
							<a href="IGSYM0404_Disp.do?roleid=${bean.roleid}">
