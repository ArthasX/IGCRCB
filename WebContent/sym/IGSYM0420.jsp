...
<html:html>
<bean:define id="id" value="IGSYM0420" toScope="request" />
...
<script type="text/javascript">	
        function setParentValue(userid, username,orgid,orgname,usermobile){
        	window.returnValue=userid+'-'+username+'-'+orgid+'-'+orgname+'-'+usermobile;
            window.close();
        }
...
<body style="background-color: white; background-image: none;OVERFLOW-X:scroll;">
<div id="maincontent">
<div id="contentainer">
<html:form styleId="form" action="/IGSYM0420"
