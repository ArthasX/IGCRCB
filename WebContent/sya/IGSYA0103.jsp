...
<html:html>
<bean:define id="id" value="IGSYA0103" toScope="request" />
<bean:define id="title" value="制度管理" toScope="request" />
<!-- header1 -->
...
<div id="contentWrap">
<div id="content"><html:form action="/IGSYA0103" styleId="form" onsubmit="return checkSubmit(this);">
	<div id="location">
	<div class="image"></div>
	<p class="fonts1">制度汇编 &gt;&gt; 制度汇编 &gt;&gt;制度管理</p>
	</div>
	<div id="search">
	<div class="img"></div>
	...
	<table class="table_style">
		...
		<logic:present name="IGSYA0101VO" property="institutionList">
			<logic:iterate id="bean" name="IGSYA0101VO" property="institutionList" indexId="index">
					...
					<td>
						<html:link action="/IGSYA0104.do?inid=${bean.inid}"> 
