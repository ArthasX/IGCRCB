...
<html>
<bean:define id="id" value="IGCYB0101" toScope="request" />
...
function checkForm(action){
	...
	if( window.confirm("您是否确认提交？")){
		...
		<logic:notEmpty name="IGPRR0101Form" property="isServiceStart">
		IGPRR0101Form.attributes["action"].value="IGPRR0116.do";
		</logic:notEmpty>
		return true;
	} else {
		return false;
...
function initAttFormFile(){
	if('${IGPRR0101Form.parameters}' != ''){
		getFormObj("值班计划").value='${IGPRR0101Form.parameters}';
	}
...
<logic:empty name="IGPRR0101Form" property="isServiceStart">
	<jsp:include page="/include/header2.jsp" /> <!--container 左菜单 右侧内容-->
</logic:empty>
<div id="container"><!--content  右侧内容-->
<div id="contentWrap">
<div id="content"><html:form action="/IGPRR0101" styleId="IGPRR0101Form"
	...
	<div class="back"><html:link href="IGCOM0105.do">返回</html:link></div>
	</div>
	<div>
...
<script type="text/javascript">
	jQuery(function(){
		setIGCYB0101Params('${LOGIN_USER.username}','${LOGIN_USER.orgname}','${LOGIN_USER.orgid}','${LOGIN_USER.useremail}','${LOGIN_USER.userphone}','${LOGIN_USER.usermobile}');
	})
</script>
</body>
</html>
