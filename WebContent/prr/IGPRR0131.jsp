...
<html:html>
<bean:define id="id" value="IGPRR0131" toScope="request" />
...
<div class="back"><a href="IGPRR0102_Disp.do?pdid=${IGPRR0113Form.pdid}&roleid=${IGPRR0113Form.roleid}&prid=${IGPRR0113Form.prid}" target="_self">返回</a></div>
	...
	<ul>
		<li class="TabbedPanelsTab" tabindex="0">参与者</li>
	</ul>
...
<%-- 								<LABEL><INPUT id="checkboxs_${bean.role.roleid}" onclick="selectAll('checkboxs_${bean.role.roleid}','checkbox_${bean.role.roleid}')" name="checkboxs_${bean.role.roleid}" value="" type="checkbox"></LABEL> --%>
								${bean.role.rolename}
								<input type="hidden" name="role" value="${bean.role.roleid}_${bean.role.rolename}">
								</TH>	
								<TH width="10%"><img id="image_${bean.role.roleid}" style="cursor:hand;" src="images/minus.gif" width="12" height="12" onclick="toggleElement('role_${bean.role.roleid}','image_${bean.role.roleid}','1')"/></TH>
							</TR>
						</TBODY>
					</TABLE>
				</div>
