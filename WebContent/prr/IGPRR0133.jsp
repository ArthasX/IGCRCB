							...
							<div style="width:540px;" id="${vo.processStatusDef.psdid}_${bean.role.roleid}">
								<div style="width:540px; float:left;">
									<TABLE class="table_style4" align="left">
										<TBODY>
											<TR>
												<TH width="80%" align="left"><LABEL><INPUT id="checkboxs_${vo.processStatusDef.psdid}_${bean.role.roleid}" onclick="selectAll('checkboxs_${vo.processStatusDef.psdid}_${bean.role.roleid}','checkbox_${vo.processStatusDef.psdid}_${bean.role.roleid}')" name="checkboxs_${vo.processStatusDef.psdid}_${bean.role.roleid}" value="" type="checkbox"></LABEL>${bean.role.rolename}<input type="hidden" name="role" value="${vo.processStatusDef.psdid}_${bean.role.roleid}_${bean.role.rolename}"></TH>
												<TH width="20%"><img id="image_${vo.processStatusDef.psdid}_${bean.role.roleid}" style="cursor:hand;" src="images/minus.gif" width="12" height="12" onclick="toggleElement('role_${vo.processStatusDef.psdid}_${bean.role.roleid}','image_${vo.processStatusDef.psdid}_${bean.role.roleid}', '1')"/></TH>
											</TR>
										</TBODY>
									</TABLE>
								</div>
										...
										<TABLE  align="left"  class="table_style14">
											<TBODY>
												<logic:iterate id="info" name="bean" property="lst_UserInfo">
													<c:set var="ADparticipant" value="${vo.processStatusDef.psdid}_${bean.role.roleid}_${info.userida}"></c:set>
													<TR>
													  <TD width="5%"><LABEL><html:multibox styleId="checkbox_${vo.processStatusDef.psdid}_${bean.role.roleid}" property="participants" value="${vo.processStatusDef.psdid}_${bean.role.roleid}_${info.userida}"/></LABEL></TD>
