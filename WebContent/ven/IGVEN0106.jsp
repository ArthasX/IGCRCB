...
<html:html>
<bean:define id="id" value="IGVEN0106" toScope="request" />
...
<script type="text/javascript">	
	...
	function readInfo(rmid) {
		...
		form.action = "IGVEN0202_LASTSEARCH.do?rmid=" + rmid;
		form.submit();
...
<div id="contentWrap">
<div id="content">
<html:form styleId="form" action="/IGVEN0201_LASTSEARCH" onsubmit="return checkSubmit(this);" >
<div id="location">
<div class="image"></div>
<p class="fonts1"><ig:navigation extname4="风险监测管理查询画面"/></p>
