...
<html>
<bean:define id="id" value="IGVEN0108" toScope="request" />
<bean:define id="title" value="监测指派工作发起画面" toScope="request" />
<!-- header1 -->
...
function initAttFormFile(){
	...
	if(getFormObj("人员").value!=null && getFormObj("人员").value!=''){
		$("prtitle").value= getFormObj("人员").value;		
	}
	if('${IGPRR0101Form.parameters}' != ''){
		var rcrid = '${IGPRR0101Form.parameters}';
		getFormObj("人员").value= rcrid;
	}else{
...
function toback() {
	...
	window.location.href = getAppRootUrl() + "/IGVEN0202.do?rmid="+cwrid;
}
</script>
