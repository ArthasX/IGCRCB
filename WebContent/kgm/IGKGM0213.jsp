...
<html:html>
<bean:define id="id" value="IGSYM0213" toScope="request" />
...
<div class="msg_box"><html:form styleId="form" action="/IGKGM0208"
	onsubmit="return checkSubmit(this);">
	<div class="msg_img"><img src="images/Round_Icon_09.gif"
		border="0" /></div>
	<div class="msgcontent"><ig:message /></div>
	<div class="msgbtn"><html:submit property="btn_back" value="知识审批"
