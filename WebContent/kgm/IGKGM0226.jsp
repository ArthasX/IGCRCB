...
<html:html>
<bean:define id="id" value="IGKGM0226" toScope="request" />
<bean:define id="title" value="知识审批详情页面" toScope="request" />
...
<div id="content"><html:form action="/IGKGM0207"
	...
	<div id="location">
	<div class="image"></div>
	<c:if test="${IGKGM02051VO.igkgm0215form.knflag == '0'}">
		<p class="fonts1">流程管理 &gt;&gt; 知识库 &gt;&gt; 知识审批 &gt;&gt;知识信息</p>
	</c:if>
	<c:if test="${IGKGM02051VO.igkgm0215form.knflag == '1'}">
		<p class="fonts1">流程管理 &gt;&gt; 知识库 &gt;&gt; 知识管理 &gt;&gt;知识信息</p>
	</c:if>
	<div class="back">
		<c:if test="${IGKGM02051VO.igkgm0215form.knflag == '0'}">
		<a href="IGKGM0208_BACK.do" target="_self">返回</a>
		</c:if>
		<c:if test="${IGKGM02051VO.igkgm0215form.knflag == '1'}">
		<a href="IGKGM0209_BACK.do" target="_self">返回</a>
		</c:if>
		<c:if test="${IGKGM02051VO.igkgm0215form.knflag == '2'}">
		<a href="IGCOM0202.do?linkID=IGCOM0403&firstactid=00" target="_self">返回</a>
		</c:if>
	</div>
	</div>
...
<logic:present name="IGKGM02051VO" property="knowledgeProcessList">
	...
	<div class="record_list">
		<div class="action">
			<img src="images/confirm.gif" width="16" height="16" />
			<a href="javascript:goPage('IGKGM0222_Disp.do')">存入知识库</a>
		</div>
		<div class="action"><img src="images/t111.gif" width="16"
			height="16" /><a href="javascript:goPage('IGKGM0223_Disp.do');">驳回</a>
		</div>
