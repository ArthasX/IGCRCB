...
<html:html>
<bean:define id="id" value="IGKGM0204" toScope="request" />
   ...
   <div id="content">
      <div id="location">
       <div class="image"></div>
        ...
        <div class="back"><a href="IGKGM0202_BACK.do" target="_self">返回</a></div>
      </div>
      	<div class="image"></div>
        ...
        <div>
          	...
          	<html:text name="IGKGM0201Form"  property="kntitle" styleId="kntitle" errorStyleClass="inputError imeDisabled" size="30" />      
