...
<html:html>
<bean:define id="id" value="IGFXK0703" toScope="request" />
...
<div class="msg_box"><html:form styleId="form" action="/IGFXK0702_Disp"
	onsubmit="return checkSubmit(this);">
	<div class="msg_img"><img src="images/Round_Icon_09.gif"
		border="0" /></div>
	<div class="msgcontent"><div class="txMessageInf">风险提示管理下发成功！</div></div>
