...
<html>
<bean:define id="id" value="IGFXK0401" toScope="request" />
	...
	<logic:present name="IGPRR01011VO" property="processInfoDefmap">
		<logic:iterate id="map" name="IGPRR01011VO" property="processInfoDefmap" indexId="index" >
			...
			if("2".equalsIgnoreCase(psid.getPidaccess()) || "3".equalsIgnoreCase(psid.getPidaccess()) || "4".equalsIgnoreCase(psid.getPidaccess())){
				...
				<c:if test="${pidid == '0100101005' }">
					<logic:equal value="<%=IGPRDCONSTANTS.PUBLIC_ACCESS_WRITEABLE %>" name="psid" property="pidaccess">
						<input type="text" name="show_value_pidid0100101005" id="show_value_pidid0100101005" value="" readonly="true" size="82"/>
						<img src="images/seek.gif" alt="查询" onclick="openAsmModel(this);" style="cursor: hand;"/>
					</logic:equal>
					<input type="hidden" id="pidid0100101005" name="pivarvalue[${index }]" value="${psid.pidvalue}"/>
				</c:if>
				<c:if test="${pidid != '0100101005' }">
					<ig:formToTag 
						name="IGPRR0102Form" 
