...
<html>
<bean:define id="id" value="IGFXK0404" toScope="request" />
	...
	<logic:present name="IGPRR01011VO" property="processInfoDefmap">
		<logic:iterate id="map" name="IGPRR01011VO" property="processInfoDefmap" indexId="index" >
			...
			if("2".equalsIgnoreCase(psid.getPidaccess()) || "3".equalsIgnoreCase(psid.getPidaccess()) || "4".equalsIgnoreCase(psid.getPidaccess())){
				...
				<input type="text" name="RiskCategory" id="RiskCategory" value="" readonly="true" size="82" onclick="openAsmModel(this);"/>
				<img src="images/seek.gif" alt="查询" onclick="openAsmModel(this);" style="cursor:hand;padding-top:4px;text-align:left;"/>
				<input type="hidden" id="RiskCategoryID" name="pivarvalue[${index }]" value=""/>
				...
				<%-- <tr><td style="background-color:#e8f2fc;">
					<label style="width:70px;float: left;background-color:#e8f2fc"><strong>
						风险类别1：</strong></label>
					<label id="label_0" style="width:90px;height:20px;background-color:#e8f2fc;text-align:left;"></label>
					<input type="text" name="show_value_pidid0114001019" id="show_value_pidid0114001019" value="" readonly="true" size="32"/>
					<img src="images/seek.gif" alt="查询" onclick="openAsmModel(this);" style="cursor:hand;padding-top:4px;text-align:left;"/>
					<span style="display:-moz-inline-box;display:inline-block;padding-top:4px;margin-left:162px;">
						<img src="images/seek.gif"/><a href="" style="text-decoration:none;color:#000000;top-padding:4px;padding-bottom:2px;">添加检查项</a>
						<img src="images/seek.gif"/><a href="" style="text-decoration:none;color:#000000;top-padding:4px;padding-bottom:2px;">添加风险点</a>
						<img src="images/seek.gif"/><a href="" style="text-decoration:none;color:#000000;top-padding:4px;padding-bottom:2px;">添加清单</a>
					</span>
					<input type="hidden" id="pidid0114001019" name="pivarvalue[${index }]" value="${psid.pidvalue}"/>
				</td></tr> --%>
				</c:if>
				<c:if test="${pidid != '0114001019'}">
				<logic:notEqual value="<%=IGPRDCONSTANTS.PROCESSTITLE_HIDE %>" name="psid" property="pidaccess">
