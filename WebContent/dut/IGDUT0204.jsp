...
<html:html>
<bean:define id="id" value="IGGUT0204" toScope="request" />
...
<!--
	...
	function checkForm(){
		...
		<logic:present name="IGDUT02041VO" property="hasNullDrcontent">
			<logic:equal name="IGDUT02041VO" property="hasNullDrcontent" value="1">
				if( window.confirm('<bean:message key="IGDUT0204.W001"/>是否确认交接？')){
					return true;
				} else {
					return false;
				}
...
<div id="contentWrap">
<div id="content"><html:form styleId="form" action="/IGDUT0204"
	...
	<p class="p2">${IGDUT02041VO.usersinfo}</p>
	</div>
	<div><label for="Name"><strong>值班时间</strong>：</label>
	<p class="p2"><c:if test="${IGDUT02041VO.dutyPlan.dptype == 1}">
		<ig:codeValue ccid="DAYSHIFT_DUTY_PERIOD"
			cid="${IGDUT0204Form.dadcategory}001" />-<ig:codeValue
			ccid="DAYSHIFT_DUTY_PERIOD" cid="${IGDUT0204Form.dadcategory}002" />
	</c:if> <c:if test="${IGDUT02041VO.dutyPlan.dptype == 2}">
		<ig:codeValue ccid="NIGHTSHIFT_DUTY_PERIOD"
			cid="${IGDUT0204Form.dadcategory}001" />-<ig:codeValue
			ccid="NIGHTSHIFT_DUTY_PERIOD" cid="${IGDUT0204Form.dadcategory}002" />
	</c:if></p>
	</div>
	<div><label for="Name"><strong>遗留问题</strong>：</label> <html:textarea
		name="IGDUT0204Form" property="dpquestion" cols="80" rows="5"
		errorStyleClass="inputError" tabindex="1" /></div>
	<div><label for="Name"><strong>总结</strong>：</label> <html:textarea
		name="IGDUT0204Form" property="dpinfo" cols="80" rows="5"
		errorStyleClass="inputError" tabindex="2" /></div>

	</fieldset>
	</div>

	<logic:present name="IGDUT02041VO" property="voList">
		<div class="enter"><html:submit property="btn_insert" value="交接"
...
<ul class="TabbedPanelsTabGroup">
	<logic:present name="IGDUT02041VO" property="voList">
		<logic:iterate id="vo" name="IGDUT02041VO" property="voList"
			indexId="number">
...
<div class="TabbedPanelsContentGroup"><logic:present
	name="IGDUT02041VO" property="voList">
	<logic:iterate id="vo" name="IGDUT02041VO" property="voList"
		indexId="number">
