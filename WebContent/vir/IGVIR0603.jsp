...
<html:html>
<bean:define id="id" value="IGAIM0104" toScope="request" />
...
<script type="text/javascript">	
        ...
        function toback(){
        	form.action = getAppRootUrl() + "/IGVIR0601_Disp.do?org.apache.struts.taglib.html.CANCEL=1";
        	form.submit();
        }
        var num = 0;
...
<html:form styleId="form" action="/IGAIM0104"
 ...
 <div class="enter">            
   	<c:if test="${IGCIM01041VO.flag==true}">
    	<logic:present name="IGCIM01041VO" property="configItemVersionTime">
				...
				<c:if test="${num > 1}">
			    	<html:button property="btn_compare" styleClass="button"  onclick="openEiVersionWindow_SOC('${IGCIM01041VO.entityData.eiid}');" >
			    		版本比较
			    	</html:button>	
    			</c:if>
		</logic:present>
