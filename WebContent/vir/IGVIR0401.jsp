...
<html>
<bean:define id="id" value="IGVIR0401" toScope="request" />
...
function checkVMInfo(){
	...
	var vmids = document.getElementsByName("vmids");
...
function saveVM(){
	...
	// 提交数据
	jQuery.post(getAppRootUrl() + "/IGVIR0401_SaveVM.do", jQuery("#form").serialize(),
		function(data) {
			getFormObj("调整信息").value = data;
		});
...
<%-- 				<html:textarea property="prdesc" cols="60" rows="6"  errorStyleClass="inputError imeActive"></html:textarea></td> --%>
	...
	<jsp:include page="IGVIR0401_INC.jsp"></jsp:include>
	<div class="enter">
	<div>
