...
<html:html>
<bean:define id="id" value="IGVIR0604" toScope="request"/>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGVIR0604"
            ...
            <div id="location">
                ...
                <div id="search">
		             ...
		             <div class="conditions">
                          ...
                          <div>
                           <html:hidden property="esyscoding" value="999001029001"/>
...
<%-- 							   <th width="8%"><bean:message bundle="asmResources" key="title.IGCIM0101.relationship"/></th> --%>
			            ...
			            <!-- body部 -->			  
			                <logic:present name="IGVIR06041VO" property="entityDataList" >
			                	<bean:define id="vo"  name="IGVIR06041VO" />
			                	<bean:define id="showRelation"  name="IGVIR06041VO" property="showRelationMap"/>
			                    <logic:iterate id="bean" name="IGVIR06041VO" property="entityDataList" indexId="index">
			                        ...
			                        <td>${PagingDTO.viewStartCount+index}</td>
			                           ...
			                           <!-- 详细信息 -->
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGCIM0905_Disp.do?eiid=${bean.eiid}&backUrl=IGVIR0604_Back.do"><img src="images/xx.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0101.displayInfo.alt"/>' width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
