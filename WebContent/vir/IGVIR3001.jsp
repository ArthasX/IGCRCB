...
<html>
<bean:define id="id" value="IGVIR3001" toScope="request" />
...
function saveVM(){
	...
	// 提交数据
	jQuery.post(getAppRootUrl() + "/IGVIR3001_SaveVM.do", jQuery("#form").serialize(),
		function(data) {
...
<%-- 				<html:textarea property="prdesc" cols="60" rows="6"  errorStyleClass="inputError imeActive"></html:textarea></td> --%>
	...
	<jsp:include page="IGVIR3001_INC.jsp"></jsp:include>
	<div class="enter">
	<div>
