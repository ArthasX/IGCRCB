...
<html>
<bean:define id="id" value="IGVIR0301" toScope="request" />
...
function checkVMInfo(){
	...
	//alert(vmnames.length);
	var checkRes = true;
	for (var i = 1; i < vmcpus.length; i++) {
		if (vmcpus[i].value === "") {
...
// 	root.deleteRow(1);
	...
	// 提交数据
	jQuery.post(getAppRootUrl() + "/IGVIR0301_SaveVM.do", jQuery("#form").serialize(),
		function(data) {
// 		   alert("项目主键：" + data);
		});
	getFormObj("项目主键").value = jQuery("#pid").val();
}
...
<%-- 				<html:textarea property="prdesc" cols="60" rows="6"  errorStyleClass="inputError imeActive"></html:textarea></td> --%>
	...
	<jsp:include page="IGVIR0301_INC.jsp"></jsp:include>
	<div class="enter">
	<div>
