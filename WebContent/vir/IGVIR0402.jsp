...
<bean:define id="id" value="IGVIM0402" toScope="request" />
...
<div id="content"><html:form action="/IGPRR0102" styleId="form"
	...
	<logic:present name="IGPRR01021VO" property="processInfoDefmap">
		...
		<table cellspacing="2" class="table_style1">
			...
			<jsp:include page="IGVIR0402_INC04.jsp"></jsp:include>
		</table>
		</div>
	</logic:present>
	</logic:equal>
	...
	<jsp:include page="IGVIR0402_INC01.jsp"></jsp:include>
...
<%-- 	<jsp:include page="${relevantProcessJsp}"/> --%>
	...
	<jsp:include page="IGVIR0402_INC03.jsp"/>
