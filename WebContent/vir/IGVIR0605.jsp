...
<html:html>
<bean:define id="id" value="IGVIR0605" toScope="request"/>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGVIR0605"
            ...
            <div id="location">
                ...
                <div id="search">
		             ...
		             <div class="conditions">
                          ...
                          <div>
                           <html:hidden property="esyscoding" value="999001029002"/>
...
<%-- 							   <th width="8%"><bean:message bundle="asmResources" key="title.IGCIM0101.relationship"/></th> --%>
			            ...
			            <!-- body部 -->			  
			                <logic:present name="IGVIR06051VO" property="entityDataList" >
			                	<bean:define id="vo"  name="IGVIR06051VO" />
			                	<bean:define id="showRelation"  name="IGVIR06051VO" property="showRelationMap"/>
			                    <logic:iterate id="bean" name="IGVIR06051VO" property="entityDataList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                           ...
			                           <!-- 详细信息 -->
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGCIM0905_Disp.do?eiid=${bean.eiid}&backUrl=IGVIR0605_Back.do"><img src="images/xx.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0101.displayInfo.alt"/>' width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
