...
<div id="container"><!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGVIR0901_Insert" onsubmit="return checkSubmit(this);">
                      <!--  message -->
                      <ig:message/>
                      <!--  /message -->     
		            <fieldset>
	                    <legend>计费策略设定</legend>
                        <div>
                            <label for="Name"><strong><span class="red">*</span>策略名称</strong>：</label>
                            <html:text property="strategyName" errorStyleClass="inputError imeActive" tabindex="2" styleId="strategyName"/>
                            <br>
                        </div>
                        <logic:present name="IGVIR09011VO" property="configItemList" >
	                        ...
	                        <div>
			                	...
			                	<html:text property="values" tabindex="1" style="width:125px;" errorStyleClass="inputError" styleId="values${index}"/>(元/天)
