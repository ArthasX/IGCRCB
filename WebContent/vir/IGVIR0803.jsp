...
<html:html>
<bean:define id="id" value="IGVIR0803" toScope="request" />
<bean:define id="title" value="部门资源 " toScope="request" />
<!-- header1 -->
...
// 	alert(orgcode);
	location.href = "IGVIR0802.do?showType=ctrl&searchType=org&orgsyscoding="+orgcode;
}
</script><body>
<div id="maincontent">
<!--header  头部和 一级菜单-->
...
<div id="contentWrap">
<div id="content">
<html:form styleId="form" action="/IGVIR0803_SEARCH"
...
<p class="fonts1"><ig:navigation extname1="${urlable}"/></p>
	...
	<div>
	<span>所属机构：</span><html:text property="orgname" readonly="true" name="IGVIR0803Form"/>
		<img src="images/tree.gif" style="cursor: hand;" width="16" height="16" border="0" onclick="setOrg('IGSYM0101_TREE.do');" alt="请选择机构"/>
	<html:hidden property="orgsyscoding_like" name="IGVIR0803Form"/>
	...
	<div id="results_list" >
		...
		<table class="table_style" style="width: 98%;float: center;">
			<logic:present name="IGVIR08031VO" property="vim03oList">
				<tr>
					<th style="text-align: center;" width="10%">序号</th>
					<th style="text-align: center;" width="60%" >机构</th>
					<th style="text-align: center;" width="40%">虚机数量</th>
				</tr>
				<logic:iterate id="bean" name="IGVIR08031VO"
