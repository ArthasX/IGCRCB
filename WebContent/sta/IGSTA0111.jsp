...
%>
<html:html>
<bean:define id="id" value="IGSTA0111" toScope="request" />
<bean:define id="title" value="检查工作监督详细显示画面" toScope="request" />
<!-- header1 -->
...
<!--content  右侧内容-->
   ...
   <div id="location">
	<div class="image"></div>
	<p class="fonts1">查看</p>
	<div class="back"><a href="IGSTA0101_Back.do" target="_self">返回</a></div>
	</div>
	<div class="title">
