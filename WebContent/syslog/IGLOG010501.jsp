...
<!-- /header1 -->
	<script type="text/javascript">	
		window.onunload = function(){ 
        	this.opener.location.href = getAppRootUrl()+'/IGLOG0101_Search.do?isRealTimeCollect=1';    
		};
            ...
            <div id="formwrapper">
            	...
            	<legend>屏蔽规则录入</legend>
		         <html:form styleId="IGLOG0101Form" action="/IGLOG0101_Filter" onsubmit="return checkSubmit(this);" >
		            ...
		            <html:hidden property="isRealTimeCollect" name="IGLOG0101Form" value="${IGLOG0101Form.isRealTimeCollect }"/>
 		         </html:form>
 		      </fieldset>
            </div>
        </div>
