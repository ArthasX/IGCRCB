...
<script type="text/javascript">
	...
	function tiaozuan(prid, inde) {
		...
		window.parent.location.href = getAppRootUrl() + '/IGPRR0102_Disp.do?prid='+prid+'&alarmFlag=true02_syslog';
...
<html:form styleId="form" action="/IGLOG0102_Search">
	...
	<div style="width: 98.7%;display: none;" id="search">
		...
		<table>
			<tr>
				<td><!--查询触发时间段-->确认时间：从<html:text
					property="starttime_from" size="15" readonly="true" /> <img
					src="images/date.gif" style="cursor: pointer;"
					onClick="calendar($('starttime_from'))" /> 到<html:text
					property="starttime_to" size="15" readonly="true" /> <img
					src="images/date.gif" align="middle" style="cursor: pointer;"
					onClick="calendar($('starttime_to'));" /> &nbsp;&nbsp;
					
					<!--告警IP--> 
					<bean:message bundle="mtmResources" key="label.IGLOG0001.AlarmIP" />：
					<html:text property="ip_like" styleId="ip_like" errorStyleClass="inputError imeDisabled" 
						size="15" maxlength="16" tabindex="2"></html:text> &nbsp;&nbsp;
					
					<!--告警状态-->	
					<bean:message bundle="mtmResources" key="label.IGLOG0001.alarmState" />：
				    <html:select name="IGLOG0102Form" styleId="state" property="state"
						style="width: 100px;" errorStyleClass="inputError">
			...
			<tr>
				<td>
				<!--查询触发时间段-->修复时间：从<html:text property="endtime_from" size="15" readonly="true" /> <img
					src="images/date.gif" align="middle" style="cursor: pointer;"
					onClick="calendar($('endtime_from'))" border="0" /> 
				<!--查询触发时间段-->到<html:text property="endtime_to" size="15" readonly="true" /> <img
					src="images/date.gif" align="middle" style="cursor: pointer;"
					onClick="calendar($('endtime_to'))" border="0" />&nbsp;&nbsp;
				<!--关键字--> 
					关键字：
			...
			<tr>
				<td width="100%"><logic:present name="IGLOG0102VO" property="ruleli"> 
					告警等级：
				...
				<html:submit property="btn_search" styleClass="button" value="确认"
		...
		<logic:present name="IGLOG0102VO" property="list_vo">
			<logic:iterate id="bean" name="IGLOG0102VO"
				...
				<tr class="alarmcolor_level${bean.rulelevel}">
					<td width="4%">
						 <input type="checkbox" name="id" value="${bean.id}">
					</td>
