...
<html:form action="/IGSVC0100" styleId="form" onsubmit="return checkSubmit(this);">
    ...
    <span>&nbsp;&nbsp;状态：</span><span><html:select property="prstatus">
		<ig:optionsCollection ccid="I"
			 isMakeBlankRow="true"
			isCodeLabel="true" />
	</html:select></span>
	</div>
	<div>
	<span>时间：从</span><span><html:text property="propentime" styleId="propentime" errorStyleClass="inputError imeDisabled" size="16" readonly="true"/>
	<img src="images/date.gif" align="middle" onclick="calendar($('propentime'))" border="0" style="cursor: hand" /></span>
	...
	<ig:optionsCollection ccid="IURGENCY_GRADE_CODE" isMakeBlankRow="true" isCodeLabel="true"/>
	</html:select></span>
