...
<%		
		...
		response.setHeader("Content-disposition","attachment;filename="  + new String( "设备运行报告.xls".getBytes("gb2312"), "ISO8859-1" ) );
		ExportExcel.exportIGSVC0622(response.getOutputStream(),vo.getProcessCountList(),form.getPropentime_from(),form.getPropentime_to());
		out.clear();
