...
%>
<html:html>
<bean:define id="id" value="IGSVC0629" toScope="request" />
...
function checkForm(){
	...
	if(!checkDate("propentime_from","propentime_to")){
		...
		document.forms[0].action = getAppRootUrl() + "/IGSVC0629.do";
...
function exportExcel() {
	if(!checkDate("propentime_from","propentime_to")){
		...
		document.forms[0].action = getAppRootUrl() + "/IGSVC0629.do?report1=1";
		document.forms[0].submit();
	}
}
...
function showNewPage1(prassetid,type,from,to){
	...
	openSubWindow('/IGSVC0625_Read.do?prassetid='+prassetid+'&type=001&prtype='+type+'&propentime_from='+from+'&propentime_to='+to+' 23:59&modes=2' ,"_blank","1000","600");
	
}
function showNewPage2(prassetid,type,from,to){

	openSubWindow('/IGSVC0625_Read1.do?prassetid='+prassetid+'&type=001&prtype='+type+'&propentime_from='+from+'&propentime_to='+to+' 23:59&modes=2' ,"_blank","1000","600");
	
}
function showNewPage3(prassetid,type,from,to){

	openSubWindow('/IGSVC0625_Read2.do?prassetid='+prassetid+'&type=001&prtype='+type+'&propentime_from='+from+'&propentime_to='+to+' 23:59&modes=2' ,"_blank","1000","600");
...
<div id="contentainer">
   ...
   <div id="location">
       <div class="image"></div>
        <p class="fonts1">设备运行报告</p>
    </div>  
     <div id="search">
     <html:form styleId="form" action="/IGSVC0629" onsubmit="return checkSubmit(this);">
         <div class="img"></div>
