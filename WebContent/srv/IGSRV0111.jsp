...
<html:html>
<bean:define id="id" value="IGSRV0111" toScope="request" />
<bean:define id="title"  toScope="request" >
<bean:message bundle="srvResources" key="ietitle.IGSRV0111"/>
</bean:define>
<!-- header1 -->
...
function ope(temp,prid){
	if(temp=="del"){
		if(window.confirm('<bean:message bundle="srvResources" key="message.IGSRV0111.001"/>')){
			window.location=getAppRootUrl() + "/IGSRV0111_del.do?delprid="+prid;			
		}
	}
}
...
<html:form action="/IGSRV0111" styleId="form"
	...
	-->
	<span>&nbsp;&nbsp;<bean:message bundle="srvResources" key="label.IGSRV0111.prtitle"/>：</span><span><html:text
		property="prtitle" /></span>
		<!--  
		<span>&nbsp;&nbsp;发起者：</span><span><html:text
		property="prusername" size="12"/></span>
		-->
			<span>&nbsp;&nbsp;&nbsp;&nbsp;<bean:message bundle="srvResources" key="label.IGSRV0111.pdid"/>：</span><span>
            <html:select property="pdid" onchange="searchprocessStatus();">
            	<option></option>
            	<logic:iterate name="ADlist" id="bean" type="com.deliverik.framework.workflow.prd.model.IG380Info">
	...
	<span>&nbsp;&nbsp;<bean:message bundle="srvResources" key="label.IGSRV0111.time"/>：<bean:message bundle="srvResources" key="label.IGSRV0111.propentime"/></span><span><html:text
	...
	<span>&nbsp;&nbsp;<bean:message bundle="srvResources" key="label.IGSRV0111.prclosetime"/></span><span><html:text
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span> <html:submit
		styleClass="button"  >
		<bean:message bundle="srvResources" key="button.IGSRV0111.search"/>
		</html:submit>
		</span>
		<div>
		<span>&nbsp;&nbsp;<bean:message bundle="srvResources" key="label.IGSRV0111.psort"/>：</span><span>
            <html:select property="psort" onchange="setpsort_order()">
            	<option></option>
				<html:option value="prpdname"><bean:message bundle="srvResources" key="title.IGSRV0111.prtype"/></html:option>
			</html:select></span>
		</div>
	...
	<table class="table_style" style="width:670px;">
		<tr>
			<th width="3%"></th>
			<th width="10%"><a href="javascript:showSort('prid');"><bean:message bundle="srvResources" key="title.IGSRV0111.prid"/><img id="img_prid" src="images/timeup.gif" border="0"></a></th>
			<th width="15%"><a href="javascript:showSort('prtitle');"><bean:message bundle="srvResources" key="title.IGSRV0111.prtitle"/><img id="img_prtitle" src="images/timeup.gif" border="0"></a></th>
			<th width="10%"><a href="javascript:showSort('prpdname');"><bean:message bundle="srvResources" key="title.IGSRV0111.prtype"/><img id="img_prpdname" src="images/timeup.gif" border="0"></a></th>
			<th width="15%"><a href="javascript:showSort('propentime');"><bean:message bundle="srvResources" key="title.IGSRV0111.propentime"/><img id="img_propentime" src="images/timeup.gif" border="0"></a></th>
			<th width="15%"><a href="javascript:showSort('prclosetime');"><bean:message bundle="srvResources" key="title.IGSRV0111.prclosetime"/><img id="img_prclosetime" src="images/timeup.gif" border="0"></a></th>
			<th width="10%"><a href="javascript:showSort('prstatus');"><bean:message bundle="srvResources" key="title.IGSRV0111.prstatus"/><img id="img_prstatus" src="images/timeup.gif" border="0"></a></th>
			<% if("1".equals(request.getAttribute("isAdmin"))){ %>
				<th width="5%"><bean:message bundle="srvResources" key="title.IGSRV0111.delete"/></th>
	...
	<table class="table_style" style="width:670px;">
		<logic:present name="IGSRV02011VO" property="processList">
			<logic:iterate id="bean" name="IGSRV02011VO" property="processList"
				indexId="index" type="com.deliverik.framework.workflow.prr.model.entity.IG500TB">
			<bean:define id="prtype" name="bean" property="prtype" type="java.lang.String" />
				...
				onclick="doLookOpen('IGEXTWA0103_Disp_SOC.do?prid=<bean:write name="bean" property="prid" />');"
			</logic:equal>
			<logic:equal name="bean" property="prtype" value="WB">
				onclick="doLookOpen('IGEXTWB0103_Disp_SOC.do?prid=<bean:write name="bean" property="prid" />');"
			</logic:equal>
			<logic:notEqual name="bean" property="prtype" value="WA">
			       <logic:notEqual name="bean" property="prtype" value="WB">
				 onclick="doLookOpen(getAppRootUrl()+'/IGPRR0102_Disp_SOC.do?prid=<bean:write name="bean" property="prid" />&prtype=<bean:write name="bean" property="prtype" />&prstatus=<bean:write name="bean" property="prstatus" />');" 
			       </logic:notEqual>
			</logic:notEqual>
					 >
					<td width="3%">
						<%
							...
							if(prassetname!=null&& prassetname.split(":").length==2)
							{
								...
								{
								%>
									<img src="images/full-time.gif" width="16" height="16" border="0" alt='<bean:message bundle="srvResources" key="img.IGSRV0111.time.alt"/>' />
								<%
							}
						}
						%>
					...
					<%if("1".equals(request.getAttribute("isAdmin"))){ %>
						<td width="5%">
							<a href="javascript:ope('del','${bean.prid}');">
								<img src="images/delete.gif" width="16" height="16" border="0" alt='<bean:message bundle="srvResources" key="img.IGSRV0111.delete.alt"/>' />
							</a>
						</td>
