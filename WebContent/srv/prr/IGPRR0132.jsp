...
<html:html>
<bean:define id="id" value="IGPRR0132" toScope="request" />
...
<div id="contentWrap">
<div id="content">
<html:form styleId="form" action="/IGPRR0102_Assign?prid=${IGPRR0101Form.prid}&psdid=${IGPRR0101Form.psdid}&roleid=${IGPRR0101Form.prroleid}&prroleid=${IGPRR0101Form.prroleid}&pdid=${IGPRR0101Form.pdid}&psdcode=Z&action=10" onsubmit="return checkSubmit(this);">
<div id="location">
<div class="image"></div>
<p class="fonts1">参与者</p>
<div class="back"><a href="IGPRR0102_Disp.do?pdid=${IGPRR0101Form.pdid}&roleid=${IGPRR0101Form.roleid}&prid=${IGPRR0101Form.prid}" target="_self">返回</a></div>
</div>
<div id="results_list">
<div id="search">
	<div class="img"></div>
											...
											<TR>
												...
												<LABEL><span class="red">*</span>主办部门：</LABEL>
													<logic:present name="vo" property="labelList">
														...
														<html:select name="IGPRR0101Form" property="ppsupers" errorStyleClass="inputError imeActive" styleId="ppsupers[${index}]" value="${IGPRR0101Form.ppsupers[index]}">
...
<html:hidden property="prid" styleId="prid" name="IGPRR0101Form"/>
<html:hidden property="psdid" styleId="psdid" name="IGPRR0101Form"/>
<html:hidden property="prroleid" styleId="prroleid" name="IGPRR0101Form"/>
