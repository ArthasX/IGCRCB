...
<div id="contentWrap">
<div id="content"><html:form action="/IGEXTWB0104_SOC" styleId="form" onsubmit="return checkSubmit(this);return checkFile();" enctype="multipart/form-data">
	<%-- 变更编号--%>
	<html:hidden property="prid" />
	<div id="location">
	<div class="image"></div>
	<p class="fonts1">更新信息</p>
	<div class="back"><a href="javascript:show('IGEXTWB0103_Disp_SOC.do?prid=<bean:write name="IGEXTWB0104Form" property="prid" />')" ><bean:message bundle="wkmResources" key="button.IGEXTWB0104.back"/></a></div> 
	</div>
