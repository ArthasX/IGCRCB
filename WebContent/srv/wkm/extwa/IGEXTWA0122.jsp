...
function checkNotSelect(obj) {
	...
	function checkForm(){
		...
		if(window.confirm(confirmMsg)){
			document.forms[0].action=getAppRootUrl() + "/IGEXTWA0122_SOC.do?prid="+${IGEXTWA0102Form.prid};
	...
	function verifiors(flag){
		...
		if(flag=="1"){
			...
			var data = window.showModalDialog(getAppRootUrl()+'/IGEXTWA0124_Disp_SOC.do?prid='+${IGEXTWA0102Form.prid},new Array(window),"dialogWidth:1000px;dialogHeight:650px;status:no;help:no;resizable:yes");
			window.location.href ="IGEXTWA0122_Assign_Disp_SOC.do?aa=yy&prid = "+${IGEXTWA0102Form.prid};	
	 		return false;
		}else{
			...
			if(window.confirm(confirmMsg)){
	            form.action = getAppRootUrl() + "/IGEXTWA0124_Del_SOC.do?mode="+mode+"&path="+"IGEXTWA0122_SOC";
	            return true;
	        } else {
	            return false;
	        }
	...
	function implementors(flag){
		...
		if(flag=="1"){
			//openSubWindow('/IGEXTWA0123_Disp_SOC.do?prid='+${IGEXTWA0102Form.prid} , '', '1000', '600');
			var data = window.showModalDialog(getAppRootUrl()+'/IGEXTWA0123_Disp_SOC.do?prid='+${IGEXTWA0102Form.prid},new Array(window),"dialogWidth:1000px;dialogHeight:650px;status:no;help:no;resizable:yes");
			window.location.href ="IGEXTWA0122_Assign_Disp_SOC.do?aa=yy&prid = "+${IGEXTWA0102Form.prid};	
	 		return false;
		}else{
			...
			if(window.confirm(confirmMsg)){
	            form.action = getAppRootUrl() + "/IGEXTWA0123_Del_SOC.do?mode="+mode+"&path="+"IGEXTWA0122_SOC";
	            return true;
	        } else {
	            return false;
	        }
	...
	function freshPage(){
		document.forms[0].action=getAppRootUrl() + "/IGEXTWA0122_Assign_Disp_SOC.do?prid="+${IGEXTWA0102Form.prid};
		document.forms[0].submit();
	}
</script>
<body>
...
<div id="contentWrap">
<div id="content"><html:form styleId="form" action="/IGEXTWA0122_SOC"
	...
	<div class="enter">
		...
		styleClass="button" onclick="return goPage('IGEXTWA0122_DispI_SOC.do');" />
	...
	<html:hidden property="path" value="IGEXTWA0122_SOC" name="IGEXTWA0102Form" />
</html:form></div>
</div>
