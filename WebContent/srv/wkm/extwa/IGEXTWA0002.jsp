...
<html:html>
<bean:define id="id" value="IGEXTWA0002" toScope="request" />
...
<script type="text/javascript">
	...
	function checkForm(){
		...
		if(window.confirm(confirmMsg)){
			document.forms[0].action=getAppRootUrl() + "/IGEXTWA0002_SOC.do";
	...
	function implementors(flag){
		...
		if(flag=="1"){
			openSubWindow('/IGEXTWA0126_Disp.do' , '', '1000', '600');
	 		return false;
		}else{
			...
			if(window.confirm(confirmMsg)){
	            form.action = getAppRootUrl() + "/IGEXTWA0126_Del.do";
	            return true;
	        } else {
	            return false;
	        }
...
<div id="contentWrap">
<div id="content"><html:form styleId="form" action="/IGEXTWA0002_SOC"
	...
	<div class="enter">
		...
		styleClass="button" onclick="return goPage('IGEXTWA0002_DispI.do');" />
