...
<!--
	...
	function deleteRec(flag){
        ...
        if(window.confirm(confirmMsg)){
            ...
            form.action = getAppRootUrl() + "/IGEXTWA0105_SOC.do?mode="+mode+"&isSOC=1";
            return true;
        } else {
            return false;
        }
...
<div id="contentWrap">
<div id="content">
<html:form styleId="form" action="/IGEXTWA0105_SOC" onsubmit="return checkSubmit(this);">
<div id="location">
<div class="image"></div>
<p class="fonts1">审核人</p>
<div class="back"><a href="IGEXTWA0103_Disp_SOC.do?prid=<bean:write name="IGEXTWA0105Form" property="prid" />&bkmode=<bean:write name="IGEXTWA0105Form" property="bkmode" />">返回</a></div> 
</div>
