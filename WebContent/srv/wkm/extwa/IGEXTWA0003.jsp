...
<script type="text/javascript">
	...
	function implementors(flag){
		...
		if(flag=="1"){
			openSubWindow('/IGEXTWA0127_Disp_SOC.do?queryjsp=exta0003' , '', '1000', '600');
	 		return false;
		}else{
			...
			if(window.confirm(confirmMsg)){
	            form.action = getAppRootUrl() + "/IGEXTWA0127_Del_SOC.do";
	            return true;
	        } else {
	            return false;
	        }
...
<div id="container">
<div id="contentWrap">
<div id="content"><html:form styleId="form" action="/IGEXTWA0003_SOC"
	...
	<div class="enter">
		...
		styleClass="button" onclick="return goPage('IGEXTWA0003_DispI_SOC.do');" />
