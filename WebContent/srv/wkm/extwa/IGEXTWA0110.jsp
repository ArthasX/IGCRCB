...
<div id="contentWrap">
<div id="content"><html:form action="/IGEXTWA0110_SOC" styleId="form" onsubmit="return checkSubmit(this);" enctype="multipart/form-data">
	<%-- 工作编号--%>
	...
	<div class="image"></div>
	<p class="fonts1">中止</p>
	<div class="back"><a href="IGEXTWA0103_Disp_SOC.do?prid=<bean:write name="IGEXTWA0110Form" property="prid" />&bkmode=<bean:write name="IGEXTWA0110Form" property="bkmode" />">返回</a></div> 
	</div>
