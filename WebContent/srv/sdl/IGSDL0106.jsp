...
<bean:define id="id" value="IGSDL0106" toScope="request" />
...
<!--          <div class="back"><a href="IGSDL0105_Disp.do" target="_self">返回</a></div>-->
    </div>
        <div id="formwrapper">
		<html:form>
        <ig:message />
       ...
       <div>
            <label for="Name"><strong>开始日期</strong>：</label>
             <p class="p2">
             	<bean:write name="IGSDL01051VO" property="beginDate" />
             	<html:hidden property="qjcrttime" value="${IGSDL01051VO.beginDate}" />
             </p>      
          <br />
       </div>
