...
<logic:present name="${vo}" property="process">
	...
	<table width="100%">
		<tr>
			<td width="80%"></td>
			<td width="20%" align="left"><a href="javascript:openHistoryPage('/IGSVC0824.do?prid=${process.prid}');">查看状态日志</a></td>
		</tr>
	</table>
	</div>
	...
	<div class="title" onclick="toggleElement('personMessage','personMessageImg')">
		<div class="name" style="cursor: hand;">人员信息<img id="personMessageImg" src="images/add_1.jpg"></div>
	</div>
	...
	<table cellspacing="2" class="table_style1">
		...
		<tr>
			<th>办公电话：</th>
			<td><bean:write name="${vo}" property="workphone" /></td>
			<th>邮箱：</th>
	...
	<c:choose>
		...
		<table width="100%">
			<tr>
				...
				<a href="###" onclick="initProcessQuick('${process.prid}','S','IGSVC0807_Disp.do?prid=${process.prid}')">发起相关流程</a>
				</td>
			</tr>
		</table>
		</div>
