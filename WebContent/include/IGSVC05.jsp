...
<logic:present name="${vo}" property="process">
	...
	<table cellspacing="2" class="table_style1">
		...
		<tr>
			<th>相关资产：</th>
			<td colspan="5"><a href="javascript:void(0)" onclick="openSubIGCOM0303('${process.prassetid}','')">
			<bean:write name="process" property="prassetname" /> </a></td>
		</tr>
		<tr>
			<th>发布描述：</th>
			...
			<logic:iterate id="info" name="${vo}" property="processInfo"
				...
				<tr>
					...
					<td colspan="3">
						...
						<% } else if(info.getPivarvalue().contains("_asset_")){ %>
							<a href="javascript:void(0)" onclick="openSubIGCOM0303('<%=info.getPivarvalue().split("_asset_")[0] %>','')">
								<%=info.getPivarvalue().split("_asset_")[1] %> </a>
