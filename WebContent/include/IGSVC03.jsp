...
<logic:present name="${vo}" property="process">
	...
	<table width="100%">
		<tr>
			<td width="80%"></td>
			<td width="20%" align="left"><a href="javascript:openHistoryPage('/IGSVC0319.do?prid=${process.prid}');">查看状态日志</a></td>
		</tr>
	</table>
	</div>
	<logic:present name="${vo}" property="processInfo">
		...
		<bean:define id="count" name="${vo}" property="processInfo" type="java.util.List"/>
			<logic:iterate id="info" name="${vo}" property="processInfo"
				indexId="index" type="com.deliverik.framework.workflow.prr.model.IG599Info">
				<%
	...
	<div id="timeMessage" class="record_list" style="display: none">
	<table cellspacing="2" class="table_style1">
		<tr>
			<th width="15%">发生时间：</th>
	...
	<c:choose>
		...
		<table width="100%">
			<tr>
				...
				<a href="###" onclick="initProcessQuick('${process.prid}','P','IGSVC0307_Disp.do?prid=${process.prid}')">发起相关流程</a>
				</td>
			</tr>
		</table>
		</div>
	...
	<div class="title" style="cursor: hand;">
	<div class="name" onclick="toggleElement('attachMessage','attachMessageImg')">
	附件信息<img id="attachMessageImg" src="images/add_1.jpg"></div>
	</div>
	<div id="attachMessage" class="record_list" style="display: none">
