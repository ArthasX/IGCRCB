...
<html:html>
<title>IGRPT0103报表订制画面</title>
<bean:define id="treemap" name="IGRPT01011VO" property="treeNodeMap" type="java.util.Map" />
<style>
html,body {
   margin:0;
   padding:0;
...
<%if(!treemap.isEmpty()){%>
	...
	<script type="text/javascript">
		...
		function selectType(id,name){
			if(id == '217') {
				$("frmcontent").src = "IGRPT0104.do";
			} else {
				$("frmcontent").src = "IGRPT0104.do?rfdtype=" + id.split("_")[2];
			}
		}
	</script>
</table>
...
<iframe name="frmcontent" width="756" height="460" frameborder="0" scrolling="auto" src="IGRPT0104.do" ></iframe>
</div>
</div>
</div>
</div>
