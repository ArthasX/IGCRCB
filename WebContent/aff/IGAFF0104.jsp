...
<html:html>
<bean:define id="id" value="IGAFF0104" toScope="request"/>
...
<!-- /header1 -->
	...
	function checkForm(){
	 ...
	 function selectEntityItem(){
	     	openSubWindow('/IGAFF0000_Disp.do?paramEsyscoding=999001029002', '', '850', '600');
	     }
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGAFF0104"
            ...
            <div id="location">
                ...
                <div id="search">
		             ...
		             <div class="conditions">
                          ...
                          <div>
			                ...
			                <label><span class="red">*</span>虚拟设备</label>
			                <html:text property="einame" styleId="einame" errorStyleClass="inputError imeDisabled" size="20" ><script type="text/javascript">printBRByScreenWidth();</script></html:text> 
                ...
                <div id="results_list">
			       ...
			       <table width="100%" class="table_style">
			            ...
			            <!-- body部 -->			  
			                <logic:present name="IGAFF01031VO" property="soc0118List" >
			                	<bean:define id="vo"  name="IGAFF01031VO" />
			                    <logic:iterate id="bean" name="IGAFF01031VO" property="soc0118List" indexId="index">
