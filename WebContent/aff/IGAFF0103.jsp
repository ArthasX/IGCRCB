...
<html:html>
<bean:define id="id" value="IGAFF0103" toScope="request"/>
...
<!-- /header1 -->
	...
	function checkForm(){
	 ...
	 function selectEntityItem(){
	     	openSubWindow('/IGAFF0000_Disp.do?paramEsyscoding=999002001', '', '850', '600');
	     }
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGAFF0103"
                ...
                <div id="search">
		             ...
		             <div class="conditions">
                          ...
                          <div>
			                ...
			                <label><span class="red">*</span>数据库</label>
