...
<html:html>
<bean:define id="id" value="IGAFF0102" toScope="request"/>
...
<!-- /header1 -->
	...
	//打开选择页面
	 function selectEntityItem(){
    	openSubWindow('/IGAFF0000_Disp.do?paramEsyscoding=999002002', '', '850', '600');
    }
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGAFF0102"
            ...
            <div id="location">
                ...
                <div id="search">
		             ...
		             <div class="conditions">
                          ...
                          <div>
			                <label><span class="red">*</span>中间件</label>
                ...
                <div id="results_list">
			       ...
			       <table width="100%" class="table_style">
			            ...
			            <!-- body部 -->			  
			                <logic:present name="IGAFF01021VO" property="soc0118List" >
			                	<bean:define id="vo"  name="IGAFF01021VO" />
			                    <logic:iterate id="bean" name="IGAFF01021VO" property="soc0118List" indexId="index">
