...
<%@ page import="com.deliverik.infogovernor.soc.aut.vo.IGAUT01031VO"%>
...
<%
IGAUT01031VO vo = (IGAUT01031VO) request.getAttribute("vo");
...
%>
<html:html>
<bean:define id="id" value="IGAUT0103" toScope="request" />
<bean:define id="type" name="IGAUT0103Form" property="prtype" />
<bean:define id="title" value="审计结果填写" toScope="request" />
<!-- header1 -->
...
<div id="contentWrap">
<div id="content">
	<html:form action="/IGAUT0103" styleId="form" onsubmit="return checkSubmit(this);">
	<div id="location">
	<div class="image"></div>
    ...
    <html:hidden property="prstatus" value="W"/>
	<logic:present name="AD_ProcessInfoQueryMap" scope="session">
		<logic:iterate id="map" name="AD_ProcessInfoQueryMap" scope="session" indexId="index">
			...
			<ig:processInfoQuery pdid="${bean.pdid }" pidname="${bean.pidname }" name="IGAUT0103Form" property="varvalues[${index }]"/>&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<table class="table_style">
		<tr>
			<th width="2%"></th>
			<th width="2%"></th>
			<th width="8%"><a href="IGAUT0103.do?orderVal=prserialnum">编号
			<logic:equal name="IGAUT0103Form" property="order" value="prserialnum">
				<logic:equal name="IGAUT0103Form" property="sing" value="ASC">
					<img src="images/timeup.gif" border="0">
				</logic:equal>
				<logic:equal name="IGAUT0103Form" property="sing" value="DESC">
					<img src="images/timedown.gif" border="0">
				</logic:equal>
			</logic:equal></a></th>
			<th width="18%"><a href="IGAUT0103.do?orderVal=prtitle">审计简述		
			<logic:equal name="IGAUT0103Form" property="order" value="prtitle">
				<logic:equal name="IGAUT0103Form" property="sing" value="ASC">
					<img src="images/timeup.gif" border="0">
				</logic:equal>
				<logic:equal name="IGAUT0103Form" property="sing" value="DESC">
			...
			<th width="8%"><a href="IGAUT0103.do?orderVal=prusername">发起者
			<logic:equal name="IGAUT0103Form" property="order" value="prusername">
				<logic:equal name="IGAUT0103Form" property="sing" value="ASC">
					<img src="images/timeup.gif" border="0">
				</logic:equal>
				<logic:equal name="IGAUT0103Form" property="sing" value="DESC">
			...
			<th width="10%"><a href="IGAUT0103.do?orderVal=propentime">发起时间
			<logic:equal name="IGAUT0103Form" property="order" value="propentime">
				<logic:equal name="IGAUT0103Form" property="sing" value="ASC">
					<img src="images/timeup.gif" border="0">
				</logic:equal>
				<logic:equal name="IGAUT0103Form" property="sing" value="DESC">
			...
			<th width="10%"><a href="IGAUT0103.do?orderVal=prclosetime">关闭时间
			<logic:equal name="IGAUT0103Form" property="order" value="prclosetime">
				<logic:equal name="IGAUT0103Form" property="sing" value="ASC">
					<img src="images/timeup.gif" border="0">
				</logic:equal>
				<logic:equal name="IGAUT0103Form" property="sing" value="DESC">
			...
			<th width="10%"><a href="IGAUT0103.do?orderVal=prstatus">状态
			<logic:equal name="IGAUT0103Form" property="order" value="prstatus">
				<logic:equal name="IGAUT0103Form" property="sing" value="ASC">
					<img src="images/timeup.gif" border="0">
				</logic:equal>
				<logic:equal name="IGAUT0103Form" property="sing" value="DESC">
		...
		<logic:present name="IGAUT01031VO" property="processList">
			<logic:iterate id="bean" name="IGAUT01031VO" property="processList"
				indexId="index">
