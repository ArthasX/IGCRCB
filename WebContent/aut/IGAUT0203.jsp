...
<html:html>
<bean:define id="id" value="IGAUT0203" toScope="request"/>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGAUT0203"
...
<!-- 					           </th> -->
			            ...
			            <!-- body部 -->			  
			                <logic:present name="IGAUT02031VO" property="entityItemVWInfoList" >
			                	<bean:define id="vo"  name="IGAUT02031VO" />
			                	<bean:define id="showRelation"  name="IGAUT02031VO" property="showRelationMap"/>
			                    <logic:iterate id="bean" name="IGAUT02031VO" property="entityItemVWInfoList" indexId="index">
