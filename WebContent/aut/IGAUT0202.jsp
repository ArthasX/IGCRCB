...
<html:html>
<bean:define id="id" value="IGAUT0202" toScope="request"/>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGAUT0202"
...
<!-- 					           </th> -->
			            ...
			            <!-- body部 -->			  
			                <logic:present name="IGAUT02021VO" property="entityItemVWInfoList" >
			                	<bean:define id="vo"  name="IGAUT02021VO" />
			                	<bean:define id="showRelation"  name="IGAUT02021VO" property="showRelationMap"/>
			                    <logic:iterate id="bean" name="IGAUT02021VO" property="entityItemVWInfoList" indexId="index">
