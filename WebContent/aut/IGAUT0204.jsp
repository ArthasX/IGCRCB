...
<html:html>
<bean:define id="id" value="IGAUT0204" toScope="request"/>
	...
	function checkForm(){
	 ...
	 function setEntity(){
		 var alertMessage = '<bean:message bundle="asmResources" key="message.IGCIM0101.005"/>';
			var url = "IGCIM1203_ENTITY_TREE.do?levelnode=999001029";
...
//				 document.forms[0].eid.value = "";
	 ...
	 function initEname(){
		 	if("设备资产"==document.forms[0].ename.value){
				document.forms[0].ename.value = "虚拟设备";
				document.forms[0].esyscoding.value = "999001029";
		 	}
		}
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGAUT0204"
...
<!-- 					           </th> -->
			            ...
			            <!-- body部 -->			  
			                <logic:present name="IGAUT02041VO" property="entityItemVWInfoList" >
			                	<bean:define id="vo"  name="IGAUT02041VO" />
			                	<bean:define id="showRelation"  name="IGAUT02041VO" property="showRelationMap"/>
			                    <logic:iterate id="bean" name="IGAUT02041VO" property="entityItemVWInfoList" indexId="index">
