...
<html:html>
<bean:define id="id" value="IGAUT0205" toScope="request"/>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGAUT0205"
...
<!-- 					           </th> -->
			            ...
			            <!-- body部 -->			  
			                <logic:present name="IGAUT02051VO" property="entityItemVWInfoList" >
			                	<bean:define id="vo"  name="IGAUT02051VO" />
			                	<bean:define id="showRelation"  name="IGAUT02051VO" property="showRelationMap"/>
			                    <logic:iterate id="bean" name="IGAUT02051VO" property="entityItemVWInfoList" indexId="index">
