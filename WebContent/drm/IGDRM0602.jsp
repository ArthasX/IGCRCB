...
<html:html>
<bean:define id="id" value="IGDRM0602" toScope="request"/>
...
<script type="text/javascript">	
	...
	function doDel(id){
		...
		if( window.confirm(confirmMsg)){			
			form.action = getAppRootUrl() + "/IGDRM0602_Dele.do?did="+id;
			form.submit();
		}
	}
...
<div id="container">
	...
	<html:form styleId="form" action="/IGDRM0602" onsubmit="return checkSubmit(this);">
            <div id="location">
                <div class="image"></div>
				<p class="fonts1">
应急管理&nbsp;&nbsp;&gt;&gt;&nbsp;&nbsp;演练计划管理&nbsp;&nbsp;&gt;&gt;&nbsp;&nbsp;演练计划管理
			                ...
			                <logic:present name="IGDRM06021VO" property="searchDrillplanMap" >
			                    <logic:iterate id="bean" name="IGDRM06021VO" property="searchDrillplanMap" indexId="index">
			                       <tr class="<ig:rowcss index="${index}" />"  style='cursor:hand' onmouseover="mouseOver(this);" onmouseout="mouseOut(this);">
			                            ...
			                            <td onclick="doLook(getAppRootUrl()+'/IGDRM0605_SEE.do?did=${bean['DID']}&flag=manager');">
				                           <a> ${bean['DNAME']}</a>
			                            </td>
			                            <td>
				                            ${bean['DUSERNAME']}
...
<%-- 			                            		<html:link action="/IGDRM0602_Dele.do?did=${bean['DID']}"> --%>
			                            			<img src="images/delete_16x16.gif" width="16" height="16"  border="0" alt="删除" onclick="doDel(${bean['DID']})"/>
<%-- 			                            		</html:link> --%>
