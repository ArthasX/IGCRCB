...
<html>
<bean:define id="id" value="IGDRM0101" toScope="request" />
...
jQ(function(){
	...
	//复制标识
	var copyFlag = jQ("#pidid"+pdid+"017").val();
	//隐藏场景类型
	...
	if(copyFlag){
		...
		if(psdid.substring(7,10)=='001'){
			var sceneType = jQ("#pidid"+pdid+"016").val();
			jQ("#pidid"+pdid+"016").empty();
			jQ("<option  value="+sceneType+">"+sceneType+"</option>").appendTo("#pidid"+pdid+"016");//添加下拉框的option
			jQ("#pidid"+pdid+"016").parent().parent().find("span").remove();
	}
	}
});
</script>
