...
<html:html>
<bean:define id="id" value="IGDRM0419" toScope="request" />
...
<table class="table_style">
	...
	<logic:present name="IGDRM04191VO" property="configurationCodeDetailList">
		<logic:iterate id="bean" name="IGDRM04191VO" property="configurationCodeDetailList">
		...
		<tr class="<ig:rowcss index="${index}"/>">
			...
			<!-- 修改属性 -->
			<td>
				<a href="IGDRM0420_Disp.do?ccdcategory=${bean.ccdcategory}">
					修改属性
				</a>
			</td>
		</tr>
...
<div class="enter">
	<input type="button" id="btn_add" value="增加" class="button" onclick="window.location='IGDRM0418_Disp.do'" />
</div>
<div id="operate">
<!-- paging --> 
