...
<html:html>
<bean:define id="id" value="IGDRM1404" toScope="request"/>
	       	...
	       	<tr>
	       	 ...
	       	 <logic:present name="IGDRM07011VO" property="ig500InfoList" >
	       	 	<logic:iterate id="bean" name="IGDRM07011VO" property="ig500InfoList" indexId="index">
	       	 		<tr>
	       	 			<td>
	       	 				<a href="javascript:void(0);" style="text-decoration: none;" onclick="setParam('${bean.prid}','${bean.prtitle }')"><img src="images/select_asset.gif" title="选择"/> </a>
	       	 			</td>
