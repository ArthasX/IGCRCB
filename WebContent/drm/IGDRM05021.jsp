...
<html:html>
<bean:define id="id" value="IGDRM05021" toScope="request"/>
<bean:define id="title" value="专项预案资产查询画面" toScope="request"/>
<!-- header1 -->
...
<div id="container">
	...
	<div id="contentWrap">
		<div id="treeNode">
			<html:form styleId="form" action="/IGDRM0502_Search" onsubmit="">			
...
<!-- 						<th width="8%">删除</th> -->
					...
					<logic:present name="IGDRM05021VO" property="entityItemList" >
						...
						<tr class="<ig:rowcss index="${index}"/>" onclick="location=getAppRootUrl()+'/IGDRM0504_SEARCH_Disp.do?eiid=${bean.eiid}';" style="cursor:pointer;">
								<td>
...
<%-- 										<html:link action="/IGDRM0501_Disp.do?eiid=${bean.eiid}" > --%>
										${bean.einame}
<%-- 										</html:link> --%>
									</div>
								</td>
...
<!-- 								<td> -->
<!-- 									<div class="nowrapDiv"> -->
<%-- 										<html:link action="/IGDRM0503_Disp.do?eiid=${bean.eiid}&civersion="><img src="images/notepad_16x16.gif" alt="历史版本" width="16" height="16"  border="0"/></html:link> --%>
<!-- 									</div> -->
<!-- 								</td> -->
								<!-- 编辑 -->
...
<!-- 										<td> -->
<!-- 											<div align="center"> -->
<%-- 												<html:link action="/IGDRM0504_SEARCH_Disp.do?eiid=${bean.eiid}"><img src="images/edit.gif" alt="查看" width="16" height="16"  border="0"/></html:link> --%>
<!-- 												</div> -->
<!-- 										</td> -->
<!-- 										<td> -->
<!-- 											<div align="center"> -->
...
function doDel(obj){
	...
	var confirmMsg ='<bean:message key="IGCO10000.W002" arg0="专项预案资产基本信息" />';
