...
<html>
<bean:define id="id" value="IGDRM0901" toScope="request" />
...
function checkForm(action,vbrequired){
	...
	<logic:present name="IGPRR01011VO" property="processTitleDefTB">
		...
		var eventName =  jQ("#pidid"+pdid+"005").val();
		eventName += '-应急恢复';
		if(eventName.strlen()>191){
			alert("${psid.pidlabel}不能大于"+Math.floor(191/strByteFlag)+"个汉字！");
			return false;
		}
