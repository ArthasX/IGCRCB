...
<bean:define id="bean" name="IGDRM04211VO" property="configurationCodeDetail" />
<!-- header1 -->
 ...
 <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
            ...
            <div id="formwrapper">
            <html:form styleId="form" action="/IGDRM0421" onsubmit="return checkSubmit();">
				<!--  message -->
				<ig:message/>
				<!--  /message -->     
                <fieldset>
				...
				<div class="enter">
				    ...
				    <input type="button" value="返回" class="button" onclick="window.location='IGDRM0420_Disp.do?ccdcategory=<%=request.getParameter("ccdcategory") %>';"/>
				</div>
            </html:form>
            </div>
        </div>
