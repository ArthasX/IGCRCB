...
<html:html>
<bean:define id="id" value="IGDRM1703" toScope="request"/>
...
<div id="search">
	...
	<div class="conditions">
		<div>
			<span>
				机构：
				<html:text property="orgname" name="IGDRM1703Form" styleId="orgname" readonly="true"/>
				<img src="images/tree.gif" style="cursor: hand;" alt="选择机构" width="16" height="16" border="0" onclick="setOrg();"/>
				<html:hidden property="orgsyscoding" styleId="orgsyscoding" name="IGDRM1703Form"/>
				<html:hidden property="single" styleId = "single" name="IGDRM1703Form"/>
			</span>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<span>
				角色：
				<html:text property="rolename" styleId="rolename" name="IGDRM1703Form" readonly="true"/>
				<img src="images/seek.gif" alt="角色查询"  style="cursor: hand" onclick="setRole();"/>
				<html:hidden property="roleid" styleId="roleid" name="IGDRM1703Form"/>
			</span>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<html:hidden property="roletype" styleId="roletype" name="IGDRM1703Form"/>
			<html:hidden property="pidid" styleId="pidid" name="IGDRM1703Form"/>
			<html:hidden property="roleid_in" styleId="roleid_in" name="IGDRM1703Form"/>
...
<div id="results_list" style="width:540px;margin-left:10px;">
	<logic:present name="IGDRM17031VO" property="userRoleInfoMap">
		<logic:iterate id="userRoleInfoIdMap" name="IGDRM17031VO" property="userRoleInfoMap">
