...
<html:html>
<bean:define id="id" value="IGDRM05011" toScope="request"/>
...
<div class="msg">
			...
			<div class="msg_box">
			<html:form styleId="form" action="/IGDRM0502.do" >
		        ...
		        <html:button property="btn_contiune" onclick="goAdd()" styleClass="button">继续新增</html:button>
				</div>
			</div>
			</html:form>
			</div>
...
<script type="text/javascript">
	function goAdd(){
		form.action = getAppRootUrl()+"/IGDRM0501_Disp.do";
		form.submit();
	}
</script>
</html:html>
