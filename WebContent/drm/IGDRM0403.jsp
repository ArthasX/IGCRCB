...
<html:html>
<bean:define id="id" value="IGDRM0403" toScope="request" />
<bean:define id="title" value="应急资源配置信息历史版本画面" toScope="request" />
<!-- header1 -->
...
<script type="text/javascript">	
	var gid='IGDRM0403';
    function toback(){
        form.action = getAppRootUrl() + "/IGDRM0403_Back.do?btn_back=1";
        form.submit();
    }
    /**
     * 配置信息历史记录弹出画面
    ...
    function openVersionInfoDetail(eiid, civersion, cismallversion){
    	openSubWindow( '/IGDRM0503_Version.do?eiid='+ eiid + '&civersion=' + civersion +'&cismallversion=' + cismallversion,"versioninfo","800","600");
    }
    /**
     * 版本比较弹出画面
     * @param eiid 资产ID
...
<div class="title">
<div class="name">应急资源基本信息</div>
</div>
 <div id="results_list">
                    <table class="table_style">
                        <tr>
<!--                          	<th width="10%">模型名称</th> -->
	                        <th width="15%">应急资源编号</th>
	                        <th width="20%">应急资源名称</th>
	                        <th width="20%">应急资源所属机构</th>
	                        <th width="18%">应急资源说明</th>
	                        <th width="10%">管理人</th>
	                        <th width="15%">登记日</th>
			...
			<logic:iterate id="bean" name="IGDRM05031VO" property="configItemVersionTime"
				...
				<tr>
				       ...
				       <c:if test="${IGDRM05031VO.flag==true}">
				          <a href='javascript:openVersionInfoDetail(${IGDRM05031VO.entityData.eiid},${bean.civersion},${bean.cismallversion})'>${bean.civersion}版 </a>
				       </c:if>
...
<div class="enter">
	<html:form styleId="form"  action="/IGDRM0403_Back" onsubmit="return checkSubmit(this);">
	<c:if test="${IGDRM05031VO.flag==true}">
    	<logic:present name="IGDRM05031VO" property="configItemVersionTime">
