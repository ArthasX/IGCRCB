...
<html:html>
<bean:define id="id" value="IGDRM0420" toScope="request" />
...
<table class="table_style">
	...
	<logic:present name="IGDRM04201VO" property="configurationCodeDetailList">
		<logic:iterate id="bean" name="IGDRM04201VO" property="configurationCodeDetailList">
...
<div class="enter">
	<input type="button" value="增加" class="button" onclick="window.location='IGDRM0421_Disp.do?ccdcategory=<%=request.getParameter("ccdcategory") %>';"/>
	<input type="button" value="返回" class="button" onclick="window.location='IGDRM0419_Disp.do'"/>
</div>
<div id="operate">
<!-- paging --> 
