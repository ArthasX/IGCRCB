...
function submit_fb(cruid,prid,buttonname){
	...
	<logic:notEqual value="C" name="IGPRR01021VO" property="process.prstatus">
		<logic:notEqual value="#" name="IGPRR01021VO" property="process.prstatus">
	...
	<logic:equal value="<%=IGPRDCONSTANTS.PROCESS_START_STATUS%>" name="IGPRR01021VO" property="process.prstatus">
