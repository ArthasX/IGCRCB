...
<html:html>
<bean:define id="id" value="IGDRM0418" toScope="request"/>
...
<!-- /header1 -->
	...
	function checkForm(){
	 ...
	 function toback(){
	        form.action = getAppRootUrl() + "/IGDRM0419_Disp.do";
	        form.submit();
	    }
	</script>
<body >
...
<!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
            ...
            <div id="formwrapper">
            <html:form styleId="form" action="/IGDRM0418" onsubmit="return checkSubmit(this);">
				<!--  message -->
				<ig:message/>
				<!--  /message -->     
                <fieldset>
