...
<html:html>
<bean:define id="id" value="IGPRM0004" toScope="request" />
...
<script>
function selectType(pttype,flag,pdid,ptid){
	window.showModalDialog(getAppRootUrl() + "/IGCOM0404.do?parprid=${IGPRM0004Form.prid}&prtype="+pttype+"&prpdid="+pdid+"&flag="+flag+"&ptid="+ptid,null,"dialogWidth:800px;dialogHeight:650px;status:no;help:no;resizable:yes");
}
</script>
<body>
<div id="location">
...
<ig:message />
<html:form action="/IGPRM0004" method="post" >
<ul>
			...
			<logic:present name="list">
				<logic:iterate id="pd" name="list"
					...
					<li
						...
						href="###"
						onclick="selectType('${pt.pttype}','0','${pd.pdid}','${pd.ptid}')">${pd.pdname}</a></li>
				</logic:iterate>
			</logic:present>
		</logic:iterate>
	</logic:present>
</ul>
<html:hidden property="prid" name="IGPRM0004Form" style="prid"/>
</html:form>
</body>
</html:html>
