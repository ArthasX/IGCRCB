...
<html:html>
<bean:define id="id" value="IGEXTWA0110" toScope="request" />
<bean:define id="title" value="工作中止页面" toScope="request" />
<!-- header1 -->
...
<div id="contentWrap">
<div id="content"><html:form action="/IGEXTWA0110" styleId="form" onsubmit="return checkSubmit(this);" enctype="multipart/form-data">
	<%-- 工作编号--%>
	...
	<div class="image"></div>
	<p class="fonts1">中止</p>
	<div class="back"><a href="IGEXTWA0103_Disp.do?prid=<bean:write name="IGEXTWA0110Form" property="prid" />&bkmode=<bean:write name="IGEXTWA0110Form" property="bkmode" />" target="_self">返回</a></div> 
	</div>
