...
<html:html>
<bean:define id="id" value="IGEXTWA0113" toScope="request" />
<bean:define id="title" value="状态日志" toScope="request" />
<jsp:include page="/include/header1.jsp" />
<body>
<div id="maincontent">
<div id="container">
<html:form action="/IGEXTWA0113" styleId="form"
...
<p class="fonts1">状态日志</p>
	...
	<table class="table_style">
		...
		<logic:present name="IGEXTWA01131VO" property="recordStatusLogList">
			<logic:iterate id="bean" name="IGEXTWA01131VO" property="recordStatusLogList"
				indexId="index">
