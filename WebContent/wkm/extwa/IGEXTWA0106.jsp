...
<div id="contentWrap">
<div id="content"><html:form action="/IGEXTWA0106" styleId="form" onsubmit="return checkSubmit(this);return checkFile();" enctype="multipart/form-data">
	<%-- 工作编号--%>
	<html:hidden property="prid" />
	<div id="location">
	<div class="image"></div>
	<p class="fonts1">更新信息</p>
	<div class="back"><a href="IGEXTWA0103_Disp.do?prid=<bean:write name="IGEXTWA0106Form" property="prid" />&bkmode=<bean:write name="IGEXTWA0106Form" property="bkmode" />" target="_self">返回</a></div> 
	</div>
