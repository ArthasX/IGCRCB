...
<div class="back"><a href="IGEXTWA0103_Disp.do?prid=<bean:write name="IGEXTWA0112Form" property="prid" />&bkmode=<bean:write name="IGEXTWA0112Form" property="bkmode" />" target="_self">返回</a></div> 
</div>
