...
%>
<html:html>
<bean:define id="id" value="IGEXTWA0001" toScope="request" />
...
function setdefault(){
	<%if(user1!=null && user1.getUsermobile()!=null && !"".equals(user1.getUsermobile())){	
	%>			
...
<div id="contentWrap">
<div id="content">
<html:form action="/IGEXTWA0001" styleId="form" onsubmit="return checkSubmit(this);" enctype="multipart/form-data">
	<div id="location">
	<div class="image"></div>
	<p class="fonts1">日常工作计划&gt;&gt; 指派工作发起</p>
	</div>
