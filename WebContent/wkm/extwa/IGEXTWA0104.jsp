...
<!--
	...
	function deleteRec(flag){
        ...
        if(window.confirm(confirmMsg)){
            ...
            form.action = getAppRootUrl() + "/IGEXTWA0104.do?mode="+mode;
           return true;
...
<div id="contentWrap">
<div id="content">
<html:form styleId="form" action="/IGEXTWA0104" onsubmit="return checkSubmit(this);">
<div id="location">
<div class="image"></div>
<p class="fonts1">处理人</p>
<div class="back"><a href="IGEXTWA0103_Disp.do?prid=<bean:write name="IGEXTWA0104Form" property="prid" />&bkmode=<bean:write name="IGEXTWA0104Form" property="bkmode" />" target="_self">返回</a></div> 
</div>
