...
<html:html>
<bean:define id="id" value="IGEXTWA0101" toScope="request" />
...
<div id="contentWrap">
<div id="content">
	<html:form action="/IGEXTWA0101" styleId="form" onsubmit="return checkSubmit(this);">
	<div id="location">
	<div class="image"></div>
	<p class="fonts1">流程管理 &gt;&gt; 工作管理 &gt;&gt; 工作查询</p>
	</div>
	<div id="search">
	<div class="img"></div>
	<div class="conditions">
	<div>
	<span>编号：</span><html:text property="prserialnum" size="12" />
	<span>&nbsp;&nbsp;名称：</span><html:text property="prtitle" />
	<span>&nbsp;&nbsp;发起者：</span><html:text property="prusername" />&nbsp;&nbsp;
	<span>状态：</span><html:select name="IGEXTWA0101Form" property="prstatus" style="width: 100px;" errorStyleClass="inputError">
    <ig:optionsCollection ccid="C" isMakeBlankRow="true" isCodeLabel="true" />
		</html:select>
   </div>
	<div>
	...
	<table class="table_style">
		...
		<logic:present name="IGEXTWA01011VO" property="processList">
			<logic:iterate id="bean" name="IGEXTWA01011VO" property="processList"
				indexId="index">
				<tr class="<ig:rowcss index="${index}"/>">
					...
					<td>
					<ig:codeValue ccid="WAURGENCY_GRADE_CODE"
							cid="${bean.prurgency}" />

					</td>
					<td>
					<a href="IGEXTWA0103_Disp.do?prid=<bean:write name="bean" property="prid" />"><img
