...
<html:html>
<bean:define id="id" value="IGEXTWB0107" toScope="request" />
...
<table class="table_style">
	...
	<logic:present name="IGEXTWB01071VO" property="recordLogMap">
		<logic:iterate id="map" name="IGEXTWB01071VO" property="recordLogMap"
			indexId="index">
...
<table width="100%">
		<tr>
			...
			<div class="record_list"><a href="javascript:openHistoryPage('/IGEXTWB0108.do?prid=${IGEXTWB0107Form.prid}');">查看状态日志</a></div>
			</td>
		</tr>
	</table>
<div class="enter">
<input type="button" class="button" value="关闭" onclick="window.close();"></div>
</div>
</div>
</body>
</html:html>
