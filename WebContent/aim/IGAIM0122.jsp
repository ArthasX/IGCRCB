...
<html:html>
<bean:define id="id" value="IGAIM0122" toScope="request"/>
...
<!-- /header1 -->
	<script type="text/javascript">	
	    ...
	    function setEntity(url){
	    	url = url+"?roletype=IGBU01&subtype=999003";
			var temp = window.showModalDialog(url,null,"dialogWidth:400px;dialogHeight:500px;status:no;help:no;resizable:yes");
	    ...
	    function toback(){
	        form.action = getAppRootUrl() + "/IGAIM0121_Disp.do?";
	        form.submit();
	    }
...
<div id="container"> <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGAIM0122" onsubmit="return checkSubmit(this);">
                      <!--  message -->
                      <ig:message/>
                      <!--  /message -->     
		            <fieldset>
	                    ...
	                    <legend><bean:message bundle="asmResources" key="label.IGCIM0122.InfoChange"/></legend>
			             ...
			             <div>
                            ...
                            <html:text property="ename" errorStyleClass="inputError imeActive" readonly="true" tabindex="1"/>
			            ...
			            --><div>
			                ...
			                <html:text property="eilabel" style="width:125px;" tabindex="2" errorStyleClass="inputError imeActive"/>
			                <br>
			            </div>
			            <div>
			                <label for="Name"><strong><span class="red">*</span><bean:message bundle="asmResources" key="label.IGCIM0122.UserName"/></strong>：</label>
			                <html:text property="einame" style="width:200px;" errorStyleClass="inputError imeActive" tabindex="3"/>
			                <br>
			            </div>
			            <div>
			                <label for="Name"><strong><bean:message bundle="asmResources" key="label.IGCIM0122.UserRemark"/></strong>：</label>
			                <html:text property="eidesc" styleId="eidesc" tabindex="4" style="width:450px;" errorStyleClass="inputError"/>
			                <br>
			            </div>
                        <div>
