...
<html:html>
<bean:define id="id" value="IGAIM0126" toScope="request"/>
<bean:define id="title" value="关系查看"   toScope="request" />
<!-- header1 -->
	...
	<script type="text/javascript">	
	    function deleteRec(){
	        ...
	        if( window.confirm(confirmMsg)){
	            form.action = getAppRootUrl() + "/IGAIM0126_Del.do";
	            return true;
	        } else {
	            return false;
	        }
	    ...
	    function toback(){
	        //form.action = getAppRootUrl() + "/IGAIM0126.do?btn_back=1";
	        //form.submit();
	        form.action = getAppRootUrl() + "/IGCIM0150_Disp.do?eiid="+${IGCIM01261VO.entityData.eiid};
	        form.submit();
	    }
	</script>
	<link rel="stylesheet"
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            ...
            <html:form styleId="form"  action="/IGAIM0126" onsubmit="return checkSubmit(this);">
                <div class="title">
