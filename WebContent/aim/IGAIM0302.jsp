...
<bean:define id="id" value="IGAIM0302" toScope="request" />
...
<script type="text/javascript">	
	 ...
	 function exportExcelOne() {
	 	...
	 	document.forms[0].action = getAppRootUrl() + "/IGAIM0302_ExportOne.do";
	 	document.forms[0].submit();
	 }
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
          <html:form styleId="form" action="/IGAIM0302" onsubmit="return checkSubmit(this);">
            <div id="location">
                <div class="image"></div>
                    <p class="fonts1">
