...
<html:html>
<bean:define id="id" value="IGAIM0203" toScope="request" />
...
<script type="text/javascript">	
    ...
    if( window.confirm(confirmMsg)){
        form.action = getAppRootUrl() + "/IGAIM0203_Del.do";
        return true;
    } else {
        return false;
    }
...
<div id="contentWrap">
<div id="content"><html:form styleId="form" action="/IGAIM0203"
	...
	<html:button property="btn_add" styleClass="button" onclick="location.href='IGAIM0202_Disp.do'">
			...
			<logic:iterate id="bean" name="IGCIM02031VO"
				...
				<tr class="<ig:rowcss index="${index}"/>">
					...
					<div class="nowrapDiv"><html:link
						action="/IGAIM0205_Disp.do?eiddid=${bean.eiddid}&&version=${bean.version}">${bean.name}</html:link>
					</div>
					</td>
					<!-- 版本号-->
					<td>
					...
					<td>
					<div class="nowrapDiv"><html:link
						action="/IGAIM0204_Disp.do?eiddid=${bean.eiddid}&eiddversion=${bean.version}">
					...
					<div align="center"><html:link
						action="/IGAIM0202_Edit_Disp.do?eiddid=${bean.eiddid}&&version=${bean.version}">
			        ...
			        <td>
			        <div class="nowrapDiv">
                          <html:link action="/IGAIM0212_Disp.do?eiddid=${bean.eiddid}&&version=${bean.version}"><img src="images/notepad_16x16.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0203.HistoryVersion.alt"/>'  width="16" height="16"  border="0"/></html:link>
			        </div>
			        </td>
					<!-- 拓扑图 -->
			        <td>
					...
					<td>
					<div align="center"><html:link
						action="/IGAIM0205_Snapshot.do?eiddid=${bean.eiddid}&&version=${bean.version}">
