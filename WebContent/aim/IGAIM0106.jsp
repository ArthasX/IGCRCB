...
<html:html>
<bean:define id="id" value="IGAIM0106" toScope="request" />
    ...
    var backUrl = '${backUrl}';
	    function deleteRec(){
	        ...
	        if( window.confirm(confirmMsg)){
	            form.action = getAppRootUrl() + "/IGAIM0106_Del.do?backUrl=" + backUrl;
	            return true;
	        } else {
	            return false;
	        }
	    ...
	    function toback(){
	    	if(backUrl){
	    		form.action = getAppRootUrl() + "/"+backUrl;
	       		...
	       		form.action = getAppRootUrl() + "/IGAIM0106.do?btn_back=1";
	    	}
	        form.submit();
	    }
	    ...
	    function add() {
	    	if(backUrl){
	    		form.action = getAppRootUrl() + "/IGAIM0106.do?backUrl=" + backUrl;
	    	}
	    	return true;
	    }
...
<div class="image"></div>
<p class="fonts1">
	<ig:navigation extname1="${urlable}"/> &gt;&gt; CI关系
	</p>
	<div class="back">
...
<html:form styleId="form" action="/IGAIM0106"
	...
	<logic:present name="IGCIM01061VO" property="rlnmap">
	 ...
	 <div id="TabbedPanels2" class="TabbedPanels">
		<ul class="TabbedPanelsTabGroup">
			<logic:iterate id="map" name="IGCIM01061VO"
				property="rlnmap" indexId="number">
				<li class="TabbedPanelsTab" tabindex="0">${map.key}</li>
			</logic:iterate>
		</ul>
...
//-->
	...
	value="${IGCIM01061VO.entityData.esyscoding}" />
</html:form></div>
</div>
</div>
