...
<script type="text/javascript">	
    ...
    if( window.confirm(confirmMsg)){
        form.action = getAppRootUrl() + "/IGAIM0307_Del.do";
        return true;
    } else {
        return false;
    }
...
<div id="contentWrap">
<div id="content"><html:form styleId="form" action="/IGAIM0307"
	...
	<html:submit property="btn_add" styleClass="button" onclick="location.href='IGAIM0305_Disp.do'">
