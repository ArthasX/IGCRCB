...
<html:html>
<bean:define id="id" value="IGAIM0108" toScope="request"/>
<bean:define id="title"  toScope="request">
	<bean:message bundle="asmResources" key="ietitle.IGCIM0108"/>
</bean:define>
<!-- header1 -->
...
// 		    	}
	    ...
	    function toback(){
	    	if(backurl){
		        ...
		        form.action = getAppRootUrl() + "/IGAIM0101_Back.do?";
	    	}
	        form.submit();
	    }
    ...
    <div id="contentWrap">
        <div id="content">
            ...
            <div id="location">
                <div class="image"></div>
                <p class="fonts1">
					<ig:navigation extname1="${urlable}"/> &gt;&gt; 设备信息修改
                </p>
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGAIM0108" onsubmit="return checkSubmit(this);">
                      ...
                      <!--  /message -->     
		            <fieldset>
	                    <legend><bean:message bundle="asmResources" key="label.IGCIM0108.DeviceChangeInfo"/></legend>
                        <div>
                            <label for="Name"><strong><span class="red">*</span><bean:message bundle="asmResources" key="label.IGCIM0108.ModelName"/></strong></label>
                        ...
                        <!--<div><label for="Name"><strong><span class="red">*</span><bean:message bundle="asmResources" key="label.IGCIM0108.DeviceOrgan"/></strong></label>
							<html:text name="IGCIM0108Form" property="eiorgname" readonly="true" errorStyleClass="inputError imeActive"></html:text>
			            ...
			            <div>
			                <label for="Name"><strong><span class="red">*</span><bean:message bundle="asmResources" key="label.IGCIM0108.DeviceNO"/></strong></label>
			            ...
			            <div>
			                <label for="Name"><strong><span class="red">*</span><bean:message bundle="asmResources" key="label.IGCIM0108.DeviceName"/></strong></label>
			                <html:text name="IGCIM0108Form" property="einame" size="18" style="width:300px;" errorStyleClass="inputError imeActive" tabindex="2"/>
			                <br>
			            </div>
			            <div>
			                <label for="Name"><strong><bean:message bundle="asmResources" key="label.IGCIM0108.DeviceRemark"/></strong></label>
			                <html:text name="IGCIM0108Form" property="eidesc" styleId="eidesc" size="30" tabindex="3" style="width:450px;" errorStyleClass="inputError"/>
			                <br>
			            </div>
			            <logic:present name="IGCIM0108Form" property="roleManager">
			            <logic:equal value="true" name="IGCIM0108Form" property="roleManager">
			            <div>
                            <label for="Name"><strong><span class="red">*</span><bean:message bundle="asmResources" key="label.IGCIM0108.DeviceManager"/></strong></label>
                        ...
                        <div>
                            <label for="Name"><strong><span class="red">*</span><bean:message bundle="asmResources" key="label.IGCIM0108.DeviceMarkDay"/></strong></label>
