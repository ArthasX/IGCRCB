...
<html:html>
<bean:define id="id" value="IGAIM0204" toScope="request" />
...
<!--
	...
	function deleteRec(obj,flag){
        ...
        if(window.confirm(confirmMsg)){
            form.action = getAppRootUrl() + "/IGAIM0204.do?mode="+mode;
            return true;
        } else {
            return false;
        }
...
<div id="content">
	...
	<html:form styleId="form" action="/IGAIM0204" onsubmit="return checkSubmit(this);">
