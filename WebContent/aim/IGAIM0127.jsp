...
<html:html>
<bean:define id="id" value="IGAIM0127" toScope="request"/>
...
<!-- /header1 -->
	<script type="text/javascript">	
        ...
        function toback(){
            form.action = getAppRootUrl() + "/IGAIM0127.do?org.apache.struts.taglib.html.CANCEL=1";
            form.submit();
        }
    ...
    <div id="contentWrap">
        <div id="content">
            ...
            <div id="location">
                ...
                <p class="fonts1">
                    <logic:equal name="IGCIM0127Form" property="mode" value="0">
                 		  配置管理 &gt;&gt;应用管理 &gt;&gt;应用维护 &gt;&gt;关系管理 &gt;&gt;应用关系登记
                    </logic:equal>
                    <logic:equal name="IGCIM0127Form" property="mode" value="1">
                   		 配置管理 &gt;&gt;应用管理 &gt;&gt;应用维护 &gt;&gt;关系管理  &gt;&gt;应用关系修改
                    </logic:equal>
                </p>
                <div class="back">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGAIM0127" onsubmit="return checkSubmit(this);">
                    <!--  message -->
                    <ig:message/>
                    <!--  /message -->     
		            <fieldset>
