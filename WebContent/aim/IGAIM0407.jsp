...
<ul>
	<logic:present name="IGCIM04071VO" property="configurationCodeDetailBeanList">
			<logic:iterate id="bean" name="IGCIM04071VO" property="configurationCodeDetailBeanList">
