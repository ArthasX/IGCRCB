...
<html:html>
<bean:define id="id" value="IGAIM0215" toScope="request"/>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            <html:form styleId="form" action="/IGAIM0215"
...
<!--			                            <td>-->
<!--			                                <div align="center">-->
<!--                                                <html:link action="/IGCIM0124_Disp.do?eiid=${bean.eiid}"><img src="images/xx.gif" alt='<bean:message bundle="asmResources" key="img.IGCIM0121.DiaplayDetail.alt"/>' width="16" height="16"  border="0"/></html:link>-->
<!--			                                </div>-->
<!--			                            </td>-->
			                            <!-- 关系信息 -->
<!--			                            <td>-->
