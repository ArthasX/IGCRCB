...
<html:html>
<bean:define id="id" value="IGAIM0111" toScope="request" />
...
<div id="content">
    ...
    <html:form styleId="form" action="/IGAIM0111_Disp.do">
		<logic:present name="IGCIM01111VO" property="data">
			...
			<div>
				<table cellspacing="2" class="table_style1" style="margin-left:10px;">
					<tr>
						<th width="13%">设备标识：</th>
						<td width="20%">${IGCIM01111VO.entityItem.einame }</td>
						<th width="13%">配置类别：</th>
						<td width="20%">
					...
					<div style="height:400px;overflow-y:scroll;overflow-x:hidden;" id="datadiv">
						...
						<logic:iterate id="map" name="IGCIM01111VO" property="data">
							...
							<logic:iterate id="bean" name="list" indexId="index">
								<tr>
									<c:if test="${index==0 }">
									<td width="20%" align="left" valign="top" rowspan="${listsize }">
									<pre>${map.key }</pre>
									</td>
									</c:if>
