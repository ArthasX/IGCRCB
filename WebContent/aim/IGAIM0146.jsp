...
var setting = {
	...
	var zNodes =${IGCIM01461VO.initTreeStr};
	...
	function beforeClick(treeId, treeNode) {
		...
		if(nlv>0){//判断不是第一个结点
			...
			if(idTypeFlag==1){
				$('#IndexContext').attr("src","IGAIM0147_Disp.do?eiid=" + idArr[1] + "&civersion=" + idArr[3] +"&cismallversion=" + idArr[4]);
			}
		}
	}
...
<div style="float: left;">
		<ul id="treeDemo" class="ztree" style="height:530px"></ul>
</div>

<iframe name="IndexContext" id="IndexContext" width="756" height="600" frameborder="0" scrolling="auto" src="IGAIM0147_Disp.do?eiid=${IGCIM0146Form.eiid}&civersion=${IGCIM0146Form.eiversion}&cismallversion=${IGCIM0146Form.eismallversion}&flag=${IGCIM0146Form.flag}&assetRoleType='IGCI01'"></iframe>
</div>
</div>
</body>
</html:html>
