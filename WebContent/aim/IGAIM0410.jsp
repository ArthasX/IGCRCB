...
<html:html>
<bean:define id="id" value="IGCIM0410" toScope="request" />
...
function changeStatus(ccdid,ccdcategory){
	if(confirm("是否确认改变状态？")){
		...
		form.action="IGAIM0410_ChangeCCDStatus.do";
		form.submit();
	}
}
...
<html:form action="/IGAIM0410_ChangeValue">
...
<table class="table_style">
	...
	<tr>
		<th width="25%">显示名称</th>
		<th width="25%">属性值</th>
		<th width="25%">修改属性值</th>
		<!-- <th width="20%">状态</th> -->
		<th width="25%"><!--调整-->状态</th>
	</tr>
	
	<logic:present name="IGCIM04101VO" property="configurationCodeDetailList">
		<logic:iterate id="bean" name="IGCIM04101VO" property="configurationCodeDetailList">
			...
			<td>
				<a href="javascript:changeStatus('${bean.ccdid}','${bean.ccdcategory}');">
					<logic:equal name="bean" property="ccdstatus" value="0">
						<img src="images/stop.gif" border="0" alt="启动" />
					</logic:equal>
					<logic:equal name="bean" property="ccdstatus" value="1">
						<img src="images/start.gif" border="0" alt="停止" />
					</logic:equal>
				</a>
			</td>		
		</tr>
...
<div class="enter">
	<input type="button" value="增加" class="button" onclick="window.location='IGAIM0411_Disp.do?ccdcategory=<%=request.getParameter("ccdcategory") %>';"/>
	<input type="button" value="返回" class="button" onclick="window.location='IGAIM0409_Disp.do'"/>
</div>
<div id="operate">
<!-- paging --> 
