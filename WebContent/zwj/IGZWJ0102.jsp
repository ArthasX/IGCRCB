...
<html:html>
<bean:define id="id" value="IGZWJ0102" toScope="request" />
...
//选择按钮 begin
function setParentValue(username,orgname,orgid,useremail,userphone,usermobile){
    if(!window.opener.closed){
        window.opener.setIGZWJ0101Params(username,orgname,orgid,useremail,userphone,usermobile);
     }
    window.close();
}
//选择按钮 end
...
function clearParentValue(){
       if(!window.opener.closed){
           window.opener.setIGZWJ0101Params("","","","","","");
        }
       window.close();
}
//清空end
...
<div id="contentWrap">
<div id="content">
<html:form styleId="form" action="/IGZWJ0101" onsubmit="return checkSubmit(this);">
<div id="location">
<div class="image"></div>
...
<!-- 				<th width="13%">User ID</th> -->
			...
			<logic:present name="IGZWJ01011VO" property="userList">
				<logic:iterate id="bean" name="IGZWJ01011VO"
					...
					onclick="setParentValue('${bean.username}','${bean.orgname}','${bean.orgid}','${bean.useremail}','${bean.userphone}','${bean.usermobile}')">
						<td>
