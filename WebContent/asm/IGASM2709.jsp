...
<html:html>
<bean:define id="id" value="IGASM2709" toScope="request" />
...
<html:form styleId="form" action="/IGASM2704"
	...
	<table class="table_style">
		...
		<tr>
			<td align="center">${IGASM27041VO.entityData.ename}</td>
			<td>${IGASM27041VO.entityData.eilabel}</td>
			<td>${IGASM27041VO.entityData.einame}</td>
			<td>${IGASM27041VO.eiorgname}</td>
			<td>${IGASM27041VO.entityData.eidesc}</td>
			<td>${IGASM27041VO.entityData.eiusername}</td>
			<td>${IGASM27041VO.entityData.eiinsdate}</td>
			...
			<logic:iterate id="map" name="IGASM27041VO"
				...
				<table class="table_style2">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						...
						<bean:define id="cldVersionMap" name="IGASM2704Form" property="cldVersionMap" type="java.util.Map"/>
...
//-->
	...
	<html:hidden property="eiid" styleId="eiid"
		value="${IGASM2704Form.eiid}" />
	<html:hidden property="eiversion" styleId="eiversion"
		value="${IGASM27041VO.entityData.eiversion}" />
</html:form></div>
</div>
</div>
