...
<html:html>
<bean:define id="id" value="IGASM2809" toScope="request" />
...
<html:form styleId="form" action="/IGASM2804"
	...
	<table class="table_style">
		...
		<tr>
			<td align="center">${IGASM28041VO.entityData.ename}</td>
			<td>${IGASM28041VO.entityData.eilabel}</td>
			<td>${IGASM28041VO.entityData.einame}</td>
			<td>${IGASM28041VO.eiorgname}</td>
			<td>${IGASM28041VO.entityData.eidesc}</td>
			<td>${IGASM28041VO.entityData.eiusername}</td>
			<td>${IGASM28041VO.entityData.eiinsdate}</td>
			...
			<logic:iterate id="map" name="IGASM28041VO"
				...
				<table class="table_style2">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						...
						<bean:define id="cldVersionMap" name="IGASM2804Form" property="cldVersionMap" type="java.util.Map"/>
...
//-->
	...
	<html:hidden property="eiid" styleId="eiid"
		value="${IGASM2804Form.eiid}" />
	<html:hidden property="eiversion" styleId="eiversion"
		value="${IGASM28041VO.entityData.eiversion}" />
</html:form></div>
</div>
</div>
