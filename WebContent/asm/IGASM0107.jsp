...
<html:html>
<bean:define id="id" value="IGASM0107" toScope="request" />
...
<ul>
	<logic:present name="IGASM01071VO" property="configurationCodeDetailBeanList">
			<logic:iterate id="bean" name="IGASM01071VO" property="configurationCodeDetailBeanList">
