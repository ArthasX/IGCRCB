...
<html:html>
<bean:define id="id" value="IGASM2713" toScope="request"/>
...
<!-- /header1 -->
	...
	function toback(){
    	...
    	form.action = getAppRootUrl() + "/IGASM2704.do?org.apache.struts.taglib.html.CANCEL=1";
    	form.submit();
    }
	</script>
<body >
