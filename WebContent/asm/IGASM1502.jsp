...
<html:html>
<bean:define id="id" value="IGASM1502" toScope="request"/>
...
<!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGASM1502" onsubmit="return checkSubmit(this);">
                      <!--  message -->
                      <ig:message/>
                      <!--  /message -->     
		            <fieldset>
	                    <logic:equal name="IGASM1502Form" property="mode" value="0">
			            <legend>人员基本信息添加</legend>
			            </logic:equal>
	                    <logic:equal name="IGASM1502Form" property="mode" value="1">
