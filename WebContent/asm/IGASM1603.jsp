...
<html:html>
<bean:define id="id" value="IGASM1603" toScope="request"/>
...
<div class="msg">
			...
			<div class="msg_box">
			<html:form styleId="form" action="/IGASM1603" onsubmit="return checkSubmit(this);">
			  ...
			  <html:hidden property="eiid" styleId="eiid" value="${IGASM16021VO.entityData.eiid}"/>
