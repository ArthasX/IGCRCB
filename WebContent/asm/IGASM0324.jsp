...
<html:html>
<bean:define id="id" value="IGASM0324" toScope="request" />
<bean:define id="title" value="设备关系查看详细画面" toScope="request" />
...
<html:form styleId="form" action="/IGASM0324_Disp"
	...
	<table class="table_style">
		...
		<tr>
			...
			<td align="center">
			<ig:codeValue ccid="EQUIPMENT_STATUS_CODE" cid="${IGASM03061VO.entityData.eistatus}"/>
			</td>
