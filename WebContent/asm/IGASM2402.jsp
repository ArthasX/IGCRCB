...
<html:html>
<bean:define id="id" value="IGASM2402" toScope="request"/>
<bean:define id="title" value="发票基本信息登记画面" toScope="request"/>
...
<!-- /header1 -->
	<script type="text/javascript">	
		 ...
		 function checkForm(){
		    	...
		    	if($F('eiinsdate').trim()==""){
		    		...
		    		alert("费用说明不能大于"+Math.floor(256/strByteFlag)+"个汉字！");
		    		return false;
		    	}else {
		    		var message = '<bean:message key="IGCO10000.W001" arg0="发票基本信息" />';
	    ...
	    function setEntity(url){
	    	url = url+"?roletype=IGAC11&subtype=999014";
			var temp = window.showModalDialog(url,null,"dialogWidth:400px;dialogHeight:500px;status:no;help:no;resizable:yes");
			if("_resetall"==temp){
	...
	function searchMaxEntityItemLable(){
		var objAjax = new Ajax.Request(getAppRootUrl() + ajaxAction,{ parameters: 'ecategorykey=FPGL&type=eilable',
 ...
 <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGASM2402" onsubmit="return checkSubmit(this);">
                      <!--  message -->
                      <ig:message/>
                      <!--  /message -->     
		            <fieldset>
	                    <logic:equal name="IGASM2402Form" property="mode" value="0">
			            <legend>发票基本信息添加</legend>
			            </logic:equal>
	                    <logic:equal name="IGASM2402Form" property="mode" value="1">
...
<!--                            	<p class="p2"><bean:write name="IGASM2402Form" property="ename"/></p>-->
...
<!--                        	<p class="p2"><bean:write name="IGASM2402Form" property="eiorgname"/></p>-->
...
<!--							</div>-->
			            ...
			            <div>
			                <label for="Name"><strong><span class="red">*</span>费用摘要</strong>：</label>
