...
<html:html>
<bean:define id="id" value="IGASM0342" toScope="request" />
<bean:define id="title" value="配置信息" toScope="request" />
<bean:define id="treemap" name="IGASM03011VO" property="treeNodeMap" type="java.util.Map" />
