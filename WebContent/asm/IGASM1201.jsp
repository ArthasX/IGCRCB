...
<html:html>
<bean:define id="id" value="IGASM1201" toScope="request"/>
<bean:define id="title" value="机柜查询画面" toScope="request"/>
...
<!-- /header1 -->
	...
	function redisplay1(){
		$("ekey1").value = "";
		$("ekey2").value = "";
		form.action = getAppRootUrl() + "/IGASM1201_ReDisp.do";
		form.submit();
	}
	function redisplay2(){
		$("ekey2").value = "";
	...
	function deleteRec(){
        ...
        var confirmMsg ='<bean:message key="IGCO10000.W002" arg0="机柜基本信息" />';
        ...
        if( window.confirm(confirmMsg)){
            form.action = getAppRootUrl() + "/IGASM1201_Del.do";
            return true;
        } else {
            return false;
        }
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            ...
            <html:form styleId="form" action="/IGASM1201"
           ...
           <div id="results_list">
			       ...
			       <table class="table_style">
			            ...
			            <!-- body部 -->
			                ...
			                <logic:present name="IGASM12011VO" property="entityDataList" >
			                    <logic:iterate id="bean" name="IGASM12011VO" property="entityDataList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                            ...
			                            <td align="center">
			                                <div align="center">
                                                <html:link action="/IGASM1204_Disp.do?eiid=${bean.eiid}"><img src="images/xx.gif" alt="显示详细信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                            <!-- 关系信息 -->
			                            <td align="center">
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM1206_Disp.do?eiid=${bean.eiid}"><img src="images/record_(copy)_16x16.gif" alt="关系信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                            <!-- 历史版本 -->
			                            <td align="center">
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM1205_Disp.do?eiid=${bean.eiid}&civersion="><img src="images/notepad_16x16.gif" alt="历史版本" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                        </tr>
			                    </logic:iterate>
                ...
                <html:hidden property="ecategory" styleId="ecategory" value="${IGASM1201Form.ecategory}"/>
            </html:form>
        </div>
    </div>
