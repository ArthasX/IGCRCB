...
<html:html>
<bean:define id="id" value="IGASM1006" toScope="request"/>
<bean:define id="title" value="资产项关系管理详细画面" toScope="request"/>
...
<!-- /header1 -->
    ...
    var gid='IGASM1006';
	    function toback(){
	        form.action = getAppRootUrl() + "/IGASM1006.do?btn_back=1";
	        form.submit();
	    }
	</script>
	<link rel="stylesheet"
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            ...
            <html:form styleId="form"  action="/IGASM1006" onsubmit="return checkSubmit(this);">
                <div class="title">
                ...
                <div id="results_list">
                  <table class="table_style">
                      ...
                      <tr>
                        <td align="center">${IGASM10061VO.entityData.ename}</td>
                        <td align="center">${IGASM10061VO.entityData.eilabel}</td>
                        <td align="center">${IGASM10061VO.entityData.einame}</td>
                       <td>${IGASM10061VO.entityData.organizationTB.orgname}</td>
                        <td align="center">
                            <label>
                                 ${IGASM10061VO.entityData.eidesc}
                            </label>
                       </td>
                        <!--<td align="center">
                             <ig:codeValue ccid="ENTITY_ITEM_STATUS_CODE" cid="${IGASM10061VO.entityData.eistatus}"/>
                       </td>
                       -->
                       <td align="center">${IGASM10061VO.entityData.eiusername}</td>
                       <td align="center">${IGASM10061VO.entityData.eiinsdate}</td>
                        <td align="center"> ${IGASM10061VO.entityData.eiupdtime}</td>
                      </tr>
                   </table>
                </div>
                    
                                <div class="title">
                    <div class="name">资产关系信息</div>
                </div>
                <div class="message"><ig:message /></div>

	            <div id="results_list"> <logic:present
		name="IGASM10061VO" property="parEntityItemRelationMap">
		<div id="TabbedPanels1" class="TabbedPanels">
		<ul class="TabbedPanelsTabGroup">
			<logic:iterate id="map" name="IGASM10061VO"
...
//-->
                ...
                <html:hidden property="pareid" styleId="pareid" value="${IGASM10061VO.entityData.eid}"/>
                <html:hidden property="pareiid" styleId="pareiid" value="${IGASM10061VO.entityData.eiid}"/>
                <html:hidden property="parversion" styleId="parversion" value="${IGASM10061VO.entityData.eiversion}" />
				<html:hidden property="parsmallversion" styleId="parsmallversion" value="${IGASM10061VO.entityData.eismallversion}" />
            </html:form>  
		 </div>
     </div>
</div>
