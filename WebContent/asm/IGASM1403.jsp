...
<html:html>
<bean:define id="id" value="IGASM1403" toScope="request"/>
...
<div id="container">
 ...
 <div class="msg">
			...
			<div class="msg_box">
			 <html:form styleId="form" action="/IGASM1403" onsubmit="return checkSubmit(this);">
			...
			<html:hidden property="eiid" styleId="eiid" value="${IGASM14021VO.entityData.eiid}"/>
