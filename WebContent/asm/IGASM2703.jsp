...
<html:html>
<bean:define id="id" value="IGASM2703" toScope="request"/>
...
<!-- /header1 -->
	...
	function reg(){
		window.location.href=getAppRootUrl() + "/IGASM2702_Disp.do";
	}
	function toback(){
...
<div class="msg">
			...
			<div>
			风险点编号：
			<a href="IGASM2704_Disp.do?eiid=${eiiddd }&eiversion=1&looksign=0">${eilabel}</a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
			</div>
