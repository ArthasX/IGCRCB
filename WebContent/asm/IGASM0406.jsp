...
<html:html>
<bean:define id="id" value="IGASM0406" toScope="request"/>
<bean:define id="title" value="合同关系管理详细画面" toScope="request"/>
...
<!-- /header1 -->
    ...
    var gid='IGASM0406';
	    function deleteRec(){
	        ...
	        var confirmMsg ='<bean:message key="IGCO10000.W002" arg0="合同关系信息" />';
	        ...
	        if( window.confirm(confirmMsg)){
	            form.action = getAppRootUrl() + "/IGASM0406_Del.do";
	            return true;
	        } else {
	            return false;
	        }
	    ...
	    function toback(){
	        form.action = getAppRootUrl() + "/IGASM0406.do?btn_back=1";
	        form.submit();
	    }
	</script>
	<link rel="stylesheet"
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            ...
            <html:form styleId="form"  action="/IGASM0406" onsubmit="return checkSubmit(this);">
                <div class="title">
                ...
                <div id="results_list">
                    <table class="table_style">
                        ...
                        <tr>
                          <td align="center">${IGASM04061VO.entityData.ename}</td>
                          <td align="center">${IGASM04061VO.entityData.eilabel}</td>
                          <td align="center">${IGASM04061VO.entityData.einame}</td>
                          <td>${IGASM04061VO.eiorgname}</td>
					 	  <td>${IGASM04061VO.entityData.eidesc}</td>
                          <td align="center">${IGASM04061VO.entityData.eiusername}</td>
                          <td align="center">${IGASM04061VO.entityData.eiinsdate}</td>
                          <td align="center">${IGASM04061VO.entityData.eiupdtime}</td>
                        </tr>
                     </table>
                </div>
                    
<div class="title">
	<div class="name">合同关系信息</div>
</div>
<div class="message"><ig:message /></div>
<logic:present name="IGASM04061VO" property="flag">
<logic:equal value="true" name="IGASM04061VO" property="flag">  
	            <div id="results_list"><logic:present
		name="IGASM04061VO" property="parEntityItemRelationMap">
		<div id="TabbedPanels1" class="TabbedPanels">
		<ul class="TabbedPanelsTabGroup">
			<logic:iterate id="map" name="IGASM04061VO"
...
//-->
	            ...
	            <logic:equal value="true" name="IGASM04061VO" property="flag"> 
                     ...
                     <logic:present name="IGASM04061VO" property="parEntityItemRelationMap" >
                ...
                <html:hidden property="pareid" styleId="pareid" value="${IGASM04061VO.entityData.eid}"/>
                <html:hidden property="pareiid" styleId="pareiid" value="${IGASM04061VO.entityData.eiid}"/>
                <html:hidden property="pareilabel" styleId="pareilabel" value="${IGASM04061VO.entityData.eilabel}"/>
                <html:hidden property="pareiname" styleId="pareiname" value="${IGASM04061VO.entityData.einame}"/>
                <html:hidden property="parversion" styleId="parversion" value="${IGASM04061VO.entityData.eiversion}" />
				<html:hidden property="parsmallversion" styleId="parsmallversion" value="${IGASM04061VO.entityData.eismallversion}" />
            </html:form>  
		 </div>
     </div>
</div>
