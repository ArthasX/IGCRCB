...
<html:html>
<bean:define id="id" value="IGASM1703" toScope="request"/>
...
<div class="msg">
			...
			<div class="msg_box">
			 <html:form styleId="form" action="/IGASM1703" onsubmit="return checkSubmit(this);">
			...
			<html:hidden property="eiid" styleId="eiid" value="${IGASM17021VO.entityData.eiid}"/>
