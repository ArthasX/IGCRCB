...
<html:html>
<bean:define id="id" value="IGASM1306" toScope="request" />
...
function exportExcel() {
	document.forms[0].action = getAppRootUrl() + "/IGASM1306.do?report=1";
	document.forms[0].submit();
}
function search() {
	document.forms[0].action = getAppRootUrl() + "/IGASM1306.do";
	document.forms[0].submit();
}
...
<div id="location">
<div class="image"></div>
<p class="fonts1">设备存量统计</p>
</div>
	<div id="search">
<html:form styleId="form" action="/IGASM1306"
