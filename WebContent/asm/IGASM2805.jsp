...
<html:html>
<bean:define id="id" value="IGASM2805" toScope="request" />
...
<script type="text/javascript">	
	var gid='IGASM2805';
    function toback(){
        form.action = getAppRootUrl() + "/IGASM2805_Back.do?btn_back=1";
        form.submit();
    }
	</script>
<body >
...
<div class="enter">
	<html:form styleId="form"  action="/IGASM2805_Back" onsubmit="return checkSubmit(this);">
	<c:if test="${IGASM28051VO.flag==true}">
    	<logic:present name="IGASM28051VO" property="configItemVersionTime">
