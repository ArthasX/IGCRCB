...
<html:html>
<bean:define id="id" value="IGASM0311" toScope="request"/>
<bean:define id="title" value="设备预报废页面" toScope="request"/>
...
function setMuchEntityItemValue(){
	<c:if test="${IGASM0311Form.type == 'I'}">
	var selectCount = 0;
	var eid = "";
    var elabel = "";
    var ename = "";
...
<c:if test="${IGASM0311Form.type != 'I'}">
<bean:define id="entityItemVWInfo" name="IGASM03111VO" property="entityItemVWInfo" />
</c:if>
<!--container 左菜单 右侧内容-->
<div id="contentWrap">
        <div id="content">
            ...
            <div id="location">
                <div class="image"></div>
                <p class="fonts1"><ig:navigation extname1="${urlable}"/>&gt;&gt; 设备预报废
                </p>
		    ...
		    <div id="formwrapper">
		    	 <c:if test="${IGASM0311Form.type != 'I'}">
		         <html:form styleId="form" action="/IGASM0311" onsubmit="return checkSubmit(this);">
                      <!--  message -->
                      <ig:message/>
                      <!--  /message -->     
		            <fieldset>
		            ...
		            <div class="enter">
		            <logic:present name="IGASM03111VO" property="flag">
		            <logic:equal value="true" name="IGASM03111VO" property="flag">
		                <html:submit property="btn_insert" value="预报废" styleClass="button"  onclick="return checkForm();"  />
		            </logic:equal>
		            </logic:present>
		         ...
		         <c:if test="${IGASM0311Form.type == 'I'}">
		         <html:form styleId="form" action="/IGASM0311_batch" onsubmit="return checkSubmit(this);">
			     <div id="countinfo">
				 </div>
	          	 <div id="muchCivalue">
				 </div>
