...
<html:html>
<bean:define id="id" value="IGASM1123" toScope="request" />
...
var gid='IGASM0323';
        function toback(){
        	form.action = getAppRootUrl() + "/IGASM1120_Back.do";
        	form.submit();
        }
...
<html:form styleId="form" action="/IGASM0304"
	...
	<table class="table_style">
		...
		<tr>
			...
			<td><ig:codeValue ccid="EQUIPMENT_STATUS_CODE" cid="${IGASM03041VO.entityData.eistatus}"/></td>
				...
				<table class="table_style2">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						...
						<logic:equal name="bean" property="cattach" value="6">
							...
							${bean.civersion}<logic:notEqual name="bean" property="cismallversion" value=""><c:if test="${IGASM03041VO.entityData.emodeltype == '1' && (bean.civersion + bean.cismallversion) > 0}">.${bean.cismallversion}</c:if></logic:notEqual>
								</div>
							</td>
							<!-- 更新时间 -->
							<!--td align="center">
...
//-->
	...
	<div class="enter"><html:button property="btn_back" styleClass="button" value="返回" onclick="javascript:toback()"/></div>
