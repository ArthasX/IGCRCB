...
<html:html>
<bean:define id="id" value="IGASM2701" toScope="request" />
<bean:define id="title" value="风险点管理画面" toScope="request" />
<!-- header1 -->
...
jQuery(document).ready(function() {
	var risksign="<%=request.getParameter("risksign")%>";
	   ...
	   if(risksign==''){
         ...
         function deleteRec(){
              ...
              var confirmMsg ='<bean:message key="IGCO10000.W002" arg0="风险点基本信息" />';
...
function setEntity(url){
	url = url+"?roletype=IGAC13&subtype=999017";
	...
	function checkitem(eid,version){
		window.location.href="IGASM2704_Disp.do?eiid="+eid+"&eiversion="+version+"&looksign=1";
	}
	function onShow(){
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
          <html:form styleId="form" action="/IGASM2701" onsubmit="return checkSubmit(this);">
            <div id="location">
                <div class="image"></div>
            ...
            <div id="search">
                   ...
                   <html:text property="ename" styleId="ename" readonly="readonly"  size="16"/>
					...
					<span class="subscribe">风险严重等级：</span>
					 <html:select  name="IGASM2713Form" property="grad"  style="width:100px;height:20px;margin:0px;">
			               	 <option value=""></option>
