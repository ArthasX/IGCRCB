...
<html:html>
<bean:define id="id" value="IGASM0401" toScope="request"/>
<bean:define id="title" value="合同管理画面" toScope="request"/>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            <html:form styleId="form" action="/IGASM0401"
			                ...
			                <logic:present name="IGASM04011VO" property="entityItemCompactVWInfoList" >
			                    <logic:iterate id="bean" name="IGASM04011VO" property="entityItemCompactVWInfoList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                            ...
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM0412_Disp.do?eiid=${bean.eiid}">${bean.eilabel}</html:link>
			                                </div>
			                            </td>
			                            <!-- 名称 -->
			                            <td>
			                           ...
			                           <!-- 经手人 -->
			                            ...
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGASM0404_Disp.do?eiid=${bean.eiid}&flag=0"><img src="images/xx.gif" alt="显示详细信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                            <!-- 历史版本 -->
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM0405_Disp.do?eiid=${bean.eiid}"><img src="images/notepad_16x16.gif" alt="历史版本" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                        </tr>
			                    </logic:iterate>
