...
<html:html>
<bean:define id="id" value="IGASM2803" toScope="request"/>
...
<script type="text/javascript">	
	function reg(){
		window.location.href=getAppRootUrl() + "/IGASM2802_Disp.do";
	}
	function toback(){
		window.location.href=getAppRootUrl() + "/IGASM2814_Disp.do";
	}
	</script>
<body>
<div id="maincontent">
...
<div class="msg">
			...
			<div>
			检查项编号：
			<a href="IGASM2804_Disp.do?eiid=${eiiddd }&eiversion=1&looksign=0">${eilabel}</a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
			</div>
