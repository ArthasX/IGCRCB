...
<html:html>
<bean:define id="id" value="IGASM0909" toScope="request" />
<bean:define id="title" value="服务商配置信息查看画面" toScope="request" />
...
var gid='IGASM0909';
        function toback(){
        	form.action = getAppRootUrl() + "/IGASM0908_Back.do";
        	form.submit();
        }
					...
					<logic:iterate id="bean" name="list" indexId="index">
						<tr onmouseover="mouseOverNoHand(this);"
							...
							<div class="nowrapDiv"><logic:notEqual name="bean"
								...
								<logic:empty name="bean" property="civalue">&nbsp;</logic:empty>${bean.civalue}</logic:notEqual>
							<logic:equal name="bean" property="cattach" value="4">
								<bean:define id="ei" value="${bean.civalue}" />
								<bean:define id="cldVersionMap" name="IGASM0904Form" property="cldVersionMap" type="java.util.Map"/>
