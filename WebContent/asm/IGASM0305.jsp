...
<html:html>
<bean:define id="id" value="IGASM0305" toScope="request" />
...
var gid='IGASM0305';
	function toback() {
		form.action = getAppRootUrl() + "/IGASM0305_Back.do?btn_back=1";
		form.submit();
	}
</script>
<body >
...
<table class="table_style">
	...
	<tr>
		...
		<td align="center">${IGASM03051VO.eiorgname}</td>
			...
			<logic:iterate id="bean" name="IGASM03051VO" property="configItemVersionTime"
				...
				<tr>
				       ...
				       <c:if test="${IGASM03051VO.flag==true}">
				          <a href='javascript:openVersionInfoDetail(${IGASM03051VO.entityData.eiid},${bean.civersion},${bean.cismallversion})'>${bean.civersion}<c:if test="${IGASM03051VO.entityData.emodeltype == '1' && (bean.civersion + bean.cismallversion) > 0}">.${bean.cismallversion}</c:if>版</a>
				       </c:if>
				       <c:if test="${IGASM03051VO.flag!=true}">${bean.civersion}<c:if test="${IGASM03051VO.entityData.emodeltype == '1' && (bean.civersion + bean.cismallversion) > 0}">.${bean.cismallversion}</c:if>版</c:if>
		       		</td>
...
<div class="enter">
	<html:form styleId="form"  action="/IGASM0305_Back" onsubmit="return checkSubmit(this);">
	<c:if test="${IGASM03051VO.flag==true}">
		<logic:present name="IGASM03051VO" property="configItemVersionTime">
