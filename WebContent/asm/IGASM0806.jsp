...
<html:html>
<bean:define id="id" value="IGASM0806" toScope="request"/>
<bean:define id="title" value="应用关系管理详细画面" toScope="request"/>
...
<!-- /header1 -->
    ...
    var gid='IGASM0806';
	    function deleteRec(){
	        ...
	        var confirmMsg ='<bean:message key="IGCO10000.W002" arg0="应用关系信息" />';
	    ...
	    function toback(){
	        form.action = getAppRootUrl() + "/IGASM0806.do?btn_back=1";
	        form.submit();
	    }
	</script>
	<link rel="stylesheet"
            ...
            <html:form styleId="form"  action="/IGASM0806" onsubmit="return checkSubmit(this);">
                ...
                <div id="results_list">
                    <table class="table_style">
                        ...
                        <tr>
                       		 <td align="center">
                            ${IGASM08061VO.entityData.ename}
                          </td>
                          <td align="center">${IGASM08061VO.entityData.eilabel}</td>
                          <td align="center">${IGASM08061VO.entityData.einame}</td>
                          <td>${IGASM08061VO.eiorgname}</td>
					 	  <td>${IGASM08061VO.entityData.eidesc}</td>
                          <td align="center">${IGASM08061VO.entityData.eiusername}</td>
                          <td align="center">${IGASM08061VO.entityData.eiinsdate}</td>
                          <td align="center">${IGASM08061VO.entityData.eiupdtime}</td>
                        </tr>
                     </table>
                </div>
                    
                               <div class="title">
                    <div class="name">应用关系信息</div>
                </div>
                <div class="message"><ig:message /></div>
                <logic:present name="IGASM08061VO" property="flag">
<logic:equal value="true" name="IGASM08061VO" property="flag">  
	            <div id="results_list"> <logic:present
		name="IGASM08061VO" property="parEntityItemRelationMap">
		<div id="TabbedPanels1" class="TabbedPanels">
		<ul class="TabbedPanelsTabGroup">
			<logic:iterate id="map" name="IGASM08061VO"
...
//-->
	            ...
	            <logic:equal value="true" name="IGASM08061VO" property="flag">
                     ...
                     <logic:present name="IGASM08061VO" property="parEntityItemRelationMap" >
                ...
                <html:hidden property="pareid" styleId="pareid" value="${IGASM08061VO.entityData.eid}"/>
                <html:hidden property="pareiid" styleId="pareiid" value="${IGASM08061VO.entityData.eiid}"/>
                <html:hidden property="pareilabel" styleId="pareilabel" value="${IGASM08061VO.entityData.eilabel}"/>
                <html:hidden property="pareiname" styleId="pareiname" value="${IGASM08061VO.entityData.einame}"/>
                <html:hidden property="parversion" styleId="parversion" value="${IGASM08061VO.entityData.eiversion}" />
				<html:hidden property="parsmallversion" styleId="parsmallversion" value="${IGASM08061VO.entityData.eismallversion}" />
            </html:form>  
		 </div>
     </div>
</div>
