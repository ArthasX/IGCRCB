...
<html:html>
<bean:define id="id" value="IGASM0904" toScope="request" />
<bean:define id="title" value="服务商配置信息编辑画面" toScope="request" />
...
<script type="text/javascript">	
		...
		function confirmDisp(ident){
			var message1 = '<bean:message key="IGCO10000.W003" arg0="服务商配置信息" />';

			<logic:present name="IGASM09041VO" property="configItemVWInfoMap">
			<logic:iterate id="map" name="IGASM09041VO" property="configItemVWInfoMap" indexId="number">
        ...
        function toback(){
        	form.action = getAppRootUrl() + "/IGASM0904.do?org.apache.struts.taglib.html.CANCEL=1";
        	form.submit();
        }
        var num = 0;
      ...
      //删除附件
    	function delFile(fileid){
    		 if( window.confirm("您是否确定删除附件？")){
    			form.action = getAppRootUrl() + "/IGASM0904.do?delfile["+fileid+"]="+1+"&ident="+0;
    	        form.submit();
    		 }
      }

    	function pics(){
       	 var pics = "${IGASM09041VO.picsXml}";
       	 openIntegrationWindow(pics, "pics", "1000", "600");
        }
        
        function picu(){
       	 var picu = "${IGASM09041VO.picuXml}";
...
<div id="location">
<div class="image"></div>
<p class="fonts1"><ig:navigation extname1="${urlable}"/>&gt;&gt; 服务商配置编辑</p>
<div class="back"><html:link href="javascript:toback();">返回</html:link></div>
</div>

<html:form styleId="form" action="/IGASM0904"
	...
	<table class="table_style">
		...
		<tr>
			<td align="center">${IGASM09041VO.entityData.ename}</td>
			<td>${IGASM09041VO.entityData.eilabel}</td>
			<td>${IGASM09041VO.entityData.einame}</td>
			<td>${IGASM09041VO.eiorgname}</td>
			<td>${IGASM09041VO.entityData.eidesc}</td>
			<td>${IGASM09041VO.entityData.eiusername}</td>
			<td>${IGASM09041VO.entityData.eiinsdate}</td>
	...
	<div class="title">
	<div class="name">服务商配置信息</div>
	</div>
	<div class="message"><ig:message /></div>
	<logic:present name="IGASM09041VO" property="flag">
	<logic:equal value="true" name="IGASM09041VO" property="flag">	
	<logic:present name="IGASM09041VO" property="configItemVWInfoMap">
		<div id="TabbedPanels1" class="TabbedPanels">
		<ul class="TabbedPanelsTabGroup">
			<logic:iterate id="map" name="IGASM09041VO"
		...
		<div class="TabbedPanelsContentGroup"><logic:present
			name="IGASM09041VO" property="configItemVWInfoMap">
			<logic:iterate id="map" name="IGASM09041VO"
				property="configItemVWInfoMap" indexId="number">
				...
				<table class="table_style2">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						<tr onmouseover="mouseOverNoHand(this);" onmouseout="mouseOutNoHand(this);">
							...
							</logic:equal><logic:notEqual name="bean" property="cattach" value="5">align="left"</logic:notEqual>>
							...
							<logic:equal name="bean" property="cattach" value="4">
								...
								<html:checkbox property="isUpgrade[${ADcount}]" styleId="isUpgrade[${ADcount}]" value="1">是否关系升级</html:checkbox>
								<br />
							</logic:equal>
							<logic:equal name="bean" property="cattach" value="5">
								<logic:present name="IGASM0904Form" property="civalue[${ADcount}]">
									<bean:define id="civalue" name="IGASM0904Form" property="civalue[${ADcount}]" type="java.lang.String" />
								...
								<logic:notPresent name="IGASM0904Form" property="civalue[${ADcount}]">
									<logic:iterate id="checkboxbean" name="ADlist${ADmapcount}">
...
<!--	<logic:notEqual value="true" name="IGASM09041VO" property="image_flag">-->
...
<!--	</logic:notEqual>-->
	...
	<html:hidden property="eiid" styleId="eiid" value="${IGASM0904Form.eiid}" />
	<html:hidden property="eiversion" styleId="eiversion" value="${IGASM09041VO.entityData.eiversion}" />
	<html:hidden property="eiorgsyscoding" styleId="eiorgsyscoding" value="${IGASM09041VO.entityData.eiorgsyscoding}" />
</html:form></div>
</div>
</div>
