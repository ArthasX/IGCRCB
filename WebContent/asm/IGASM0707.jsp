...
<html:html>
<bean:define id="id" value="IGASM0707" toScope="request"/>
<logic:equal name="IGASM0707Form" property="mode" value="0">
<bean:define id="title" value="机房关系登记画面" toScope="request"/>
</logic:equal>
<logic:equal name="IGASM0707Form" property="mode" value="1">
<bean:define id="title" value="机房关系编辑画面" toScope="request"/>
</logic:equal>
...
<!-- /header1 -->
	<script type="text/javascript">	
		...
		function confirmDisp(){
			var msgConfirm = '';
			var message1 = '<bean:message key="IGCO10000.W001" arg0="机房关系信息"/>';
			var message2 = '<bean:message key="IGCO10000.W003" arg0="机房关系信息" />';

		    if ('${IGASM0707Form.mode}' == '0'){
		    	msgConfirm = message1;
		    } else {
		    	msgConfirm = message2;
		    }
        ...
        function toback(){
            form.action = getAppRootUrl() + "/IGASM0707.do?org.apache.struts.taglib.html.CANCEL=1";
            form.submit();
        }
	</script>
...
<!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGASM0707" onsubmit="return checkSubmit(this);">
                    <!--  message -->
                    <ig:message/>
                    <!--  /message -->     
		            <fieldset>
	                    <logic:equal name="IGASM0707Form" property="mode" value="0">
			            <legend>机房关系信息添加</legend>
			            </logic:equal>
	                    <logic:equal name="IGASM0707Form" property="mode" value="1">
	                    <legend>机房关系信息变更</legend>
	                    </logic:equal>
                        <div>
                            <label for="Name"><strong>机房模型编号(父)</strong>：</label>
                        ...
                        <div>
                            <label for="Name"><strong>机房编号(父)</strong>：</label>
                        ...
                        <div>
                            <label for="Name"><strong>机房名称(父)</strong>：</label>
