...
<html:html>
<bean:define id="id" value="IGASM1909" toScope="request" />
<bean:define id="title" value="外包人员配置信息查看画面" toScope="request" />
...
<div id="location">
<div class="image"></div>
<p class="fonts1"><ig:navigation extname1="${urlable}"/> &gt;&gt; 外包人员配置查看</p>
			...
			<logic:iterate id="map" name="IGASM19041VO"
				...
				<table class="table_style2">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						...
						<bean:define id="cldVersionMap" name="IGASM1904Form" property="cldVersionMap" type="java.util.Map"/>
...
//-->
	...
	<html:hidden property="eiid" styleId="eiid"
		value="${IGASM1904Form.eiid}" />
	<html:hidden property="eiversion" styleId="eiversion"
		value="${IGASM19041VO.entityData.eiversion}" />
</html:form></div>
</div>
</div>
