...
<html:html>
<bean:define id="id" value="IGASM2702" toScope="request"/>
...
<script type="text/javascript">	
		...
		if(asss[2].value.strlen()>240){
			alert("风险点名称不能大于"+Math.floor(240/strByteFlag)+"个汉字！");
    		return false;
		}
		  	if(asss[10].value.strlen()>3000){
		  		alert("风险点说明内容长度不能大于1000个汉字！");
		  		flag=false;
		  		return;
		  	}
		  	if(asss[11].value.length>500){
		  		alert("备注内容长度不能超过500");
		  		flag=false;
		  		return;
		  	}
			var message = '<bean:message key="IGCO10000.W001" arg0="风险点基本信息" />';
			...
			if(flag){
		  		form.action = "IGASM2702.do";
		  		form.submit();
		  		}
		}
	var eilabelvalue;
   function setEntity(url){
   	url = url+"?roletype=IGAC13&subtype=999017&selecedlast=1";
	...
	function onExcel(){
		window.location.href = getAppRootUrl() + '/IGASM2714_Disp.do';
	}
	function getEilabel(syscode){
		...
		var eilabel=firstLeval+'-D'+secondLevalCode+thirdLevalCode;
		return eilabel;
	}
 ...
 <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGASM2702" onsubmit="return checkSubmit(this);">
                      <!--  message -->
                      <ig:message/>
                      <!--  /message -->     
		            <fieldset>
	                    <logic:equal name="IGASM2702Form" property="mode" value="0">
			            <legend>风险点基本信息添加</legend>
			            </logic:equal>
	                    <logic:equal name="IGASM2702Form" property="mode" value="1">
	                    <legend>风险点基本信息变更</legend>
	                    </logic:equal>
            ...
            <table  width="850px" style="margin-left:60px;margin-top:20px;">
            	...
            	<td align="right" width="130px" style="background-color: #EEEEEE; "><span class="red">*&nbsp&nbsp</span><strong>风险点编号：</strong></td>
            ...
            <tr>
	         <logic:present name="IGASM27021VO" property="soc0109List" >
	              <logic:iterate id="bean" name="IGASM27021VO" property="soc0109List" indexId="index">
	              
				<c:if test="${bean.cattach =='2' && bean.cname == '风险级别'}">
				...
				<option value=""></option>
				<logic:present name="IGASM27021VO" property="levelList" >
	            	  <logic:iterate id="cv" name="IGASM27021VO" property="levelList" indexId="index1"> 
				...
				<c:if test="${bean.cattach =='2' && bean.cname == '风险严重等级'}">
				<td height="20px" align="right" width="130px" style="background-color: #EEEEEE; "><strong>${bean.cname }：</strong></td>
				<td align="left" width="250px">
				<div id="shade"> 
				<html:select property="civalue">
				<option value=""></option>
				<logic:present name="IGASM27021VO" property="gradeList" >
	            	  <logic:iterate id="cv" name="IGASM27021VO" property="gradeList" indexId="index1"> 
						<option value="${cv.ccdvalue }"> ${cv.ccdvalue} </option>
				      </logic:iterate>
				</logic:present> 
				</html:select>
            	...
            	<td align="left" width="40px"></td>
				</c:if><c:if test="${bean.cattach =='2' && bean.cname == '风险发生可能'}">
				<td height="20px" align="right" width="130px" style="background-color: #EEEEEE; "><strong>${bean.cname }：</strong></td>
				<td align="left" width="250px"> 
				<div id="shade">
				<html:select property="civalue">
				<option value=""></option>
				<logic:present name="IGASM27021VO" property="possibleList" >
	            	  <logic:iterate id="cv" name="IGASM27021VO" property="possibleList" indexId="index1"> 
						<option value="${cv.ccdvalue }"> ${cv.ccdvalue} </option>
				      </logic:iterate>
				</logic:present> 
				</html:select>
            	...
            	<td align="left" width="40px"></td>
				</c:if><c:if test="${bean.cattach =='2' && bean.cname == '风险点标志'}">
				<td height="20px" align="right" width="130px" style="background-color: #EEEEEE; "><span class="red"></span><strong>${bean.cname }：</strong></td>
				<td align="left" width="250px"> 
				<div id="shade">
				<html:select property="civalue">
				<option value=""></option>
				<logic:present name="IGASM27021VO" property="signList" >
	            	  <logic:iterate id="cv" name="IGASM27021VO" property="signList" indexId="index1"> 
						<option value="${cv.ccdvalue }"> ${cv.ccdvalue} </option>
				      </logic:iterate>
				</logic:present> 
				</html:select>
				...
				<c:if test="${bean.cattach == '0' && bean.cname != '风险点管理人' }">	
				<td height="20px" align="right" width="130px" style="background-color: #EEEEEE; "><span class="red">*</span><strong>${bean.cname }：</strong></td>
				<td align="left" width="250px"> 
