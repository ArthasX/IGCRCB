...
<html:html>
<bean:define id="id" value="IGASM0302" toScope="request"/>
...
<!-- /header1 -->
	<script type="text/javascript">	
	    ...
	    function setEntity(url){
	    	url = url+"?roletype=IGAC01&subtype=999001";
			var temp = window.showModalDialog(url,null,"dialogWidth:400px;dialogHeight:500px;status:no;help:no;resizable:yes");
			if("_resetall"==temp){
 ...
 <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGASM0302" onsubmit="return checkSubmit(this);">
                      <!--  message -->
                      <ig:message/>
                      <!--  /message -->     
		            <fieldset>
	                    <logic:equal name="IGASM0302Form" property="mode" value="0">
			            <legend>设备基本信息添加</legend>
			            </logic:equal>
	                    <logic:equal name="IGASM0302Form" property="mode" value="1">
