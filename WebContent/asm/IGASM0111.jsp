...
<html:html>
<bean:define id="id" value="IGASM0111" toScope="request"/>
<bean:define id="title" value="取值范围登记画面" toScope="request"/>
<bean:define id="bean" name="IGASM01111VO" property="configurationCodeDetail" />
<!-- header1 -->
 ...
 <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
            ...
            <div id="formwrapper">
            <html:form styleId="form" action="/IGASM0111" onsubmit="return checkSubmit();">
				<!--  message -->
				<ig:message/>
				<!--  /message -->     
                <fieldset>
				...
				<div class="enter">
				    ...
				    <input type="button" value="返回" class="button" onclick="window.location='IGASM0110_Disp.do?ccdcategory=<%=request.getParameter("ccdcategory") %>';"/>
				</div>
            </html:form>
            </div>
        </div>
