...
<html:html>
<bean:define id="id" value="IGASM0423" toScope="request" />
<bean:define id="title" value="合同应付款信息查看画面" toScope="request" />
...
<script type="text/javascript">	
        function toback(){
        	location.href="IGASM0420_Back.do";
        }
	</script>
<link rel="stylesheet"
				...
				<table class="table_style2">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						...
						>
							...
							<!-- 名称 -->
							<td align="left">
							<div class="nowrapDiv"><logic:empty name="bean" property="cname">&nbsp;</logic:empty> ${bean.cname}</div>
							</td>
							<!-- 内容 -->
