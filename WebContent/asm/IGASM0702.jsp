...
<html:html>
<bean:define id="id" value="IGASM0702" toScope="request"/>
<bean:define id="title" value="机房基本信息登记画面" toScope="request"/>
...
<!-- /header1 -->
	<script type="text/javascript">	
		...
		function redisplay1(){
			$("ekey1").value = "";
			$("ekey2").value = "";
			form.action = getAppRootUrl() + "/IGASM0702_ReDisp.do";
			form.submit();
		}
		function redisplay2(){
			$("ekey2").value = "";
		...
		function confirmDisp(){
			var message = '<bean:message key="IGCO10000.W001" arg0="机房基本信息" />';
 ...
 <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGASM0702" onsubmit="return checkSubmit(this);">
                      <!--  message -->
                      <ig:message/>
                      <!--  /message -->     
		            <fieldset>
	                    <logic:equal name="IGASM0702Form" property="mode" value="0">
			            <legend>机房基本信息添加</legend>
			            </logic:equal>
	                    <logic:equal name="IGASM0702Form" property="mode" value="1">
	                    <legend>机房基本信息变更</legend>
	                    </logic:equal>
	                    <div>
