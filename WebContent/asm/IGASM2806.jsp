...
<html:html>
<bean:define id="id" value="IGASM2806" toScope="request"/>
    ...
    var gid='IGASM2806';
	    function deleteRec(){
	        ...
	        if( window.confirm(confirmMsg)){
	            form.action = getAppRootUrl() + "/IGASM2806_Del.do";
	            return true;
	        } else {
	            return false;
	        }
	    ...
	    function toback(){
	        form.action = getAppRootUrl() + "/IGASM2806.do?btn_back=1";
	        form.submit();
	    }
	</script>
	<link rel="stylesheet"
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            ...
            <html:form styleId="form"  action="/IGASM2806" onsubmit="return checkSubmit(this);">
                <div class="title">
                ...
                <div id="results_list">
                    <table class="table_style">
                        ...
                        <tr>
                       		 <td align="center">
                            ${IGASM28061VO.entityData.ename}
                          </td>
                          <td align="center">${IGASM28061VO.entityData.eilabel}</td>
                          <td align="center">${IGASM28061VO.entityData.einame}</td>
                          <td>${IGASM28061VO.eiorgname}</td>
					 	  <td>${IGASM28061VO.entityData.eidesc}</td>
                          <td align="center">${IGASM28061VO.entityData.eiusername}</td>
                          <td align="center">${IGASM28061VO.entityData.eiinsdate}</td>
                          <td align="center"> ${IGASM28061VO.entityData.eiupdtime}</td>
                        </tr>
                     </table>
                </div>
                ...
                <logic:present name="IGASM28061VO" property="flag">
<logic:equal value="true" name="IGASM28061VO" property="flag">  
	            <div id="results_list"> <logic:present
		name="IGASM28061VO" property="parEntityItemRelationMap">
		<div id="TabbedPanels1" class="TabbedPanels">
		<ul class="TabbedPanelsTabGroup">
			<logic:iterate id="map" name="IGASM28061VO"
...
//-->
	            ...
	            <logic:equal value="true" name="IGASM28061VO" property="flag">
                     ...
                     <logic:present name="IGASM28061VO" property="parEntityItemRelationMap" >
                ...
                <html:hidden property="pareid" styleId="pareid" value="${IGASM28061VO.entityData.eid}"/>
                <html:hidden property="pareiid" styleId="pareiid" value="${IGASM28061VO.entityData.eiid}"/>
                <html:hidden property="pareilabel" styleId="pareilabel" value="${IGASM28061VO.entityData.eilabel}"/>
                <html:hidden property="pareiname" styleId="pareiname" value="${IGASM28061VO.entityData.einame}"/>
                <html:hidden property="parversion" styleId="parversion" value="${IGASM28061VO.entityData.eiversion}" />
				<html:hidden property="parsmallversion" styleId="parsmallversion" value="${IGASM28061VO.entityData.eismallversion}" />
            </html:form>  
		 </div>
     </div>
</div>
