...
<html:html>
<bean:define id="id" value="IGASM0803" toScope="request"/>
...
<div class="msg">
			...
			<div class="msg_box">
			<html:form styleId="form" action="/IGASM0803" onsubmit="return checkSubmit(this);">
			  ...
			  <html:hidden property="eiid" styleId="eiid" value="${IGASM08021VO.entityData.eiid}"/>
