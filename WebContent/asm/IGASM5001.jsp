...
<html:html>
<bean:define id="id" value="IGASM5001" toScope="request"/>
<bean:define id="title" value="应急制度管理画面" toScope="request"/>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            <html:form styleId="form" action="/IGASM5001"
			       ...
			       <table class="table_style"  style="text-align: left !important;">
			            <!-- header部 -->
			                ...
			                <tr style="text-align: left !important;">
					           <th width="2%" >
					         	    <input type="checkbox" name="allbox" id="allbox" onclick="selectAll('allbox','deleteEiid')" style="width: 15px;"/>
					           </th>
					           <th width="12%" style="text-align: left !important;">制度编号</th>
					           <th width="23%" style="text-align: left !important;">制度名称</th>
					           <th width="20%" style="text-align: left !important;">制度说明</th>
			            ...
			            <!-- body部 -->
			                ...
			                <logic:present name="IGASM50011VO" property="entityDataList" >
			                    <logic:iterate id="bean" name="IGASM50011VO" property="entityDataList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>" style="text-align: left !important;">
			                            <td style="text-align: left !important;">
			                            <html:checkbox property="deleteEiid" value="${bean.eiid}" style="width:15px;"/>
<%-- 			                            <c:if test="${ADmode == 'A'}"> --%>
...
<%-- 			                            </c:if> --%>
			                            ...
			                            <td style="text-align: left !important;">
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM5008_Disp.do?eiid=${bean.eiid}">${bean.eilabel}</html:link>
			                                </div>
			                            </td>
			                            <!-- 名称 -->
			                            <td style="text-align: left !important;">
			                            ...
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGASM5004_Disp.do?eiid=${bean.eiid}"><img src="images/xx.gif" alt="显示详细信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                            <!-- 关系信息 -->
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM5006_Disp.do?eiid=${bean.eiid}"><img src="images/record_(copy)_16x16.gif" alt="关系信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                            <!-- 历史版本 -->
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM5005_Disp.do?eiid=${bean.eiid}&civersion="><img src="images/notepad_16x16.gif" alt="历史版本" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                        </tr>
			                    </logic:iterate>
