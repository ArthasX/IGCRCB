...
<html:html>
<bean:define id="id" value="IGASM0402" toScope="request"/>
<bean:define id="title" value="合同基本信息登记画面" toScope="request"/>
	...
	<script type="text/javascript">	
		 ...
		 function checkForm(){
		    	...
		    	if($F('eilabel').strlen()>32){
		    		...
		    		var message = '<bean:message key="IGCO10000.W001" arg0="合同基本信息" />';
	    ...
	    function setEntity(url){
	    	url = url+"?roletype=IGAC02&subtype=999011";
			var temp = window.showModalDialog(url,null,"dialogWidth:400px;dialogHeight:500px;status:no;help:no;resizable:yes");
			if("_resetall"==temp){
	    ...
	    function searchMaxEntityItemLable(){
			var objAjax = new Ajax.Request(getAppRootUrl() + ajaxAction,{ parameters: 'ecategorykey=HTZC&type=eilable',
 ...
 <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
            ...
            <div id="location">
                <div class="image"></div>
                <logic:equal name="IGASM0402Form" property="mode" value="0">
                <p class="fonts1">资产管理 &gt;&gt; 合同资产 &gt;&gt; 合同登记</p>
                 </logic:equal>
                  <logic:equal name="IGASM0402Form" property="mode" value="1">
	                    <p class="fonts1">资产管理 &gt;&gt; 合同资产 &gt;&gt; 合同变更</p>
	              </logic:equal>
            </div>
            
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGASM0402" onsubmit="return checkSubmit(this);">
                      <!--  message -->
                      <ig:message/>
                      <!--  /message -->     
		            <fieldset>
	                    <logic:equal name="IGASM0402Form" property="mode" value="0">
			            <legend>合同基本信息添加</legend>
			            </logic:equal>
	                    <logic:equal name="IGASM0402Form" property="mode" value="1">
                    ...
                    <html:hidden property="eid" styleId="eid" value="CM06000000"/>
