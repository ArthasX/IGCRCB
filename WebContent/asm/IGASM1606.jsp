...
<html:html>
<bean:define id="id" value="IGASM1606" toScope="request" />
<bean:define id="title" value="数据关系管理详细画面" toScope="request" />
...
<script type="text/javascript">	
    var gid='IGASM1606';
	    function deleteRec(){
	        ...
	        var confirmMsg ='<bean:message key="IGCO10000.W002" arg0="数据关系信息" />';
	        ...
	        if( window.confirm(confirmMsg)){
	            form.action = getAppRootUrl() + "/IGASM1606_Del.do";
	            return true;
	        } else {
	            return false;
	        }
	    ...
	    function toback(){
	        form.action = getAppRootUrl() + "/IGASM1606.do?btn_back=1";
	        form.submit();
	    }
	</script>
<link rel="stylesheet"
...
<html:form styleId="form" action="/IGASM1606"
	...
	<table class="table_style">
		...
		<tr>
			<td align="center">${IGASM16061VO.entityData.ename}</td>
			<td align="center">${IGASM16061VO.entityData.eilabel}</td>
			<td align="center">${IGASM16061VO.entityData.einame}</td>
			<td>${IGASM16061VO.eiorgname}</td>
			<td>${IGASM16061VO.entityData.eidesc}</td>
			<td align="center">${IGASM16061VO.entityData.eiusername}</td>
			<td align="center">${IGASM16061VO.entityData.eiinsdate}</td>
			<td align="center">${IGASM16061VO.entityData.eiupdtime}</td>
		</tr>
	</table>
	</div>

	<div class="title">
	<div class="name">数据关系信息</div>
	</div>
	<div class="message"><ig:message /></div>
	<logic:present name="IGASM16061VO" property="flag">
<logic:equal value="true" name="IGASM16061VO" property="flag">  
	<div id="results_list"><logic:present
		name="IGASM16061VO" property="parEntityItemRelationMap">
		<div id="TabbedPanels1" class="TabbedPanels">
		<ul class="TabbedPanelsTabGroup">
			<logic:iterate id="map" name="IGASM16061VO"
...
//-->
	...
	<logic:present name="IGASM16061VO" property="parEntityItemRelationMap">
	...
	<html:hidden property="pareid" styleId="pareid"
		value="${IGASM16061VO.entityData.eid}" />
	<html:hidden property="pareiid" styleId="pareiid"
		value="${IGASM16061VO.entityData.eiid}" />
	<html:hidden property="pareilabel" styleId="pareilabel"
		value="${IGASM16061VO.entityData.eilabel}" />
	<html:hidden property="pareiname" styleId="pareiname"
		value="${IGASM16061VO.entityData.einame}" />
		 <html:hidden property="parversion" styleId="parversion" value="${IGASM16061VO.entityData.eiversion}" />
				<html:hidden property="parsmallversion" styleId="parsmallversion" value="${IGASM16061VO.entityData.eismallversion}" />
</html:form></div>
</div>
</div>
