...
<html:html>
<bean:define id="id" value="IGASM0347" toScope="request" />
...
//-->
	...
	<div class="enter"><html:button property="btn_back" styleClass="button" value="关闭" onclick="javascript:window.close();"/></div>
