...
<html:html>
<bean:define id="id" value="IGASM0315" toScope="request"/>
<bean:define id="title" value="设备预报废撤销页面" toScope="request"/>
...
function setMuchEntityItemValue(){
	<c:if test="${IGASM0315Form.type == 'I'}">
	var selectCount = 0;
	var eid = "";
    var elabel = "";
    var ename = "";
...
<c:if test="${IGASM0315Form.type != 'I'}">
<bean:define id="entityItemVWInfo" name="IGASM03151VO" property="entityItemVWInfo" />
</c:if>
<!--container 左菜单 右侧内容-->
<div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		    	<c:if test="${IGASM0315Form.type != 'I'}">
		         <html:form styleId="form" action="/IGASM0315" onsubmit="return checkSubmit(this);">
                      <!--  message -->
                      <ig:message/>
                      <!--  /message -->     
		            <fieldset>
		            ...
		            <div class="enter">
		            <logic:present name="IGASM03151VO" property="flag">
		            <logic:equal value="true" name="IGASM03151VO" property="flag">
		                <html:submit property="btn_insert" value="撤销预报废" styleClass="button"  onclick="return checkForm();"  />
		            </logic:equal>
		            </logic:present>
		         ...
		         <c:if test="${IGASM0315Form.type == 'I'}">
		         <html:form styleId="form" action="/IGASM0315_batch" onsubmit="return checkSubmit(this);">
			     <div id="countinfo">
				 </div>
	          	 <div id="muchCivalue">
				 </div>
				 <html:submit property="btn_insert" value="撤销" styleClass="button"  onclick="return checkForm();"  />
				 <html:button property="button" value="返回" styleClass="button" onclick="toback();" />
			     </html:form>
		         </c:if>
		    </div>
