...
<html:html>
<bean:define id="id" value="IGASM1509" toScope="request" />
			...
			<logic:iterate id="map" name="IGASM15041VO"
				...
				<table class="table_style2">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						...
						<bean:define id="cldVersionMap" name="IGASM1504Form" property="cldVersionMap" type="java.util.Map"/>
...
//-->
	...
	<html:hidden property="eiid" styleId="eiid"
		value="${IGASM1504Form.eiid}" />
	<html:hidden property="eiversion" styleId="eiversion"
		value="${IGASM15041VO.entityData.eiversion}" />
</html:form></div>
</div>
</div>
