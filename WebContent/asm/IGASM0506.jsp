...
<html:html>
<bean:define id="id" value="IGASM0506" toScope="request"/>
    ...
    var gid='IGASM0506';
	    function deleteRec(){
	        ...
	        if( window.confirm(confirmMsg)){
	            form.action = getAppRootUrl() + "/IGASM0506_Del.do";
	            return true;
	        } else {
	            return false;
	        }
	    ...
	    function toback(){
	        form.action = getAppRootUrl() + "/IGASM0506.do?btn_back=1";
	        form.submit();
	    }
	</script>
	<link rel="stylesheet"
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            ...
            <html:form styleId="form"  action="/IGASM0506" onsubmit="return checkSubmit(this);">
                <div class="title">
                ...
                <div id="results_list">
                    <table class="table_style">
                        ...
                        <tr>
                       		 <td align="center">
                            ${IGASM05061VO.entityData.ename}
                          </td>
                          <td align="center">${IGASM05061VO.entityData.eilabel}</td>
                          <td align="center">${IGASM05061VO.entityData.einame}</td>
                          <td>${IGASM05061VO.eiorgname}</td>
					 	  <td>${IGASM05061VO.entityData.eidesc}</td>
                          <td align="center">${IGASM05061VO.entityData.eiusername}</td>
                          <td align="center">${IGASM05061VO.entityData.eiinsdate}</td>
                          <td align="center"> ${IGASM05061VO.entityData.eiupdtime}</td>
                        </tr>
                     </table>
                </div>
                ...
                <logic:present name="IGASM05061VO" property="flag">
<logic:equal value="true" name="IGASM05061VO" property="flag">  
	            <div id="results_list"> <logic:present
		name="IGASM05061VO" property="parEntityItemRelationMap">
		<div id="TabbedPanels1" class="TabbedPanels">
		<ul class="TabbedPanelsTabGroup">
			<logic:iterate id="map" name="IGASM05061VO"
...
//-->
	            ...
	            <logic:equal value="true" name="IGASM05061VO" property="flag">
                     ...
                     <logic:present name="IGASM05061VO" property="parEntityItemRelationMap" >
                ...
                <html:hidden property="pareid" styleId="pareid" value="${IGASM05061VO.entityData.eid}"/>
                <html:hidden property="pareiid" styleId="pareiid" value="${IGASM05061VO.entityData.eiid}"/>
                <html:hidden property="pareilabel" styleId="pareilabel" value="${IGASM05061VO.entityData.eilabel}"/>
                <html:hidden property="pareiname" styleId="pareiname" value="${IGASM05061VO.entityData.einame}"/>
                <html:hidden property="parversion" styleId="parversion" value="${IGASM05061VO.entityData.eiversion}" />
				<html:hidden property="parsmallversion" styleId="parsmallversion" value="${IGASM05061VO.entityData.eismallversion}" />
            </html:form>  
		 </div>
     </div>
</div>
