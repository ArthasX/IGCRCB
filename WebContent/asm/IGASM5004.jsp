...
<html:html>
<bean:define id="id" value="IGASM5004" toScope="request"/>
<bean:define id="title" value="制度配置信息编辑画面" toScope="request"/>
...
<!-- /header1 -->
	<script type="text/javascript">	
		...
		function confirmDisp(ident){
			var message1 = '<bean:message key="IGCO10000.W003" arg0="制度属性信息" />';

			<logic:present name="IGASM50041VO" property="configItemVWInfoMap">
			<logic:iterate id="map" name="IGASM50041VO" property="configItemVWInfoMap" indexId="number">
        ...
        function toback(){
        	form.action = getAppRootUrl() + "/IGASM5001_Back.do";
        	form.submit();
        }
        var num = 0;
      ...
      //删除附件
    	function delFile(fileid){
    		 if( window.confirm("您是否确定删除附件？")){
    			form.action = getAppRootUrl() + "/IGASM5004.do?delfile["+fileid+"]="+1+"&ident="+0;
    	        form.submit();
    		 }
      }
...
function init(){
	if($("civalue[2]") != null){
		var img = "<img style=\"cursor: hand;\" onclick=\"selectTree('124_tree_制度分类','1');\" alt=\"查询\" src=\"images/seek.gif\" complete=\"complete\"/>";
      ...
      function selectVersion(){
			...
			if(document.getElementById("eiversion").value !=  a){
				window.location.href="IGASM5009_Disp.do?eiid="+eiid+"&eiversion="+a;
			}else{
				window.location.href="IGASM5004_Disp.do?eiid="+eiid+"&eiversion="+a;
    		}
	      }
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            ...
            <div id="location">
                <div class="image"></div>
                <p class="fonts1"><ig:navigation extname1="${urlable}"/> &gt;&gt; 制度属性编辑 </p>
                <div class="back"><html:link href="javascript:toback();">返回</html:link></div> 
            </div>

		    <html:form styleId="form" action="/IGASM5004" enctype="multipart/form-data" onsubmit="return checkSubmit(this);">
                 <div class="title">
                     <div class="name">制度基本信息</div>
                 </div>
                 <div id="results_list">
				    <table class="table_style">
						...
						<tr>
						  <td align="center" title="${IGASM50041VO.entityData.einame}"><div style="width:100%; white-space:nowrap; text-overflow:ellipsis; overflow:hidden;">${IGASM50041VO.entityData.einame}</div></td>
						  <td title="${IGASM50041VO.eiorgname}"><div style="width:100%; white-space:nowrap; text-overflow:ellipsis; overflow:hidden;">${IGASM50041VO.eiorgname}</div></td>
						  <td title="${IGASM50041VO.entityData.eidesc}" ><div style="width:100%; white-space:nowrap; text-overflow:ellipsis; overflow:hidden;">${IGASM50041VO.entityData.eidesc}</div> </td>
						  <td align="center" title="${IGASM50041VO.entityData.eiusername}"><div style="width:100%; white-space:nowrap; text-overflow:ellipsis; overflow:hidden;">${IGASM50041VO.entityData.eiusername}</div></td>
						  <td align="center" title="${IGASM50041VO.entityData.eiinsdate}">
                           <div style="width:100%; white-space:nowrap; text-overflow:ellipsis; overflow:hidden;">${IGASM50041VO.entityData.eiinsdate}</div>
                      </td>
						</tr>
                     </table>
                  </div>
                  ...
                  <div class="title">
                      <div class="name">制度属性信息</div>
                  </div>
                  
	    <div class="message"><ig:message /></div>
	    <logic:present name="IGASM50041VO" property="flag">
	    <logic:equal value="true" name="IGASM50041VO" property="flag">	
		<logic:present name="IGASM50041VO" property="configItemVWInfoMap">
			<div id="TabbedPanels1" class="TabbedPanels">
			<ul class="TabbedPanelsTabGroup">
				<logic:iterate id="map" name="IGASM50041VO"
					...
					<li class="TabbedPanelsTab" tabindex="0"><ig:codeValue
						...
						<option value="">版本选择&nbsp&nbsp当前版本${IGASM5004Form.selecteiversion}.0 </option>
						 <logic:present name="IGASM50041VO" property="checkVersionMap" >
						 <logic:iterate id="versionMap" name="IGASM50041VO" property="checkVersionMap" indexId="index">
			...
			<div class="TabbedPanelsContentGroup"><logic:present
				name="IGASM50041VO" property="configItemVWInfoMap">
				<logic:iterate id="map" name="IGASM50041VO"
					property="configItemVWInfoMap" indexId="number">
					...
					<table class="table_style2" id = "tab1">
						...
						<logic:iterate id="bean" name="list" indexId="index">
							<tr onmouseover="mouseOverNoHand(this);" onmouseout="mouseOutNoHand(this);" <logic:equal name="bean" property="cseq" value="1">style="display: none;"</logic:equal>>
								...
								<logic:equal name="bean" property="cattach" value="5">
									<logic:present name="IGASM5004Form" property="civalue[${ADcount}]">
										<bean:define id="civalue" name="IGASM5004Form" property="civalue[${ADcount}]" type="java.lang.String" />
									...
									<logic:notPresent name="IGASM5004Form" property="civalue[${ADcount}]">
										<logic:iterate id="checkboxbean" name="ADlist${ADmapcount}">
		    ...
		    <html:hidden property="eiid" styleId="eiid" value="${IGASM5004Form.eiid}"/>
		    <html:hidden property="eiversion" styleId="eiversion" value="${IGASM50041VO.entityData.eiversion}"/>
		    <html:hidden property="eiorgsyscoding" styleId="eiorgsyscoding" value="${IGASM50041VO.entityData.eiorgsyscoding}" />
