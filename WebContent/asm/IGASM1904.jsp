...
<html:html>
<bean:define id="id" value="IGASM1904" toScope="request" />
<bean:define id="title" value="外包人员配置信息编辑画面" toScope="request" />
...
<script type="text/javascript">	
		...
		function confirmDisp(ident){
			var message1 = '<bean:message key="IGCO10000.W003" arg0="外包人员配置信息" />';

			<logic:present name="IGASM19041VO" property="configItemVWInfoMap">
			<logic:iterate id="map" name="IGASM19041VO" property="configItemVWInfoMap" indexId="number">
        ...
        function toback(){
        	form.action = getAppRootUrl() + "/IGASM1904.do?org.apache.struts.taglib.html.CANCEL=1";
        	form.submit();
        }
      ...
      //删除附件
    	function delFile(fileid){
    		 if( window.confirm("您是否确定删除附件？")){
    			form.action = getAppRootUrl() + "/IGASM1904.do?delfile["+fileid+"]="+1+"&ident="+0;
    	        form.submit();
    		 }
      }
	</script>
...
<div id="location">
<div class="image"></div>
<p class="fonts1"><ig:navigation extname1="${urlable}"/> &gt;&gt; 外包人员配置编辑</p>
<div class="back"><html:link href="javascript:toback();">返回</html:link></div>
</div>

<html:form styleId="form" action="/IGASM1904"
	...
	<table class="table_style">
		...
		<tr>
			<td align="center">${IGASM19041VO.entityData.ename}</td>
			<td>${IGASM19041VO.entityData.eilabel}</td>
			<td>${IGASM19041VO.entityData.einame}</td>
			<td>${IGASM19041VO.eiorgname}</td>
			<td>${IGASM19041VO.entityData.eidesc}</td>
			<td>${IGASM19041VO.entityData.eiusername}</td>
			<td>${IGASM19041VO.entityData.eiinsdate}</td>
			
		</tr>
	</table>
</div>
	<div class="title">
	<div class="name">外包人员配置信息</div>
	</div>
	<div class="message"><ig:message /></div>
	<logic:present name="IGASM19041VO" property="flag">
	<logic:equal value="true" name="IGASM19041VO" property="flag">	
	<logic:present name="IGASM19041VO" property="configItemVWInfoMap">
		<div id="TabbedPanels1" class="TabbedPanels">
		<ul class="TabbedPanelsTabGroup">
			<logic:iterate id="map" name="IGASM19041VO"
		...
		<div class="TabbedPanelsContentGroup"><logic:present
			name="IGASM19041VO" property="configItemVWInfoMap">
			<logic:iterate id="map" name="IGASM19041VO"
				property="configItemVWInfoMap" indexId="number">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						<tr  onmouseover="mouseOverNoHand(this);" onmouseout="mouseOutNoHand(this);" <logic:equal name="bean" property="cseq" value="1">style="display: none;"</logic:equal>>
							...
							<logic:equal name="bean" property="cattach" value="4">
								...
								<logic:equal name="bean" property="cattach" value="5">
								<logic:present name="IGASM1904Form" property="civalue[${ADcount}]">
									<bean:define id="civalue" name="IGASM1904Form" property="civalue[${ADcount}]" type="java.lang.String" />
								...
								<logic:notPresent name="IGASM1904Form" property="civalue[${ADcount}]">
									<logic:iterate id="checkboxbean" name="ADlist${ADmapcount}">
	...
	<html:hidden property="eiid" styleId="eiid" value="${IGASM1904Form.eiid}" />
	<html:hidden property="eiversion" styleId="eiversion" value="${IGASM19041VO.entityData.eiversion}" />
	<html:hidden property="eiorgsyscoding" styleId="eiorgsyscoding" value="${IGASM19041VO.entityData.eiorgsyscoding}" />
</html:form></div>
</div>
</div>
