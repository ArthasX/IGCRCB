	...
	<script type="text/javascript">	
		 ...
		 function checkForm(){
		    	...
		    	if($F('eiinsdate').trim()==""){
		    		...
		    		alert("检查项编号不能大于32个字符！");
		    		return false;
		    	}if($F('einame').strlen()>120){
		    		alert("检查项名称不能大于"+Math.floor(120/strByteFlag)+"个汉字！");
		    		return false;
		    	}if($F('eidesc').strlen()>256){
		    		alert("检查项说明不能大于"+Math.floor(256/strByteFlag)+"个汉字！");
		    		return false;
		    	}else {
