...
<html:html>
<bean:define id="id" value="IGASM1911" toScope="request"/>
...
<!-- /header1 -->
    ...
    var gid='IGASM1911';
	    ...
	    function toback(){
	        form.action = getAppRootUrl() + "/IGASM1908_Back.do";
	        form.submit();
	    }
	</script>
	<link rel="stylesheet"
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            ...
            <html:form styleId="form"  action="/IGASM1906" onsubmit="return checkSubmit(this);">
                <div class="title">
...
//-->
                ...
                <html:hidden property="pareid" styleId="pareid" value="${IGASM19061VO.entityData.eid}"/>
                <html:hidden property="pareiid" styleId="pareiid" value="${IGASM19061VO.entityData.eiid}"/>
                <html:hidden property="pareiname" styleId="pareiname" value="${IGASM19061VO.entityData.einame}"/>
            </html:form>  
		 </div>
     </div>
</div>
