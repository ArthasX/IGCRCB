...
<html:html>
<bean:define id="id" value="IGASM0507" toScope="request"/>
<logic:equal name="IGASM0507Form" property="mode" value="0">
<bean:define id="title" value="文档关系登记画面" toScope="request"/>
</logic:equal>
<logic:equal name="IGASM0507Form" property="mode" value="1">
...
<!-- /header1 -->
	<script type="text/javascript">	
        ...
        function toback(){
            form.action = getAppRootUrl() + "/IGASM0507.do?org.apache.struts.taglib.html.CANCEL=1";
            form.submit();
        }
 ...
 <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGASM0507" onsubmit="return checkSubmit(this);">
                    <!--  message -->
                    <ig:message/>
                    <!--  /message -->     
		            <fieldset>
