...
<html:html>
<bean:define id="id" value="IGASM0802" toScope="request"/>
<bean:define id="title" value="应用基本信息登记画面" toScope="request"/>
	...
	<script type="text/javascript">	
		 ...
		 function checkForm(){
		    	...
		    	if($F('eiinsdate').trim()==""){
		    		...
		    		var message = '<bean:message key="IGCO10000.W001" arg0="应用基本信息" />';
	    ...
	    function setEntity(url){
	    	url = url+"?roletype=IGAC07&subtype=999003";
			var temp = window.showModalDialog(url,null,"dialogWidth:400px;dialogHeight:500px;status:no;help:no;resizable:yes");
			if("_resetall"==temp){
 ...
 <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGASM0802" onsubmit="return checkSubmit(this);">
                      <!--  message -->
                      <ig:message/>
                      <!--  /message -->     
		            <fieldset>
	                    <logic:equal name="IGASM0802Form" property="mode" value="0">
			            <legend>应用基本信息添加</legend>
			            </logic:equal>
	                    <logic:equal name="IGASM0802Form" property="mode" value="1">
