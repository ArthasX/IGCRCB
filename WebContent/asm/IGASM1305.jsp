...
<%		
		...
		response.setHeader("Content-disposition","attachment;filename="  + new String( "新进设备统计.xls".getBytes("gb2312"), "ISO8859-1" ) );
		ExportExcel.exportIGASM1305(response.getOutputStream(),vo.getEntityCountList(),form.getOrgname(),form.getCiupdtime_from(),form.getCiupdtime_to());
		out.clear();
