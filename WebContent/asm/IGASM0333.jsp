...
<html:html>
<bean:define id="id" value="IGASM0333" toScope="request" />
<bean:define id="title" value="资产关系查看详细画面" toScope="request" />
...
<html:form styleId="form" action="/IGASM0324_Disp"
	...
	<table class="table_style">
		...
		<tr>
			...
			<td>${IGASM03061VO.entityData.organizationTB.orgname}</td>
...
//-->
	...
	<div class="enter">
	<html:button property="btn_back" styleClass="button" value="返回" onclick="toback()"/></div>
