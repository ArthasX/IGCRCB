...
<html:html>
<bean:define id="id" value="IGASM1710" toScope="request" />
             ...
             <div id="results_list">
               <table class="table_style">
                   ...
                   <tr>
                     ...
                     <td align="center">${IGASM17051VO.entityData.eidesc}</td>
...
<div class="enter">
	<html:form styleId="form"  action="/IGASM1708_Back" onsubmit="return checkSubmit(this);">
	<c:if test="${IGASM17051VO.flag==true}">
    	<logic:present name="IGASM17051VO" property="configItemVersionTime">
