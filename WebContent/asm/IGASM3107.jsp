...
<html:html>
<bean:define id="id" value="IGASM3107" toScope="request"/>
<logic:equal name="IGASM3107Form" property="mode" value="0">
<bean:define id="title" value="风险指标关系登记画面" toScope="request"/>
</logic:equal>
<logic:equal name="IGASM3107Form" property="mode" value="1">
<bean:define id="title" value="风险指标关系编辑画面" toScope="request"/>
</logic:equal>
	...
	<script type="text/javascript">	
		...
		function confirmDisp(){
	    	...
	    	if($F('eirdesc').strlen()>64){
				...
				var msgConfirm = '';
				var message1 = '<bean:message key="IGCO10000.W001" arg0="风险指标关系信息"/>';
				var message2 = '<bean:message key="IGCO10000.W003" arg0="风险指标关系信息" />';
	
			    if ('${IGASM3107Form.mode}' == '0'){
			    	msgConfirm = message1;
			    } else {
			    	msgConfirm = message2;
			    }
        ...
        function toback(){
            form.action = getAppRootUrl() + "/IGASM3107.do?org.apache.struts.taglib.html.CANCEL=1";
            form.submit();
        }
 ...
 <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGASM3107" onsubmit="return checkSubmit(this);">
                    <!--  message -->
                    <ig:message/>
                    <!--  /message -->     
		            <fieldset>
	                    <logic:equal name="IGASM3107Form" property="mode" value="0">
			            <legend>风险指标关系信息添加</legend>
			            </logic:equal>
	                    <logic:equal name="IGASM3107Form" property="mode" value="1">
	                    <legend>风险指标关系信息变更</legend>
	                    </logic:equal>
                        <div>
                            <label for="Name"><strong>风险指标编号</strong>：</label>
                        ...
                        <div>
                            <label for="Name"><strong>风险指标名称</strong>：</label>
