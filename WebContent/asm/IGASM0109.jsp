...
<html:html>
<bean:define id="id" value="IGASM0109" toScope="request" />
...
<table class="table_style">
	...
	<logic:present name="IGASM01091VO" property="configurationCodeDetailList">
		<logic:iterate id="bean" name="IGASM01091VO" property="configurationCodeDetailList">
		...
		<tr class="<ig:rowcss index="${index}"/>">
			...
			<!-- 修改属性 -->
			<td>
				<a href="IGASM0110_Disp.do?ccdcategory=${bean.ccdcategory}">
					修改属性
				</a>
			</td>
		</tr>
...
<div class="enter">
	<input type="button" id="btn_add" value="增加" class="button" onclick="window.location='IGASM0108_Disp.do'" />
</div>
<div id="operate">
<!-- paging --> 
