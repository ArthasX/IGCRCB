...
<html:html>
<bean:define id="id" value="IGASM1701" toScope="request"/>
<bean:define id="title" value="组件管理画面" toScope="request"/>
...
<!-- /header1 -->
	...
	function deleteRec(){
        ...
        var confirmMsg ='<bean:message key="IGCO10000.W002" arg0="组件基本信息" />';
        ...
        if( window.confirm(confirmMsg)){
            form.action = getAppRootUrl() + "/IGASM1701_Del.do";
            return true;
        } else {
            return false;
        }
...
//	}
	 ...
	 function setEntity(){
			...
			var url = "IGSYM0304_ASSET.do?roletype=IGAC01&subtype=999012";
			</logic:notPresent>
			<logic:present name="ADrolemanager">
			<logic:equal name="ADrolemanager" value="true">
			var url = "IGSYM1203_ENTITY_TREE.do?levelnode=999012";
			</logic:equal>
			</logic:present>
			var temp = window.showModalDialog(url,null,"dialogWidth:400px;dialogHeight:500px;status:no;help:no;resizable:yes");
			if("_resetall"==temp){
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            <html:form styleId="form" action="/IGASM1701"
          ...
          <div id="search">
		             ...
		             <div class="conditions">
                          ...
                          <!--<label><span class="red">*</span>所属机构:</label>
								...
								<img src="images/tree.gif" style="cursor: hand;" alt="选择管理范围" width="16" height="16" border="0" onclick="setRoleDomain('IGSYM0317.do');"/>
			                ...
			                <label>组件名称：</label><html:text property="einame" styleId="einame" errorStyleClass="inputError imeDisabled" size="10" />&nbsp;&nbsp; 
                ...
                <div id="results_list">
			       ...
			       <table class="table_style">
			            ...
			            <!-- body部 -->
			                ...
			                <logic:present name="IGASM17011VO" property="entityDataList" >
			                    <logic:iterate id="bean" name="IGASM17011VO" property="entityDataList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                            ...
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM1712_Disp.do?eiid=${bean.eiid}">${bean.eilabel}</html:link>
			                                </div>
			                            </td>
			                            <!-- 名称 -->
			                            <td>
			                            ...
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGASM1704_Disp.do?eiid=${bean.eiid}"><img src="images/xx.gif" alt="显示详细信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                            <!-- 关系信息 -->
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM1706_Disp.do?eiid=${bean.eiid}"><img src="images/record_(copy)_16x16.gif" alt="关系信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                            <!-- 关系图 -->
			                            <!-- 
			                            ...
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM1705_Disp.do?eiid=${bean.eiid}&civersion="><img src="images/notepad_16x16.gif" alt="历史版本" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                        </tr>
			                    </logic:iterate>
                ...
                <html:hidden property="ecategory" styleId="ecategory" value="${IGASM1701Form.ecategory}"/>
            </html:form>
        </div>
    </div>
