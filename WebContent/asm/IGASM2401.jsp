...
<html:html>
<bean:define id="id" value="IGASM2401" toScope="request"/>
...
<!-- /header1 -->
	...
	function deleteRec(){
        ...
        if( window.confirm(confirmMsg)){
            form.action = getAppRootUrl() + "/IGASM2401_Del.do";
            return true;
        } else {
            return false;
        }
	...
	function setRoleDomain(){
		...
		var url = "IGSYM0304.do?roletype=IGAC11";
		</logic:notPresent>
	...
	function setDefRoleDomain(){
	 ...
	 function setEntity(){
		 	<logic:notPresent name="ADrolemanager">
			var url = "IGSYM0304_ASSET.do?roletype=IGAC11&subtype=999014";
			</logic:notPresent>
			<logic:present name="ADrolemanager">
			<logic:equal name="ADrolemanager" value="true">
			var url = "IGSYM1203_ENTITY_TREE.do?levelnode=999014";
			</logic:equal>
			</logic:present>
			var temp = window.showModalDialog(url,null,"dialogWidth:400px;dialogHeight:500px;status:no;help:no;resizable:yes");
			if("_resetall"==temp){
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            <html:form styleId="form" action="/IGASM2401"
            ...
            <div id="location">
                ...
                <div id="search">
		             ...
		             <div class="conditions">
                          <div>
			                <label>费用名称：</label><html:text property="einame" styleId="einame" errorStyleClass="inputError imeDisabled" size="10" />&nbsp;&nbsp; 
			                <label>费用摘要：</label><html:text property="eidesc_like" styleId="eidesc_like" errorStyleClass="inputError imeDisabled" size="10" />&nbsp;&nbsp; 
	                        <label>经办人：</label>
                            <html:hidden property="cname[0]" styleId="cname" value="经办人"/>
                            <html:text property="civalue[0]" styleId="civalue" errorStyleClass="inputError imeDisabled" size="10" />
                            <label>收款人：</label>
                            <html:hidden property="cname[1]" styleId="cname" value="收款人"/>
                            <html:text property="civalue[1]" styleId="civalue" errorStyleClass="inputError imeDisabled" size="10" />
	                        <br/>
			       ...
			       <table class="table_style">
			            <!-- header部 -->
			                ...
			                <tr>
					           ...
					           <th width="12%" align="left">费用编号</th>
					           <th width="20%" align="left">费用名称</th>
					           <th width="35%" align="left">费用摘要</th>
                               <th width="7%" >管理人</th>
                               <th width="10%">登记日</th>
					           <th width="7%">详细信息</th>
<!--					           <th width="7%">关系信息</th>-->
...
<!--					           <th width="7%">历史版本</th>-->
			            ...
			            <!-- body部 -->
			                ...
			                <logic:present name="IGASM24011VO" property="entityDataList" >
			                    <logic:iterate id="bean" name="IGASM24011VO" property="entityDataList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                            ...
			                            <td align="left">
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM2412_Disp.do?eiid=${bean.eiid}">${bean.eilabel}</html:link>
			                                </div>
			                            </td>
			                            <!-- 名称 -->
			                            <td align="left">
			                            ...
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGASM2404_Disp.do?eiid=${bean.eiid}"><img src="images/xx.gif" alt="显示详细信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
<!--			                             关系信息 -->
<!--			                            <td>-->
<!--			                                <div class="nowrapDiv">-->
<!--                                                <html:link action="/IGASM2406_Disp.do?eiid=${bean.eiid}"><img src="images/record_(copy)_16x16.gif" alt="关系信息" width="16" height="16"  border="0"/></html:link>-->
<!--			                                </div>-->
<!--			                            </td>-->
<!--			                              关系图 -->
<!--			                            <td>-->
...
<!--			                            <td>-->
<!--			                                <div class="nowrapDiv">-->
<!--                                                <html:link action="/IGASM2405_Disp.do?eiid=${bean.eiid}&civersion="><img src="images/notepad_16x16.gif" alt="历史版本" width="16" height="16"  border="0"/></html:link>-->
<!--			                                </div>-->
<!--			                            </td>-->
			                        </tr>
			                    </logic:iterate>
                ...
                <html:hidden property="ecategory" styleId="ecategory" value="${IGASM2401Form.ecategory}"/>
            </html:form>
        </div>
    </div>
