...
<html:html>
<bean:define id="id" value="IGASM1302" toScope="request" />
...
function checkForm(){
	...
	if(!checkDate("ciupdtime_from","ciupdtime_to")){
		...
		document.forms[0].action = getAppRootUrl() + "/IGASM1302.do";
...
function exportExcel() {
	if(!checkDate("ciupdtime_from","ciupdtime_to")){
		...
		document.forms[0].action = getAppRootUrl() + "/IGASM1302.do?report1=1";
		document.forms[0].submit();
	}
}
...
<p class="fonts1"><ig:navigation extname1="${urlable}"/></p>
	...
	<div id="search">
<html:form styleId="form" action="/IGASM1302"
