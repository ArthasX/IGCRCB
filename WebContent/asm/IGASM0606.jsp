...
<html:html>
<bean:define id="id" value="IGASM0606" toScope="request"/>
<bean:define id="title" value="软件关系管理详细画面" toScope="request"/>
...
<!-- /header1 -->
    ...
    var gid='IGASM0606';
	    function deleteRec(){
	        ...
	        var confirmMsg ='<bean:message key="IGCO10000.W002" arg0="软件关系信息" />';
	        ...
	        if( window.confirm(confirmMsg)){
	            form.action = getAppRootUrl() + "/IGASM0606_Del.do";
	            return true;
	        } else {
	            return false;
	        }
	    ...
	    function toback(){
	        form.action = getAppRootUrl() + "/IGASM0606.do?btn_back=1";
	        form.submit();
	    }
	</script>
	<link rel="stylesheet"
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            ...
            <html:form styleId="form"  action="/IGASM0606" onsubmit="return checkSubmit(this);">
                <div class="title">
                ...
                <div id="results_list">
                    <table class="table_style">
                        ...
                        <tr>
                          <td align="center">
                            ${IGASM06061VO.entityData.ename}
                          </td>
                          <td align="center">${IGASM06061VO.entityData.eilabel}</td>
                          <td align="center">${IGASM06061VO.entityData.einame}</td>
                          <td>${IGASM06061VO.eiorgname}</td>
					 	  <td>${IGASM06061VO.entityData.eidesc}</td>
                          <td align="center">${IGASM06061VO.entityData.eiusername}</td>
                          <td align="center">${IGASM06061VO.entityData.eiinsdate}</td>
                          <td align="center">${IGASM06061VO.entityData.eiupdtime}</td>
                        </tr>
                     </table>
                                ...
                                <div class="title">
                    <div class="name">软件关系信息</div>
                </div>
                <div class="message"><ig:message /></div>
                <logic:present name="IGASM06061VO" property="flag">
<logic:equal value="true" name="IGASM06061VO" property="flag">  
	            <div id="results_list"><logic:present
		name="IGASM06061VO" property="parEntityItemRelationMap">
		<div id="TabbedPanels1" class="TabbedPanels">
		<ul class="TabbedPanelsTabGroup">
			<logic:iterate id="map" name="IGASM06061VO"
...
//-->
	            ...
	            <logic:equal value="true" name="IGASM06061VO" property="flag">
                     ...
                     <logic:present name="IGASM06061VO" property="parEntityItemRelationMap" >
                ...
                <html:hidden property="pareid" styleId="pareid" value="${IGASM06061VO.entityData.eid}"/>
                <html:hidden property="pareiid" styleId="pareiid" value="${IGASM06061VO.entityData.eiid}"/>
                <html:hidden property="pareilabel" styleId="pareilabel" value="${IGASM06061VO.entityData.eilabel}"/>
                <html:hidden property="pareiname" styleId="pareiname" value="${IGASM06061VO.entityData.einame}"/>
                <html:hidden property="parversion" styleId="parversion" value="${IGASM06061VO.entityData.eiversion}" />
				<html:hidden property="parsmallversion" styleId="parsmallversion" value="${IGASM06061VO.entityData.eismallversion}" />
            </html:form>  
		 </div>
     </div>
</div>
