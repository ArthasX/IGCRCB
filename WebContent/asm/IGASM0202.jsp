...
<html:html>
<bean:define id="id" value="IGASM0202" toScope="request"/>
<bean:define id="title" value="配置项基本信息登记画面" toScope="request"/>
	...
	<script type="text/javascript">	
	    ...
	    function checkForm(){
	    	...
	    	if($F('eiinsdate').trim()==""){
	    		...
	    		alert("资产名称不能大于"+Math.floor(120/strByteFlag)+"个汉字！");
	    		return false;
	    	}if($F('eidesc').strlen()>256){
	    		alert("资产说明不能大于"+Math.floor(256/strByteFlag)+"个汉字！");
	    		return false;
	    	}else {
	    		var message = '<bean:message key="IGCO10000.W001" arg0="配置项基本信息" />';
 ...
 <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGASM0202" onsubmit="return checkSubmit(this);">
                      <!--  message -->
                      <ig:message/>
                      <!--  /message -->     
		            <fieldset>
	                    <logic:equal name="IGASM0202Form" property="mode" value="0">
			            <legend>配置项基本信息添加</legend>
			            </logic:equal>
	                    <logic:equal name="IGASM0202Form" property="mode" value="1">
	                    <legend>配置项基本信息变更</legend>
	                    </logic:equal>
