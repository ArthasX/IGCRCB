...
<html:html>
<bean:define id="id" value="IGASM0316" toScope="request"/>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
<html:form styleId="form" action="/IGASM0316"
            ...
            <div id="location">
			                ...
			                <logic:present name="IGASM03011VO" property="entityDataList" >
			                    <logic:iterate id="bean" name="IGASM03011VO" property="entityDataList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                            ...
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGASM0318_Disp.do?eiid=${bean.eiid}"><img src="images/xx.gif" alt="显示详细信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                            <td>
			                            <div align="center">
			                             	<c:choose>
	                                          	<c:when test="${bean.eiversion == 0 && bean.eismallversion == 0}">
	      											<img src="images/nobatch.gif" border="0" width="16" height="16" alt="属性为空不许批量入库" />
												</c:when>
												<c:otherwise>
			                           		 		<a href="IGASM0317_Disp.do?pareiid=${bean.eiid}"><img src="images/batch.gif" border="0" width="16" height="16" alt="批量入库" /></a>
												</c:otherwise>
											</c:choose>
			                             </div>
			                            </td>
                ...
                <html:hidden property="ecategory" styleId="ecategory" value="${IGASM0316Form.ecategory}"/>
            </html:form>
        </div>
    </div>
