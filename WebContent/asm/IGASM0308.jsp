...
<html:html>
<bean:define id="id" value="IGASM0308" toScope="request"/>
<bean:define id="title" value="设备下发查询画面" toScope="request"/>
...
<!-- /header1 -->
	<script type="text/javascript">	
	    ...
	    function issueRec(){
	        ...
	        var confirmMsg ='<bean:message key="IGCO10000.W004" arg0="设备下发" />';
	        var result = "";
	        ...
	        if(result != null && result.trim() != ""){
				if(result > '0') {
					if( window.confirm(confirmMsg)){
			            form.action = getAppRootUrl() + "/IGASM0309_IssueDisp.do?type=I";
			            return true;
			        } else {
			            return false;
			        }
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
    <html:form styleId="form" action="/IGASM0308" onsubmit="return checkSubmit(this);">
            <div id="location">
                <div class="image"></div>
           ...
           <div id="search">
		             ...
		             <div class="conditions">
                          <div>
			               ...
			               <html:hidden property="esyscoding"/>
	                        ...
	                        <img src="images/date.gif" align="middle" onClick="calendar($('eiupdtime_from'))" />
	                        &nbsp;&nbsp;
                            ...
                            <img src="images/date.gif" align="middle" onClick="calendar($('eiupdtime_to'))" />
                ...
                <div id="results_list">
			       ...
			       <table width="100%" class="table_style">
			            ...
			            <!-- body部 -->			  
			                <logic:present name="IGASM03081VO" property="entityDataList" >
			                    <logic:iterate id="bean" name="IGASM03081VO" property="entityDataList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                        
			                        	<td align="center">
			                        	<c:choose>
                                          	<c:when test="${bean.eiversion == 0 && bean.eismallversion == 0}">
											</c:when>
											<c:otherwise>
			                        		 	<html:checkbox property="issueEiid" value="${bean.eiid}" onclick="selectEntityItem(this)"/>
											</c:otherwise>
										</c:choose>
			                            </td>
			                            ...
			                            <td>
                                            ...
                                            <c:choose>
	                                          	<c:when test="${bean.eiversion == 0 && bean.eismallversion == 0}">
		      										<img src="images/noissued.gif" border="0" width="16" height="16" alt="属性为空不许下发" />
												</c:when>
												<c:otherwise>
		      										<a href="IGASM0309_IssueDisp.do?eiid=${bean.eiid}&eiversion=${bean.eiversion}&type=S"><img src="images/issued.gif" border="0" width="16" height="16" alt="下发" /></a>
												</c:otherwise>
											</c:choose>
                                            </div>
			                            </td>
			     ...
			     <div id="operate">
			        	<logic:present name="IGASM03081VO" property="entityDataList" >
                            <html:submit property="btn_issue" value="批量下发" styleClass="button" onclick="return issueRec();" />
                            </logic:present>
		                <!-- paging -->
