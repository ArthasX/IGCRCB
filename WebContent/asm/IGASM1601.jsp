...
<html:html>
<bean:define id="id" value="IGASM1601" toScope="request"/>
<bean:define id="title" value="数据管理画面" toScope="request"/>
...
<!-- /header1 -->
	...
	function deleteRec(){
        ...
        var confirmMsg ='<bean:message key="IGCO10000.W002" arg0="数据基本信息" />';
	...
	function setRoleDomain(){
		...
		var url = "IGSYM0304.do?roletype=IGAC05";
		</logic:notPresent>
	...
	function setEntity(){
    	<logic:notPresent name="ADrolemanager">
		var url = "IGSYM0304_ASSET.do?roletype=IGAC05&subtype=999004";
		</logic:notPresent>
		<logic:present name="ADrolemanager">
		<logic:equal name="ADrolemanager" value="true">
		var url = "IGSYM1203_ENTITY_TREE.do?levelnode=999004";
		</logic:equal>
		</logic:present>
		var temp = window.showModalDialog(url,null,"dialogWidth:400px;dialogHeight:500px;status:no;help:no;resizable:yes");
		if("_resetall"==temp){
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            <html:form styleId="form" action="/IGASM1601"
       ...
       <div id="search">
		             ...
		             <div class="conditions">
                          ...
                          <label><span class="red">*</span>所属机构：</label><html:text property="eiorgname" readonly="true"></html:text>
			                ...
			                <label>数据名称：</label><html:text property="einame" styleId="einame" errorStyleClass="inputError imeDisabled" size="10" />&nbsp;&nbsp; 
                ...
                <div id="results_list">
			       ...
			       <table class="table_style">
			            ...
			            <!-- body部 -->
			                ...
			                <logic:present name="IGASM16011VO" property="entityDataList" >
			                    <logic:iterate id="bean" name="IGASM16011VO" property="entityDataList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                            ...
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM1612_Disp.do?eiid=${bean.eiid}">${bean.eilabel}</html:link>
			                                </div>
			                            </td>
			                            <!-- 名称 -->
			                            <td>
			                            ...
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGASM1604_Disp.do?eiid=${bean.eiid}"><img src="images/xx.gif" alt="显示详细信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                            <!-- 关系信息 -->
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM1606_Disp.do?eiid=${bean.eiid}"><img src="images/record_(copy)_16x16.gif" alt="关系信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                             <!-- 关系图 -->
			                            <td>
			                            ...
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM1605_Disp.do?eiid=${bean.eiid}&civersion="><img src="images/notepad_16x16.gif" alt="历史版本" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                        </tr>
			                    </logic:iterate>
                ...
                <html:hidden property="ecategory" styleId="ecategory" value="${IGASM1601Form.ecategory}"/>
            </html:form>
        </div>
    </div>
