...
<html:html>
<bean:define id="id" value="IGASM5012" toScope="request"/>
...
<!-- /header1 -->
	...
	function toback(){
    	...
    	form.action = getAppRootUrl() + "/IGASM5004.do?org.apache.struts.taglib.html.CANCEL=1";
    	form.submit();
    }
	</script>
<body >
