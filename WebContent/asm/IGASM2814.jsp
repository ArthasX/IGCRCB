...
<html:html>
<bean:define id="id" value="IGASM2814" toScope="request" />
...
function checkitem(eid,version){
	window.location.href="IGASM2804_Disp.do?eiid="+eid+"&eiversion="+version+"&looksign=0";
}

function onExcel(){
	form.action = "IGASM2814_Excel.do";
	form.submit();
}
function onSearch(){
	form.action = "IGASM2814.do";
	form.submit();
}
</script>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
          <html:form styleId="form" action="/IGASM2814" onsubmit="return checkSubmit(this);">
            <div id="location">
                <div class="image"></div>
                    <p class="fonts1">风险管理 &gt;&gt; 检查项管理 &gt;&gt; 检查项查询</p>
            </div>
            <div id="search">
                   <div class="img"></div>
