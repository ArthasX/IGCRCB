...
<html:html>
<bean:define id="id" value="IGASM0211" toScope="request" />
<bean:define id="title" value="配置项配置信息画面" toScope="request" />
...
<html:form styleId="form" action="/IGASM0211_Disp"
	...
	<table class="table_style">
		...
		<tr>
			<td>${IGASM02041VO.entityData.ename}</td>
			<td>${IGASM02041VO.entityData.eilabel}</td>
			<td>${IGASM02041VO.entityData.einame}</td>
			<td>${IGASM02041VO.entityData.organizationTB.orgname}</td>
			<td>${IGASM02041VO.entityData.eidesc}</td>
			<td>${IGASM02041VO.entityData.eiusername}</td>
			<td>${IGASM02041VO.entityData.eiinsdate}</td>
...
//-->
	...
	<html:hidden property="eiid" styleId="eiid"
		value="${IGASM0204Form.eiid}" />
	<html:hidden property="eiversion" styleId="eiversion"
		value="${IGASM02041VO.entityData.eiversion}" />
	<html:hidden property="eid" styleId="eid"
		value="${IGASM02041VO.entityData.eid}" />
</html:form></div>
