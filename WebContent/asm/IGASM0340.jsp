...
<html:html>
<bean:define id="id" value="IGASM0340" toScope="request"/>
<bean:define id="title" value="维保查询画面" toScope="request"/>
             ...
             <div id="search">
		             ...
		             <div>
			               ...
			               <label>所属模型：</label><html:text property="ename" styleId="ename"  errorStyleClass="inputError imeDisabled" size="15" readonly="true"/>
			                 <img src="images/tree.gif" style="cursor: hand;" alt="资产类型" width="16" height="16" border="0" onclick="setEntity('IGSYM1201_ENTITY_TREE.do?type=0&levelnode=');"/>
	                       ...
	                       <br>
		         			<label>维保到期日：从</label><html:text property="wbdate_from" styleId="eiupdtime_from" errorStyleClass="inputError imeDisabled" size="12" readonly="true"/> 
	                        <img src="images/date.gif" align="middle" onClick="calendar($('eiupdtime_from'))" border="0"/>
	                        &nbsp;&nbsp;
	                        <label>到</label><html:text property="wbdate_to" styleId="eiupdtime_to" errorStyleClass="inputError imeDisabled" size="12" readonly="true"/> 
                ...
                <div id="results_list">
			       ...
			       <table  class="table_style">
			            ...
			            <!-- body部 -->
			                <logic:present name="IGASM10011VO" property="entityDataList" >
			                    <logic:iterate id="bean" name="IGASM10011VO" property="entityDataList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                          ...
			                          <!-- 登记日 -->
			                            ...
			                            <td>
                                                ...
                                                <html:link action="/IGASM1004_Disp.do?operType=wb&eiid=${bean.eiid}"><img src="images/xx.gif" alt="显示详细信息" width="16" height="16"  border="0"/></html:link>
			                                
			                            </td>
			                            <!-- 关系信息 -->
			                            <td align="center">
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM1006_Disp.do?operType=wb&eiid=${bean.eiid}"><img src="images/record_(copy)_16x16.gif" alt="关系信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                              <!-- 关系图 -->
<%-- 			                            <td>
			                            ...
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM1005_Disp.do?eiid=${bean.eiid}&civersion="><img src="images/notepad_16x16.gif" alt="历史版本" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                        </tr>
			                    </logic:iterate>
			     ...
			     <html:hidden property="pageType"  value="weibao" />
			     <div id="operate">
			                <!-- paging -->
