...
<html:html>
<bean:define id="id" value="IGASM0809" toScope="request" />
<bean:define id="title" value="应用配置信息查看画面" toScope="request" />
...
<div id="location">
<div class="image"></div>
<p class="fonts1"><ig:navigation extname1="${urlable}"/>&gt;&gt; 应用配置查看</p>
...
<html:form styleId="form" action="/IGASM0804"
	...
	<table class="table_style">
		...
		<tr>
			<td align="center">${IGASM08041VO.entityData.ename}</td>
			<td>${IGASM08041VO.entityData.eilabel}</td>
			<td>${IGASM08041VO.entityData.einame}</td>
			<td>${IGASM08041VO.eiorgname}</td>
			<td>${IGASM08041VO.entityData.eidesc}</td>
			<td>${IGASM08041VO.entityData.eiusername}</td>
			<td>${IGASM08041VO.entityData.eiinsdate}</td>
			...
			<logic:iterate id="map" name="IGASM08041VO"
				...
				<table class="table_style2">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						...
						<bean:define id="cldVersionMap" name="IGASM0804Form" property="cldVersionMap" type="java.util.Map"/>
...
//-->
	...
	<html:hidden property="eiid" styleId="eiid"
		value="${IGASM0804Form.eiid}" />
	<html:hidden property="eiversion" styleId="eiversion"
		value="${IGASM08041VO.entityData.eiversion}" />
</html:form></div>
</div>
</div>
