...
<html:html>
<bean:define id="id" value="IGASM5003" toScope="request"/>
		...
		<div class="msg">
			...
			<html:form styleId="form" action="/IGASM5003" onsubmit="return checkSubmit(this);">
				...
				<html:submit property="btn_add_conf" value="增加配置信息" styleClass="buttonCX2" />
		                    <html:submit property="btn_back" value="返回" styleClass="buttonCX2"/>
			</div>
			  <html:hidden property="eiid" styleId="eiid" value="${IGASM50021VO.entityData.eiid}"/>
