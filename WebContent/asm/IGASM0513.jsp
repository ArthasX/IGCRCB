...
<html:html>
<bean:define id="id" value="IGASM0513" toScope="request"/>
...
<!-- /header1 -->
	...
	function toback(){
    	...
    	form.action = getAppRootUrl() + "/IGASM0504.do?org.apache.struts.taglib.html.CANCEL=1";
    	form.submit();
    }
	</script>
<body >
