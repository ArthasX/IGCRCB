...
<html:html>
<bean:define id="id" value="IGASM0212" toScope="request" />
<bean:define id="title" value="关系详细画面" toScope="request" />
...
<script type="text/javascript">	
    var gid='IGASM0206';
	    function deleteRec(){
	        ...
	        var confirmMsg ='<bean:message key="IGCO10000.W002" arg0="配置项关系信息" />';
	        ...
	        if( window.confirm(confirmMsg)){
	            form.action = getAppRootUrl() + "/IGASM0206_Del.do";
	            return true;
	        } else {
	            return false;
	        }
	    ...
	    function toback(){
	        form.action = getAppRootUrl() + "/IGASM0206.do?btn_back=1";
	        form.submit();
	    }
	</script>
<link rel="stylesheet"
...
<html:form styleId="form"
	action="/IGASM0212_Disp" onsubmit="return checkSubmit(this);">
	<div id="location">
	<div class="image"></div>
	...
	<table class="table_style">
		...
		<tr>
			<td align="center">${IGASM02061VO.entityData.ename}</td>
			<td align="center">${IGASM02061VO.entityData.eilabel}</td>
			<td align="center">${IGASM02061VO.entityData.einame}</td>
			<td>${IGASM02061VO.entityData.organizationTB.orgname}</td>
			<td align="center">${IGASM02061VO.entityData.eidesc}</td>
			<td align="center">${IGASM02061VO.entityData.eiusername}</td>
			<td align="center">${IGASM02061VO.entityData.eiinsdate}</td>
			<td align="center">${IGASM02061VO.entityData.eiupdtime}</td>
		</tr>
	</table>
	</div>
...
//-->
	...
	<div class="enter"><html:submit property="btn_back"
		styleClass="button" value="关闭" onclick="window.close();" /></div>
	<html:hidden property="pareid" styleId="pareid"
		value="${IGASM02061VO.entityData.eid}" />
	<html:hidden property="pareiid" styleId="pareiid"
		value="${IGASM02061VO.entityData.eiid}" />
	<html:hidden property="pareiname" styleId="pareiname"
		value="${IGASM02061VO.entityData.einame}" />
</html:form></div>
