...
<html:html>
<bean:define id="id" value="IGASM0106" toScope="request"/>
...
<script type="text/javascript">	
    ...
    function add(){
        form.action = getAppRootUrl() + "/IGASM0104_Disp.do?route=1";
        form.submit();
    }

    function toback(){
    	form.action = getAppRootUrl() + "/IGASM0106.do?btn_back=1";
    	form.submit();
    }
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            <html:form styleId="form" action="/IGASM0106" onsubmit="return checkSubmit(this);">
           <div id="location">
                <div class="image"></div>
			    ...
			    <div id="results_list">
			        <table width="100%" class="table_style">
			            ...
			            <tr>
			               <td align="center">${IGASM01021VO.entityData.ename}</td>
			               <td align="center">${IGASM01021VO.entityData.edesc}</td>
			               <td align="center">
			                  
			                    <ig:codeValue ccid="ENTITY_STATUS_CODE" cid="${IGASM01021VO.entityData.estatus}"/>                                
						...
						<bean:define id="countMap" name="IGASM01061VO" property="configurationMap" type="java.util.Map" />
			                    ...
			                    <logic:iterate id="bean" name="list" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
										...
										<div align="center">
										<logic:empty name="bean" property="clabel">
										<html:link action="/IGASM0104_Edit_Disp.do?cidStr=${bean.cid}&route=1">
