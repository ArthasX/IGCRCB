...
<html:html>
<bean:define id="id" value="IGASM5006" toScope="request"/>
<bean:define id="title" value="制度关系管理详细画面" toScope="request"/>
...
<!-- /header1 -->
    ...
    var gid='IGASM5006';
	    function deleteRec(){
	        ...
	        var confirmMsg ='<bean:message key="IGCO10000.W002" arg0="制度关系信息" />';
	        ...
	        if( window.confirm(confirmMsg)){
	            form.action = getAppRootUrl() + "/IGASM5006_Del.do";
	            return true;
	        } else {
	            return false;
	        }
	    ...
	    function toback(){
	        form.action = getAppRootUrl() + "/IGASM5006.do?btn_back=1";
	        form.submit();
	    }
	</script>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            ...
            <html:form styleId="form"  action="/IGASM5006" onsubmit="return checkSubmit(this);">
                <div class="title">
                ...
                <div id="results_list">
                    <table class="table_style">
                        ...
                        <tr>
                       		 <td align="center">
                            ${IGASM50061VO.entityData.ename}
                          </td>
                          <td align="center">${IGASM50061VO.entityData.eilabel}</td>
                          <td align="center">${IGASM50061VO.entityData.einame}</td>
                          <td>${IGASM50061VO.eiorgname}</td>
					 	  <td>${IGASM50061VO.entityData.eidesc}</td>
                          <td align="center">${IGASM50061VO.entityData.eiusername}</td>
                          <td align="center">${IGASM50061VO.entityData.eiinsdate}</td>
                          <td align="center"> ${IGASM50061VO.entityData.eiupdtime}</td>
                        </tr>
                     </table>
                </div>
                <div class="title">
                    <div class="name">制度关系信息</div>
                </div>
                <div class="message"><ig:message /></div>
                <logic:present name="IGASM50061VO" property="flag">
				<logic:equal value="true" name="IGASM50061VO" property="flag">  
	            <div id="results_list"> 
	            <logic:present name="IGASM50061VO" property="parEntityItemRelationMap">
				<div id="TabbedPanels1" class="TabbedPanels">
					<ul class="TabbedPanelsTabGroup">
						<logic:iterate id="map" name="IGASM50061VO"
					...
					<logic:present name="IGASM50061VO" property="parEntityItemRelationMap">
					<logic:iterate id="map" name="IGASM50061VO" property="parEntityItemRelationMap" indexId="number">
		...
		<script type="text/javascript">
			...
			//-->
		      ...
		      <div class="enter">
                ...
                <html:hidden property="pareid" styleId="pareid" value="${IGASM50061VO.entityData.eid}"/>
                <html:hidden property="pareiid" styleId="pareiid" value="${IGASM50061VO.entityData.eiid}"/>
                <html:hidden property="pareilabel" styleId="pareilabel" value="${IGASM50061VO.entityData.eilabel}"/>
                <html:hidden property="pareiname" styleId="pareiname" value="${IGASM50061VO.entityData.einame}"/>
                <html:hidden property="parversion" styleId="parversion" value="${IGASM50061VO.entityData.eiversion}" />
				<html:hidden property="parsmallversion" styleId="parsmallversion" value="${IGASM50061VO.entityData.eismallversion}" />
            </html:form>  
		 </div>
     </div>
</div>
