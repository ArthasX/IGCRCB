...
<html:html>
<bean:define id="id" value="IGASM0105" toScope="request"/>
...
<div class="msg">
			...
			<div class="msg_box">
			<html:form styleId="form" action="/IGASM0105" onsubmit="return checkSubmit(this);">
				<div class="msg_img"><img src="images/Round_Icon_09.gif" border="0" /></div>
				<div class="msgcontent"><ig:message/>
				<html:submit property="btn_add_conf" value="继续增加配置信息" styleClass="buttonCX2"/>
		          <html:submit property="btn_next" value="显示配置详细" styleClass="buttonCX2"/>
			</div>
