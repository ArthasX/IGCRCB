...
<html:html>
<bean:define id="id" value="IGASM0306" toScope="request" />
...
<script type="text/javascript">	
    var gid='IGASM0306';
	    function deleteRec(){
	        ...
	        var confirmMsg ='<bean:message key="IGCO10000.W002" arg0="设备关系信息" />';
	        ...
	        if( window.confirm(confirmMsg)){
	            form.action = getAppRootUrl() + "/IGASM0306_Del.do";
	            return true;
	        } else {
	            return false;
	        }
	    ...
	    function toback(){
	        form.action = getAppRootUrl() + "/IGASM0306.do?btn_back=1";
	        form.submit();
	    }
	</script>
<link rel="stylesheet"
...
<logic:present name="IGASM03061VO" property="flag">
<logic:equal value="true" name="IGASM03061VO" property="flag">  
	<div id="results_list"><logic:present
		name="IGASM03061VO" property="parEntityItemRelationMap">
				...
				<table class="table_style2">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						...
						<tr onmouseover="mouseOverNoHand(this);" onmouseout="mouseOutNoHand(this);">
						 	...
						 	<logic:notEqual name="category" value="007">
						 	<logic:notEqual name="category" value="008">
...
//-->
	...
	<html:submit property="btn_delete" styleClass="button" value="删除所选"
