...
<html:html>
<bean:define id="id" value="IGASM0911" toScope="request" />
...
<html:form styleId="form" action="/IGASM0906"
...
//-->
	...
	<html:hidden property="pareid" styleId="pareid"
		value="${IGASM09061VO.entityData.eid}" />
	<html:hidden property="pareiid" styleId="pareiid"
		value="${IGASM09061VO.entityData.eiid}" />
	<html:hidden property="pareiname" styleId="pareiname"
		value="${IGASM09061VO.entityData.einame}" />
</html:form></div>
</div>
</div>
