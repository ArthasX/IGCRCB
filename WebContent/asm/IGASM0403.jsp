...
<html:html>
<bean:define id="id" value="IGASM0403" toScope="request"/>
...
<div class="msg">
			...
			<div class="msg_box">
			 <html:form styleId="form" action="/IGASM0403" onsubmit="return checkSubmit(this);">
			...
			<html:hidden property="eiid" styleId="eiid" value="${IGASM04021VO.entityData.eiid}"/>
