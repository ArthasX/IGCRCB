...
<html:html>
<bean:define id="id" value="IGASM1907" toScope="request"/>
<logic:equal name="IGASM1907Form" property="mode" value="0">
<bean:define id="title" value="外包人员关系登记画面" toScope="request"/>
</logic:equal>
<logic:equal name="IGASM1907Form" property="mode" value="1">
<bean:define id="title" value="外包人员关系编辑画面" toScope="request"/>
</logic:equal>
...
<!-- /header1 -->
	<script type="text/javascript">	
        ...
        function selectEntityItem(){
			 ...
			 openSubIGCOM0302PARAM("?ecategory="+getRelationEcategory($F('eirrelationcode').trim(),"016"));
        }
        ...
        function toback(){
            form.action = getAppRootUrl() + "/IGASM1907.do?org.apache.struts.taglib.html.CANCEL=1";
            form.submit();
        }
 ...
 <!--content  右侧内容-->
   <div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGASM1907" onsubmit="return checkSubmit(this);">
                    <!--  message -->
                    <ig:message/>
                    <!--  /message -->     
		            <fieldset>
	                    <logic:equal name="IGASM1907Form" property="mode" value="0">
			            <legend>外包人员关系信息添加</legend>
			            </logic:equal>
	                    <logic:equal name="IGASM1907Form" property="mode" value="1">
	                    <legend>外包人员关系信息变更</legend>
	                    </logic:equal>
	                    <div>
                            <label for="Name"><strong>外包人员编号</strong>：</label>
                        ...
                        <div>
                            <label for="Name"><strong>外包人员姓名</strong>：</label>
