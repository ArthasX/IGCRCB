...
<html:html>
<bean:define id="id" value="IGASM0318" toScope="request" />
...
var gid='IGASM0318';
        function toback(){
        	form.action = getAppRootUrl() + "/IGASM0316_Back.do";
        	form.submit();
        }
	</script>
<link rel="stylesheet"
...
<html:form styleId="form" action="/IGASM0304"
	...
	<table class="table_style">
		...
		<tr>
			<td>${IGASM03041VO.entityData.ename}</td>
			...
			<logic:iterate id="map" name="IGASM03041VO"
				...
				<table class="table_style2">
					<tr>
						...
						<th width="36%" align="left">配置项内容</th>
