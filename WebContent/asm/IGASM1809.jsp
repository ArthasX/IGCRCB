...
<html:html>
<bean:define id="id" value="IGASM1809" toScope="request" />
<bean:define id="title" value="系统配置信息查看画面" toScope="request" />
...
<div id="location">
<div class="image"></div>
<p class="fonts1"><ig:navigation extname1="${urlable}"/>&gt;&gt; 系统配置查看</p>
<div class="back"><html:link href="javascript:toback();">返回</html:link></div>
</div>

<html:form styleId="form" action="/IGASM1804"
	...
	<table class="table_style">
		...
		<tr>
			<td align="center">${IGASM18041VO.entityData.ename}</td>
			<td>${IGASM18041VO.entityData.eilabel}</td>
			<td>${IGASM18041VO.entityData.einame}</td>
			<td>${IGASM18041VO.eiorgname}</td>
			<td>${IGASM18041VO.entityData.eidesc}</td>
			<td>${IGASM18041VO.entityData.eiusername}</td>
			<td>${IGASM18041VO.entityData.eiinsdate}</td>
			...
			<logic:iterate id="map" name="IGASM18041VO"
				...
				<table class="table_style2">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						...
						<bean:define id="cldVersionMap" name="IGASM1804Form" property="cldVersionMap" type="java.util.Map"/>
...
//-->
	...
	<html:hidden property="eiid" styleId="eiid"
		value="${IGASM1804Form.eiid}" />
	<html:hidden property="eiversion" styleId="eiversion"
		value="${IGASM18041VO.entityData.eiversion}" />
</html:form></div>
</div>
</div>
