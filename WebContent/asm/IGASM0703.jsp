...
<html:html>
<bean:define id="id" value="IGASM0703" toScope="request"/>
...
<div class="msg">
			...
			<div class="msg_box">
			<html:form styleId="form" action="/IGASM0703" onsubmit="return checkSubmit(this);">
			  ...
			  <html:hidden property="eiid" styleId="eiid" value="${IGASM07021VO.entityData.eiid}"/>
