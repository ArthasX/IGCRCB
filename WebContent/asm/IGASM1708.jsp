...
<html:html>
<bean:define id="id" value="IGASM1708" toScope="request"/>
<bean:define id="title" value="组件查询画面" toScope="request"/>
...
<!-- /header1 -->
	...
	function deleteRec(){
        ...
        if( window.confirm(confirmMsg)){
            form.action = getAppRootUrl() + "/IGASM1601_Del.do";
            return true;
        } else {
            return false;
        }
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            <html:form styleId="form" action="/IGASM1708"
                ...
                <div id="search">
		             ...
		             <div class="conditions">
                          ...
                          <!--<label><span class="red">*</span>所属机构:</label>
								...
								<img src="images/tree.gif" style="cursor: hand;" alt="选择管理范围" width="17" height="16" border="0" onclick="setRoleDomain('IGSYM0304.do');"/>
			                ...
			                <label>所属模型：</label><html:text property="ename" styleId="ename"  errorStyleClass="inputError imeDisabled" size="15" readonly="true"/>
			                 <img src="images/tree.gif" style="cursor: hand;" alt="资产模型" width="16" height="16" border="0" onclick="setEntity('IGSYM1201_ENTITY_TREE.do?levelnode=999012');"/>
			                ...
			                <logic:present name="IGASM17011VO" property="entityDataList" >
			                    <logic:iterate id="bean" name="IGASM17011VO" property="entityDataList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                            ...
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGASM1709_Disp.do?eiid=${bean.eiid}"><img src="images/xx.gif" alt="显示详细信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                            <!-- 关系信息 -->
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM1711_Disp.do?eiid=${bean.eiid}"><img src="images/record_(copy)_16x16.gif" alt="关系信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                             <!-- 关系图 -->
			                             <!-- 
			                            ...
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGASM1710_Disp.do?eiid=${bean.eiid}&civersion="><img src="images/notepad_16x16.gif" alt="历史版本" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                        </tr>
			                    </logic:iterate>
