...
<html:html>
<bean:define id="id" value="IGASM5009" toScope="request" />
<bean:define id="title" value="制度配置信息查看画面" toScope="request" />
...
var gid='IGASM5009';
function toback(){
	form.action = getAppRootUrl() + "/IGASM5013_Back.do";
	form.submit();
}
		...
		<div id="container">
			...
			<div id="contentWrap">
				<div id="content">
					<div id="location">
						<div class="image"></div>
						<p class="fonts1"><ig:navigation extname1="${urlable}"/>&gt;&gt; 制度配置查看</p>
					...
					<html:form styleId="form" action="/IGASM5004" enctype="multipart/form-data" onsubmit="return checkSubmit(this);">
						...
						<div id="results_list">
							<table class="table_style">
								...
								<tr>
									<td>${IGASM50041VO.entityData.einame}</td>
									<td>${IGASM50041VO.eiorgname}</td>
									<td>${IGASM50041VO.entityData.eidesc}</td>
									<td>${IGASM50041VO.entityData.eiusername}</td>
									<td>${IGASM50041VO.entityData.eiinsdate}</td>
								...
								<logic:iterate id="map" name="IGASM50041VO" property="configItemVWInfoMap" indexId="number">
									...
									<table class="table_style2" id = "tab1">
										...
										<logic:iterate id="bean" name="list" indexId="index">
											...
											<bean:define id="cldVersionMap" name="IGASM5004Form" property="cldVersionMap" type="java.util.Map"/>
						...
						<html:hidden property="isModify" styleId="isModify" value="${IGASM5004Form.isModify}" />
				</html:form>
			</div>
		</div>
	</div>
