...
<html:html>
<bean:define id="id" value="IGASM0206" toScope="request"/>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            ...
            <html:form styleId="form"  action="/IGASM0206" onsubmit="return checkSubmit(this);">
                <div class="title">
	            ...
	            <div id="results_list"><!--  message --> <ig:message /> <logic:present
...
//-->
	            ...
	            <div class="enter">
                     ...
                     <logic:present name="IGASM02061VO" property="parEntityItemRelationMap" >
                ...
                <html:hidden property="pareilabel" styleId="pareilabel" value="${IGASM02061VO.entityData.eilabel}"/>
