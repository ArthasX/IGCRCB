...
<html:html>
<bean:define id="id" value="IGASM2406" toScope="request"/>
...
<!-- /header1 -->
    ...
    var gid='IGASM2406';
	    ...
	    function toback(){
	        form.action = getAppRootUrl() + "/IGASM2406.do?btn_back=1";
	        form.submit();
	    }
	</script>
	<link rel="stylesheet"
...
//-->
	            ...
	            <logic:equal value="true" name="IGASM24061VO" property="flag">
                     ...
                     <logic:present name="IGASM24061VO" property="parEntityItemRelationMap" >
                ...
                <html:hidden property="pareilabel" styleId="pareilabel" value="${IGASM24061VO.entityData.eilabel}"/>
                <html:hidden property="pareiname" styleId="pareiname" value="${IGASM24061VO.entityData.einame}"/>
                <html:hidden property="parversion" styleId="parversion" value="${IGASM24061VO.entityData.eiversion}" />
				<html:hidden property="parsmallversion" styleId="parsmallversion" value="${IGASM24061VO.entityData.eismallversion}" />
            </html:form>  
		 </div>
     </div>
</div>
