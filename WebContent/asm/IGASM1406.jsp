...
<html:html>
<bean:define id="id" value="IGASM1406" toScope="request"/>
<bean:define id="title" value="服务记录关系管理详细画面" toScope="request"/>
...
<!-- /header1 -->
    ...
    var gid='IGASM1406';
	    function deleteRec(){
	        ...
	        var confirmMsg ='<bean:message key="IGCO10000.W002" arg0="服务记录关系信息" />';
	        ...
	        if( window.confirm(confirmMsg)){
	            form.action = getAppRootUrl() + "/IGASM1406_Del.do";
	            return true;
	        } else {
	            return false;
	        }
	    ...
	    function toback(){
	        form.action = getAppRootUrl() + "/IGASM1406.do?btn_back=1";
	        form.submit();
	    }
	</script>
	<link rel="stylesheet"
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            ...
            <html:form styleId="form"  action="/IGASM1406" onsubmit="return checkSubmit(this);">
                <div class="title">
			...
			<th width="15%">更新时间</th>
                     ...
                     <tr>
                       <td align="center">${IGASM14061VO.entityData.ename}</td>
                       <td align="center">${IGASM14061VO.entityData.eilabel}</td>
                       <td align="center">${IGASM14061VO.entityData.einame}</td>
                       <td align="center">
                           <label>
                                ${IGASM14061VO.entityData.eidesc}
                           </label>
                      </td>
                      <td align="center">${IGASM14061VO.entityData.eiusername}</td>
                      <td align="center">${IGASM14061VO.entityData.eiinsdate}</td>
                       <td align="center">${IGASM14061VO.entityData.eiupdtime}</td>
                     </tr>
                  </table>
                </div>
                    
                                <div class="title">
                    <div class="name">服务记录关系信息</div>
                </div>
                <div class="message"><ig:message /></div>
                <logic:present name="IGASM14061VO" property="flag">
<logic:equal value="true" name="IGASM14061VO" property="flag">  
	            <div id="results_list"><logic:present
		name="IGASM14061VO" property="parEntityItemRelationMap">
		<div id="TabbedPanels1" class="TabbedPanels">
		<ul class="TabbedPanelsTabGroup">
			<logic:iterate id="map" name="IGASM14061VO"
...
//-->
                ...
                <html:hidden property="pareid" styleId="pareid" value="${IGASM14061VO.entityData.eid}"/>
                <html:hidden property="pareiid" styleId="pareiid" value="${IGASM14061VO.entityData.eiid}"/>
                <html:hidden property="pareilabel" styleId="pareilabel" value="${IGASM14061VO.entityData.eilabel}"/>
                <html:hidden property="pareiname" styleId="pareiname" value="${IGASM14061VO.entityData.einame}"/>
                 <html:hidden property="parversion" styleId="parversion" value="${IGASM14061VO.entityData.eiversion}" />
				<html:hidden property="parsmallversion" styleId="parsmallversion" value="${IGASM14061VO.entityData.eismallversion}" />
            </html:form>  
		 </div>
     </div>
</div>
