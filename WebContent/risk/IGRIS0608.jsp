...
<html:html>
<bean:define id="id" value="IGRIS0608" toScope="request"/>
...
<!-- /header1 -->
	...
	function deleteRec(){
        ...
        if( window.confirm(confirmMsg)){
            form.action = getAppRootUrl() + "/IGRIS0601_Del.do";
            return true;
        } else {
            return false;
        }
	...
	function setRoleDomain(){
		...
		var url = "IGSYM0304.do?roletype=IGBP19";
		</logic:notPresent>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            <html:form styleId="form" action="/IGRIS0608"
           ...
           <div id="search">
                ...
                <div id="results_list">
			       ...
			       <table class="table_style">
			            ...
			            <!-- body部 -->
			                ...
			                <logic:present name="IGRIS06011VO" property="entityDataList" >
			                    <logic:iterate id="bean" name="IGRIS06011VO" property="entityDataList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                            ...
			                            <td>
			                                <div align="center">
                                                <html:link action="/IGRIS0609_Disp.do?eiid=${bean.eiid}"><img src="images/xx.gif" alt="显示详细信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                            <!-- 关系信息 -->
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGRIS0611_Disp.do?eiid=${bean.eiid}"><img src="images/record_(copy)_16x16.gif" alt="关系信息" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                             <!-- 关系图 -->
			                             <!-- 
			                            ...
			                            <td>
			                                <div class="nowrapDiv">
                                                <html:link action="/IGRIS0610_Disp.do?eiid=${bean.eiid}&civersion="><img src="images/notepad_16x16.gif" alt="历史版本" width="16" height="16"  border="0"/></html:link>
			                                </div>
			                            </td>
			                        </tr>
			                    </logic:iterate>
                ...
                <html:hidden property="ecategory" styleId="ecategory" value="${IGRIS0601Form.ecategory}"/>
            </html:form>
        </div>
    </div>
