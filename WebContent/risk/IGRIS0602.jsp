...
<html:html>
<bean:define id="id" value="IGRIS0602" toScope="request" />
...
<script type="text/javascript">
	...
	function initDate(){
		...
		//改变登记日期位置
		//var dengjidateTr = jQuery("#dengjidate").parent().parent();
		//var flagTr = jQuery("#flag");
		//dengjidateTr.insertBefore(flagTr);//将A元素调换到B元素后面；
	}
										...
										<logic:iterate id="bean" name="IGRIS06071VO"
											...
											<c:if test="${bean.cattach =='0' && bean.cname=='检查项名称'}">
												<tr id="checkName">
													...
													<td align="left"  ><html:text styleClass="input"
