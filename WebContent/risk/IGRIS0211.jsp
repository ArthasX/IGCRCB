...
<html:html>
<bean:define id="id" value="IGRIS0211" toScope="request" />
...
<!--
	...
	function readInfo(cwrid){
		...
		form.action="IGRIS0203_sel.do?cwrid="+cwrid;
		form.submit();
...
<div id="contentWrap">
<div id="content">
<html:form styleId="form" action="/IGRIS0205" onsubmit="return checkSubmit(this);" >
<div id="location">
<div class="image"></div>
