...
<bean:define id="id" value="IGRIS0303" toScope="request" />
...
<html:form action="/IGPRR0102" styleId="form" onsubmit="return checkSubmit(this);" enctype="multipart/form-data">
	...
	<logic:present name="IGPRR01021VO" property="processInfoDefmap">
		...
		<table cellspacing="2" class="table_style1">
			...
			<tr>
				<th><label for="Name"><strong>检查工作：</strong></label></th>
				<td colspan="3">
					<SCRIPT>
						var jq = jQuery.noConflict();
						jq(getFormObj("检查工作")).parent().parent().hide();
						if(getFormObj("检查工作").value!=''){
							var rcname = (getFormObj("检查工作").value).split("#")[1];
							var rcid = (getFormObj("检查工作").value).split("#")[0];
