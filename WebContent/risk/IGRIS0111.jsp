...
<html:html>
<bean:define id="id" value="IGRIS0111" toScope="request"/>
...
<div id="container">
 ...
 <div class="msg">
			...
			<div class="msg_box">
			 <html:form styleId="form" action="/IGRIS0111" onsubmit="return checkSubmit(this);">
				...
				<html:submit property="btn_add" value="继续增加" styleClass="button"/>
		         <html:submit property="btn_search" value="审计管理" styleClass="button"/>
			</div>
			</html:form>
			</div>
		 </div>
