...
<html:html>
<bean:define id="id" value="IGRIS0615" toScope="request"/>
	...
	<script type="text/javascript">	
        ...
        function toback(){
        	 ...
        	 if(looksign=="1"){
        		 ...
        		 form.action = getAppRootUrl() + "/IGRIS0614.do";      		 
        	 }
        	form.submit();
        }
        var num = 0;
        ...
        function selectVersion(){
		      ...
		      window.location.href="IGRIS0604_Disp.do?eiid="+eiid+"&eiversion="+a;
        }
	    function searchuser(){	
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
		    ...
		    <html:form styleId="form" action="/IGRIS0604" enctype="multipart/form-data" onsubmit="return checkSubmit(this);">
                 <div class="title">
                 ...
                 <div id="results_list">
                  <table class="table_style"  >
						<!-- header部 -->
						 ...
						 <logic:present name="IGRIS06041VO" property="itemList" >
		               <logic:iterate id="bean" name="IGRIS06041VO" property="itemList" indexId="index">
		...
		<ul class="TabbedPanelsTabGroup">
			<logic:iterate id="map" name="IGRIS06041VO"
				...
				<li class="TabbedPanelsTab" tabindex="0"><ig:codeValue
					...
					<option value="">版本选择&nbsp&nbsp当前版本${IGRIS0604Form.selecteiversion}.0 </option>
					 <logic:present name="IGRIS06041VO" property="checkVersionMap" >
					<%-- <html:optionsCollection name="IGASM27041VO" property="checkVersionMap" label="${versionMap.value}" value="${versionMap.value}"/> --%>
		               <logic:iterate id="versionMap" name="IGRIS06041VO" property="checkVersionMap" indexId="index">
				...
				<table class="table_style2">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						<tr onmouseover="mouseOverNoHand(this);" onmouseout="mouseOutNoHand(this);" <logic:equal name="bean" property="cseq" value="1">style="display: none;"</logic:equal>>
							...
							<logic:equal name="bean" property="cattach" value="5">
								<logic:present name="IGRIS0604Form" property="civalue[${ADcount}]">
									<bean:define id="civalue" name="IGRIS0604Form" property="civalue[${ADcount}]" type="java.lang.String" />
								...
								<logic:notPresent name="IGRIS0604Form" property="civalue[${ADcount}]">
									<logic:iterate id="checkboxbean" name="ADlist${ADmapcount}">
			...
			<div class="TabbedPanelsContent">
				...
				<table class="table_style2">
					<tr>
					  ...
					  <logic:present name="IGRIS06041VO" property="checkToRiskRelateList" >
	               <logic:iterate id="bean" name="IGRIS06041VO" property="checkToRiskRelateList" indexId="index">
						<tr>
							<td>${bean.eilabel }</td>
							<td>${bean.einame }</td>
							<td>${bean.eidesc }</td>
			...
			<div class="TabbedPanelsContent">
				...
				<table class="table_style2">
					<tr>
						...
						<th width="10%" align="center">阀值</th>
						<th width="20%" align="center">是否关键指标</th>
					</tr>
					<logic:present name="IGRIS06041VO" property="riskToZhRelateList" >
	               <logic:iterate id="bean" name="IGRIS06041VO" property="riskToZhRelateList" indexId="index">
						<tr>
							<td>${bean.eilabel }</td>
							<td>${bean.einame }</td>
							<td>${bean.eidesc }</td>
    ...
    <%-- <html:cancel styleClass="button" value="返回"/> --%>
     <html:hidden property="selecteiversion"    styleId="selecteiversion" value="${IGRIS0604Form.selecteiversion}"/>
    </div>
	</html:form>
		</div>
    </div>
