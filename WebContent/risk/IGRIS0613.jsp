...
<html:html>
<bean:define id="id" value="IGRIS0613" toScope="request"/>
...
<!-- /header1 -->
	...
	function toback(){
    	...
    	form.action = getAppRootUrl() + "/IGRIS0604.do?org.apache.struts.taglib.html.CANCEL=1";
    	form.submit();
    }
	</script>
<body >
