...
%>
<html:html>
<bean:define id="id" value="IGRIS0204" toScope="request" />
					...
					<div class="record_list">
						...
						<table cellspacing="2" class="table_style1">
							<tr>
								...
								<th width="15%" align="right">检查项类型：</th>
								<td width="35%"><ig:codeValue ccid="RISKCHECK_CLASS_CODE" cid="${bean.rcclass}" /></td>
							</tr>
							<tr>
							...
							<tr>
								<th width="15%" align="right">策略开始时间：</th>
								<td width="35%">${bean.rcstartdate}</td>
								<th align="right">策略结束时间：</th>
