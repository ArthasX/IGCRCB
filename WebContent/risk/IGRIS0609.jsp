...
<html:html>
<bean:define id="id" value="IGRIS0609" toScope="request" />
...
<html:form styleId="form" action="/IGRIS0604"
	...
	<table class="table_style">
		...
		<tr>
			<td align="center">${IGRIS06041VO.entityData.ename}</td>
			<td>${IGRIS06041VO.entityData.eilabel}</td>
			<td>${IGRIS06041VO.entityData.einame}</td>
			<td>${IGRIS06041VO.eiorgname}</td>
			<td>${IGRIS06041VO.entityData.eidesc}</td>
			<td>${IGRIS06041VO.entityData.eiusername}</td>
			<td>${IGRIS06041VO.entityData.eiinsdate}</td>
			...
			<logic:iterate id="map" name="IGRIS06041VO"
				...
				<table class="table_style2">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						...
						<bean:define id="cldVersionMap" name="IGRIS0604Form" property="cldVersionMap" type="java.util.Map"/>
...
//-->
	...
	<html:hidden property="eiid" styleId="eiid"
		value="${IGRIS0604Form.eiid}" />
	<html:hidden property="eiversion" styleId="eiversion"
		value="${IGRIS06041VO.entityData.eiversion}" />
</html:form></div>
</div>
</div>
