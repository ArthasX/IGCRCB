...
<html:html>
<bean:define id="id" value="IGRIS0107" toScope="request" />
<bean:define id="title" value="审计项列表" toScope="request" />
<bean:define id="treemap" name="IGRIS01051VO" property="treeNodeMap" type="java.util.Map" />
...
<%!
	ArrayList<String> treeIdCounter=new ArrayList<String>();//审计项id信息读取位置计数器
	ArrayList<String> treeNameCounter=new ArrayList<String>();//审计项name信息读取位置计数器
