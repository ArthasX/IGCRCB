...
<html:html>
<bean:define id="id" value="IGRIS0607" toScope="request"/>
<logic:equal name="IGRIS0607Form" property="mode" value="0">
<bean:define id="title" value="文档关系登记画面" toScope="request"/>
</logic:equal>
<logic:equal name="IGRIS0607Form" property="mode" value="1">
...
<!-- /header1 -->
	<script type="text/javascript">	
        ...
        function toback(){
            form.action = getAppRootUrl() + "/IGRIS0607.do?org.apache.struts.taglib.html.CANCEL=1";
            form.submit();
        }
 ...
 <!--content  右侧内容-->
    <div id="contentWrap">
        <div id="content">
		    ...
		    <div id="formwrapper">
		         <html:form styleId="form" action="/IGRIS0607" onsubmit="return checkSubmit(this);">
                    <!--  message -->
                    <ig:message/>
                    <!--  /message -->     
		            <fieldset>
