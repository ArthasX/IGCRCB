...
function goPageSDL(){
	...
	var date = $("date").value;
	form.action="IGMTP0103_Disp.do?date=" + date;
	form.submit();
}
</script>
<bean:define id="id" value="IGSDL0115" toScope="request" />
...
<div id="contentWrap">
<div id="content">
<html:form action="/IGSDL0112" styleId="form">
<div id="location">
<div class="image"></div>
...
<div class="conditions">
	<div>
	<span>日期：</span><html:text property="date" styleId="date" errorStyleClass="inputError imeDisabled" size="16" readonly="true"/>
	<img src="images/date.gif" align="middle" onclick="calendar($('date'))" border="0" style="cursor: hand" />
	...
	<logic:present name="IGSDL01101VO" property="quartzJobsDetailList">
		<logic:iterate id="bean" name="IGSDL01101VO" property="quartzJobsDetailList"
			...
			<tr class="<ig:rowcss index="${index}"/>">
				...
				<td><a href="IGSDL0111_List.do?qjid=<bean:write name="bean" property="qjid" />&qjtype=<bean:write name="bean" property="qjtype" />&backUrl=IGSDL0112"><img
				...
				<logic:equal name="bean" property="qjcrtuser" value="${user.userid}">
					<%
	      	 	    ...
	      	 	    %>
	      	 		<a href="IGMTP0105_Modify.do?qjid=<bean:write name="bean" property="qjid" />">
				...
				<td>
					...
					%>
						...
						<a href="IGSDL0111_Del.do?qjid=<bean:write name="bean" property="qjid"/>" onclick="return checkForm();"> 
...
<script>
	var dateStr = '${date }';
	jQuery(function(){
		dateStr&&(jQuery("#date").val(dateStr));
	})
