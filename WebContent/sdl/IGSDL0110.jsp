...
<div id="contentWrap">
<div id="content">
<html:form action="/IGSDL0110" styleId="form">
<div id="location">
<div class="image"></div>
	...
	<logic:present name="IGSDL01101VO" property="quartzJobsDetailList">
		<logic:iterate id="bean" name="IGSDL01101VO" property="quartzJobsDetailList"
			...
			<tr class="<ig:rowcss index="${index}"/>">
				...
				<td><a href="IGSDL0111_List.do?qjid=<bean:write name="bean" property="qjid" />&qjtype=<bean:write name="bean" property="qjtype" />"><img
