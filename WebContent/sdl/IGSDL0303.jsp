...
<html:html>
<bean:define id="id" value="IGSDL0303" toScope="request" />
...
<div class="msg_box"><html:form styleId="form" action="/IGCOM0202.do?linkID=IGSDL0301&actname=ACT03SDL0101"
	...
	<div class="msgbtn"><html:submit property="btn_back" value="继续新增"
		...
		value="目标查询" styleClass="button" /></div>
</html:form></div>
</div>
</div>
