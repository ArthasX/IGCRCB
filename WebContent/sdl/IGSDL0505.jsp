...
<html:html>
<bean:define id="id" value="IGSDL0505" toScope="request" />
...
<body onload="changeDiv();" style="background-color: white; background-image: none;" >
<div id="maincontent">
<div id="contentainer">
<html:form styleId="form" action="/IGSDL0505"
	onsubmit="return checkSubmit(this);">
	<div id="location">
	<div class="image"></div>
	<p class="fonts1">服务水平统计</p>
	</div>
	...
	<table class="table_style">
		<tr>
			<th rowspan="2" width="10%">月份</th>
			<th colspan="4" width="46%">业务连续性</th>
			<th colspan="2" width="17%">安全</th>
			<th width="10%">风险</th>
			<th colspan="2" width="17%">容量</th>
		</tr>
		<tr>
