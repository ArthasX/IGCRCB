...
<html:html>
<bean:define id="id" value="IGSDL0701" toScope="request" />
...
<div id="content"><html:form styleId="form" action="/IGSDL0701"
	...
	<table class="table_style4" width="60%" align="left">
		...
		<logic:iterate id="bean" name="IGSDL07011VO" property="incidentKpiList">
			<tr>
                   <c:if test="${bean.typeName!=null}">
                   <td>
                   <logic:equal value="" name="bean" property="typeName">
                   自定义
                   </logic:equal>
                   <logic:notEqual value="" name="bean" property="typeName">
                   	${bean.typeName}
                   </logic:notEqual>
