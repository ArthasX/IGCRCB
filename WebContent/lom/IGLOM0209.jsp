...
<html:html>
<bean:define id="id" value="IGLOM0209" toScope="request" />
<bean:define id="title" value="调剂物品画面" toScope="request" />
<!-- header1 -->
...
<script type="text/javascript">	
	...
	function operation(name,id){
		if(name=="search"){
			document.forms[0].action=getAppRootUrl() + "/IGLOM0208_Disp1.do";
			document.forms[0].submit();

		}else if(name=="insert"){
			
			 if(window.confirm("您确定要调剂这些物品吗？")){
				 var count=0;
				...
				for(var i=0;i<check.length;i++){
				 ...
				 document.forms[0].action=getAppRootUrl() + "/IGLOM0208_Insert.do";
				 document.forms[0].submit();
			 } 
		}else if(name=="read"){
...
<div id="contentWrap">
<div id="content">
<html:form styleId="form" action="/IGLOM0208_Disp1">
<div id="location">
<div class="image"></div>
<p class="fonts1">后勤管理 &gt;&gt; 物品管理 &gt;&gt; 物品调剂</p>
<div class="back"><a href="IGLOM0208_Disp.do" target="_self">返回</a></div> 
</div>
	<div id="search">
	<div class="img"></div>
...
<span>物品种类：</span> <span> <html:text property="gscategoryname" size="18" readonly="true"/> 
...
<br>
<span>调剂机构：</span><span>${IGLOM0208Form.goorgname}</span>&nbsp;&nbsp;
<span>调剂人：</span><span>${IGLOM0208Form.gorequsername}</span>
...
<html:hidden property="rid"/>
	...
	<table class="table_style">
			...
			<logic:present name="IGLOM02081VO" property="itemsCategoryList">
				<logic:iterate id="bean" name="IGLOM02081VO" property="itemsCategoryList" indexId="index">
					...
					<tr class="<ig:rowcss index="${index}"/>">
						...
						<td>				
							<html:text name="IGLOM0208Form" property="goinnums[${ADcount}]"  size="10" errorStyleClass="inputError" />
	...
	<logic:present name="IGLOM02081VO" property="itemsCategoryList">
		<span> 
			<html:button property="btn_add" value="调剂" styleClass="button" onclick="operation('insert')"  />
