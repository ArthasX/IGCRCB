...
<html:html>
<bean:define id="id" value="IGLOM0321" toScope="request"/>
<bean:define id="title" value="借款确认画面" toScope="request"/>
<!-- header1 -->
...
<!-- /header1 -->
	...
	function confirmResult(lpdstatus){
        var message ='请选择要确认的对象！';
        var confirmMsg ='请确认是否要进行审批确认处理？';
        ...
        if( window.confirm(confirmMsg)){
            form.action = getAppRootUrl() + "/IGLOM0321_Change.do?&lpdstatus="+lpdstatus;
            return true;
        } else {
            return false;
        }
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            <html:form styleId="form" action="/IGLOM0321" onsubmit="return checkSubmit(this);">
          	<div id="location">
                <div class="image"></div>
                    <p class="fonts1">后勤管理 &gt;&gt; 预支管理 &gt;&gt; 借款确认
					</p>
            	</div>
                <div id="search">
		             <div class="img"></div>
                ...
                <div id="results_list">
			     ...
			     <div id="operate">
                            <logic:present name="IGLOM03041VO" property="loanPayDetailList" >
                            		...
                            		<html:submit property="btn_delete" value="确认" styleClass="button" onclick="return confirmResult('0');" />
                            </logic:present>
			                <!-- paging -->
