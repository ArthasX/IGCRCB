...
<html:html>
<bean:define id="id" value="IGLOM0205" toScope="request" />
<bean:define id="title" value="物品领用基本信息画面" toScope="request" />
<!-- header1 -->
...
<!--
	function confirmDisp(){
			...
			if($F('gorequsername').strlen()>32){
				alert("领用人不能大于"+Math.floor(32/strByteFlag)+"个汉字！");
				return false;
			}
...
<div id="formwrapper"><html:form styleId="form"
	action="/IGLOM0205" onsubmit="return checkSubmit(this);">
	<!--  message -->
	<ig:message />
	<!--  /message -->
	<fieldset>
	<legend>物品领用基本信息</legend>
	
	
	
	<div><label for="Name"><strong><span class="red">*</span>领用机构</strong>：</label>
	<html:text property="goorgname" readonly="true"></html:text>
	<img src="images/tree.gif" style="cursor: hand;" width="16" height="16" border="0" onclick="setOrg('IGSYM0101_TREE.do');" alt="请选择领用机构"/>
	<html:hidden property="goorg"/>
	<br/>
	</div>
	<div><label for="Name"><strong><span class="red">*</span>领用人</strong>：</label>
