...
<html:html>
<bean:define id="id" value="IGLOM0261" toScope="request" />
...
<script type="text/javascript">	
	...
	function operation(name,id){
		if(name=="search"){
			document.forms[0].action=getAppRootUrl() + "/IGLOM0261_Disp1.do";
			document.forms[0].submit();
			 ...
			 document.forms[0].action=getAppRootUrl() + "/IGLOM0261_Insert.do";
			 document.forms[0].submit();
			 } 
		}else if(name=="read"){
...
<div id="contentWrap">
<div id="content">
<html:form styleId="form" action="/IGLOM0261_Disp1">
<div id="location">
<div class="image"></div>
<logic:equal name="IGLOM0203Form" property="lomid" value="lom0103">
  <p class="fonts1">后勤管理 &gt;&gt; 接待管理 &gt;&gt;接待工作管理 &gt;&gt;领用物品信息&gt;&gt;物品领用</p>
</logic:equal>

<logic:equal name="IGLOM0203Form" property="lomid" value="lom0107">
   <p class="fonts1">后勤管理 &gt;&gt; 就餐管理 &gt;&gt;外出就餐管理 &gt;&gt;领用物品信息&gt;&gt;物品领用</p>
</logic:equal>
<div class="back"><a href="IGLOM0260_Disp.do" target="_self">返回</a></div> 
</div>
	<div id="search">
	<div class="img"></div>
