...
<html:html>
<bean:define id="id" value="IGLOM0370" toScope="request" />
...
<div class="msgbtn"><input type="button" class="button"
	value="预支费用查询" onclick="window.location='IGLOM0302_Disp.do';" /></div>
</div>
</div>
</div>
