...
<html:html>
<bean:define id="id" value="IGLOM0120" toScope="request" />
<bean:define id="title" value="部门外出就餐汇总画面" toScope="request" />
<!-- header1 -->
...
<script type="text/javascript">	
	...
	function checkSearch(){
		...
		if(Number($F('month_from')) > Number($F('month_to'))){
			...
			document.forms[0].action = getAppRootUrl() + "/IGLOM0120.do";
	...
	function exportExcel() {
		...
		if(Number($F('month_from')) > Number($F('month_to'))){
			...
			document.forms[0].action = getAppRootUrl() + "/IGLOM0120.do?report=1";
			document.forms[0].submit();
		}
...
<div id="contentWrap">
<div id="content"><html:form styleId="form" action="/IGLOM0120"
	onsubmit="return checkSubmit(this);">
	<div id="location">
	<div class="image"></div>
	<p class="fonts1">后勤管理 &gt;&gt; 就餐管理 &gt;&gt; 部门外餐汇总</p>
	</div>
	<div id="search">
	<div class="img"></div>
	<div class="conditions">&nbsp;&nbsp;&nbsp;&nbsp;<span class="red">*</span>年度：
	<html:select property="year" name="IGLOM0120Form">
		...
		<ig:optionsCollection ccid="MONTH_CODE" isMakeBlankRow="false"
			isCodeLabel="true" />
	</html:select> <label>月&nbsp;&nbsp;申请部门：</label> <html:text property="deptName"
	...
	<table width="100%" class="table_style">
		...
		<tr>
			<th width="5%"></th>
			<th width="10%">申请部门</th>
			<th width="12%">外出就餐数量</th>
			<th width="10%">费用总额</th>
		</tr>
		<!-- body部 -->
		<logic:present name="IGLOM01081VO" property="dealOrgVWList">
			<logic:iterate id="bean" name="IGLOM01081VO"
				property="dealOrgVWList" indexId="index">
				<tr onmouseover="mouseOver(this);" onmouseout="mouseOut(this,'');"
					onclick="doLook('IGLOM0121.do?rapporgid_org=${bean.rapporgid}&year_org=${IGLOM0120Form.year}&month_from_org=${IGLOM0120Form.month_from}&month_to_org=${IGLOM0120Form.month_to}');">
			...
			<logic:iterate id="bean" name="IGLOM01081VO"
				property="dealOrgVWList" length="1">
				<tr>
					<td></td>
					<td>合计:</td>
