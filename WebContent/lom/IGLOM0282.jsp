...
<html:html>
<bean:define id="id" value="IGLOM0282" toScope="request"/>
...
<div id="contentWrap">
        <div id="content">
			...
			<div class="msg_box">
				...
				<div class="msgcontent"><div class="txMessageInf">信息登记成功！</div>
                <input type="button" class="button" value="继续添加" 
                onclick="window.location='IGCOM0202.do?linkID=IGLOM0203';" />
			</div>
			</div>
		 </div>
    </div>
