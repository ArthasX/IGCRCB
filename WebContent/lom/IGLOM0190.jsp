...
<html:html>
<bean:define id="id" value="IGLOM0190" toScope="request" />
...
<div class="msg_box"><html:form styleId="form" action="/IGLOM0101_Disp"
	...
	<div class="msgbtn">
	<input type="button" class="button" value="接待客人登记"  onclick="window.location='IGLOM0102_Disp.do?rid=${IGLOM0101Form.rid}';" />
