...
<html:html>
<bean:define id="id" value="IGLOM0304" toScope="request"/>
...
<!-- /header1 -->
	...
	function deleteRec(){
        ...
        if( window.confirm(confirmMsg)){
            form.action = getAppRootUrl() + "/IGLOM0304_Delete.do";
            return true;
        } else {
            return false;
        }
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            <html:form styleId="form" action="/IGLOM0304" onsubmit="return checkSubmit(this);">
          	<div id="location">
                <div class="image"></div>
                    <p class="fonts1">后勤管理 &gt;&gt; 预支管理 &gt;&gt; 借款管理
					</p>
            	</div>
                <div id="search">
		             <div class="img"></div>
                ...
                <div id="results_list">
			                ...
			                <logic:present name="IGLOM03041VO" property="loanPayDetailList" >
			                    <logic:iterate id="bean" name="IGLOM03041VO" property="loanPayDetailList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                            <td>
			                            <!-- 借款管理lpdstatus_q为空且待审批1可以删除 -->
				               		
			                            <c:if test="${bean.lpdstatus == '1' }">
			     ...
			     <div id="operate">
                            <logic:present name="IGLOM03041VO" property="loanPayDetailList" >
			                     <c:if test="${IGLOM0304Form.lpdstatus_q == '' }">
