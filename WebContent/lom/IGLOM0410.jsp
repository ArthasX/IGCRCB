...
<html:html>
<bean:define id="id" value="IGLOM0410" toScope="request"/>
...
<div id="container">
    ...
    <div id="contentWrap">
        <div id="content">
            <html:form styleId="form" action="/IGLOM0407" onsubmit="return checkSubmit(this);">
          	<div id="location">
                <div class="image"></div>
                    <p class="fonts1">后勤管理 &gt;&gt; 发票管理 &gt;&gt; 付款信息修改</p>
            	</div>
                <div id="search">
		             <div class="img"></div>
			 ...
			 <logic:present name="IGLOM04021VO" property="invoiceList" >
			                    <logic:iterate id="bean" name="IGLOM04021VO" property="invoiceList" indexId="index">
			                        <tr class="<ig:rowcss index="${index}"/>">
			                           ...
			                           <td>							
											<div class="nowrapDiv">
											<html:link action="/IGLOM0407_Edit_Disp.do?iid=${bean.iid}">
