...
<html:html>
<bean:define id="id" value="IGPRJ0107" toScope="request" />
<bean:define id="title" value="调整参与人页面" toScope="request" />
<!-- header1 -->
...
<!--
	...
	function submitForm(flag){
        ...
        if(window.confirm(confirmMsg)){
            ...
            form.action = getAppRootUrl() + "/IGPRJ0107.do?mode="+mode;
            return true;
        } else {
            return false;
        }
...
<div id="contentWrap">
<div id="content">
<html:form styleId="form" action="/IGPRJ0107" onsubmit="return checkSubmit(this);">
<div id="location">
<div class="image"></div>
<p class="fonts1">参与人</p>
<div class="back"><a href="IGPRJ0101_Detail.do?pid=<bean:write name="IGPRJ0107Form" property="pid" />" target="_self">返回</a></div> 
</div>
	<div class="role_title">现有参与人（参与人不能多于8人）</div>
	...
	<table id="tab_del" class="table_style" align="left">
			...
			<logic:present name="IGPRJ0107VO" property="participantList">
				<logic:iterate id="bean" name="IGPRJ0107VO"
					property="participantList" indexId="index">
	...
	<logic:present name="IGPRJ0107VO" property="roleMap">
		<div id="TabbedPanels1" class="TabbedPanels">
		<ul class="TabbedPanelsTabGroup">
			<logic:iterate id="map" name="IGPRJ0107VO" property="roleMap" indexId="number">
				...
				<table class="table_style" align="left">
					...
					<logic:iterate id="bean" name="list" indexId="index">
						<tr class="<ig:rowcss index="${index}"/>">
							...
							<td><input type="text" name="ppusername" size="40" style="text-align: center" readonly="readonly"/>
	...
	<div id="operate">
		<span> <html:submit property="btn_delete" value="添加所选"
			styleClass="button"  onclick="return submitForm('1');"/></span>
	</div>
