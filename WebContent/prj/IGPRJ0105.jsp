...
<html:html>
<bean:define id="id" value="IGPRJ0105" toScope="request" />
<bean:define id="title" value="调整人员成功页面" toScope="request" />
<!-- header1 -->
...
<div class="msg_box">
	...
	<div class="msgcontent"><div class="txMessageInf">项目人员调整成功！</div></div>
	<div class="msgbtn">
