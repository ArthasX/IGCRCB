...
public class DateFormGeneratedTagImpl extends FormGeneratedTagImpl{
	...
	public String generatedPublicWriteableTag(Map<String, Object> params){
		...
		tagString.append("<input type=\"text\" id=\"pidid")
				 ...
				 .append("\" name=\"")
				 .append(property)
				 .append("\" size=\"32\" onclick=\"showDate(this);\" value=\"")
				 .append(value)
	...
	public String generatedPublicWriteableTableColumn(Map<String, Object> params){
		...
		tagString.append("<input id=\"")
				 ...
				 .append("\" rownumber=\"")
				 .append(rownum)
				 .append("\" onclick=\"showDate(this);\" style=\"width:85px;\" type=\"text\" readonly=\"true\" pidtype=\"")
				 .append(pidtype)
