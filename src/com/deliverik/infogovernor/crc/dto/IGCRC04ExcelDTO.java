 ...
 * 创建记录：刁泽旭 2014/07/07
 */
public class IGCRC04ExcelDTO extends ExcelDTO {
	/** 流信息集合 */
	 ...
	 * @return the voLists
	 */
	public List<IGCRC14012VO> getVoLists() {
		return voLists;
	}

	/**
	 * 导出内容设定
	 * @param voLists the 导出内容
	 */
	public void setVoLists(List<IGCRC14012VO> voLists) {
