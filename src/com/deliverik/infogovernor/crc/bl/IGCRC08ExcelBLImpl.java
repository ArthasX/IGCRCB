 ...
 * 创建记录：史凯龙 2014/07/20
 */
public class IGCRC08ExcelBLImpl extends ExcelBaseBLImpl implements
		IGCRC08ExcelBL {
	/** 日志对象 */
	private static final Log log = LogFactory.getLog(IGCRC08ExcelBLImpl.class);

	/**
	 * 获取导出相应信息编写Excel文件，并输出。
	 */
	public ExcelDTO initBody(ExcelDTO dto) throws BLException {
		log.debug("=================获取指派工作管理导出开始=================");
		IGCRC08ExcelDTO exceldto = (IGCRC08ExcelDTO) excelDTO;
		// 设置起始行数
