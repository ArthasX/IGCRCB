 ...
 * 修改记录：
 */
public class IGSMR0305JOB implements Job {
...
private static Log log = LogFactory.getLog(IGSMR0304JOB.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		...
		for(UserRoleInfo info:listrole){
			...
			tb.setRitype(IGSMRJOBCONSTANTS.QUARTER4REPORT_TYPE);
			tb.setRiinfo("请发起第四季度的季报填报");
			//插入到提醒信息表中
			try {
			...
			//发送短信提醒
			sendMessageBL.sendSmsToUser(info.getUserid(), "请发起第四季度的季报填报");
		}
