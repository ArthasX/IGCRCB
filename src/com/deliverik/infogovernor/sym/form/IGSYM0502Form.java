...
public class IGSYM0502Form extends BaseForm implements Notice{
	...
	private String isPush;//是否推送到指挥台  (暂定不需要此功能 2015年2月3日11:07:27)
	
	private String pushPrid;//指挥台名称  (暂定不需要此功能 2015年2月3日11:07:27)
	
	protected String ntargettype;//发布对象 1:人员  2:角色

	protected String ntargetuserid; //人员id

	protected String ntargetusername;//人员姓名

	protected String ntargetroleid;//角色id

	protected String ntargetrolename;//角色名
