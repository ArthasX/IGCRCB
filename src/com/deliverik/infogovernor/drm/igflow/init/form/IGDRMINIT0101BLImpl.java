...
/**
 * <p>
 * 场景复制-待发起节点（第一页）表单初始化
 * 
 * </p>
 */
public class IGDRMINIT0101BLImpl extends BaseBLImpl implements WorkFlowInitFormHandlerBL{

    static Log log = LogFactory.getLog(IGDRMINIT0101BLImpl.class);
	...
	/**
	 * 场景定义/复制-通过资产实例ID获取资产信息初始化场景定义流程发起页面
	 * @param dto
	 * @return String
	 * @throws BLException
	 */
	...
	private Map<String, Object> getProcessDefineInfoByEiid(Integer eiid, Map<String, Object> map) throws BLException {
		// 查询预案资产
		//SOC0118Info eiInfo = soc0118BL.searchEntityItemByKey(eiid);
		//资产编号
		//String eilabel = eiInfo.getEilabel();
		//资产属性配置表
