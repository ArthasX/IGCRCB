...
/**
 * 组合场景复制-待发起节点（第一页）表单初始化
 * 
 */
public class IGDRMINIT0201BLImpl extends BaseBLImpl implements WorkFlowInitFormHandlerBL{

    static Log log = LogFactory.getLog(IGDRMINIT0201BLImpl.class);
