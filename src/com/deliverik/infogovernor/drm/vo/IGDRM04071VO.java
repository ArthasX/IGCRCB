...
public class IGDRM04071VO extends BaseVO implements Serializable{
	 ...
	 */
	public IGDRM04071VO(SOC0124Info soc0124Info,Map<String,List<SOC0129Info>> soc0129InfoVWMap) {
		this.soc0124Info = soc0124Info;
		this.soc0129InfoVWMap = soc0129InfoVWMap;
	}
