...
public class IGMTP0102Action extends BaseAction {
	
	static Log log = LogFactory.getLog(IGMTP0102Action.class);
	...
	public ActionForward doProcess(ActionMapping mapping, ActionForm actionForm,
		...
		form.setWorkType(IGMTP01BLType.PROCESS_PERSON_TYPE);
