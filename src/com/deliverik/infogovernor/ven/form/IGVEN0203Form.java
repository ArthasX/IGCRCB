...
public class IGVEN0203Form extends BaseForm {
	
	/** 风险监测主键id 集合 */
	protected Integer[] rmids;
...
//	}
	...
	/**
	 * 结果说明取得
	 * @return resultdescs  结果说明
	 */
	public String[] getResultdescs() {
		return resultdescs;
	}

	/**
	 * 结果说明设定
	 * @param resultdescs  结果说明
	 */
	public void setResultdescs(String[] resultdescs) {
		this.resultdescs = resultdescs;
	}
