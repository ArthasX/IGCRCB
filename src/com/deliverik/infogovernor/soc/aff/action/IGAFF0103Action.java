 ...
 *
 */
public class IGAFF0103Action extends BaseAction {

	static Log log = LogFactory.getLog(IGAFF0103Action.class);
	...
	public ActionForward doProcess(ActionMapping mapping, ActionForm actionForm, HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		// FORM取得
				IGAFF0103Form form = (IGAFF0103Form) actionForm;
				...
				if ("DISP".equals(mapping.getParameter())) {
					...
					// ***************************************************************************
					// 类型分类(设备)设定
					form = new IGAFF0103Form();
					// form.setEcategory(CommonDefineUtils.ENTIY_CATEGORY_DEVICE);
					req.setAttribute("IGAFF0103Form", form);
				...
				if ("SEARCH".equals(mapping.getParameter())
					...
					if ("SEARCH1".equals(mapping.getParameter())) {
						...
						form = (IGAFF0103Form) req.getSession().getAttribute(
								"IGAFF0103Form");
						if (form == null) {
							form = new IGAFF0103Form();
						} else {
					...
					// 查询记录最大件数取得
					int maxCnt = getMaxDataCount("IGAFF0103");
