...
import com.deliverik.infogovernor.soc.aff.vo.IGAFF01031VO;
 ...
 *
 */
public class IGAFF0104Action extends BaseAction {

	static Log log = LogFactory.getLog(IGAFF0104Action.class);
	...
	public ActionForward doProcess(ActionMapping mapping, ActionForm actionForm, HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		// FORM取得
		IGAFF0104Form form = (IGAFF0104Form) actionForm;
		...
		if ("DISP".equals(mapping.getParameter())) {
			...
			// ***************************************************************************
			// 类型分类(设备)设定
			form = new IGAFF0104Form();
			req.setAttribute("IGAFF0104Form", form);
		...
		if ("SEARCH".equals(mapping.getParameter())
			...
			if ("SEARCH1".equals(mapping.getParameter())) {
				...
				form = (IGAFF0104Form) req.getSession().getAttribute(
						"IGAFF0104Form");
				if (form == null) {
					form = new IGAFF0104Form();
				} else {
			...
			// 查询记录最大件数取得
			int maxCnt = getMaxDataCount("IGAFF0104");
			...
			// 将设备信息检索结果设定到VO中
			IGAFF01031VO vo = new IGAFF01031VO(dto.getSoc0118List());

			super.<IGAFF01031VO> setVO(req, vo);
