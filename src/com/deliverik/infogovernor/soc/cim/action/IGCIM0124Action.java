...
import com.deliverik.infogovernor.soc.cim.vo.IGCIM01241VO;

/**
 * 应用配置信息详细画面Action处理
 *
 */
public class IGCIM0124Action extends BaseAction {

	static Log log = LogFactory.getLog(IGCIM0124Action.class);
	...
	public ActionForward doProcess(ActionMapping mapping, ActionForm actionForm, HttpServletRequest req, HttpServletResponse res) throws Exception {
		//FORM取得
		IGCIM0124Form form = (IGCIM0124Form)actionForm;
		...
		if( "DISP".equals(mapping.getParameter())){
			...
			//应用配置信息登记画面初期显示逻辑调用
			dto = ctlBL.initIGCIM0124Action(dto);
			
			//将应用配置信息检索结果设定到VO中
			IGCIM01241VO vo = new IGCIM01241VO(dto.getEntityItemVWInfo(),
			...
			super.<IGCIM01241VO>setVO(req.getSession(), vo);
			...
			if (isTokenValid(req, true)){
				...
				req.setAttribute("eiid", form.getEiid());
			}else{
