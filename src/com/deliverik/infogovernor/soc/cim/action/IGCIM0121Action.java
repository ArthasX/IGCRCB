...
import com.deliverik.infogovernor.soc.cim.vo.IGCIM01211VO;
 ...
 *
 */
public class IGCIM0121Action extends BaseAction {
	...
	public ActionForward doProcess(ActionMapping mapping, ActionForm actionForm, HttpServletRequest req, HttpServletResponse res) throws Exception {
		//FORM取得
		IGCIM0121Form form = (IGCIM0121Form)actionForm;
		...
		if( "SEARCH".equals(mapping.getParameter())||"SEARCH1".equals(mapping.getParameter())){
			...
			if ("SEARCH1".equals(mapping.getParameter())){
				...
				form = (IGCIM0121Form) req.getSession().getAttribute("IGCIM0121Form");
				if ( form== null){
					form = new IGCIM0121Form();
					form.setEcategory(CommonDefineUtils.ENTIY_CATEGORY_APPLICATION);
				}else {
			...
			//将应用信息检索结果设定到VO中
			IGCIM01211VO vo = new IGCIM01211VO(dto.getEntityItemVWInfoList());
			
			super.<IGCIM01211VO>setVO(req, vo);
