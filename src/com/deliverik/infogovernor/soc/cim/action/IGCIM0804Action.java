...
import com.deliverik.infogovernor.soc.cim.form.IGCIM0804Form;
 ...
 * 修改记录：
 */
public class IGCIM0804Action extends BaseAction {

	static Log log = LogFactory.getLog(IGCIM0804Action.class);
	...
	public ActionForward doProcess(ActionMapping mapping, ActionForm actionForm, HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		//Get Form
		IGCIM0804Form form=(IGCIM0804Form)actionForm;
