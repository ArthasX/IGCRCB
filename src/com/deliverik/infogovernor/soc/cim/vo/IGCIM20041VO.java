...
public class IGCIM20041VO extends BaseVO implements Serializable{
	
	/** 设备信息检索结果 */
	protected List<SOC0163Info> entityDataList;
	 ...
	 */
	public IGCIM20041VO(List<SOC0163Info> entityDataList) {
	 ...
	 * @return 资产项信息检索结果
	 */
	public List<SOC0163Info> getEntityDataList() {
	 ...
	 */
	public void setEntityDataList(List<SOC0163Info> entityDataList) {
		this.entityDataList = entityDataList;
	}
