...
/**
  * 概述: vCloud ServiceInstance实体
  * 功能描述: vCloud ServiceInstance实体
  * 创建记录: 2014/02/25
  * 修改记录: 
  */
...
@Entity
@Table(name="VCD01")
public class VCD01TB extends BaseEntity implements Serializable,
		Cloneable, VCD01Info {

	/** 主键 */
	@Id
	@TableGenerator(
		name="VCD01_TABLE_GENERATOR", table="SEQUENCE_GENERATOR_TABLE",
		pkColumnName="SEQUENCE_NAME", valueColumnName="SEQUENCE_VALUE",
		pkColumnValue="VCD01_SEQUENCE", initialValue=1, allocationSize=1
	)
	@GeneratedValue(strategy = GenerationType.TABLE, generator="VCD01_TABLE_GENERATOR")
