 ...
 * @Version V1.0
 */
public class IGPRR0102Action extends BaseAction {

	static Log log = LogFactory.getLog(IGPRR0102Action.class);
	...
	public ActionForward doProcess(ActionMapping mapping, ActionForm actionForm, HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		if( "DISP".equals(mapping.getParameter()) || "COPY".equals(mapping.getParameter())){
			...
			if("COPY".equals(mapping.getParameter())){
				...
				req.setAttribute("prpdid", dto.getPdid());
				req.setAttribute("IGPRR0102Form", form);
			}
				//状态级私有表单关闭节点显示逻辑
			if(dto.getStatusclosedetails()!=null){
			    req.setAttribute("StatusCloseDetails", dto.getStatusclosedetails());
			}
