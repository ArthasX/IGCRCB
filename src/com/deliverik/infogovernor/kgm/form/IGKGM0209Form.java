...
/**
 * 概述: 知识管理检索条件接口 功能描述：知识管理检索条件接口 创建记录：宋海洋 2010/12/08 修改记录：
 */
public class IGKGM0209Form extends BaseForm implements KnowledgeSearchCond {
