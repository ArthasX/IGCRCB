 ...
 * 
 */
public class IGASM3202Form extends BaseForm{
	...
	/** 版本选择下拉框*/
	public Map<Integer,Integer> checkVersionMap;
	
	public String selecteiversion;
	...
	/**
	 * @param highVersion the highVersion to set
	 */
	public void setHighVersion(Integer highVersion) {
