...
public class IGASM1412Form extends BaseForm implements SOC0118Info{
	 ...
	 * 服务记录更新时间FROM设定
	 *
	 * @param eiupdtime_from 服务记录更新时间FROM
	 */
	 ...
	 * 服务记录共通配置编号检索条件数组设定
	 *
	 * @param cclabel 服务记录共通配置编号检索条件数组
	 */
	 ...
	 * 服务记录共通配置值检索条件数组设定
	 *
	 * @param ccivalue 服务记录共通配置值检索条件数组
	 */
