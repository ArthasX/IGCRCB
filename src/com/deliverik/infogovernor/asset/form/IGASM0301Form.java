 ...
 * 
 */
public class IGASM0301Form extends BaseForm implements SOC0124SearchCond{
	...
	/**
	 * @param aote the aote to set
	 */
	public void setAote(String aote) {
		this.aote = aote;
	}
