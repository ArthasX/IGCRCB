...
public class IGASM21091VO extends BaseVO implements Serializable{
	/** 设备信息 */
	 ...
	 */
	public IGASM21091VO(IG688Info entityItemData,Map<String,List<IG002Info>> configItemVWInfoMap) {
