...
public class IGASM15DTO extends BaseDTO implements Serializable{
	 ...
	 * 人员信息检索条件取得
	 * 
	 * @return entityItemVWSearchCond 人员信息检索条件
	 */
...
Map<String, List<SOC0119Info>> cldEntityItemRelationMap) {
	 ...
	 * 人员配置信息检索条件设定
	 *
	 * @param igasm1504Form 人员配置信息检索条件
	 */
	 ...
	 * 人员配置信息历史记录检索条件设定
	 *
	 * @param igasm1505Form 人员配置信息历史记录检索条件
	 */
	 ...
	 * 人员关系管理检索条件设定
	 *
	 * @param igasm1506Form 人员关系管理检索条件
	 */
	 ...
	 * 人员关系编辑后信息取得
	 * 
	 * @return entityItemRelation 人员关系编辑后信息
	 */
...
Map<String, List<SOC0107Info>> configItemMap) {
	 ...
	 * 人员检索结果取得
	 * 
	 * @return entityItemVWInfoList 人员检索结果
	 */
	 ...
	 * 人员配置信息画面人员信息取得
	 * 
	 * @return entityItemVWInfo 人员配置信息画面人员信息
	 */
	 ...
	 * 资产版本列表取得
	 * 
	 * @return configItemVersionTime 资产版本列表
	 */
