...
import com.deliverik.infogovernor.asset.form.IGASM2801Form;
import com.deliverik.infogovernor.asset.vo.IGASM28011VO;
 ...
 *
 */
public class IGASM2801Action extends BaseAction {

	static Log log = LogFactory.getLog(IGASM2801Action.class);
	...
	public ActionForward doProcess(ActionMapping mapping, ActionForm actionForm, HttpServletRequest req, HttpServletResponse res) throws Exception {
		//FORM取得
		IGASM2801Form form = (IGASM2801Form)actionForm;
		...
		if( "DISP".equals(mapping.getParameter())){
			...
			//***************************************************************************
			//类型分类(检查项)设定
			form = new IGASM2801Form();
			form.setEcategory(CommonDefineUtils.ENTIY_CATEGORY_CHECKITEMS);
			req.setAttribute("IGASM2801Form", form);
		...
		if( "SEARCH".equals(mapping.getParameter())||"SEARCH1".equals(mapping.getParameter())){
			...
			if ("SEARCH1".equals(mapping.getParameter())){
				...
				form = (IGASM2801Form) req.getSession().getAttribute("IGASM2801Form");
				if ( form== null){
					form = new IGASM2801Form();
					form.setEcategory(CommonDefineUtils.ENTIY_CATEGORY_CHECKITEMS);
				}else {
			...
			//查询记录最大件数取得
			int maxCnt = getMaxDataCount("IGASM2801");
			...
			//将检查项信息检索结果设定到VO中
			IGASM28011VO vo = new IGASM28011VO(dto.getEntityItemVWInfoList());
			
			super.<IGASM28011VO>setVO(req, vo);
