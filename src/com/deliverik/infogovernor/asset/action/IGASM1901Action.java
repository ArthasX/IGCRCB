...
import com.deliverik.infogovernor.asset.form.IGASM1901Form;
import com.deliverik.infogovernor.asset.vo.IGASM19011VO;
 ...
 *
 */
public class IGASM1901Action extends BaseAction {

	static Log log = LogFactory.getLog(IGASM1901Action.class);
	...
	public ActionForward doProcess(ActionMapping mapping, ActionForm actionForm, HttpServletRequest req, HttpServletResponse res) throws Exception {
		//FORM取得
		IGASM1901Form form = (IGASM1901Form)actionForm;
		...
		if( "DISP".equals(mapping.getParameter())){
			...
			//***************************************************************************
			//类型分类(人员)设定
			form = new IGASM1901Form();
			form.setEcategory(CommonDefineUtils.ENTIY_CATEGORY_EPI_PERSON);
			req.setAttribute("IGASM1901Form", form);
			...
			if(dto.getFlag() && EntityCategory.ENTITYITEM_PERMISSION_MODE_A.equals(ResourceUtility.getString(EntityCategory.ENTITYITEM_PERMISSION_MODE))) {
				...
				String roletype = req.getParameter("roletype")==null?EntityCategory.ROLE_TYPE_EPI_PERSON:req.getParameter("roletype");
				...
				sym03dto1.setSubtype(CommonDefineUtils.ENTIY_CATEGORY_EPI_PERSON_SYSCODING);
				String roletype1 = req.getParameter("roletype")==null?EntityCategory.ROLE_TYPE_EPI_PERSON:req.getParameter("roletype");
		...
		if( "SEARCH".equals(mapping.getParameter())||"SEARCH1".equals(mapping.getParameter())){
			...
			if ("SEARCH1".equals(mapping.getParameter())){
				...
				form = (IGASM1901Form) req.getSession().getAttribute("IGASM1901Form");
				if ( form== null){
					form = new IGASM1901Form();
					form.setEcategory(CommonDefineUtils.ENTIY_CATEGORY_EPI_PERSON);
				}else {
			...
			//查询记录最大件数取得
			int maxCnt = getMaxDataCount("IGASM1901");
			...
			//将人员信息检索结果设定到VO中
			IGASM19011VO vo = new IGASM19011VO(dto.getEntityItemVWInfoList());
			
			super.<IGASM19011VO>setVO(req, vo);
