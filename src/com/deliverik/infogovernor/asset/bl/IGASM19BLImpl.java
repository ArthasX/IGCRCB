 ...
 *
 */
public class IGASM19BLImpl extends BaseBLImpl implements IGASM19BL {

	static Log log = LogFactory.getLog(IGASM19BLImpl.class);
	...
	public static final String  EIRRELATIONCODE="'002-016','003-016','005-016','006-016','011-016','016-016','013-016','009-016','001-016'";
	...
	public IGASM19DTO insertEntityItemAction(IGASM19DTO dto) throws BLException {
		...
		//输入Form取得
		IGASM1902Form form = dto.getIgasm1902Form();
...
//		form.setEid(entity.getEid());
		...
		//人员信息登录
		SOC0118Info entityItem = this.soc0118BL.registEntityItem(dto.getIgasm1902Form());
	...
	public IGASM19DTO initIGASM1904Action(IGASM19DTO dto) throws BLException {
		...
		IGASM1904Form form = dto.getIgasm1904Form();
...
//		dto.addMessage(new ActionMessage("IGCO10000.I007",totalCount));
	 ...
	 */
	public IGASM19DTO editEntityItemAction(IGASM19DTO dto) throws BLException, FileNotFoundException, IOException {
		...
		if(StringUtils.isEmpty(ident)){
			ident = IGASM19BLImpl.SAVE_VERSION;
		}
		// 版本号初始化
		int version = 1;
		...
		// 判断是否升级版本号
		// =====================>> 修改 start
		if (IGASM19BLImpl.SAVE_VERSION_UP.equals(ident)) { // 升级版本号
		...
		} else if (IGASM19BLImpl.SAVE_VERSION.equals(ident)) { // 不升级版本号
...
//		entityItem.setEistatus(form.getEistatus());
		...
		if(version ==1&&versonFlag){
			...
			//与该资产相关的关系码
			eircond1.setEirrelationcode(IGASM19BLImpl.EIRRELATIONCODE);
	...
	public IGASM19DTO initIGASM1905Action(IGASM19DTO dto) throws BLException {
		log.debug("========人员配置信息历史记录画面初期化处理开始========");
		
		//人员信息检索
		SOC0124Info entityItemVWInfo = this.soc0118BL.searchEntityItemVWByKey(
				Integer.parseInt(dto.getIgasm1905Form().getEiid()));
		...
		if (StringUtils.isEmpty(dto.getIgasm1905Form().getCiversion())) {
			dto.getIgasm1905Form().setCiversion(entityItemVWInfo.getEiversion()+"");
		}
		//获取历史版本更新时间
		dto.setConfigItemVersionTime(this.soc0118BL.searchVersionUpdateTime(Integer.parseInt(dto.getIgasm1905Form().getEiid())));
	...
	public IGASM19DTO initIGASM1906Action(IGASM19DTO dto) throws BLException {
		...
		//人员信息检索
		SOC0124Info entityItemVWInfo = this.soc0118BL.searchEntityItemVWByKey(
				Integer.parseInt(dto.getIgasm1906Form().getEiid()));
		...
		parcond.setPareiid(Integer.parseInt(dto.getIgasm1906Form().getEiid()));
...
//		
//		cldcond.setCldeiid(dto.getIgasm1906Form().getEiid());
...
//		}
	...
	public IGASM19DTO insertEntityItemRelationAction(IGASM19DTO dto) throws BLException {
		...
		IGASM1907Form form = dto.getIgasm1907Form();
		...
		//资产关系登记
		SOC0119Info ret = 
			this.soc0119BL.registEntityItemRelation(dto.getIgasm1907Form());
	...
	public IGASM19DTO searchRelationListAction(IGASM19DTO dto) throws BLException {
		...
		List<LabelValueBean> list = this.codeDetailBL.searchLabelValueBeanList(CommonDefineUtils.ENTIY_CATEGORY_EPI_PERSON,CodeDefine.getCodeDefine("ENTITY_ITEM_RELATION_CODE").getCcid());
	...
	public IGASM19DTO initEntityItem(IGASM19DTO dto) throws BLException {
		...
		IGASM1912Form form = dto.getIgasm1912Form();
		...
		boolean isRoleManager = this.userRoleBL.checkRoleManagerByType(dto.getUser().getUserid(), EntityCategory.ROLE_TYPE_EPI_PERSON);
...
//		ercond.setCldeid(String.valueOf(entityItem.getEid()));
	...
	public IGASM19DTO searchEntityItemLableAction(IGASM19DTO dto) throws BLException {
		...
		cond.setEilabel(CommonDefineUtils.ENTIY_CATEGORY_EPI_PERSON_KEY + IGStringUtils.getCurrentYear().substring(2));
	...
	public IGASM19DTO checkEntityItemDomain(IGASM19DTO dto) throws BLException{
		...
		if(isRoleManager) {
			...
			SOC0117SearchCondImpl entityCond = new SOC0117SearchCondImpl();
			entityCond.setEsyscoding(CommonDefineUtils.ENTIY_CATEGORY_EPI_PERSON_SYSCODING);
