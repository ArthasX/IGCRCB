...
public class EiDomainDetailPK extends BasePK implements Serializable {
	 ...
	 * 构造函数
	 */
	public EiDomainDetailPK(Integer eiddid, Integer eiddversion, String einame,Integer eiImportversion) {
		super();
		this.eiddid = eiddid;
