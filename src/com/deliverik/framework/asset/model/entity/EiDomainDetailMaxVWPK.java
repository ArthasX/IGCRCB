...
public class EiDomainDetailMaxVWPK extends BasePK implements Serializable {
	 ...
	 * 构造函数
	 */
	public EiDomainDetailMaxVWPK(Integer eiddid, Integer eiddversion, String einame,Integer eiImportversion) {
		super();
		this.eiddid = eiddid;
