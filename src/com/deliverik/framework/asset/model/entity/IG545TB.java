...
@Table(name="IG545")
public class IG545TB extends BaseEntity implements Serializable, Cloneable, IG545Info {
	...
	@Id
	@TableGenerator(
		    name="IG545_TABLE_GENERATOR", table="SEQUENCE_GENERATOR_TABLE", 
		    pkColumnName="SEQUENCE_NAME", valueColumnName="SEQUENCE_VALUE", 
		    pkColumnValue="IG545_SEQUENCE", initialValue=1, allocationSize=1
	)
	@GeneratedValue(strategy = GenerationType.TABLE, generator="IG545_TABLE_GENERATOR")
	...
	public IG545TB clone(IG545Info ccd){
