...
@Entity
@Table(name="AuditTask")
public class AuditTaskTB extends BaseEntity implements Serializable,
		Cloneable, AuditTaskInfo {

	/** 逻辑主键 */
	@Id
	@TableGenerator(
		name="AUDITTASK_TABLE_GENERATOR", table="SEQUENCE_GENERATOR_TABLE",
		pkColumnName="SEQUENCE_NAME", valueColumnName="SEQUENCE_VALUE",
		pkColumnValue="AUDITTASK_SEQUENCE", initialValue=1, allocationSize=1
	)
	@GeneratedValue(strategy = GenerationType.TABLE, generator="AUDITTASK_TABLE_GENERATOR")
