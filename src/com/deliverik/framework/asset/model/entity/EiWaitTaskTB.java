...
@Entity
@Table(name="EiWaitTask")
public class EiWaitTaskTB extends BaseEntity implements Serializable,
		Cloneable, EiWaitTaskInfo, LogicalDelete {

	/** 逻辑主键 */
	@Id
	@TableGenerator(
		name="EIWAITTASK_TABLE_GENERATOR", table="SEQUENCE_GENERATOR_TABLE",
		pkColumnName="SEQUENCE_NAME", valueColumnName="SEQUENCE_VALUE",
		pkColumnValue="EIWAITTASK_SEQUENCE", initialValue=1, allocationSize=1
	)
	@GeneratedValue(strategy = GenerationType.TABLE, generator="EIWAITTASK_TABLE_GENERATOR")
