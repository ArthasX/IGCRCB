...
public class EiLinkMapPK extends BasePK implements Serializable {
	 ...
	 * 构造函数
	 */
	public EiLinkMapPK(Integer domainid, Integer domainversion, Integer linkid, Integer linkorder) {
		super();
