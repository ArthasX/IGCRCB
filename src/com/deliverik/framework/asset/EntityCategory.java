...
public class EntityCategory {
	...
	/** 角色类型（外包人员） */
	public final static String ROLE_TYPE_EPI_PERSON = "IGAC12";

	/** 角色类型（风险点） */
	public final static String ROLE_TYPE_RISK = "IGAC13";

	/** 角色类型（检查项） */
	public final static String ROLE_TYPE_CHECKITEMS = "IGAC14";
	...
	public static void init() {
		if (!init) {
			...
			categoryMap.put(CommonDefineUtils.ENTIY_CATEGORY_EPI_PERSON, ROLE_TYPE_EPI_PERSON);
			categoryMap.put(CommonDefineUtils.ENTIY_CATEGORY_RISK, ROLE_TYPE_RISK);
			categoryMap.put(CommonDefineUtils.ENTIY_CATEGORY_CHECKITEMS, ROLE_TYPE_CHECKITEMS);
			init = true;
