...
public class SOC0138PK extends BasePK implements Serializable {
	 ...
	 * 构造函数
	 */
	public SOC0138PK(Integer eiddid, Integer eiddversion, String einame,Integer eiImportversion) {
		super();
		this.eiddid = eiddid;
