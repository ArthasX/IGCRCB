 ...
 * 
 */
public interface SOC0118VWDAO extends BaseHibernateDAO<SOC0118VWInfo> {
	/**
	 * 主键检索处理
	 * @param id 主键
	 * @param eiid 主键
	 ...
	 * @return 检索结果列表
	 */
	public List<SOC0118VWInfo> findByCond(final SOC0118VWSearchCond cond, final int start, final int count);
 ...
 */
	...
	/**自己写的查询*/
	public List<CodeDetailEntity> findByCondSQL(final SOC0118VWSearchCond cond, final int start, final int count);

	public List<TableSpaceInfo> searchTableRelationInfo(final 
			SOC0118VWSearchCondImpl soc0118Cond,final int start,final int count);
	 ...
	 * @return
	 */
	public Integer clearEidesc(final SOC0118VWSearchCond cond);
