...
@Entity
@Table(name="SOC0105")
public class SOC0105TB extends BaseEntity implements Serializable,
		Cloneable, SOC0105Info, LogicalDelete {

	/** 逻辑主键 */
	@Id
	@TableGenerator(
		name="SOC0105_TABLE_GENERATOR", table="SEQUENCE_GENERATOR_TABLE",
		pkColumnName="SEQUENCE_NAME", valueColumnName="SEQUENCE_VALUE",
		pkColumnValue="SOC0105_SEQUENCE", initialValue=1, allocationSize=1
	)
	@GeneratedValue(strategy = GenerationType.TABLE, generator="SOC0105_TABLE_GENERATOR")
