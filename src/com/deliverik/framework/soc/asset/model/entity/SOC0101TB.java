...
@Entity
@Table(name="SOC0101")
public class SOC0101TB extends BaseEntity implements Serializable,
		Cloneable, SOC0101Info {

	/** 资产属性ID */
	@Id
	@TableGenerator(
		name="SOC0101_TABLE_GENERATOR", table="SEQUENCE_GENERATOR_TABLE",
		pkColumnName="SEQUENCE_NAME", valueColumnName="SEQUENCE_VALUE",
		pkColumnValue="SOC0101_SEQUENCE", initialValue=1, allocationSize=1
	)
	@GeneratedValue(strategy = GenerationType.TABLE, generator="SOC0101_TABLE_GENERATOR")
