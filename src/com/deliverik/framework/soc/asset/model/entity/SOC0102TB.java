...
@Entity
@Table(name="SOC0102")
public class SOC0102TB extends BaseEntity implements Serializable,
		Cloneable, SOC0102Info {

	/** 资产ID */
	@Id
	@TableGenerator(
		name="SOC0102_TABLE_GENERATOR", table="SEQUENCE_GENERATOR_TABLE",
		pkColumnName="SEQUENCE_NAME", valueColumnName="SEQUENCE_VALUE",
		pkColumnValue="SOC0102_SEQUENCE", initialValue=1, allocationSize=1
	)
	@GeneratedValue(strategy = GenerationType.TABLE, generator="SOC0102_TABLE_GENERATOR")
