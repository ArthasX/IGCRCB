...
@Table(name="SOC0107")
@SQLInsert(sql="insert into SOC0107 (fingerPrint, cicurver, cid, ciexpire, cismallversion, cistatus, ciupdtime, civalue, civerinfo, civersion, eid, eiid, esyscoding, ciid) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", check=ResultCheckStyle.NONE)

public class SOC0107TB extends BaseEntity implements Serializable, Cloneable, SOC0107Info {

	/** 资产属性ID */
	@Id
	@TableGenerator(
			name="SOC0107_TABLE_GENERATOR", table="SEQUENCE_GENERATOR_TABLE",
			pkColumnName="SEQUENCE_NAME", valueColumnName="SEQUENCE_VALUE",
			pkColumnValue="SOC0107_SEQUENCE", initialValue=1, allocationSize=1
		)
		@GeneratedValue(strategy = GenerationType.TABLE, generator="SOC0107_TABLE_GENERATOR")
