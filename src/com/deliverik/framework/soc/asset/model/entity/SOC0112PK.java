...
public class SOC0112PK extends BasePK implements Serializable {
	 ...
	 * 构造函数
	 */
	public SOC0112PK(Integer eiddid, Integer eiddversion, String einame,Integer eiImportversion) {
		super();
		this.eiddid = eiddid;
