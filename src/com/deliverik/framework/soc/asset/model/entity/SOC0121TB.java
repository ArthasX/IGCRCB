...
@Entity
@Table(name="SOC0121")
public class SOC0121TB extends BaseEntity implements Serializable,
		Cloneable, SOC0121Info,LogicalDelete  {

	/** 逻辑主键 */
	@Id
	@TableGenerator(
		name="SOC0121_TABLE_GENERATOR", table="SEQUENCE_GENERATOR_TABLE",
		pkColumnName="SEQUENCE_NAME", valueColumnName="SEQUENCE_VALUE",
		pkColumnValue="SOC0121_SEQUENCE", initialValue=1, allocationSize=1
	)
	@GeneratedValue(strategy = GenerationType.TABLE, generator="SOC0121_TABLE_GENERATOR")
