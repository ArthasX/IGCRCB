...
public class IGCYB0105BLImpl extends BaseBLImpl implements WorkFlowEventHandlerBL {
    static Log log = LogFactory.getLog(IGCYB0105BLImpl.class);
    /** 更新功能API类 */
    ...
    public void preTreatmentExecute(WorkFlowStatusEventBeanInfo bean) throws BLException {
        log.debug("========事件分派节点添加所有流程分派人员为 参与者开始========");

        List<ParticipantInfo> pInfoList = this.flowSearchBL.searchStatusParticipant(bean.getLogInfo().getPrid(), "事件分派");
        ...
        for(UserRoleInfo info :roleList){
            ...
            //封装流程状态名称
            participants.setStatusname("事件分派");
            
            //参与角色和参与人添加
            flowSetBL.setStatusParticipant(participants);
        }
        
        log.debug("========事件分派节点添加所有流程分派人员为 参与者结束========");
    }
}
