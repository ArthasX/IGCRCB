...
public class IGCYB0107BLImpl extends BaseBLImpl implements WorkFlowEventHandlerBL {
    ...
    public void preTreatmentExecute(WorkFlowStatusEventBeanInfo bean) throws BLException {
        log.debug("========服务请求分派节点添加所有流程分派人员为 参与者开始========");

        List<ParticipantInfo> pInfoList = this.flowSearchBL.searchStatusParticipant(bean.getLogInfo().getPrid(), "审批分派");
        ...
        //封装流程状态名称
        participant.setStatusname("审批分派");
        ...
        for(UserRoleInfo info :roleList){
            ...
            //封装流程状态名称
            participants.setStatusname("审批分派");
            
            //参与角色和参与人添加
            flowSetBL.setStatusParticipant(participants);
        }
        
        log.debug("========服务请求分派节点添加所有流程分派人员为 参与者结束========");
    }
}
