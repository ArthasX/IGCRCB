...
public class IGCYB0110BLImpl extends BaseBLImpl implements WorkFlowEventHandlerBL {
    static Log log = LogFactory.getLog(IGCYB0110BLImpl.class);
    ...
    public void afterTreatmentExecute(WorkFlowStatusEventBeanInfo bean) throws BLException {
        log.debug("========复核人确认结点后处理添加当前人为默认审核人开始========");
        ...
        participant1.setStatusname("变更复核");
