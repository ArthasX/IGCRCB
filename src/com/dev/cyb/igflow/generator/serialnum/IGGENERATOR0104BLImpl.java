 ...
 * </p>
 */
public class IGGENERATOR0104BLImpl extends BaseBLImpl implements
	...
	public String serialnumGenerator(Integer prid) throws BLException {
        ...
        if (null == maxSerialNum) {
            return serialNum + StringUtils.leftPad("1", 3, "0");
        }
        String num = "";
        num = maxSerialNum.substring(7);
        
        int maxNumber = Integer.valueOf(num) + 1;
        serialNum.append(StringUtils.leftPad(String.valueOf(maxNumber), 3, "0"));
