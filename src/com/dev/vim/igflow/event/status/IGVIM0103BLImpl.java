 ...
 * @version 1.0.0
 */
public class IGVIM0103BLImpl extends BaseBLImpl implements WorkFlowEventHandlerBL {
    static Log log = LogFactory.getLog(IGVIM0103BLImpl.class);
    ...
    public void preTreatmentExecute(WorkFlowStatusEventBeanInfo bean) throws BLException {
        ...
        log.debug("======== 资源申请待部署状态节点前处理设置参与者处理开始========");
        
        List<ParticipantInfo> pInfoList = this.flowSearchBL.searchStatusParticipant(bean.getLogInfo().getPrid(), "待部署");
        if(pInfoList == null || pInfoList.size() <= 0){
            throw new BLException("IGPRR0102.E006", "待部署");
        }
...
//            for(UserRoleInfo info :roleList){
                ...
                //封装流程状态名称
                participants.setStatusname("待部署");
                //参与角色和参与人添加
...
//            }
        ...
        log.debug("========资源申请待部署状态节点前处理设置参与者处理结束========");
    }
}
