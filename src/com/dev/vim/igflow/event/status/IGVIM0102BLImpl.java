 ...
 * @version 1.0.0
 */
public class IGVIM0102BLImpl extends BaseBLImpl implements WorkFlowEventHandlerBL {
    static Log log = LogFactory.getLog(IGVIM0102BLImpl.class);
    ...
    public void preTreatmentExecute(WorkFlowStatusEventBeanInfo bean) throws BLException {
        ...
        log.debug("======== 资源申请审批状态节点前处理设置参与者处理开始========");
...
//            }
        ...
        log.debug("========资源申请审批状态节点前处理设置参与者处理结束========");
    }
}
