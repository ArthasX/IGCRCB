 ...
 * @version 1.0.0
 */
public class IGVIM0205BLImpl extends BaseBLImpl implements WorkFlowEventHandlerBL {
    static Log log = LogFactory.getLog(IGVIM0205BLImpl.class);
    ...
    public void preTreatmentExecute(WorkFlowStatusEventBeanInfo bean) throws BLException {
        ...
        log.debug("======== 资源调整调整异常状态节点前处理设置参与者处理开始========");
        
        List<ParticipantInfo> pInfoList = this.flowSearchBL.searchStatusParticipant(bean.getLogInfo().getPrid(), "调整异常");
        if(pInfoList == null || pInfoList.size() <= 0){
            throw new BLException("IGPRR0102.E006", "调整异常");
        }
        ...
        if(roleList != null && roleList.size() > 0){
            ...
            //封装流程状态名称
            participant.setStatusname("调整异常");
            //删除跃迁节点的原有参与者
...
//            for(UserRoleInfo info :roleList){
                ...
                //封装流程状态名称
                participants.setStatusname("调整异常");
                //参与角色和参与人添加
...
//            }
        ...
        log.debug("========资源调整调整异常状态节点前处理设置参与者处理结束========");
    }
}
