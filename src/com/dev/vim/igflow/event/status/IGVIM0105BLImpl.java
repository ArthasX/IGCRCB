 ...
 * @version 1.0.0
 */
public class IGVIM0105BLImpl extends BaseBLImpl implements WorkFlowEventHandlerBL {
    static Log log = LogFactory.getLog(IGVIM0105BLImpl.class);
    ...
    public void preTreatmentExecute(WorkFlowStatusEventBeanInfo bean) throws BLException {
        ...
        log.debug("======== 资源申请部署异常状态节点前处理设置参与者处理开始========");
        
        List<ParticipantInfo> pInfoList = this.flowSearchBL.searchStatusParticipant(bean.getLogInfo().getPrid(), "部署异常");
        if(pInfoList == null || pInfoList.size() <= 0){
            throw new BLException("IGPRR0102.E006", "部署异常");
        }
        ...
        if(roleList != null && roleList.size() > 0){
            ...
            //封装流程状态名称
            participant.setStatusname("部署异常");
            //删除跃迁节点的原有参与者
...
//            for(UserRoleInfo info :roleList){
                ...
                //封装流程状态名称
                participants.setStatusname("部署异常");
                //参与角色和参与人添加
...
//            }
        ...
        log.debug("========资源申请部署异常状态节点前处理设置参与者处理结束========");
    }
}
