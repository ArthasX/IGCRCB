 ...
 * @version 1.0.0
 */
public class IGVIM0106BLImpl extends BaseBLImpl implements WorkFlowEventHandlerBL {
    static Log log = LogFactory.getLog(IGVIM0106BLImpl.class);
    ...
    public void preTreatmentExecute(WorkFlowStatusEventBeanInfo bean) throws BLException {
        ...
        log.debug("======== 资源申请部署中状态节点前处理设置参与者处理开始========");
        
      //日志参数信息设定
        StatusParticipant participant = new StatusParticipant(bean.getLogInfo());
        
        //封装流程状态名称
        participant.setStatusname("部署中");
        ...
        for(ParticipantInfo info :pInfoList){
            ...
            //封装流程状态名称
            participants.setStatusname("部署中");
            
            //参与角色和参与人添加
            flowSetBL.setStatusParticipant(participants);
        }
        
        log.debug("========资源申请部署中状态节点前处理设置参与者处理结束========");
    }
}
