 ...
 * @version 1.0.0
 */
public class IGVIM0203BLImpl extends BaseBLImpl implements WorkFlowEventHandlerBL {
    static Log log = LogFactory.getLog(IGVIM0203BLImpl.class);
    ...
    public void preTreatmentExecute(WorkFlowStatusEventBeanInfo bean) throws BLException {
        ...
        log.debug("======== 资源调整待调整状态节点前处理设置参与者处理开始========");
        ...
        if(pInfoList == null || pInfoList.size() <= 0){
            throw new BLException("IGPRR0102.E006", "待调整");
        }
...
//            for(UserRoleInfo info :roleList){
                ...
                //封装流程状态名称
                participants.setStatusname("待调整");
                //参与角色和参与人添加
...
//            }
        ...
        log.debug("========资源调整待调整状态节点前处理设置参与者处理结束========");
    }
}
