 ...
 * </p>
 * <p>
 * Description: 虚拟化管理_资源回收_自动回收
 * </p>
 * 
 * @author wangtingzhi@deliverik.com
 * @version 1.0
 */
public class IGVIM0401JOB implements Job{

	private static Log log = LogFactory.getLog(IGVIM0401JOB.class);
    ...
    public static final String JOB_NAME = "RECYCLE_JOB_";
    public static final String JOB_GROUP_NAME = "RECYCLE_JOB_GROUP";
    public static final String TRIGGER_NAME = "RECYCLE_TRIGGER_";
    public static final String TRIGGER_GROUP_NAME = "RECYCLE_TRIGGER_GROUP";
	...
	public void execute(JobExecutionContext context)
	    ...
	    try {
            ...
            String[] result = vimBL.RecycleVM(info.getVcid(), info.getVmName(), cpm);
            ...
            while (!created) {
                ...
                try {
                    ...
                    if (this.isSuccessed()) {
                        ...
                        vim03tb.setStatus(IGVIRCONSTANTS.VM_STATUS_F);
                        this.getVim03BL().updateVim03(vim03tb);
                        created = true;
                        log.debug("--------------- 虚机配置调整完成 ---------------");
                    } else {
