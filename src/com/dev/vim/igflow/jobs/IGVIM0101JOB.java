...
public class IGVIM0101JOB implements Job {

	private static Log log = LogFactory.getLog(IGVIM0101JOB.class);
    ...
    public static final String JOB_NAME = "AUTODEPLOY_JOB_";
    public static final String JOB_GROUP_NAME = "AUTODEPLOY_JOB_GROUP";
    public static final String TRIGGER_NAME = "AUTODEPLOY_TRIGGER_";
    public static final String TRIGGER_GROUP_NAME = "AUTODEPLOY_TRIGGER_GROUP";
	...
	public void execute(JobExecutionContext context)
	    ...
	    try {
            ...
            String[] result = vimBL.cloneVMFromTemplate(template, info.getVmName(), info.getDatacenterName(), info.getResourcePoolName(), cpm);
            ...
            while (!created) {
                ...
                try {
                    ...
                    if (this.isSuccessed()) {
                        ...
                        vim03tb.setStatus(IGVIRCONSTANTS.VM_STATUS_C);
                        // 更新部署时间
                        vim03tb.setApplyTime(IGStringUtils.getCurrentDate());
                        this.getVim03BL().updateVim03(vim03tb);
                        created = true;
                        log.debug("--------------- 虚机部署完成 ---------------");
                    } else {
