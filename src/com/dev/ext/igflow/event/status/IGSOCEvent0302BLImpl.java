...
/**
 * <p>
 * SOC变更"变更准备"节点前处理设置处理人指定到人员
 * </p>
 */
public class IGSOCEvent0302BLImpl extends BaseBLImpl implements
		WorkFlowEventHandlerBL {
	static Log log = LogFactory.getLog(IGSOCEvent0302BLImpl.class);
	...
	public void preTreatmentExecute(WorkFlowStatusEventBeanInfo bean) throws BLException {
		...
		participant.setStatusname("变更准备");
		participant.setUserid(userid);
		participant.setRoleid(1001);
		flowSetBL.setStatusParticipant(participant);
		log.debug("========变更准备前处理设置参与者处理结束========");		
	}
