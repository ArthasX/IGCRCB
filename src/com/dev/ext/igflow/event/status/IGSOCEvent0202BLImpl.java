...
public class IGSOCEvent0202BLImpl extends BaseBLImpl implements
	...
	/**
	 * 流程状态"工程师处理"节点前处理将处理角色指定到人员
	 * 
	 * @param bean 流程信息
	 */
	public void preTreatmentExecute(WorkFlowStatusEventBeanInfo bean) throws BLException {
		log.debug("========工程师处理前处理设置参与者处理开始========");
		//删除当前状态目前的参与者，重新进行设定
		StatusParticipant spInfo = new StatusParticipant(bean.getLogInfo());
		spInfo.setStatusname("工程师处理");
		...
		participant.setStatusname("工程师处理");
		participant.setUserid(userid);
		participant.setRoleid(1001);
		flowSetBL.setStatusParticipant(participant);
		log.debug("========工程师处理前处理设置参与者处理结束========");
	}
