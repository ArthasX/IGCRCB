...
/**
 * <p>
 * SOC变更"处理中"节点前处理设置处理人指定到人员
 * </p>
 */
public class IGSOCEvent0303BLImpl extends BaseBLImpl implements
		WorkFlowEventHandlerBL {
	static Log log = LogFactory.getLog(IGSOCEvent0303BLImpl.class);
