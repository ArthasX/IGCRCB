 ...
 * </p>
 */
public class IGSOCEvent0404BLImpl extends BaseBLImpl implements
		WorkFlowEventHandlerBL {
	static Log log = LogFactory.getLog(IGSOCEvent0404BLImpl.class);
...
//		flowSetBL.setStatusParticipant(participant);
		...
		List<ParticipantInfo> er = flowSearchBL.searchStatusParticipant(bean.getLogInfo().getPrid(), "二级审批");
		...
		if(san != null && san.size() > 0 && er != null && er.size() > 0){
			fv.setFormvalue("2");
		}
