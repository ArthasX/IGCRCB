 ...
 * @version 1.0
 */
public class IGBDS0216BLImpl implements WorkFlowEventHandlerBL{
	...
	public void preTreatmentExecute(WorkFlowStatusEventBeanInfo bean)
			throws BLException {
		//查询参与人
		List<ParticipantInfo> participants = flowSearchBL.searchStatusParticipant(bean.getLogInfo().getPrid(), "变更申请");
