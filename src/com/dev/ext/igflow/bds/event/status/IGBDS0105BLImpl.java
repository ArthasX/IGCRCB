 ...
 * @version 1.0
 */
public class IGBDS0105BLImpl implements WorkFlowEventHandlerBL{
	...
	public void afterTreatmentExecute(WorkFlowStatusEventBeanInfo bean)
			throws BLException {
		String flag = flowSearchBL.searchPublicProcessInfo(bean.getLogInfo().getPrid(), "变更是否实现");
		if("是".equals(flag)){
			...
			record.setDefid("0106001");
			record.setTitle(processInfos.get(0).getPrpdname() + "_" + processInfos.get(0).getPrtitle() + "_发起的配置");
			record.setDescription(processInfos.get(0).getPrpdname() + "_" + processInfos.get(0).getPrtitle() + "_发起的配置");
