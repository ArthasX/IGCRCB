 ...
 * </p>
 * <p>
 * Description: 配置管理预置处理人
 * </p>
 * 
 * @author wangtingzhi@deliverik.com
 * @version 1.0
 */
public class IGBDS0212BLImpl implements WorkFlowEventHandlerBL{
	...
	public void preTreatmentExecute(WorkFlowStatusEventBeanInfo bean)
			throws BLException {
		//查询参与人
		List<ParticipantInfo> participants = flowSearchBL.searchStatusParticipant(bean.getLogInfo().getPrid(), "确认处理期限");
