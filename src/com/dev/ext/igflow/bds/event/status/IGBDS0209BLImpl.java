 ...
 * </p>
 * <p>
 * Description: 重大事件预置处理人
 * </p>
 * 
 * @author wangtingzhi@deliverik.com
 * @version 1.0
 */
public class IGBDS0209BLImpl implements WorkFlowEventHandlerBL{
	...
	public void preTreatmentExecute(WorkFlowStatusEventBeanInfo bean)
			throws BLException {
		//查询参与人
		List<ParticipantInfo> participants = flowSearchBL.searchStatusParticipant(bean.getLogInfo().getPrid(), "集中诊断");
