 ...
 * @author 史凯龙   2014-9-9
 */
public class IGVEN0104BLImpl extends BaseBLImpl implements
		WorkFlowEventHandlerBL {

	/** 日志对象取得 */
	static Log log = LogFactory.getLog(IGVEN0104BLImpl.class);
