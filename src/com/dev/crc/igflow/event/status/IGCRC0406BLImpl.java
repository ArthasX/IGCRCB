...
/***
 * 变更流程 - UAT变更执行分派节点处理人初始化
 * @time 2014/08/26
 * @author wanglei
 * @version 1.0
 * @mail wanglei@deliverik.com
 */
public class IGCRC0406BLImpl extends BaseBLImpl implements WorkFlowEventHandlerBL{
	...
	public void preTreatmentExecute(WorkFlowStatusEventBeanInfo bean) throws BLException {
	    ...
	    log.debug("========变更流程UAT变更执行分派前处理开始========");

	    //获取流程参与者信息
	    List<ParticipantInfo> participantInfos =  flowSearchBL.searchStatusParticipant(bean.getLogInfo().getPrid(), "标准变更执行");
	    for (ParticipantInfo participantInfo : participantInfos) {
	    	...
	    	statusParticipant.setStatusname("UAT变更执行分派");
