 ...
 * @version 1.0
 */
public class IGCRC0601BLImpl extends BaseBLImpl implements
	...
	public void preTreatmentExecute(WorkFlowStatusEventBeanInfo bean)
		...
		if (bean.getBfstatus().equals("0110001009")) {
			//查询子流程发起人
			...
			if(list != null && list.size() > 0){
				...
				flowSetBL.setStatusParticipantRehandle(bean.getLogInfo().getPrid(),
						"处理", info.getPrroleid(), info.getPruserid());
			}
		} else {
