...
/***
 * 变更流程 - UAT变更分派节点处理人初始化
 * @time 2014/07/13
 * @author taoye
 * @version 1.0
 * @mail taoye@deliverik.com
 */
public class IGCRC0403BLImpl extends BaseBLImpl implements WorkFlowEventHandlerBL{
	...
	public void preTreatmentExecute(WorkFlowStatusEventBeanInfo bean) throws BLException {
	    ...
	    statusParticipant.setStatusname("UAT变更分派");
	    statusParticipant.setUserid(participantInfos.get(0).getUserid());
	    statusParticipant.setRoleid(participantInfos.get(0).getRoleid());
	    //添加参与角色和参与人
	    flowSetBL.setStatusParticipant(statusParticipant);
	    
		log.debug("========变更流程UAT变更分派前处理结束========");
	}
}
