...
@Table(name="OutStock")
public class OutStockTB extends BaseEntity implements Serializable, Cloneable, OutStock {

	@Id
	@TableGenerator(
		    name="OUTSTOCK_TABLE_GENERATOR", table="SEQUENCE_GENERATOR_TABLE", 
		    pkColumnName="SEQUENCE_NAME", valueColumnName="SEQUENCE_VALUE", 
		    pkColumnValue="OUTSTOCK_SEQUENCE", initialValue=1, allocationSize=1
	)
	@GeneratedValue(strategy = GenerationType.TABLE, generator="OUTSTOCK_TABLE_GENERATOR")
	...
	public OutStockTB clone(OutStock os){
