 ...
 *
 */
public class ITEMS0174Form extends BaseForm implements OrganizationSearchCond{
	...
	/** 机构层次码集合（平台保留） */
	protected ArrayList<String> not_in_syscoding_area;
	...
	public void setNot_in_syscoding_area(ArrayList<String> not_in_syscoding_area) {
