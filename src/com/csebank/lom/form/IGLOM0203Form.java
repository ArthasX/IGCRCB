...
public class IGLOM0203Form extends BaseForm implements Ginoutstockdetail,GinoutstockdetailSearchCond{
	...
	protected String gscategoryname;
	...
	/**
	 * @param giodoutnum the giodoutnum to set
	 */
	...
	public String getGscategoryname() {
		return gscategoryname;
	}

	public void setGscategoryname(String gscategoryname) {
		this.gscategoryname = gscategoryname;
	}
