...
public class IGLOM0204Form extends BaseForm implements GinoutstockdetailSearchCond{
	...
	protected String[] giodunits;
	protected BigDecimal[] giodinprices;
	protected Integer[] giodinnums;
	...
	public String[] getGiodunits() {
		return giodunits;
	}
	public void setGiodunits(String[] giodunits) {
		this.giodunits = giodunits;
	}
	public BigDecimal[] getGiodinprices() {
		return giodinprices;
	}
	public void setGiodinprices(BigDecimal[] giodinprices) {
		this.giodinprices = giodinprices;
	}
	public Integer[] getGiodinnums() {
		return giodinnums;
	}
	public void setGiodinnums(Integer[] giodinnums) {
		this.giodinnums = giodinnums;
	}
